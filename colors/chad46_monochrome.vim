...
hi NeogitChangeAdded guifg=#c9d36a guibg=#abb54c ctermfg=185 ctermbg=143 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#859ba2 ctermfg=246 cterm=NONE
...
hi Identifier guisp=NONE guifg=#eee8d5 ctermfg=254 cterm=NONE
hi Float guifg=#B8B7B1 ctermfg=249 cterm=NONE
hi Delimiter guifg=#ced4df ctermfg=188 cterm=NONE
hi Define guisp=NONE guifg=#DAD4C3 ctermfg=252 cterm=NONE
...
hi CocInfoHighlight guisp=#8abae1 guifg=#8abae1 ctermfg=110 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#ffe6b5 guifg=#ffe6b5 ctermfg=223 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#ec8989 guifg=#ec8989 ctermfg=210 cterm=NONE gui=undercurl
