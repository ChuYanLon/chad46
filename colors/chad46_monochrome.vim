...
hi BlinkCmpMenuSelection guifg=#101010 guibg=#859ba2 ctermfg=233 ctermbg=246 cterm=NONE gui=bold
hi CmpSel guifg=#101010 guibg=#859ba2 ctermfg=233 ctermbg=246 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#101010 guibg=#8abae1 ctermfg=233 ctermbg=110 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#101010 guibg=#6484a4 ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#101010 guibg=#6484a4 ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#424242 guifg=#101010 ctermfg=233 ctermbg=238 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#8abae1 guifg=#101010 ctermfg=233 ctermbg=110 cterm=NONE
hi CocLoaderMutedBlock guibg=#424242 guifg=#101010 ctermfg=233 ctermbg=238 cterm=NONE
...
hi MiniTablineCurrent guifg=#D8DEE9 guibg=#101010 ctermfg=254 ctermbg=233 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#c9d36a guibg=#101010 ctermfg=185 ctermbg=233 cterm=NONE gui=underline
...
hi NeogitBranchHead guifg=#8abae1 ctermfg=110 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#8abae1 ctermfg=110 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#c9d36a guibg=#abb54c ctermfg=185 ctermbg=143 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#ec8989 ctermfg=210 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#e1bee9 ctermfg=182 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#efb6a0 ctermfg=217 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#9aafe6 ctermfg=110 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#ffe6b5 ctermfg=223 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#c9d36a ctermfg=185 cterm=NONE gui=italic,bold
...
hi GitSignsCurrentLineBlame guifg=#4c4c4c ctermfg=239 cterm=NONE
...
hi LazyH2 guifg=#ec8989 ctermfg=210 cterm=NONE gui=underline,bold
...
hi DevIconJson guifg=#eff6ab ctermfg=229 cterm=NONE
...
hi SnacksPickerDir guifg=#677777 ctermfg=243 cterm=NONE
...
hi TbBufOn guifg=#D8DEE9 guibg=#101010 ctermfg=254 ctermbg=233 cterm=NONE
hi TbBufOff guifg=#677777 guibg=#202020 ctermfg=243 ctermbg=234 cterm=NONE
hi TbBufOnModified guifg=#c9d36a guibg=#101010 ctermfg=185 ctermbg=233 cterm=NONE
hi TbBufOffModified guifg=#ec8989 guibg=#202020 ctermfg=210 ctermbg=234 cterm=NONE
hi TbBufOnClose guifg=#ec8989 guibg=#101010 ctermfg=210 ctermbg=233 cterm=NONE
hi TbBufOffClose guifg=#677777 guibg=#202020 ctermfg=243 ctermbg=234 cterm=NONE
hi TbTabNewBtn guifg=#D8DEE9 guibg=#2e2e2e ctermfg=254 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#ec8989 guibg=#101010 ctermfg=210 ctermbg=233 cterm=NONE
hi TbTabOff guifg=#D8DEE9 guibg=#202020 ctermfg=254 ctermbg=234 cterm=NONE
hi TbTabCloseBtn guifg=#101010 guibg=#a5c6e1 ctermfg=233 ctermbg=152 cterm=NONE
hi TBTabTitle guifg=#101010 guibg=#8abae1 ctermfg=233 ctermbg=110 cterm=NONE
hi TbThemeToggleBtn guifg=#D8DEE9 guibg=#383838 ctermfg=254 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#101010 guibg=#ec8989 ctermfg=233 ctermbg=210 cterm=NONE gui=bold
hi TelescopePromptPrefix guibg=#202020 guifg=#ec8989 ctermfg=210 ctermbg=234 cterm=NONE
...
hi FoldColumn guifg=#ced4df guibg=NONE ctermfg=188 cterm=NONE
...
hi CocHintLine guibg=#1c2126 ctermbg=234 cterm=NONE
hi CocInfoLine guibg=#22292f ctermbg=235 cterm=NONE
hi CocWarningLine guibg=#333028 ctermbg=236 cterm=NONE
hi CocErrorLine guibg=#312222 ctermbg=235 cterm=NONE
hi CocHintSign guifg=#6484a4 ctermfg=67 cterm=NONE
hi CocErrorFloat guifg=#ec8989 guibg=#1a1a1a ctermfg=210 ctermbg=234 cterm=NONE
...
hi CocHintFloat guifg=#6484a4 guibg=#1a1a1a ctermfg=67 ctermbg=234 cterm=NONE
hi CocInfoFloat guifg=#8abae1 guibg=#1a1a1a ctermfg=110 ctermbg=234 cterm=NONE
hi CocWarningFloat guifg=#ffe6b5 guibg=#1a1a1a ctermfg=223 ctermbg=234 cterm=NONE
...
hi CocInlayHint guifg=#677777 guibg=#202020 ctermfg=243 ctermbg=234 cterm=NONE
...
hi NeotestFocused guifg=#ffe6b5 ctermfg=223 cterm=NONE
hi NeotestNamespace guifg=#eff6ab ctermfg=229 cterm=NONE
...
hi CocDiagnosticsFile guifg=#677777 ctermfg=243 cterm=NONE
...
hi CocServicesPrefix guifg=#e1bee9 ctermfg=182 cterm=NONE
hi CocServicesName guifg=#8abae1 ctermfg=110 cterm=NONE
hi CocServicesStat guifg=#c9d36a ctermfg=185 cterm=NONE
hi CocServicesLanguages guifg=#677777 ctermfg=243 cterm=NONE
hi CocSourcesPrefix guifg=#e1bee9 ctermfg=182 cterm=NONE
hi CocSourcesName guifg=#8abae1 ctermfg=110 cterm=NONE
hi CocSourcesPriority guifg=#B8B7B1 ctermfg=249 cterm=NONE
hi CocSourcesFileTypes guifg=#677777 ctermfg=243 cterm=NONE
hi CocSourcesType guifg=#c9d36a ctermfg=185 cterm=NONE
hi CocListsDesc guifg=#677777 ctermfg=243 cterm=NONE
hi CocExtensionsActivated guifg=#c9d36a ctermfg=185 cterm=NONE
hi CocExtensionsLoaded guifg=#D8DEE9 ctermfg=254 cterm=NONE
hi CocExtensionsDisabled guifg=#4c4c4c ctermfg=239 cterm=NONE
hi CocExtensionsName guifg=#c9d36a ctermfg=185 cterm=NONE
hi CocExtensionsLocal guifg=#8abae1 ctermfg=110 cterm=NONE
hi CocExtensionsRoot guifg=#677777 ctermfg=243 cterm=NONE
hi CocOutlineName guifg=#D8DEE9 ctermfg=254 cterm=NONE
hi CocOutlineIndentLine guifg=#677777 ctermfg=243 cterm=NONE
hi CocOutlineKind guifg=#e1bee9 ctermfg=182 cterm=NONE
hi CocOutlineLine guifg=#677777 ctermfg=243 cterm=NONE
hi CocNotificationTime guifg=#677777 ctermfg=243 cterm=NONE
hi CocCommandsTitle guifg=#677777 ctermfg=243 cterm=NONE
...
hi NeotestAdapterName guifg=#e1bee9 ctermfg=182 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#8abae1 ctermfg=110 cterm=NONE
...
hi NeotestPassed guifg=#c9d36a ctermfg=185 cterm=NONE
hi NeotestRunning guifg=#ffe6b5 ctermfg=223 cterm=NONE
hi NeotestFailed guifg=#ec8989 ctermfg=210 cterm=NONE
hi NeotestSkipped guifg=#8abae1 ctermfg=110 cterm=NONE
...
hi NeotestMarked guifg=#8abae1 ctermfg=110 cterm=NONE
hi NeotestTarget guifg=#8abae1 ctermfg=110 cterm=NONE
...
hi NeotestExpandMarker guifg=#606060 ctermfg=59 cterm=NONE
hi NeotestIndent guifg=#606060 ctermfg=59 cterm=NONE
hi NeotestBorder guifg=#8abae1 ctermfg=110 cterm=NONE
hi NeotestDir guifg=#8abae1 ctermfg=110 cterm=NONE
...
hi CocSelectedText guifg=#ec8989 ctermfg=210 cterm=NONE
...
hi CocFloating guifg=#bfc5d0 guibg=#1a1a1a ctermfg=251 ctermbg=234 cterm=NONE
