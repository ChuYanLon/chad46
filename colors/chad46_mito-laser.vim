...
hi TbThemeToggleBtn guibg=#3e318a guifg=#eee8d5 ctermfg=254 ctermbg=60 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#ff047d guifg=#201947 ctermfg=235 ctermbg=198 cterm=NONE gui=bold
