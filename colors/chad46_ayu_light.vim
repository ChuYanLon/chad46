...
hi MasonHeader guifg=#fafafa guibg=#E65050 ctermfg=231 ctermbg=167 cterm=NONE
...
hi NeogitChangeAdded guibg=#4ea125 guifg=#6CBF43 ctermfg=71 ctermbg=70 cterm=NONE gui=bold,italic
...
hi NvimDapViewTabSelected guibg=#fafafa guifg=#26292f ctermfg=235 ctermbg=231 cterm=NONE
hi CmpPmenu guibg=#fafafa ctermbg=231 cterm=NONE
hi NvimDapViewTab guibg=#efefef guifg=#a0a0a0 ctermfg=247 ctermbg=255 cterm=NONE
...
hi LspInlayHint guifg=#a0a0a0 guibg=#f2f2f2 ctermfg=247 ctermbg=255 cterm=NONE
