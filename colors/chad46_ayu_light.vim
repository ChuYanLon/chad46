...
hi TbThemeToggleBtn guibg=#d7d7d7 guifg=#26292f ctermfg=235 ctermbg=188 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#E65050 guifg=#fafafa ctermfg=231 ctermbg=167 cterm=NONE gui=bold
