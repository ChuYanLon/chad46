...
hi CocCursorRange guibg=#2a2d36 ctermbg=236 cterm=NONE
hi CocErrorHighlight guifg=#FD98B9 ctermfg=211 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#becf00 ctermfg=148 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#9fd4ff ctermfg=153 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#7fdbca ctermfg=116 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#424956 ctermbg=239 cterm=NONE
hi CocSelectedText guibg=#3c424e guifg=#ffffff ctermfg=231 ctermbg=238 cterm=NONE
hi CocCodeLens guifg=#606c7e ctermfg=60 cterm=NONE
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocUnused guifg=#545e6e ctermfg=59 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocListMode guifg=#9fd4ff ctermfg=153 cterm=NONE
hi CocListSearch guifg=#becf00 guibg=#363b46 ctermfg=148 ctermbg=237 cterm=NONE
...
hi CocNormalFloat guibg=#1f2128 ctermbg=235 cterm=NONE
