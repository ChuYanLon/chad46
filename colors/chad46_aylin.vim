...
hi BlinkCmpMenuSelection guifg=#24262E guibg=#addb67 ctermfg=235 ctermbg=149 cterm=NONE gui=bold
hi CmpSel guifg=#24262E guibg=#addb67 ctermfg=235 ctermbg=149 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#545e6e ctermfg=59 cterm=NONE
...
hi Tabline guibg=#2a2d36 ctermbg=236 cterm=NONE
hi TbFill guibg=#2a2d36 ctermbg=236 cterm=NONE
hi TbBufOn guifg=#ffffff guibg=#24262E ctermfg=231 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#606c7e guibg=#2a2d36 ctermfg=60 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#9fd54d guibg=#24262E ctermfg=149 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#FD98B9 guibg=#2a2d36 ctermfg=211 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#FD98B9 guibg=#24262E ctermfg=211 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#606c7e guibg=#2a2d36 ctermfg=60 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#ffffff guibg=#3c424e ctermfg=231 ctermbg=238 cterm=NONE
hi TbTabOn guifg=#FD98B9 guibg=#24262E ctermfg=211 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#ffffff guibg=#2a2d36 ctermfg=231 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#24262E guibg=#6cbeff ctermfg=235 ctermbg=75 cterm=NONE
hi TBTabTitle guifg=#24262E guibg=#9fd4ff ctermfg=235 ctermbg=153 cterm=NONE
hi TbThemeToggleBtn guifg=#ffffff guibg=#424956 ctermfg=231 ctermbg=239 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#24262E guibg=#FD98B9 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
...
hi TodoBgFix guifg=#2a2d36 guibg=#FD98B9 ctermfg=236 ctermbg=211 cterm=NONE gui=bold
hi TodoBgHack guifg=#2a2d36 guibg=#ecc48d ctermfg=236 ctermbg=222 cterm=NONE gui=bold
hi TodoBgNote guifg=#2a2d36 guibg=#ffffff ctermfg=236 ctermbg=231 cterm=NONE gui=bold
hi TodoBgPerf guifg=#2a2d36 guibg=#d9b6f0 ctermfg=236 ctermbg=183 cterm=NONE gui=bold
hi TodoBgTest guifg=#2a2d36 guibg=#d9b6f0 ctermfg=236 ctermbg=183 cterm=NONE gui=bold
hi TodoBgTodo guifg=#2a2d36 guibg=#becf00 ctermfg=236 ctermbg=148 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#24262E guibg=#9fd4ff ctermfg=235 ctermbg=153 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#24262E guibg=#7fdbca ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#24262E guibg=#7fdbca ctermfg=235 ctermbg=116 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guifg=#2a2d36 guibg=#4e5766 ctermfg=236 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#24262E guibg=#7fdbca ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#24262E guibg=#7fdbca ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#24262E guibg=#4e5766 ctermfg=235 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#24262E guibg=#FD98B9 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#24262E guibg=#FD98B9 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#9fd4ff guibg=#3c424e ctermfg=153 ctermbg=238 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#ecc48d guibg=#3c424e ctermfg=222 ctermbg=238 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#9fd54d guibg=#81b72f ctermfg=149 ctermbg=106 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#7fdbca guibg=#2a2d36 ctermfg=116 ctermbg=236 cterm=NONE gui=bold
...
hi NeotestPassed guifg=#9fd54d ctermfg=149 cterm=NONE
hi NeotestRunning guifg=#becf00 ctermfg=148 cterm=NONE
hi NeotestFailed guifg=#FD98B9 ctermfg=211 cterm=NONE
hi NeotestSkipped guifg=#9fd4ff ctermfg=153 cterm=NONE
hi NeotestTest guifg=#545e6e ctermfg=59 cterm=NONE
hi NeotestNamespace guifg=#addb67 ctermfg=149 cterm=NONE
hi NeotestFocused guifg=#becf00 ctermfg=148 cterm=NONE
hi NeotestFile guifg=#7fdbca ctermfg=116 cterm=NONE
hi NeotestDir guifg=#9fd4ff ctermfg=153 cterm=NONE
hi NeotestBorder guifg=#9fd4ff ctermfg=153 cterm=NONE
hi NeotestIndent guifg=#5a6576 ctermfg=60 cterm=NONE
hi NeotestExpandMarker guifg=#5a6576 ctermfg=60 cterm=NONE
hi NeotestAdapterName guifg=#d9b6f0 ctermfg=183 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#9fd4ff ctermfg=153 cterm=NONE
hi NeotestMarked guifg=#9fd4ff ctermfg=153 cterm=NONE
hi NeotestTarget guifg=#9fd4ff ctermfg=153 cterm=NONE
...
hi MiniTablineCurrent guifg=#ffffff guibg=#24262E ctermfg=231 ctermbg=235 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#9fd54d guibg=#24262E ctermfg=149 ctermbg=235 cterm=NONE gui=underline
