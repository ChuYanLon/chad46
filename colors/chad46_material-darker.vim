...
hi BlinkCmpMenuSelection guifg=#212121 guibg=#6e98eb ctermfg=234 ctermbg=68 cterm=NONE gui=bold
hi CmpSel guifg=#212121 guibg=#6e98eb ctermfg=234 ctermbg=68 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#212121 guibg=#82aaff ctermfg=234 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#212121 guibg=#abcf76 ctermfg=234 ctermbg=150 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#212121 guibg=#abcf76 ctermfg=234 ctermbg=150 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#4A4A4A guifg=#212121 ctermfg=234 ctermbg=239 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#82aaff ctermfg=111 cterm=NONE
hi CocLoaderMuted guifg=#6B6B6B ctermfg=242 cterm=NONE
hi def link CocLoaderError ErrorMsg
hi ErrorMsg guifg=#b0bec5 guibg=#212121 ctermfg=250 ctermbg=234 cterm=NONE
hi def link CocLoaderNormal NormalFloat
hi NormalFloat guibg=#191919 ctermbg=234 cterm=NONE
hi def link CocLoaderSearchMatch Search
hi Search guifg=#292929 guibg=#ffcb6b ctermfg=235 ctermbg=221 cterm=NONE
hi CocLoaderWarning guifg=#ffcb6b ctermfg=221 cterm=NONE
hi CocLoaderBackdrop guibg=#212121 ctermbg=234 cterm=NONE
hi CocLoaderHighlightBlock guibg=#82aaff guifg=#212121 ctermfg=234 ctermbg=111 cterm=NONE
hi CocLoaderMutedBlock guibg=#4A4A4A guifg=#212121 ctermfg=234 ctermbg=239 cterm=NONE
...
hi PmenuSel guibg=#6e98eb guifg=#212121 ctermfg=234 ctermbg=68 cterm=NONE
...
hi Todo guifg=#ffcb6b guibg=#292929 ctermfg=221 ctermbg=235 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#292929 guibg=#4A4A4A ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#eeffff guibg=#212121 ctermfg=231 ctermbg=234 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#c3e88d guibg=#212121 ctermfg=150 ctermbg=234 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#82aaff guibg=#383838 ctermfg=111 ctermbg=237 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#c3e88d guibg=#a5ca6f ctermfg=150 ctermbg=149 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#89ddff guibg=#292929 ctermfg=117 ctermbg=235 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#545454 ctermfg=240 cterm=NONE
...
hi LspSignatureActiveParameter guifg=#212121 guibg=#c3e88d ctermfg=234 ctermbg=150 cterm=NONE
...
hi MasonHighlightBlock guifg=#212121 guibg=#c3e88d ctermfg=234 ctermbg=150 cterm=NONE
hi def link MasonHighlightBlockBold MasonHighlightBlock
hi def link MasonHeaderSecondary MasonHighlightBlock
hi MasonMuted guifg=#6B6B6B ctermfg=242 cterm=NONE
hi MasonMutedBlock guifg=#6B6B6B guibg=#303030 ctermfg=242 ctermbg=236 cterm=NONE
...
hi BufferLineBackground guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi BufferlineIndicatorVisible guifg=#292929 guibg=#292929 ctermfg=235 ctermbg=235 cterm=NONE
hi BufferLineBufferSelected guifg=#eeffff guibg=#212121 ctermfg=231 ctermbg=234 cterm=NONE
hi BufferLineBufferVisible guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi BufferLineError guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi BufferLineErrorDiagnostic guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi DapUIRestartNC guifg=#c3e88d ctermfg=150 cterm=NONE
hi BufferLineCloseButtonVisible guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi BufferLineCloseButtonSelected guifg=#f07178 guibg=#212121 ctermfg=204 ctermbg=234 cterm=NONE
hi BufferLineFill guifg=#545454 guibg=#292929 ctermfg=240 ctermbg=235 cterm=NONE
hi BufferlineIndicatorSelected guifg=#212121 guibg=#212121 ctermfg=234 ctermbg=234 cterm=NONE
hi BufferLineModified guifg=#f07178 guibg=#292929 ctermfg=204 ctermbg=235 cterm=NONE
hi BufferLineModifiedVisible guifg=#f07178 guibg=#292929 ctermfg=204 ctermbg=235 cterm=NONE
hi BufferLineModifiedSelected guifg=#c3e88d guibg=#212121 ctermfg=150 ctermbg=234 cterm=NONE
...
hi FloatTitle guifg=#eeffff guibg=#4A4A4A ctermfg=231 ctermbg=239 cterm=NONE
hi NvimInternalError guifg=#f07178 ctermfg=204 cterm=NONE
hi WinSeparator guifg=#383838 ctermfg=237 cterm=NONE
hi Normal guifg=#DFF0F0 guibg=#212121 ctermfg=255 ctermbg=234 cterm=NONE
...
hi Error guifg=#212121 guibg=#b0bec5 ctermfg=234 ctermbg=250 cterm=NONE
hi CmpItemKindTabNine guifg=#FFADFF ctermfg=219 cterm=NONE
hi CmpItemKindSuperMaven guifg=#ffcb6b ctermfg=221 cterm=NONE
hi Folded guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi IncSearch guifg=#292929 guibg=#f78c6c ctermfg=235 ctermbg=209 cterm=NONE
...
hi Substitute guifg=#292929 guibg=#ffcb6b ctermfg=235 ctermbg=221 cterm=NONE
...
hi WildMenu guifg=#b0bec5 guibg=#ffcb6b ctermfg=250 ctermbg=221 cterm=NONE
hi Title guifg=#82aaff ctermfg=111 cterm=NONE
hi Conceal guibg=NONE cterm=NONE
hi Cursor guifg=#212121 guibg=#DFF0F0 ctermfg=234 ctermbg=255 cterm=NONE
...
hi LazyH1 guibg=#c3e88d guifg=#212121 ctermfg=234 ctermbg=150 cterm=NONE
hi LazyButton guibg=#303030 guifg=#757575 ctermfg=243 ctermbg=236 cterm=NONE
...
hi DevIconJson guifg=#e6b455 ctermfg=179 cterm=NONE
...
hi SnacksPickerTitle guifg=#545454 guibg=#c3e88d ctermfg=240 ctermbg=150 cterm=NONE
hi SnacksPickerPreviewTitle guifg=#545454 guibg=#82aaff ctermfg=240 ctermbg=111 cterm=NONE
hi SnacksPickerListTitle guifg=#545454 guibg=#f07178 ctermfg=240 ctermbg=204 cterm=NONE
hi SnacksPickerFooter guifg=#545454 ctermfg=240 cterm=NONE
hi SnacksPickerMatch guibg=#303030 guifg=#82aaff ctermfg=111 ctermbg=236 cterm=NONE
...
hi SnacksPickerDir guifg=#6B6B6B ctermfg=242 cterm=NONE
hi SnacksPickerDelim guifg=#545454 ctermfg=240 cterm=NONE
hi SnacksPickerRow guifg=#545454 ctermfg=240 cterm=NONE
hi SnacksPickerPathIgnored guifg=#4A4A4A ctermfg=239 cterm=NONE
hi SnacksPickerPathHidden guifg=#4A4A4A ctermfg=239 cterm=NONE
...
hi Tabline guibg=#292929 ctermbg=235 cterm=NONE
hi TbFill guibg=#292929 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#eeffff guibg=#212121 ctermfg=231 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#c3e88d guibg=#212121 ctermfg=150 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#f07178 guibg=#292929 ctermfg=204 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#f07178 guibg=#212121 ctermfg=204 ctermbg=234 cterm=NONE
hi TbBufOffClose guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#eeffff guibg=#383838 ctermfg=231 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#f07178 guibg=#212121 ctermfg=204 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#eeffff guibg=#292929 ctermfg=231 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#212121 guibg=#6e98eb ctermfg=234 ctermbg=68 cterm=NONE
hi TBTabTitle guifg=#212121 guibg=#82aaff ctermfg=234 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#eeffff guibg=#404040 ctermfg=231 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#212121 guibg=#f07178 ctermfg=234 ctermbg=204 cterm=NONE gui=bold
...
hi FoldColumn guifg=#f07178 guibg=NONE ctermfg=204 cterm=NONE
hi CursorLine guibg=#292929 ctermbg=235 cterm=NONE
hi QuickFixLine guibg=#292929 ctermbg=235 cterm=NONE
hi healthSuccess guibg=#c3e88d guifg=#212121 ctermfg=234 ctermbg=150 cterm=NONE
...
hi Identifier guisp=NONE guifg=#eeffff ctermfg=231 cterm=NONE
...
hi Operator guifg=#DFF0F0 guisp=NONE ctermfg=255 cterm=NONE
...
hi BufferLineDuplicateVisible guifg=#82aaff guibg=#292929 ctermfg=111 ctermbg=235 cterm=NONE
hi BufferLineDuplicateSelected guifg=#f07178 guibg=#212121 ctermfg=204 ctermbg=234 cterm=NONE
...
hi Type guisp=NONE guifg=#c792ea ctermfg=176 cterm=NONE
...
hi CocHintLine guibg=#353b2d ctermbg=236 cterm=NONE
hi CocInfoLine guibg=#2f3542 ctermbg=237 cterm=NONE
hi CocWarningLine guibg=#423a2c ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#402d2e ctermbg=236 cterm=NONE
hi CocHintSign guifg=#abcf76 ctermfg=150 cterm=NONE
hi CocErrorFloat guifg=#f07178 guibg=#191919 ctermfg=204 ctermbg=234 cterm=NONE
...
hi BufferLineTabSelected guifg=#292929 guibg=#6e98eb ctermfg=235 ctermbg=68 cterm=NONE
hi BufferLineTabClose guifg=#f07178 guibg=#212121 ctermfg=204 ctermbg=234 cterm=NONE
...
hi CocHintHighlight guifg=#abcf76 guisp=#abcf76 ctermfg=150 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#545454 ctermfg=240 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#abcf76 guibg=#191919 ctermfg=150 ctermbg=234 cterm=NONE
hi CocInfoFloat guifg=#82aaff guibg=#191919 ctermfg=111 ctermbg=234 cterm=NONE
hi CocWarningFloat guifg=#ffcb6b guibg=#191919 ctermfg=221 ctermbg=234 cterm=NONE
...
hi CocInlayHint guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#212121 guibg=#89ddff ctermfg=234 ctermbg=117 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#212121 guibg=#89ddff ctermfg=234 ctermbg=117 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#212121 guibg=#b480d6 ctermfg=234 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#212121 guibg=#b480d6 ctermfg=234 ctermbg=140 cterm=NONE gui=bold
...
hi NeotestFile guifg=#89ddff ctermfg=117 cterm=NONE
hi NeotestFocused guifg=#ffcb6b ctermfg=221 cterm=NONE
hi NeotestNamespace guifg=#c3e88d ctermfg=150 cterm=NONE
hi NeotestTest guifg=#545454 ctermfg=240 cterm=NONE
...
hi NeogitHunkHeader guifg=#212121 guibg=#4A4A4A ctermfg=234 ctermbg=239 cterm=NONE gui=bold
...
hi CocDiagnosticsFile guifg=#6B6B6B ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#c792ea ctermfg=176 cterm=NONE
hi CocServicesName guifg=#82aaff ctermfg=111 cterm=NONE
hi CocServicesStat guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocServicesLanguages guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#c792ea ctermfg=176 cterm=NONE
hi CocSourcesName guifg=#82aaff ctermfg=111 cterm=NONE
hi CocSourcesPriority guifg=#f78c6c ctermfg=209 cterm=NONE
hi CocSourcesFileTypes guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocListsDesc guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocExtensionsLoaded guifg=#eeffff ctermfg=231 cterm=NONE
hi CocExtensionsDisabled guifg=#545454 ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocExtensionsLocal guifg=#82aaff ctermfg=111 cterm=NONE
hi CocExtensionsRoot guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#eeffff ctermfg=231 cterm=NONE
hi CocOutlineIndentLine guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#c792ea ctermfg=176 cterm=NONE
hi CocOutlineLine guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#6B6B6B ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#6B6B6B ctermfg=242 cterm=NONE
...
hi NeotestAdapterName guifg=#c792ea ctermfg=176 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#82aaff ctermfg=111 cterm=NONE
...
hi NeotestPassed guifg=#c3e88d ctermfg=150 cterm=NONE
hi NeotestRunning guifg=#ffcb6b ctermfg=221 cterm=NONE
hi NeotestFailed guifg=#f07178 ctermfg=204 cterm=NONE
hi NeotestSkipped guifg=#82aaff ctermfg=111 cterm=NONE
...
hi TodoBgTodo guifg=#292929 guibg=#ffcb6b ctermfg=235 ctermbg=221 cterm=NONE gui=bold
hi NeotestMarked guifg=#82aaff ctermfg=111 cterm=NONE
hi NeotestTarget guifg=#82aaff ctermfg=111 cterm=NONE
...
hi NoiceFormatProgressDone guibg=#c3e88d guifg=#212121 ctermfg=234 ctermbg=150 cterm=NONE
...
hi TodoBgFix guifg=#292929 guibg=#f07178 ctermfg=235 ctermbg=204 cterm=NONE gui=bold
hi TodoBgHack guifg=#292929 guibg=#f78c6c ctermfg=235 ctermbg=209 cterm=NONE gui=bold
hi TodoBgNote guifg=#292929 guibg=#eeffff ctermfg=235 ctermbg=231 cterm=NONE gui=bold
hi TodoBgPerf guifg=#292929 guibg=#c792ea ctermfg=235 ctermbg=176 cterm=NONE gui=bold
hi TodoBgTest guifg=#292929 guibg=#c792ea ctermfg=235 ctermbg=176 cterm=NONE gui=bold
...
hi NeotestBorder guifg=#82aaff ctermfg=111 cterm=NONE
hi NeotestDir guifg=#82aaff ctermfg=111 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#f78c6c guibg=#383838 ctermfg=209 ctermbg=237 cterm=NONE gui=bold
...
hi CocFloating guifg=#DFF0F0 guibg=#191919 ctermfg=255 ctermbg=234 cterm=NONE
hi CocMenuSel guibg=#6e98eb guifg=#212121 ctermfg=234 ctermbg=68 cterm=NONE
hi def link CocListSearch CocSearch
hi CocListMode guifg=#82aaff ctermfg=111 cterm=NONE
hi CocSelectedLine guibg=#292929 ctermbg=235 cterm=NONE
...
hi BufferLineCloseButton guifg=#6B6B6B guibg=#292929 ctermfg=242 ctermbg=235 cterm=NONE
...
hi BufferLineTab guifg=#6B6B6B guibg=#404040 ctermfg=242 ctermbg=238 cterm=NONE
...
hi MatchWord guibg=#4A4A4A guifg=#eeffff ctermfg=231 ctermbg=239 cterm=NONE
