...
hi CocLoaderHeader guifg=#292D3E guibg=#82aaff ctermfg=236 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#292D3E guibg=#89ffe6 ctermfg=236 ctermbg=122 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#292D3E guibg=#89ffe6 ctermfg=236 ctermbg=122 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#ffffff guibg=#292D3E ctermfg=231 ctermbg=236 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#c3e88d guibg=#292D3E ctermfg=150 ctermbg=236 cterm=NONE gui=underline
...
hi TodoBgFix guifg=#2f3344 guibg=#f07178 ctermfg=237 ctermbg=204 cterm=NONE gui=bold
hi TodoBgHack guifg=#2f3344 guibg=#ffa282 ctermfg=237 ctermbg=216 cterm=NONE gui=bold
hi TodoBgNote guifg=#2f3344 guibg=#ffffff ctermfg=237 ctermbg=231 cterm=NONE gui=bold
hi TodoBgPerf guifg=#2f3344 guibg=#c792ea ctermfg=237 ctermbg=176 cterm=NONE gui=bold
hi TodoBgTest guifg=#2f3344 guibg=#c792ea ctermfg=237 ctermbg=176 cterm=NONE gui=bold
hi TodoBgTodo guifg=#2f3344 guibg=#ffcb6b ctermfg=237 ctermbg=221 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#82aaff guibg=#3c4051 ctermfg=111 ctermbg=238 cterm=NONE gui=bold
...
hi NeogitChangeUpdated guifg=#ffa282 ctermfg=216 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#89ddff guibg=#2f3344 ctermfg=117 ctermbg=237 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#5b5f70 ctermfg=241 cterm=NONE
...
hi CocErrorLine guibg=#463746 ctermbg=238 cterm=NONE
hi CocWarningLine guibg=#494444 ctermbg=238 cterm=NONE
hi CocInfoLine guibg=#363f5a ctermbg=238 cterm=NONE
hi CocHintLine guibg=#374c57 ctermbg=238 cterm=NONE
...
hi CocSelectedLine guibg=#2f3344 ctermbg=237 cterm=NONE
...
hi Tabline guibg=#2f3344 ctermbg=237 cterm=NONE
hi TbFill guibg=#2f3344 ctermbg=237 cterm=NONE
hi TbBufOn guifg=#ffffff guibg=#292D3E ctermfg=231 ctermbg=236 cterm=NONE
hi TbBufOff guifg=#6d7182 guibg=#2f3344 ctermfg=243 ctermbg=237 cterm=NONE
hi TbBufOnModified guifg=#c3e88d guibg=#292D3E ctermfg=150 ctermbg=236 cterm=NONE
hi TbBufOffModified guifg=#f07178 guibg=#2f3344 ctermfg=204 ctermbg=237 cterm=NONE
hi TbBufOnClose guifg=#f07178 guibg=#292D3E ctermfg=204 ctermbg=236 cterm=NONE
hi TbBufOffClose guifg=#6d7182 guibg=#2f3344 ctermfg=243 ctermbg=237 cterm=NONE
hi TbTabNewBtn guifg=#ffffff guibg=#3c4051 ctermfg=231 ctermbg=238 cterm=NONE
hi TbTabOn guifg=#f07178 guibg=#292D3E ctermfg=204 ctermbg=236 cterm=NONE
hi TbTabOff guifg=#ffffff guibg=#2f3344 ctermfg=231 ctermbg=237 cterm=NONE
hi TbTabCloseBtn guifg=#292D3E guibg=#8fb7ff ctermfg=236 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#292D3E guibg=#82aaff ctermfg=236 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#ffffff guibg=#444859 ctermfg=231 ctermbg=239 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#292D3E guibg=#f07178 ctermfg=236 ctermbg=204 cterm=NONE gui=bold
...
hi CocFloating guifg=#d3d3d3 guibg=#232738 ctermfg=252 ctermbg=236 cterm=NONE
...
hi CocDiagnosticsFile guifg=#6d7182 ctermfg=243 cterm=NONE
...
hi CocServicesLanguages guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocSourcesPrefix guifg=#c792ea ctermfg=176 cterm=NONE
hi CocSourcesName guifg=#82aaff ctermfg=111 cterm=NONE
hi CocSourcesPriority guifg=#ffa282 ctermfg=216 cterm=NONE
hi CocSourcesFileTypes guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocSourcesType guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocListsDesc guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocExtensionsActivated guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocExtensionsLoaded guifg=#ffffff ctermfg=231 cterm=NONE
hi CocExtensionsDisabled guifg=#5b5f70 ctermfg=241 cterm=NONE
hi CocExtensionsName guifg=#c3e88d ctermfg=150 cterm=NONE
hi CocExtensionsLocal guifg=#82aaff ctermfg=111 cterm=NONE
hi CocExtensionsRoot guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocOutlineName guifg=#ffffff ctermfg=231 cterm=NONE
hi CocOutlineIndentLine guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocOutlineKind guifg=#c792ea ctermfg=176 cterm=NONE
hi CocOutlineLine guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocNotificationTime guifg=#6d7182 ctermfg=243 cterm=NONE
hi CocCommandsTitle guifg=#6d7182 ctermfg=243 cterm=NONE
...
hi NeotestTest guifg=#5b5f70 ctermfg=241 cterm=NONE
hi NeotestNamespace guifg=#96e88d ctermfg=114 cterm=NONE
...
hi NeotestIndent guifg=#65697a ctermfg=242 cterm=NONE
hi NeotestExpandMarker guifg=#65697a ctermfg=242 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#ffa282 guibg=#3c4051 ctermfg=216 ctermbg=238 cterm=NONE gui=bold
...
hi TelescopePromptPrefix guibg=#2f3344 guifg=#f07178 ctermfg=204 ctermbg=237 cterm=NONE
...
hi NeogitHunkHeaderCursor guifg=#292D3E guibg=#b383d2 ctermfg=236 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#292D3E guibg=#b383d2 ctermfg=236 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#292D3E guibg=#515566 ctermfg=236 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#292D3E guibg=#89ddff ctermfg=236 ctermbg=117 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#292D3E guibg=#89ddff ctermfg=236 ctermbg=117 cterm=NONE gui=bold
hi NeogitHunkMergeHeader guifg=#2f3344 guibg=#515566 ctermfg=237 ctermbg=240 cterm=NONE gui=bold
...
hi FoldColumn guifg=#ff5370 guibg=NONE ctermfg=203 cterm=NONE
