...
hi Type guisp=NONE guifg=#7199ee ctermfg=69 cterm=NONE
...
hi Identifier guisp=NONE guifg=#ee6d85 ctermfg=204 cterm=NONE
hi Float guifg=#7199ee ctermfg=69 cterm=NONE
hi Delimiter guifg=#f3627a ctermfg=204 cterm=NONE
hi Define guisp=NONE guifg=#a485dd ctermfg=140 cterm=NONE
...
hi CocInfoHighlight guisp=#7199ee guifg=#7199ee ctermfg=69 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#d7a65f guifg=#d7a65f ctermfg=179 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#ee6d85 guifg=#ee6d85 ctermfg=204 cterm=NONE gui=undercurl
