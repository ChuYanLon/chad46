...
hi CocLoaderHeader guifg=#282828 guibg=#458588 ctermfg=235 ctermbg=66 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#282828 guibg=#749689 ctermfg=235 ctermbg=102 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#282828 guibg=#749689 ctermfg=235 ctermbg=102 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#b8bb26 guibg=#9a9d08 ctermfg=142 ctermbg=106 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#fb4934 ctermfg=203 cterm=NONE gui=italic,bold
...
hi NeogitChangeNewFile guifg=#b8bb26 ctermfg=142 cterm=NONE gui=italic,bold
...
hi Tabline guibg=#2e2e2e ctermbg=236 cterm=NONE
hi TbFill guibg=#2e2e2e ctermbg=236 cterm=NONE
hi TbBufOn guifg=#ebdbb2 guibg=#282828 ctermfg=187 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#656565 guibg=#2e2e2e ctermfg=241 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#b8bb26 guibg=#282828 ctermfg=142 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#fb4934 guibg=#2e2e2e ctermfg=203 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#fb4934 guibg=#282828 ctermfg=203 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#656565 guibg=#2e2e2e ctermfg=241 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#ebdbb2 guibg=#3f3f3f ctermfg=187 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#fb4934 guibg=#282828 ctermfg=203 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#ebdbb2 guibg=#2e2e2e ctermfg=187 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#282828 guibg=#83a598 ctermfg=235 ctermbg=108 cterm=NONE
hi TBTabTitle guifg=#282828 guibg=#458588 ctermfg=235 ctermbg=66 cterm=NONE
hi TbThemeToggleBtn guifg=#ebdbb2 guibg=#444444 ctermfg=187 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#282828 guibg=#fb4934 ctermfg=235 ctermbg=203 cterm=NONE gui=bold
hi TelescopePromptPrefix guibg=#2e2e2e guifg=#fb4934 ctermfg=203 ctermbg=236 cterm=NONE
...
hi Operator guisp=NONE guifg=#83a598 ctermfg=108 cterm=NONE
...
hi CocHintLine guibg=#333836 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#2c3536 ctermbg=236 cterm=NONE
hi CocWarningLine guibg=#423826 ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#472c29 ctermbg=236 cterm=NONE
...
hi CocServicesStat guifg=#b8bb26 ctermfg=142 cterm=NONE
...
hi CocSourcesPriority guifg=#fe8019 ctermfg=208 cterm=NONE
hi CocSourcesFileTypes guifg=#656565 ctermfg=241 cterm=NONE
hi CocSourcesType guifg=#b8bb26 ctermfg=142 cterm=NONE
hi CocListsDesc guifg=#656565 ctermfg=241 cterm=NONE
hi CocExtensionsActivated guifg=#b8bb26 ctermfg=142 cterm=NONE
hi CocExtensionsLoaded guifg=#ebdbb2 ctermfg=187 cterm=NONE
hi CocExtensionsDisabled guifg=#4e4e4e ctermfg=239 cterm=NONE
hi CocExtensionsName guifg=#b8bb26 ctermfg=142 cterm=NONE
hi CocExtensionsLocal guifg=#458588 ctermfg=66 cterm=NONE
hi CocExtensionsRoot guifg=#656565 ctermfg=241 cterm=NONE
hi CocOutlineName guifg=#ebdbb2 ctermfg=187 cterm=NONE
...
hi NeotestPassed guifg=#b8bb26 ctermfg=142 cterm=NONE
hi NeotestRunning guifg=#d79921 ctermfg=172 cterm=NONE
hi NeotestFailed guifg=#fb4934 ctermfg=203 cterm=NONE
...
hi NeotestExpandMarker guifg=#505050 ctermfg=239 cterm=NONE
hi NeotestIndent guifg=#505050 ctermfg=239 cterm=NONE
...
hi CocSelectedText guifg=#fb4934 ctermfg=203 cterm=NONE
...
hi CocFloating guifg=#d5c4a1 guibg=#232323 ctermfg=187 ctermbg=235 cterm=NONE
...
hi CocSelectedLine guibg=#2e2e2e ctermbg=236 cterm=NONE
