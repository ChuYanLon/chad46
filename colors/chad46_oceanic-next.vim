...
hi CocLoaderHeader guifg=#1B2B34 guibg=#6699CC ctermfg=235 ctermbg=68 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1B2B34 guibg=#50a4a4 ctermfg=235 ctermbg=73 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1B2B34 guibg=#50a4a4 ctermfg=235 ctermbg=73 cterm=NONE gui=bold
...
hi ErrorMsg guifg=#6cbdbc guibg=#1B2B34 ctermfg=73 ctermbg=235 cterm=NONE
...
hi Search guifg=#343D46 guibg=#F99157 ctermfg=237 ctermbg=209 cterm=NONE
...
hi PmenuSel guibg=#15bf84 guifg=#1B2B34 ctermfg=235 ctermbg=36 cterm=NONE
...
hi Todo guifg=#F99157 guibg=#343D46 ctermfg=209 ctermbg=237 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#21313a guibg=#43535c ctermfg=236 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#1B2B34 guibg=#62B3B2 ctermfg=235 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#1B2B34 guibg=#62B3B2 ctermfg=235 ctermbg=73 cterm=NONE gui=bold
hi MiniTablineHidden guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi MiniTablineModifiedCurrent guifg=#99C794 guibg=#1B2B34 ctermfg=114 ctermbg=235 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#6699CC guibg=#2e3e47 ctermfg=68 ctermbg=237 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#99C794 guibg=#7ba976 ctermfg=114 ctermbg=108 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#EC5F67 ctermfg=203 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#C594C5 ctermfg=176 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#F99157 ctermfg=209 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#62B3B2 ctermfg=73 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#FAC863 ctermfg=221 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#99C794 ctermfg=114 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#62B3B2 guibg=#21313a ctermfg=73 ctermbg=236 cterm=NONE gui=bold
hi FlashMatch guifg=#1B2B34 guibg=#6699CC ctermfg=235 ctermbg=68 cterm=NONE
hi FlashCurrent guifg=#1B2B34 guibg=#99C794 ctermfg=235 ctermbg=114 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#4d5d66 ctermfg=240 cterm=NONE
...
hi LspSignatureActiveParameter guifg=#1B2B34 guibg=#99C794 ctermfg=235 ctermbg=114 cterm=NONE
hi LspInlayHint guibg=#21313a guifg=#5f6f78 ctermfg=242 ctermbg=236 cterm=NONE
...
hi TodoBgFix guifg=#21313a guibg=#EC5F67 ctermfg=236 ctermbg=203 cterm=NONE gui=bold
hi TodoBgHack guifg=#21313a guibg=#F99157 ctermfg=236 ctermbg=209 cterm=NONE gui=bold
hi TodoBgNote guifg=#21313a guibg=#D8DEE9 ctermfg=236 ctermbg=254 cterm=NONE gui=bold
hi TodoBgPerf guifg=#21313a guibg=#C594C5 ctermfg=236 ctermbg=176 cterm=NONE gui=bold
hi TodoBgTest guifg=#21313a guibg=#C594C5 ctermfg=236 ctermbg=176 cterm=NONE gui=bold
hi TodoBgTodo guifg=#21313a guibg=#FAC863 ctermfg=236 ctermbg=221 cterm=NONE gui=bold
...
hi MasonMutedBlock guifg=#5f6f78 guibg=#25353e ctermfg=242 ctermbg=236 cterm=NONE
...
hi BufferLineBackground guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi BufferlineIndicatorVisible guifg=#21313a guibg=#21313a ctermfg=236 ctermbg=236 cterm=NONE
hi BufferLineBufferSelected guifg=#D8DEE9 guibg=#1B2B34 ctermfg=254 ctermbg=235 cterm=NONE
hi BufferLineBufferVisible guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi BufferLineError guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi BufferLineErrorDiagnostic guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi DapUIRestartNC guifg=#99C794 ctermfg=114 cterm=NONE
hi BufferLineCloseButtonVisible guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi BufferLineCloseButtonSelected guifg=#EC5F67 guibg=#1B2B34 ctermfg=203 ctermbg=235 cterm=NONE
hi BufferLineFill guifg=#4d5d66 guibg=#21313a ctermfg=240 ctermbg=236 cterm=NONE
hi BufferlineIndicatorSelected guifg=#1B2B34 guibg=#1B2B34 ctermfg=235 ctermbg=235 cterm=NONE
hi BufferLineModified guifg=#EC5F67 guibg=#21313a ctermfg=203 ctermbg=236 cterm=NONE
hi BufferLineModifiedVisible guifg=#EC5F67 guibg=#21313a ctermfg=203 ctermbg=236 cterm=NONE
hi BufferLineModifiedSelected guifg=#99C794 guibg=#1B2B34 ctermfg=114 ctermbg=235 cterm=NONE
hi BufferLineSeparator guifg=#21313a guibg=#21313a ctermfg=236 ctermbg=236 cterm=NONE
...
hi NvimDapViewTab guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi NvimDapViewTabSelected guifg=#D8DEE9 guibg=#1B2B34 ctermfg=254 ctermbg=235 cterm=NONE
...
hi MatchWord guibg=#43535c guifg=#D8DEE9 ctermfg=254 ctermbg=239 cterm=NONE
...
hi FloatTitle guifg=#D8DEE9 guibg=#43535c ctermfg=254 ctermbg=239 cterm=NONE
...
hi Error guifg=#1B2B34 guibg=#6cbdbc ctermfg=235 ctermbg=73 cterm=NONE
hi CmpItemKindTabNine guifg=#ff7d85 ctermfg=210 cterm=NONE
hi CmpItemKindSuperMaven guifg=#FAC863 ctermfg=221 cterm=NONE
hi Folded guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi IncSearch guifg=#343D46 guibg=#FAC863 ctermfg=237 ctermbg=221 cterm=NONE
...
hi Substitute guifg=#343D46 guibg=#F99157 ctermfg=237 ctermbg=209 cterm=NONE
...
hi WildMenu guifg=#6cbdbc guibg=#F99157 ctermfg=73 ctermbg=209 cterm=NONE
hi Title guifg=#6699CC ctermfg=68 cterm=NONE
hi Conceal guibg=NONE cterm=NONE
hi Cursor guifg=#1B2B34 guibg=#C0C5Ce ctermfg=235 ctermbg=251 cterm=NONE
...
hi healthSuccess guibg=#99C794 guifg=#1B2B34 ctermfg=235 ctermbg=114 cterm=NONE
hi WinBar guibg=NONE cterm=NONE
hi WinBarNC guibg=NONE cterm=NONE
hi LazyH1 guibg=#99C794 guifg=#1B2B34 ctermfg=235 ctermbg=114 cterm=NONE
hi LazyButton guibg=#25353e guifg=#697982 ctermfg=66 ctermbg=236 cterm=NONE
...
hi Tabline guibg=#21313a ctermbg=236 cterm=NONE
hi TbFill guibg=#21313a ctermbg=236 cterm=NONE
hi TbBufOn guifg=#D8DEE9 guibg=#1B2B34 ctermfg=254 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#99C794 guibg=#1B2B34 ctermfg=114 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#EC5F67 guibg=#21313a ctermfg=203 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#EC5F67 guibg=#1B2B34 ctermfg=203 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#D8DEE9 guibg=#2e3e47 ctermfg=254 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#EC5F67 guibg=#1B2B34 ctermfg=203 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#D8DEE9 guibg=#21313a ctermfg=254 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#1B2B34 guibg=#598cbf ctermfg=235 ctermbg=67 cterm=NONE
hi TBTabTitle guifg=#1B2B34 guibg=#6699CC ctermfg=235 ctermbg=68 cterm=NONE
hi TbThemeToggleBtn guifg=#D8DEE9 guibg=#36464f ctermfg=254 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1B2B34 guibg=#EC5F67 ctermfg=235 ctermbg=203 cterm=NONE gui=bold
hi TelescopePromptPrefix guibg=#21313a guifg=#EC5F67 ctermfg=203 ctermbg=236 cterm=NONE
...
hi Normal guifg=#C0C5Ce guibg=#1B2B34 ctermfg=251 ctermbg=235 cterm=NONE
hi Exception guifg=#6cbdbc ctermfg=73 cterm=NONE
hi FoldColumn guifg=#EC5F67 guibg=NONE ctermfg=203 cterm=NONE
...
hi BufferLineDuplicateVisible guifg=#6699CC guibg=#21313a ctermfg=68 ctermbg=236 cterm=NONE
hi BufferLineDuplicateSelected guifg=#EC5F67 guibg=#1B2B34 ctermfg=203 ctermbg=235 cterm=NONE
hi BufferLineDuplicate guifg=NONE guibg=#21313a ctermbg=236 cterm=NONE
...
hi CocHintLine guibg=#223d44 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#263b4a ctermbg=237 cterm=NONE
...
hi CocWarningLine guibg=#3c423b ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#3a323b ctermbg=237 cterm=NONE
...
hi MiniTablineCurrent guifg=#D8DEE9 guibg=#1B2B34 ctermfg=254 ctermbg=235 cterm=NONE gui=underline
...
hi NeotestFailed guifg=#EC5F67 ctermfg=203 cterm=NONE
hi NeotestRunning guifg=#FAC863 ctermfg=221 cterm=NONE
...
hi NeogitHunkHeaderCursor guifg=#1B2B34 guibg=#ac7bac ctermfg=235 ctermbg=139 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#1B2B34 guibg=#ac7bac ctermfg=235 ctermbg=139 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#1B2B34 guibg=#43535c ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi NeotestSkipped guifg=#6699CC ctermfg=68 cterm=NONE
hi NeotestTest guifg=#4d5d66 ctermfg=240 cterm=NONE
hi NeotestNamespace guifg=#b9e75b ctermfg=149 cterm=NONE
hi NeotestFocused guifg=#FAC863 ctermfg=221 cterm=NONE
hi NeotestFile guifg=#62B3B2 ctermfg=73 cterm=NONE
hi NeotestDir guifg=#6699CC ctermfg=68 cterm=NONE
hi NeotestBorder guifg=#6699CC ctermfg=68 cterm=NONE
...
hi CocDiagnosticsFile guifg=#5f6f78 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#C594C5 ctermfg=176 cterm=NONE
hi CocServicesName guifg=#6699CC ctermfg=68 cterm=NONE
hi CocServicesStat guifg=#99C794 ctermfg=114 cterm=NONE
hi CocServicesLanguages guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#C594C5 ctermfg=176 cterm=NONE
hi CocSourcesName guifg=#6699CC ctermfg=68 cterm=NONE
hi CocSourcesPriority guifg=#FAC863 ctermfg=221 cterm=NONE
hi CocSourcesFileTypes guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#99C794 ctermfg=114 cterm=NONE
hi CocListsDesc guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#99C794 ctermfg=114 cterm=NONE
hi CocExtensionsLoaded guifg=#D8DEE9 ctermfg=254 cterm=NONE
hi CocExtensionsDisabled guifg=#4d5d66 ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#99C794 ctermfg=114 cterm=NONE
hi CocExtensionsLocal guifg=#6699CC ctermfg=68 cterm=NONE
hi CocExtensionsRoot guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#D8DEE9 ctermfg=254 cterm=NONE
hi CocOutlineIndentLine guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#C594C5 ctermfg=176 cterm=NONE
hi CocOutlineLine guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#5f6f78 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#5f6f78 ctermfg=242 cterm=NONE
...
hi NeotestPassed guifg=#99C794 ctermfg=114 cterm=NONE
...
hi NeotestIndent guifg=#576770 ctermfg=241 cterm=NONE
hi NeotestExpandMarker guifg=#576770 ctermfg=241 cterm=NONE
hi NeotestAdapterName guifg=#C594C5 ctermfg=176 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#6699CC ctermfg=68 cterm=NONE
hi NeotestMarked guifg=#6699CC ctermfg=68 cterm=NONE
hi NeotestTarget guifg=#6699CC ctermfg=68 cterm=NONE
hi def link MasonHighlightBlockBold MasonHighlightBlock
hi MasonHighlightBlock guifg=#1B2B34 guibg=#99C794 ctermfg=235 ctermbg=114 cterm=NONE
hi MasonHighlight guifg=#6699CC ctermfg=68 cterm=NONE
hi MasonHeader guibg=#EC5F67 guifg=#1B2B34 ctermfg=235 ctermbg=203 cterm=NONE
...
hi NoiceFormatProgressDone guibg=#99C794 guifg=#1B2B34 ctermfg=235 ctermbg=114 cterm=NONE
...
hi BufferLineCloseButton guifg=#5f6f78 guibg=#21313a ctermfg=242 ctermbg=236 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#F99157 guibg=#2e3e47 ctermfg=209 ctermbg=237 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#EC5F67 ctermfg=203 cterm=NONE
...
hi CocFloating guifg=#C0C5Ce guibg=#15252e ctermfg=251 ctermbg=235 cterm=NONE
hi CocMenuSel guibg=#15bf84 guifg=#1B2B34 ctermfg=235 ctermbg=36 cterm=NONE
hi def link CocListSearch CocSearch
hi CocListMode guifg=#6699CC ctermfg=68 cterm=NONE
hi CocSelectedLine guibg=#21313a ctermbg=236 cterm=NONE
...
hi BufferLineSeparatorVisible guifg=#21313a guibg=#21313a ctermfg=236 ctermbg=236 cterm=NONE
hi BufferLineSeparatorSelected guifg=#21313a guibg=#21313a ctermfg=236 ctermbg=236 cterm=NONE
hi BufferLineTab guifg=#5f6f78 guibg=#36464f ctermfg=242 ctermbg=238 cterm=NONE
hi BufferLineTabSelected guifg=#21313a guibg=#598cbf ctermfg=236 ctermbg=67 cterm=NONE
hi BufferLineTabClose guifg=#EC5F67 guibg=#1B2B34 ctermfg=203 ctermbg=235 cterm=NONE
