...
hi LspInlayHint guifg=#9b8e80 guibg=#f0ead6 ctermfg=245 ctermbg=254 cterm=NONE
...
hi MasonHeader guifg=#fdf6e3 guibg=#dc322f ctermfg=230 ctermbg=166 cterm=NONE
...
hi NvimDapViewTabSelected guibg=#fdf6e3 guifg=#002b36 ctermfg=234 ctermbg=230 cterm=NONE
hi NvimDapViewTab guibg=#ede7d3 guifg=#9b8e80 ctermfg=245 ctermbg=254 cterm=NONE
...
hi FlashMatch guibg=#268bd2 guifg=#fdf6e3 ctermfg=230 ctermbg=32 cterm=NONE
hi FlashCurrent guibg=#859900 guifg=#fdf6e3 ctermfg=230 ctermbg=100 cterm=NONE
