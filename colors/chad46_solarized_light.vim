...
hi TbThemeToggleBtn guibg=#ddd6be guifg=#002b36 ctermfg=234 ctermbg=187 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#dc322f guifg=#fdf6e3 ctermfg=230 ctermbg=166 cterm=NONE gui=bold
