...
hi BlinkCmpMenuSelection guifg=#1a1b26 guibg=#7aa2f7 ctermfg=234 ctermbg=111 cterm=NONE gui=bold
hi CmpSel guifg=#1a1b26 guibg=#7aa2f7 ctermfg=234 ctermbg=111 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#c0caf5 guibg=#1a1b26 ctermfg=153 ctermbg=234 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#9ece6a guibg=#1a1b26 ctermfg=149 ctermbg=234 cterm=NONE gui=underline
...
hi NeotestPassed guifg=#9ece6a ctermfg=149 cterm=NONE
hi NeotestRunning guifg=#e0af68 ctermfg=179 cterm=NONE
hi NeotestFailed guifg=#f7768e ctermfg=210 cterm=NONE
hi NeotestSkipped guifg=#7aa2f7 ctermfg=111 cterm=NONE
hi NeotestTest guifg=#565f89 ctermfg=60 cterm=NONE
hi NeotestNamespace guifg=#73daca ctermfg=80 cterm=NONE
hi NeotestFocused guifg=#e0af68 ctermfg=179 cterm=NONE
hi NeotestFile guifg=#7dcfff ctermfg=117 cterm=NONE
hi NeotestDir guifg=#7aa2f7 ctermfg=111 cterm=NONE
hi NeotestBorder guifg=#7aa2f7 ctermfg=111 cterm=NONE
hi NeotestIndent guifg=#4f5779 ctermfg=60 cterm=NONE
hi NeotestExpandMarker guifg=#4f5779 ctermfg=60 cterm=NONE
...
hi TodoBgFix guifg=#1f2336 guibg=#f7768e ctermfg=235 ctermbg=210 cterm=NONE gui=bold
hi TodoBgHack guifg=#1f2336 guibg=#ff9e64 ctermfg=235 ctermbg=215 cterm=NONE gui=bold
hi TodoBgNote guifg=#1f2336 guibg=#c0caf5 ctermfg=235 ctermbg=153 cterm=NONE gui=bold
hi TodoBgPerf guifg=#1f2336 guibg=#bb9af7 ctermfg=235 ctermbg=141 cterm=NONE gui=bold
hi TodoBgTest guifg=#1f2336 guibg=#bb9af7 ctermfg=235 ctermbg=141 cterm=NONE gui=bold
hi TodoBgTodo guifg=#1f2336 guibg=#e0af68 ctermfg=235 ctermbg=179 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guifg=#1f2336 guibg=#40486a ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#1a1b26 guibg=#7dcfff ctermfg=234 ctermbg=117 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#1a1b26 guibg=#7dcfff ctermfg=234 ctermbg=117 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#1a1b26 guibg=#40486a ctermfg=234 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#1a1b26 guibg=#9d7cd8 ctermfg=234 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#1a1b26 guibg=#9d7cd8 ctermfg=234 ctermbg=140 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#1a1b26 guibg=#7aa2f7 ctermfg=234 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1a1b26 guibg=#1abc9c ctermfg=234 ctermbg=37 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1a1b26 guibg=#1abc9c ctermfg=234 ctermbg=37 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#9ece6a guibg=#80b04c ctermfg=149 ctermbg=107 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#7dcfff guibg=#1f2336 ctermfg=117 ctermbg=235 cterm=NONE gui=bold
...
hi TbTabNewBtn guifg=#c0caf5 guibg=#414868 ctermfg=153 ctermbg=239 cterm=NONE
hi TbTabOn guifg=#f7768e guibg=#1a1b26 ctermfg=210 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#c0caf5 guibg=#1f2336 ctermfg=153 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#1a1b26 guibg=#80a8fd ctermfg=234 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#1a1b26 guibg=#7aa2f7 ctermfg=234 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#c0caf5 guibg=#353b45 ctermfg=153 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1a1b26 guibg=#f7768e ctermfg=234 ctermbg=210 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#565f89 ctermfg=60 cterm=NONE
...
hi NeotestTarget guifg=#7aa2f7 ctermfg=111 cterm=NONE
hi NeotestMarked guifg=#7aa2f7 ctermfg=111 cterm=NONE
hi NeotestWinSelect guifg=#7aa2f7 ctermfg=111 cterm=NONE
hi NeotestAdapterName guifg=#bb9af7 ctermfg=141 cterm=NONE gui=bold
...
hi TbBufOffClose guifg=#545c7e guibg=#1f2336 ctermfg=60 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#f7768e guibg=#1a1b26 ctermfg=210 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#f7768e guibg=#1f2336 ctermfg=210 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#9ece6a guibg=#1a1b26 ctermfg=149 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#545c7e guibg=#1f2336 ctermfg=60 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#c0caf5 guibg=#1a1b26 ctermfg=153 ctermbg=234 cterm=NONE
hi TbFill guibg=#1f2336 ctermbg=235 cterm=NONE
hi Tabline guibg=#1f2336 ctermbg=235 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#ff9e64 guibg=#414868 ctermfg=215 ctermbg=239 cterm=NONE gui=bold
hi NeogitDiffHeader guifg=#7aa2f7 guibg=#414868 ctermfg=111 ctermbg=239 cterm=NONE gui=bold
