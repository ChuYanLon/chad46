...
hi TbThemeToggleBtn guibg=#d7d9db guifg=#24292e ctermfg=235 ctermbg=253 cterm=NONE gui=bold
...
hi TbCloseAllBufsBtn guibg=#DE2C2E guifg=#ffffff ctermfg=231 ctermbg=160 cterm=NONE gui=bold
