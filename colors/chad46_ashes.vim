...
hi GitSignsCurrentLineBlame guifg=#4a4e51 ctermfg=239 cterm=NONE
...
hi Tabline guibg=#24282b ctermbg=235 cterm=NONE
hi TbFill guibg=#24282b ctermbg=235 cterm=NONE
hi TbBufOn guifg=#c7ccd1 guibg=#1c2023 ctermfg=252 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#565a5d guibg=#24282b ctermfg=240 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#aec795 guibg=#1c2023 ctermfg=150 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#c79595 guibg=#24282b ctermfg=174 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#c79595 guibg=#1c2023 ctermfg=174 ctermbg=234 cterm=NONE
hi TbBufOffClose guifg=#565a5d guibg=#24282b ctermfg=240 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#c7ccd1 guibg=#303437 ctermfg=252 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#c79595 guibg=#1c2023 ctermfg=174 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#c7ccd1 guibg=#24282b ctermfg=252 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#1c2023 guibg=#8ca5be ctermfg=234 ctermbg=109 cterm=NONE
hi TBTabTitle guifg=#1c2023 guibg=#95aec7 ctermfg=234 ctermbg=110 cterm=NONE
hi TbThemeToggleBtn guifg=#c7ccd1 guibg=#3a3e41 ctermfg=252 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1c2023 guibg=#c79595 ctermfg=234 ctermbg=174 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#1c2023 guibg=#95aec7 ctermfg=234 ctermbg=110 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1c2023 guibg=#8fb4b5 ctermfg=234 ctermbg=109 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1c2023 guibg=#8fb4b5 ctermfg=234 ctermbg=109 cterm=NONE gui=bold
...
hi CocServicesPrefix guifg=#ae95c7 ctermfg=140 cterm=NONE
hi CocServicesName guifg=#95aec7 ctermfg=110 cterm=NONE
hi Exception guifg=#c7ae95 ctermfg=180 cterm=NONE
hi FoldColumn guifg=#c79595 guibg=NONE ctermfg=174 cterm=NONE
...
hi CocSelectedLine guibg=#24282b ctermbg=235 cterm=NONE
...
hi CocFloating guifg=#c7ccd1 guibg=#161a1d ctermfg=252 ctermbg=234 cterm=NONE
...
hi NeotestPassed guifg=#aec795 ctermfg=150 cterm=NONE
hi NeotestRunning guifg=#c7c795 ctermfg=186 cterm=NONE
hi NeotestFailed guifg=#c79595 ctermfg=174 cterm=NONE
hi NeotestSkipped guifg=#95aec7 ctermfg=110 cterm=NONE
hi NeotestTest guifg=#4a4e51 ctermfg=239 cterm=NONE
hi NeotestNamespace guifg=#95c7ae ctermfg=115 cterm=NONE
hi NeotestFocused guifg=#c7c795 ctermfg=186 cterm=NONE
hi NeotestFile guifg=#9eb7d0 ctermfg=146 cterm=NONE
hi NeotestDir guifg=#95aec7 ctermfg=110 cterm=NONE
hi NeotestBorder guifg=#95aec7 ctermfg=110 cterm=NONE
hi NeotestIndent guifg=#515558 ctermfg=240 cterm=NONE
hi NeotestExpandMarker guifg=#515558 ctermfg=240 cterm=NONE
hi NeotestAdapterName guifg=#ae95c7 ctermfg=140 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#95aec7 ctermfg=110 cterm=NONE
hi NeotestMarked guifg=#95aec7 ctermfg=110 cterm=NONE
hi NeotestTarget guifg=#95aec7 ctermfg=110 cterm=NONE
...
hi CocDiagnosticsFile guifg=#565a5d ctermfg=240 cterm=NONE
...
hi CocSourcesPrefix guifg=#ae95c7 ctermfg=140 cterm=NONE
hi CocSourcesName guifg=#95aec7 ctermfg=110 cterm=NONE
hi CocSourcesPriority guifg=#c7c795 ctermfg=186 cterm=NONE
hi CocSourcesFileTypes guifg=#565a5d ctermfg=240 cterm=NONE
hi CocSourcesType guifg=#aec795 ctermfg=150 cterm=NONE
...
hi CocOutlineName guifg=#c7ccd1 ctermfg=252 cterm=NONE
hi CocOutlineIndentLine guifg=#565a5d ctermfg=240 cterm=NONE
hi CocOutlineKind guifg=#ae95c7 ctermfg=140 cterm=NONE
hi CocOutlineLine guifg=#565a5d ctermfg=240 cterm=NONE
hi CocNotificationTime guifg=#565a5d ctermfg=240 cterm=NONE
hi CocCommandsTitle guifg=#565a5d ctermfg=240 cterm=NONE
...
hi CocExtensionsRoot guifg=#565a5d ctermfg=240 cterm=NONE
hi CocExtensionsLocal guifg=#95aec7 ctermfg=110 cterm=NONE
hi CocExtensionsName guifg=#aec795 ctermfg=150 cterm=NONE
hi CocExtensionsDisabled guifg=#4a4e51 ctermfg=239 cterm=NONE
hi CocExtensionsLoaded guifg=#c7ccd1 ctermfg=252 cterm=NONE
hi CocExtensionsActivated guifg=#aec795 ctermfg=150 cterm=NONE
hi CocListsDesc guifg=#565a5d ctermfg=240 cterm=NONE
hi CocServicesLanguages guifg=#565a5d ctermfg=240 cterm=NONE
hi CocServicesStat guifg=#aec795 ctermfg=150 cterm=NONE
...
hi CocSelectedText guifg=#c79595 ctermfg=174 cterm=NONE
...
hi CocErrorLine guibg=#353134 ctermbg=236 cterm=NONE
hi CocWarningLine guibg=#353934 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#2e353b ctermbg=236 cterm=NONE
hi CocHintLine guibg=#2d3638 ctermbg=236 cterm=NONE
