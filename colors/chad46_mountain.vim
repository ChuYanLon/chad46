...
hi TbThemeToggleBtn guibg=#2a2a2a guifg=#F0f0f0 ctermfg=255 ctermbg=235 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#ac8a8c guifg=#0f0f0f ctermfg=233 ctermbg=138 cterm=NONE gui=bold
