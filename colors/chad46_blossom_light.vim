...
hi BlinkCmpMenuSelection guifg=#e6dfdc guibg=#857e7b ctermfg=254 ctermbg=244 cterm=NONE gui=bold
hi CmpSel guifg=#e6dfdc guibg=#857e7b ctermfg=254 ctermbg=244 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#b2aba8 ctermfg=145 cterm=NONE
...
hi TbBufOffModified guifg=#b28069 guibg=#d9d2cf ctermfg=137 ctermbg=252 cterm=NONE
hi TbBufOffClose guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
...
hi Tabline guibg=#d9d2cf ctermbg=252 cterm=NONE
hi TbFill guibg=#d9d2cf ctermbg=252 cterm=NONE
hi TbBufOn guifg=#695d57 guibg=#e6dfdc ctermfg=59 ctermbg=254 cterm=NONE
hi TbBufOff guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
...
hi TelescopePromptPrefix guibg=#d9d2cf guifg=#b28069 ctermfg=137 ctermbg=252 cterm=NONE
...
hi CocLoaderHeader guifg=#e6dfdc guibg=#5f7d9b ctermfg=254 ctermbg=66 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#e6dfdc guibg=#4b6987 ctermfg=254 ctermbg=60 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#e6dfdc guibg=#4b6987 ctermfg=254 ctermbg=60 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#b9b2af guifg=#e6dfdc ctermfg=254 ctermbg=249 cterm=NONE
...
hi ErrorMsg guifg=#8779a8 guibg=#e6dfdc ctermfg=103 ctermbg=254 cterm=NONE
hi def link CocLoaderNormal NormalFloat
hi NormalFloat guibg=#dfd8d5 ctermbg=253 cterm=NONE
hi WhichKey guifg=#695d57 ctermfg=59 cterm=NONE
hi Search guifg=#ded7d4 guibg=#738199 ctermfg=188 ctermbg=66 cterm=NONE
hi WhichKeyDesc guifg=#695d57 ctermfg=59 cterm=NONE
hi CocLoaderBackdrop guibg=#e6dfdc ctermbg=254 cterm=NONE
hi CocLoaderHighlightBlock guibg=#5f7d9b guifg=#e6dfdc ctermfg=254 ctermbg=66 cterm=NONE
hi CocLoaderMutedBlock guibg=#b9b2af guifg=#e6dfdc ctermfg=254 ctermbg=249 cterm=NONE
...
hi PmenuSel guibg=#857e7b guifg=#e6dfdc ctermfg=254 ctermbg=244 cterm=NONE
...
hi BufferLineBackground guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
hi BufferlineIndicatorVisible guifg=#d9d2cf guibg=#d9d2cf ctermfg=252 ctermbg=252 cterm=NONE
hi BufferLineBufferSelected guifg=#695d57 guibg=#e6dfdc ctermfg=59 ctermbg=254 cterm=NONE
hi BufferLineBufferVisible guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
hi BufferLineError guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
hi BufferLineErrorDiagnostic guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
hi DapUIRestartNC guifg=#6c805c ctermfg=65 cterm=NONE
hi BufferLineCloseButtonVisible guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
hi BufferLineCloseButtonSelected guifg=#b28069 guibg=#e6dfdc ctermfg=137 ctermbg=254 cterm=NONE
hi BufferLineFill guifg=#b2aba8 guibg=#d9d2cf ctermfg=145 ctermbg=252 cterm=NONE
hi BufferlineIndicatorSelected guifg=#e6dfdc guibg=#e6dfdc ctermfg=254 ctermbg=254 cterm=NONE
hi BufferLineModified guifg=#b28069 guibg=#d9d2cf ctermfg=137 ctermbg=252 cterm=NONE
hi BufferLineModifiedVisible guifg=#b28069 guibg=#d9d2cf ctermfg=137 ctermbg=252 cterm=NONE
hi BufferLineDuplicate guifg=NONE guibg=#d9d2cf ctermbg=252 cterm=NONE
hi BufferLineDuplicateSelected guifg=#b28069 guibg=#e6dfdc ctermfg=137 ctermbg=254 cterm=NONE
hi BufferLineDuplicateVisible guifg=#5f7d9b guibg=#d9d2cf ctermfg=66 ctermbg=252 cterm=NONE
...
hi MatchWord guibg=#b9b2af guifg=#695d57 ctermfg=59 ctermbg=249 cterm=NONE
...
hi FloatTitle guifg=#695d57 guibg=#b9b2af ctermfg=59 ctermbg=249 cterm=NONE
hi NvimInternalError guifg=#b28069 ctermfg=137 cterm=NONE
hi WinSeparator guifg=#d3ccc9 ctermfg=252 cterm=NONE
hi Normal guifg=#746862 guibg=#e6dfdc ctermfg=242 ctermbg=254 cterm=NONE
...
hi Error guifg=#e6dfdc guibg=#8779a8 ctermfg=254 ctermbg=103 cterm=NONE
hi CmpItemKindTabNine guifg=#b7856e ctermfg=137 cterm=NONE
hi CmpItemKindSuperMaven guifg=#a9a29f ctermfg=248 cterm=NONE
hi Folded guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
hi IncSearch guifg=#ded7d4 guibg=#a87678 ctermfg=188 ctermbg=138 cterm=NONE
...
hi Substitute guifg=#ded7d4 guibg=#738199 ctermfg=188 ctermbg=66 cterm=NONE
...
hi WildMenu guifg=#8779a8 guibg=#738199 ctermfg=103 ctermbg=66 cterm=NONE
...
hi Cursor guifg=#e6dfdc guibg=#746862 ctermfg=254 ctermbg=242 cterm=NONE
...
hi CocErrorLine guibg=#ded0ca ctermbg=252 cterm=NONE
hi CocWarningLine guibg=#dcd5d2 ctermbg=188 cterm=NONE
hi CocInfoLine guibg=#d1d0d2 ctermbg=252 cterm=NONE
hi CocHintLine guibg=#cecdcf ctermbg=252 cterm=NONE
hi LazyCommit guifg=#6c805c ctermfg=65 cterm=NONE
hi CocWarningFloat guifg=#a9a29f guibg=#dfd8d5 ctermfg=248 ctermbg=253 cterm=NONE
hi CocInfoFloat guifg=#5f7d9b guibg=#dfd8d5 ctermfg=66 ctermbg=253 cterm=NONE
hi CocHintFloat guifg=#4b6987 guibg=#dfd8d5 ctermfg=60 ctermbg=253 cterm=NONE
hi CocInlayHint guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
...
hi CocFloating guifg=#746862 guibg=#dfd8d5 ctermfg=242 ctermbg=253 cterm=NONE
...
hi CocSelectedLine guibg=#d9d2cf ctermbg=252 cterm=NONE
...
hi CocErrorFloat guifg=#b28069 guibg=#dfd8d5 ctermfg=137 ctermbg=253 cterm=NONE
hi CocMenuSel guibg=#857e7b guifg=#e6dfdc ctermfg=254 ctermbg=244 cterm=NONE
hi CocCodeLens guifg=#a09996 ctermfg=247 cterm=NONE
hi def link NvimTreeDiagnosticHintFolderHL DiagnosticHint
hi def link CocDiagnosticsWarning CocWarningSign
hi CocServicesPrefix guifg=#a685a6 ctermfg=139 cterm=NONE
hi CocServicesName guifg=#5f7d9b ctermfg=66 cterm=NONE
...
hi FoldColumn guifg=#976153 guibg=NONE ctermfg=95 cterm=NONE
hi LazyButton guibg=#d0c9c6 guifg=#8c8582 ctermfg=102 ctermbg=251 cterm=NONE
hi LazyH2 guifg=#b28069 ctermfg=137 cterm=NONE gui=underline,bold
...
hi BufferLineCloseButton guifg=#a09996 guibg=#d9d2cf ctermfg=247 ctermbg=252 cterm=NONE
...
hi NoiceFormatProgressDone guibg=#6c805c guifg=#e6dfdc ctermfg=254 ctermbg=65 cterm=NONE
...
hi SnacksPickerTitle guifg=#b2aba8 guibg=#6c805c ctermfg=145 ctermbg=65 cterm=NONE
hi SnacksPickerPreviewTitle guifg=#b2aba8 guibg=#5f7d9b ctermfg=145 ctermbg=66 cterm=NONE
hi SnacksPickerListTitle guifg=#b2aba8 guibg=#b28069 ctermfg=145 ctermbg=137 cterm=NONE
hi SnacksPickerFooter guifg=#b2aba8 ctermfg=145 cterm=NONE
hi SnacksPickerMatch guibg=#d0c9c6 guifg=#5f7d9b ctermfg=66 ctermbg=251 cterm=NONE
...
hi SnacksPickerDir guifg=#a09996 ctermfg=247 cterm=NONE
hi SnacksPickerDelim guifg=#b2aba8 ctermfg=145 cterm=NONE
hi SnacksPickerRow guifg=#b2aba8 ctermfg=145 cterm=NONE
hi SnacksPickerPathIgnored guifg=#b9b2af ctermfg=249 cterm=NONE
hi SnacksPickerPathHidden guifg=#b9b2af ctermfg=249 cterm=NONE
...
hi Todo guifg=#738199 guibg=#ded7d4 ctermfg=66 ctermbg=188 cterm=NONE
...
hi LspSignatureActiveParameter guifg=#e6dfdc guibg=#6c805c ctermfg=254 ctermbg=65 cterm=NONE
...
hi NeogitBranchHead guifg=#5f7d9b ctermfg=66 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#5f7d9b ctermfg=66 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#6c805c guibg=#4e623e ctermfg=65 ctermbg=239 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#b28069 ctermfg=137 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#a685a6 ctermfg=139 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#cc836c ctermfg=173 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#75998e ctermfg=245 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#a9a29f ctermfg=248 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#6c805c ctermfg=65 cterm=NONE gui=italic,bold
...
hi LazyH1 guibg=#6c805c guifg=#e6dfdc ctermfg=254 ctermbg=65 cterm=NONE
...
hi BufferLineModifiedSelected guifg=#6c805c guibg=#e6dfdc ctermfg=65 ctermbg=254 cterm=NONE
hi BufferLineSeparator guifg=#d9d2cf guibg=#d9d2cf ctermfg=252 ctermbg=252 cterm=NONE
hi NeotestPassed guifg=#6c805c ctermfg=65 cterm=NONE
hi NeotestRunning guifg=#a9a29f ctermfg=248 cterm=NONE
hi NeotestFailed guifg=#b28069 ctermfg=137 cterm=NONE
hi NeotestSkipped guifg=#5f7d9b ctermfg=66 cterm=NONE
hi NeotestTest guifg=#b2aba8 ctermfg=145 cterm=NONE
hi NeotestNamespace guifg=#899d79 ctermfg=108 cterm=NONE
hi NeotestFocused guifg=#a9a29f ctermfg=248 cterm=NONE
hi NeotestFile guifg=#75998e ctermfg=245 cterm=NONE
hi NeotestDir guifg=#5f7d9b ctermfg=66 cterm=NONE
hi NeotestBorder guifg=#5f7d9b ctermfg=66 cterm=NONE
hi NeotestIndent guifg=#aaa3a0 ctermfg=248 cterm=NONE
hi NeotestExpandMarker guifg=#aaa3a0 ctermfg=248 cterm=NONE
hi NeotestAdapterName guifg=#a685a6 ctermfg=139 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#5f7d9b ctermfg=66 cterm=NONE
hi NeotestMarked guifg=#5f7d9b ctermfg=66 cterm=NONE
hi NeotestTarget guifg=#5f7d9b ctermfg=66 cterm=NONE
...
hi CocDiagnosticsFile guifg=#a09996 ctermfg=247 cterm=NONE
...
hi CocSourcesPrefix guifg=#a685a6 ctermfg=139 cterm=NONE
hi CocSourcesName guifg=#5f7d9b ctermfg=66 cterm=NONE
hi CocSourcesPriority guifg=#a87678 ctermfg=138 cterm=NONE
hi CocSourcesFileTypes guifg=#a09996 ctermfg=247 cterm=NONE
hi CocSourcesType guifg=#6c805c ctermfg=65 cterm=NONE
...
hi CocOutlineName guifg=#695d57 ctermfg=59 cterm=NONE
hi CocOutlineIndentLine guifg=#a09996 ctermfg=247 cterm=NONE
hi CocOutlineKind guifg=#a685a6 ctermfg=139 cterm=NONE
hi CocOutlineLine guifg=#a09996 ctermfg=247 cterm=NONE
hi CocNotificationTime guifg=#a09996 ctermfg=247 cterm=NONE
hi CocCommandsTitle guifg=#a09996 ctermfg=247 cterm=NONE
...
hi TbBufOnModified guifg=#6c805c guibg=#e6dfdc ctermfg=65 ctermbg=254 cterm=NONE
hi TbBufOnClose guifg=#b28069 guibg=#e6dfdc ctermfg=137 ctermbg=254 cterm=NONE
hi TbTabNewBtn guifg=#695d57 guibg=#c7c0bd ctermfg=59 ctermbg=251 cterm=NONE
hi TbTabOn guifg=#b28069 guibg=#e6dfdc ctermfg=137 ctermbg=254 cterm=NONE
hi TbTabOff guifg=#695d57 guibg=#d9d2cf ctermfg=59 ctermbg=252 cterm=NONE
hi def link GrugFarResultsMatch DiffChange
hi def link GrugFarResultsMatchAdded DiffAdd
hi TbTabCloseBtn guifg=#e6dfdc guibg=#5e5f65 ctermfg=254 ctermbg=241 cterm=NONE
hi TBTabTitle guifg=#e6dfdc guibg=#5f7d9b ctermfg=254 ctermbg=66 cterm=NONE
hi TbThemeToggleBtn guifg=#695d57 guibg=#c0b9b6 ctermfg=59 ctermbg=250 cterm=NONE gui=bold
...
hi TbCloseAllBufsBtn guifg=#e6dfdc guibg=#b28069 ctermfg=254 ctermbg=137 cterm=NONE gui=bold
...
hi MasonHighlightBlock guifg=#e6dfdc guibg=#6c805c ctermfg=254 ctermbg=65 cterm=NONE
hi def link MasonHighlightBlockBold MasonHighlightBlock
hi def link MasonHeaderSecondary MasonHighlightBlock
hi MasonMuted guifg=#a09996 ctermfg=247 cterm=NONE
hi MasonMutedBlock guifg=#a09996 guibg=#d0c9c6 ctermfg=247 ctermbg=251 cterm=NONE
hi CocListFgMagenta guifg=#a685a6 ctermfg=139 cterm=NONE
hi CocListFgBlue guifg=#5f7d9b ctermfg=66 cterm=NONE
hi DevIconJson guifg=#d38a73 ctermfg=173 cterm=NONE
...
hi MiniTablineCurrent guifg=#695d57 guibg=#e6dfdc ctermfg=59 ctermbg=254 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#6c805c guibg=#e6dfdc ctermfg=65 ctermbg=254 cterm=NONE gui=underline
...
hi CocExtensionsRoot guifg=#a09996 ctermfg=247 cterm=NONE
hi CocExtensionsLocal guifg=#5f7d9b ctermfg=66 cterm=NONE
hi CocExtensionsName guifg=#6c805c ctermfg=65 cterm=NONE
hi CocExtensionsDisabled guifg=#b2aba8 ctermfg=145 cterm=NONE
hi CocExtensionsLoaded guifg=#695d57 ctermfg=59 cterm=NONE
hi CocExtensionsActivated guifg=#6c805c ctermfg=65 cterm=NONE
hi CocListsDesc guifg=#a09996 ctermfg=247 cterm=NONE
hi CocServicesLanguages guifg=#a09996 ctermfg=247 cterm=NONE
hi CocServicesStat guifg=#6c805c ctermfg=65 cterm=NONE
...
hi CocSelectedText guifg=#b28069 ctermfg=137 cterm=NONE
...
hi BufferLineSeparatorVisible guifg=#d9d2cf guibg=#d9d2cf ctermfg=252 ctermbg=252 cterm=NONE
hi BufferLineSeparatorSelected guifg=#d9d2cf guibg=#d9d2cf ctermfg=252 ctermbg=252 cterm=NONE
hi BufferLineTab guifg=#a09996 guibg=#c0b9b6 ctermfg=247 ctermbg=250 cterm=NONE
hi BufferLineTabSelected guifg=#d9d2cf guibg=#5e5f65 ctermfg=252 ctermbg=241 cterm=NONE
hi BufferLineTabClose guifg=#b28069 guibg=#e6dfdc ctermfg=137 ctermbg=254 cterm=NONE
...
hi healthSuccess guibg=#6c805c guifg=#e6dfdc ctermfg=254 ctermbg=65 cterm=NONE
