...
hi Operator guisp=NONE guifg=#746862 ctermfg=242 cterm=NONE
...
hi Identifier guisp=NONE guifg=#8779a8 ctermfg=103 cterm=NONE
hi Float guifg=#a87678 ctermfg=138 cterm=NONE
hi Delimiter guifg=#976153 ctermfg=95 cterm=NONE
hi Define guisp=NONE guifg=#7e8e8e ctermfg=245 cterm=NONE
...
hi CocHintHighlight guisp=#4b6987 guifg=#4b6987 ctermfg=60 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#5f7d9b guifg=#5f7d9b ctermfg=66 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#a9a29f guifg=#a9a29f ctermfg=248 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#b28069 guifg=#b28069 ctermfg=137 cterm=NONE gui=undercurl
...
hi Type guisp=NONE guifg=#738199 ctermfg=66 cterm=NONE
