...
hi NeotestIndent guifg=#595f6b ctermfg=241 cterm=NONE
hi NeotestExpandMarker guifg=#595f6b ctermfg=241 cterm=NONE
hi NeotestAdapterName guifg=#aab1be ctermfg=249 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#2a303c guibg=#7797b7 ctermfg=236 ctermbg=103 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#2a303c guibg=#6484a4 ctermfg=236 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#2a303c guibg=#6484a4 ctermfg=236 ctermbg=67 cterm=NONE gui=bold
...
hi MiniTablineModifiedCurrent guifg=#A3BE8C guibg=#2a303c ctermfg=144 ctermbg=236 cterm=NONE gui=underline
...
hi NeogitHunkMergeHeader guifg=#2f3541 guibg=#4d535f ctermfg=237 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#2a303c guibg=#9aafe6 ctermfg=236 ctermbg=110 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#2a303c guibg=#9aafe6 ctermfg=236 ctermbg=110 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#2a303c guibg=#4d535f ctermfg=236 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#2a303c guibg=#B48EAD ctermfg=236 ctermbg=139 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#2a303c guibg=#B48EAD ctermfg=236 ctermbg=139 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#7797b7 guibg=#3e4450 ctermfg=103 ctermbg=238 cterm=NONE gui=bold
...
hi NeogitChangeDeleted guifg=#d57780 ctermfg=174 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#aab1be ctermfg=249 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#9aafe6 guibg=#2f3541 ctermfg=110 ctermbg=237 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#545a66 ctermfg=59 cterm=NONE
...
hi Tabline guibg=#2f3541 ctermbg=237 cterm=NONE
hi TbFill guibg=#2f3541 ctermbg=237 cterm=NONE
hi TbBufOn guifg=#D8DEE9 guibg=#2a303c ctermfg=254 ctermbg=236 cterm=NONE
hi TbBufOff guifg=#606672 guibg=#2f3541 ctermfg=242 ctermbg=237 cterm=NONE
hi TbBufOnModified guifg=#A3BE8C guibg=#2a303c ctermfg=144 ctermbg=236 cterm=NONE
hi TbBufOffModified guifg=#d57780 guibg=#2f3541 ctermfg=174 ctermbg=237 cterm=NONE
hi TbBufOnClose guifg=#d57780 guibg=#2a303c ctermfg=174 ctermbg=236 cterm=NONE
hi TbBufOffClose guifg=#606672 guibg=#2f3541 ctermfg=242 ctermbg=237 cterm=NONE
hi TbTabNewBtn guifg=#D8DEE9 guibg=#3e4450 ctermfg=254 ctermbg=238 cterm=NONE
...
hi TBTabTitle guifg=#2a303c guibg=#7797b7 ctermfg=236 ctermbg=103 cterm=NONE
hi TbThemeToggleBtn guifg=#D8DEE9 guibg=#484e5a ctermfg=254 ctermbg=239 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#2a303c guibg=#d57780 ctermfg=236 ctermbg=174 cterm=NONE gui=bold
...
hi TodoBgFix guifg=#2f3541 guibg=#d57780 ctermfg=237 ctermbg=174 cterm=NONE gui=bold
...
hi FoldColumn guifg=#d57780 guibg=NONE ctermfg=174 cterm=NONE
...
hi CocSelectedText guifg=#d57780 ctermfg=174 cterm=NONE
...
hi MiniTablineCurrent guifg=#D8DEE9 guibg=#2a303c ctermfg=254 ctermbg=236 cterm=NONE gui=underline
...
hi CocDiagnosticsFile guifg=#606672 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#aab1be ctermfg=249 cterm=NONE
hi CocServicesName guifg=#7797b7 ctermfg=103 cterm=NONE
hi CocServicesStat guifg=#A3BE8C ctermfg=144 cterm=NONE
hi CocServicesLanguages guifg=#606672 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#aab1be ctermfg=249 cterm=NONE
hi CocSourcesName guifg=#7797b7 ctermfg=103 cterm=NONE
hi CocSourcesPriority guifg=#e39a83 ctermfg=174 cterm=NONE
hi CocSourcesFileTypes guifg=#606672 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#A3BE8C ctermfg=144 cterm=NONE
hi CocListsDesc guifg=#606672 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#A3BE8C ctermfg=144 cterm=NONE
hi CocExtensionsLoaded guifg=#D8DEE9 ctermfg=254 cterm=NONE
hi CocExtensionsDisabled guifg=#545a66 ctermfg=59 cterm=NONE
hi CocExtensionsName guifg=#A3BE8C ctermfg=144 cterm=NONE
hi CocExtensionsLocal guifg=#7797b7 ctermfg=103 cterm=NONE
hi CocExtensionsRoot guifg=#606672 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#D8DEE9 ctermfg=254 cterm=NONE
hi CocOutlineIndentLine guifg=#606672 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#aab1be ctermfg=249 cterm=NONE
hi CocOutlineLine guifg=#606672 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#606672 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#606672 ctermfg=242 cterm=NONE
...
hi CocHintLine guibg=#323c4b ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#353f4e ctermbg=238 cterm=NONE
hi CocWarningLine guibg=#464747 ctermbg=238 cterm=NONE
...
hi CocFloating guifg=#bfc5d0 guibg=#252b37 ctermfg=251 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#2a303c guibg=#81A1C1 ctermfg=236 ctermbg=109 cterm=NONE
hi TbTabOff guifg=#D8DEE9 guibg=#2f3541 ctermfg=254 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#d57780 guibg=#2a303c ctermfg=174 ctermbg=236 cterm=NONE
...
hi CocSelectedLine guibg=#2f3541 ctermbg=237 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#e39a83 guibg=#3e4450 ctermfg=174 ctermbg=238 cterm=NONE gui=bold
...
hi TodoBgTodo guifg=#2f3541 guibg=#EBCB8B ctermfg=237 ctermbg=186 cterm=NONE gui=bold
hi TodoBgTest guifg=#2f3541 guibg=#aab1be ctermfg=237 ctermbg=249 cterm=NONE gui=bold
hi TodoBgPerf guifg=#2f3541 guibg=#aab1be ctermfg=237 ctermbg=249 cterm=NONE gui=bold
hi TodoBgNote guifg=#2f3541 guibg=#D8DEE9 ctermfg=237 ctermbg=254 cterm=NONE gui=bold
hi TodoBgHack guifg=#2f3541 guibg=#e39a83 ctermfg=237 ctermbg=174 cterm=NONE gui=bold
...
hi NeotestFailed guifg=#d57780 ctermfg=174 cterm=NONE
hi NeotestSkipped guifg=#7797b7 ctermfg=103 cterm=NONE
hi NeotestTest guifg=#545a66 ctermfg=59 cterm=NONE
