...
hi TbThemeToggleBtn guibg=#e5e5e5 guifg=#1b1f23 ctermfg=234 ctermbg=254 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#d64545 guifg=#f5f5f5 ctermfg=255 ctermbg=167 cterm=NONE gui=bold
