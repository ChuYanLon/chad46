...
hi BlinkCmpMenuSelection guifg=#f5f5f5 guibg=#0969da ctermfg=255 ctermbg=26 cterm=NONE gui=bold
hi CmpSel guifg=#f5f5f5 guibg=#0969da ctermfg=255 ctermbg=26 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#1b1f23 guibg=#f5f5f5 ctermfg=234 ctermbg=255 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#238636 guibg=#f5f5f5 ctermfg=29 ctermbg=255 cterm=NONE gui=underline
...
hi NeotestPassed guifg=#238636 ctermfg=29 cterm=NONE
hi NeotestRunning guifg=#bb8009 ctermfg=136 cterm=NONE
hi NeotestFailed guifg=#d64545 ctermfg=167 cterm=NONE
hi NeotestSkipped guifg=#0969da ctermfg=26 cterm=NONE
hi NeotestTest guifg=#6e7681 ctermfg=243 cterm=NONE
hi NeotestNamespace guifg=#2ea043 ctermfg=35 cterm=NONE
hi NeotestFocused guifg=#bb8009 ctermfg=136 cterm=NONE
hi NeotestFile guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi NeotestDir guifg=#0969da ctermfg=26 cterm=NONE
hi NeotestBorder guifg=#0969da ctermfg=26 cterm=NONE
hi NeotestIndent guifg=#8b949e ctermfg=246 cterm=NONE
hi NeotestExpandMarker guifg=#8b949e ctermfg=246 cterm=NONE
...
hi CocSemTypeClass guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocSemTypeEnum guifg=#0969da ctermfg=26 cterm=NONE
hi CocSemTypeInterface guifg=#238636 ctermfg=29 cterm=NONE
hi CocSemTypeStruct guifg=#8250df ctermfg=98 cterm=NONE
hi CocSemTypeTypeParameter guifg=#d64545 ctermfg=167 cterm=NONE
hi CocSemTypeParameter guifg=#d64545 ctermfg=167 cterm=NONE
hi CocSemTypeVariable guifg=#8250df ctermfg=98 cterm=NONE
hi CocSemTypeProperty guifg=#d64545 ctermfg=167 cterm=NONE
hi CocSemTypeEnumMember guifg=#8250df ctermfg=98 cterm=NONE
hi CocSemTypeEvent guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocSemTypeFunction guifg=#0969da ctermfg=26 cterm=NONE
hi CocSemTypeMethod guifg=#0969da ctermfg=26 cterm=NONE
hi CocSemTypeMacro guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocSemTypeKeyword guifg=#8250df ctermfg=98 cterm=NONE
hi CocSemTypeModifier guifg=#8250df ctermfg=98 cterm=NONE
hi CocSemTypeComment guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocSemTypeString guifg=#238636 ctermfg=29 cterm=NONE
hi CocSemTypeNumber guifg=#e87c7c ctermfg=174 cterm=NONE
hi CocSemTypeBoolean guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocSemTypeRegexp guifg=#238636 ctermfg=29 cterm=NONE
hi CocSemTypeOperator guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocSemTypeDecorator guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocSemModDeprecated guifg=#6e7681 ctermfg=243 cterm=NONE gui=strikethrough
hi CocSnippetVisual guibg=#e5e5e5 ctermbg=254 cterm=NONE
...
hi Search guibg=#5c6166 guifg=#e0e0e0 ctermfg=254 ctermbg=241 cterm=NONE
...
hi TodoBgFix guifg=#e0e0e0 guibg=#d64545 ctermfg=254 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#e0e0e0 guibg=#d9822b ctermfg=254 ctermbg=172 cterm=NONE gui=bold
hi TodoBgNote guifg=#e0e0e0 guibg=#1b1f23 ctermfg=254 ctermbg=234 cterm=NONE gui=bold
hi TodoBgPerf guifg=#e0e0e0 guibg=#8250df ctermfg=254 ctermbg=98 cterm=NONE gui=bold
hi TodoBgTest guifg=#e0e0e0 guibg=#8250df ctermfg=254 ctermbg=98 cterm=NONE gui=bold
hi TodoBgTodo guifg=#e0e0e0 guibg=#bb8009 ctermfg=254 ctermbg=136 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guifg=#e0e0e0 guibg=#9ea7b1 ctermfg=254 ctermbg=248 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#f5f5f5 guibg=#2c9ab7 ctermfg=255 ctermbg=31 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#f5f5f5 guibg=#2c9ab7 ctermfg=255 ctermbg=31 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#f5f5f5 guibg=#9ea7b1 ctermfg=255 ctermbg=248 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#f5f5f5 guibg=#6f4ecf ctermfg=255 ctermbg=62 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#f5f5f5 guibg=#6f4ecf ctermfg=255 ctermbg=62 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#f5f5f5 guibg=#0969da ctermfg=255 ctermbg=26 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#f5f5f5 guibg=#2c9ab7 ctermfg=255 ctermbg=31 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#f5f5f5 guibg=#2c9ab7 ctermfg=255 ctermbg=31 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#9ea7b1 guifg=#f5f5f5 ctermfg=255 ctermbg=248 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#0969da ctermfg=26 cterm=NONE
hi CocLoaderMuted guifg=#5c6166 ctermfg=241 cterm=NONE
hi def link CocLoaderError ErrorMsg
hi def link CocLoaderNormal NormalFloat
hi def link CocLoaderSearchMatch Search
hi CocLoaderWarning guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocLoaderBackdrop guibg=#f5f5f5 ctermbg=255 cterm=NONE
hi CocLoaderHighlightBlock guibg=#0969da guifg=#f5f5f5 ctermfg=255 ctermbg=26 cterm=NONE
hi CocLoaderMutedBlock guibg=#9ea7b1 guifg=#f5f5f5 ctermfg=255 ctermbg=248 cterm=NONE
hi NeogitBranchHead guifg=#0969da ctermfg=26 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#0969da ctermfg=26 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#238636 guibg=#056818 ctermfg=29 ctermbg=22 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#d64545 ctermfg=167 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#8250df ctermfg=98 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#d9822b ctermfg=172 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#2c9ab7 ctermfg=31 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#2c9ab7 guibg=#e0e0e0 ctermfg=31 ctermbg=254 cterm=NONE gui=bold
...
hi SnacksPickerDir guifg=#5c6166 ctermfg=241 cterm=NONE
hi SnacksPickerDelim guifg=#6e7681 ctermfg=243 cterm=NONE
...
hi TbTabNewBtn guifg=#1b1f23 guibg=#ececec ctermfg=234 ctermbg=255 cterm=NONE
hi TbTabOn guifg=#d64545 guibg=#f5f5f5 ctermfg=167 ctermbg=255 cterm=NONE
hi TbTabOff guifg=#1b1f23 guibg=#e0e0e0 ctermfg=234 ctermbg=254 cterm=NONE
hi TbTabCloseBtn guifg=#f5f5f5 guibg=#0969da ctermfg=255 ctermbg=26 cterm=NONE
hi TBTabTitle guifg=#f5f5f5 guibg=#0969da ctermfg=255 ctermbg=26 cterm=NONE
hi TbThemeToggleBtn guifg=#1b1f23 guibg=#e5e5e5 ctermfg=234 ctermbg=254 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#f5f5f5 guibg=#d64545 ctermfg=255 ctermbg=167 cterm=NONE gui=bold
...
hi IncSearch guibg=#0969da guifg=#1b1f23 ctermfg=234 ctermbg=26 cterm=NONE
...
hi Substitute guibg=#5c6166 guifg=#e0e0e0 ctermfg=254 ctermbg=241 cterm=NONE
...
hi LazyH2 guifg=#d64545 ctermfg=167 cterm=NONE gui=underline,bold
...
hi CocFloatThumb guibg=#9ea7b1 ctermbg=248 cterm=NONE
hi CocFloatSbar guibg=#f5f5f5 ctermbg=255 cterm=NONE
hi CocFloatBorder guifg=#0969da ctermfg=26 cterm=NONE
hi CocFloatActive guibg=#f5f5f5 ctermbg=255 cterm=NONE
hi CocFloatDividingLine guifg=#e0e0e0 ctermfg=254 cterm=NONE
hi CocPumSearch guifg=#d9822b ctermfg=172 cterm=NONE
hi CocPumDetail guifg=#5c6166 ctermfg=241 cterm=NONE
hi def link CocPumMenu CocFloating
hi CocPumShortcut guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocPumDeprecated guifg=#6e7681 ctermfg=243 cterm=NONE gui=strikethrough
hi CocPumVirtualText guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocVirtualText guifg=#6e7681 ctermfg=243 cterm=NONE
hi def link CocInputBoxVirtualText CocVirtualText
hi CocInlineVirtualText guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocInlineAnnotation guifg=#0969da ctermfg=26 cterm=NONE
hi CocSearch guifg=#d9822b ctermfg=172 cterm=NONE
hi CocLink guifg=#0969da ctermfg=26 cterm=NONE gui=underline
hi def link CocListSearch CocSearch
hi CocListMode guifg=#0969da ctermfg=26 cterm=NONE
hi CocSelectedLine guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi CocListPath guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocListLine guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi CocListFgBlack guifg=#e0e0e0 ctermfg=254 cterm=NONE
hi CocListFgRed guifg=#d64545 ctermfg=167 cterm=NONE
hi CocListFgGreen guifg=#238636 ctermfg=29 cterm=NONE
hi CocListFgYellow guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocListFgBlue guifg=#0969da ctermfg=26 cterm=NONE
hi CocListFgMagenta guifg=#8250df ctermfg=98 cterm=NONE
hi CocListFgCyan guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocListFgWhite guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocListFgGrey guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocListBgBlack guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi CocListBgRed guibg=#d64545 ctermbg=167 cterm=NONE
hi CocListBgGreen guibg=#238636 ctermbg=29 cterm=NONE
hi CocListBgYellow guibg=#bb8009 ctermbg=136 cterm=NONE
...
hi TelescopePromptPrefix guibg=#e0e0e0 guifg=#d64545 ctermfg=167 ctermbg=254 cterm=NONE
...
hi DevIconJson guifg=#d4a72c ctermfg=178 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocListBgBlue guibg=#0969da ctermbg=26 cterm=NONE
hi CocListBgMagenta guibg=#8250df ctermbg=98 cterm=NONE
hi CocListBgCyan guibg=#2c9ab7 ctermbg=31 cterm=NONE
hi CocListBgWhite guibg=#1b1f23 ctermbg=234 cterm=NONE
hi CocListBgGrey guibg=#9ea7b1 ctermbg=248 cterm=NONE
hi CocDiagnosticsFile guifg=#5c6166 ctermfg=241 cterm=NONE
...
hi CocServicesPrefix guifg=#8250df ctermfg=98 cterm=NONE
hi CocServicesName guifg=#0969da ctermfg=26 cterm=NONE
hi CocServicesStat guifg=#238636 ctermfg=29 cterm=NONE
hi CocServicesLanguages guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocSourcesPrefix guifg=#8250df ctermfg=98 cterm=NONE
hi CocSourcesName guifg=#0969da ctermfg=26 cterm=NONE
hi CocSourcesPriority guifg=#e87c7c ctermfg=174 cterm=NONE
hi CocSourcesFileTypes guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocSourcesType guifg=#238636 ctermfg=29 cterm=NONE
hi CocListsDesc guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocExtensionsActivated guifg=#238636 ctermfg=29 cterm=NONE
hi CocExtensionsLoaded guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocExtensionsDisabled guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocExtensionsName guifg=#238636 ctermfg=29 cterm=NONE
hi CocExtensionsLocal guifg=#0969da ctermfg=26 cterm=NONE
hi CocExtensionsRoot guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocOutlineName guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocOutlineIndentLine guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocOutlineKind guifg=#8250df ctermfg=98 cterm=NONE
hi CocOutlineLine guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocNotificationTime guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocCommandsTitle guifg=#5c6166 ctermfg=241 cterm=NONE
hi def link CocPopupTerminal CocFloating
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocStrikeThrough cterm=NONE gui=strikethrough
hi CocUnderline guisp=#6e7681 cterm=NONE gui=underline
...
hi CocNotificationButton guifg=#0969da ctermfg=26 cterm=NONE gui=underline
hi CocNotificationKey guifg=#5c6166 ctermfg=241 cterm=NONE
hi def link CocNotificationError CocErrorFloat
hi def link CocNotificationWarning CocWarningFloat
hi def link CocNotificationInfo CocInfoFloat
hi CocTreeTitle guifg=#1b1f23 ctermfg=234 cterm=NONE gui=bold
hi CocTreeDescription guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocTreeOpenClose cterm=NONE gui=bold
hi CocTreeSelected guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi CocSymbolDefault guifg=#5c6166 ctermfg=241 cterm=NONE
hi CocSymbolKeyword guifg=#8250df ctermfg=98 cterm=NONE
hi CocSymbolNamespace guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolClass guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocSymbolMethod guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolProperty guifg=#d64545 ctermfg=167 cterm=NONE
hi def link CocSymbolText CocSymbolDefault
hi def link CocSymbolUnit CocSymbolDefault
hi def link CocSymbolValue CocSymbolDefault
hi CocSymbolSnippet guifg=#d64545 ctermfg=167 cterm=NONE
hi CocSymbolColor guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocSymbolReference guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocSymbolFolder guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolFile guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolModule guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocSymbolPackage guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocSymbolField guifg=#d64545 ctermfg=167 cterm=NONE
hi CocSymbolConstructor guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocSymbolEnum guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolInterface guifg=#238636 ctermfg=29 cterm=NONE
hi CocSymbolFunction guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolVariable guifg=#8250df ctermfg=98 cterm=NONE
hi CocSymbolConstant guifg=#e87c7c ctermfg=174 cterm=NONE
hi CocSymbolString guifg=#238636 ctermfg=29 cterm=NONE
hi CocSymbolNumber guifg=#e87c7c ctermfg=174 cterm=NONE
hi CocSymbolBoolean guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi def link CocSymbolArray CocSymbolDefault
hi def link CocSymbolObject CocSymbolDefault
hi CocSymbolKey guifg=#8250df ctermfg=98 cterm=NONE
hi CocSymbolNull guifg=#0969da ctermfg=26 cterm=NONE
hi CocSymbolEnumMember guifg=#8250df ctermfg=98 cterm=NONE
hi CocSymbolStruct guifg=#8250df ctermfg=98 cterm=NONE
hi CocSymbolEvent guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocSymbolOperator guifg=#1b1f23 ctermfg=234 cterm=NONE
hi CocSymbolTypeParameter guifg=#d64545 ctermfg=167 cterm=NONE
hi CocSemTypeNamespace guifg=#0969da ctermfg=26 cterm=NONE
hi CocSemTypeType guifg=#bb8009 ctermfg=136 cterm=NONE
...
hi CocFloating guifg=#1b1f23 guibg=#ebebeb ctermfg=234 ctermbg=255 cterm=NONE
...
hi CocInlayHint guifg=#5c6166 guibg=#e0e0e0 ctermfg=241 ctermbg=254 cterm=NONE
hi DiagnosticError guifg=#d64545 ctermfg=167 cterm=NONE
hi CocHintFloat guifg=#2c9ab7 guibg=#ebebeb ctermfg=31 ctermbg=255 cterm=NONE
hi CocInfoFloat guifg=#0969da guibg=#ebebeb ctermfg=26 ctermbg=255 cterm=NONE
hi CocWarningFloat guifg=#bb8009 guibg=#ebebeb ctermfg=136 ctermbg=255 cterm=NONE
hi CocErrorFloat guifg=#d64545 guibg=#ebebeb ctermfg=167 ctermbg=255 cterm=NONE
hi CocHintLine guibg=#d6e7eb ctermbg=254 cterm=NONE
hi CocInfoLine guibg=#d1e0f0 ctermbg=189 cterm=NONE
hi CocWarningLine guibg=#ece3d1 ctermbg=254 cterm=NONE
hi CocErrorLine guibg=#f0dada ctermbg=224 cterm=NONE
hi CocHintSign guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocWarningVirtualText guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocErrorVirtualText guifg=#d64545 ctermfg=167 cterm=NONE
hi CocUnusedHighlight guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocDeprecatedHighlight guifg=#6e7681 ctermfg=243 cterm=NONE gui=strikethrough
hi CocHintHighlight guifg=#2c9ab7 guisp=#2c9ab7 ctermfg=31 cterm=NONE gui=undercurl
hi CocInfoVirtualText guifg=#0969da ctermfg=26 cterm=NONE
hi CocHintVirtualText guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocErrorSign guifg=#d64545 ctermfg=167 cterm=NONE
hi CocWarningSign guifg=#bb8009 ctermfg=136 cterm=NONE
hi CocInfoSign guifg=#0969da ctermfg=26 cterm=NONE
...
hi CocErrorHighlight guifg=#d64545 guisp=#d64545 ctermfg=167 cterm=NONE gui=undercurl
...
hi CocInfoHighlight guifg=#0969da guisp=#0969da ctermfg=26 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#bb8009 guisp=#bb8009 ctermfg=136 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#e5e5e5 ctermbg=254 cterm=NONE
hi def link CocInlayHintType CocInlayHint
hi NeotestTarget guifg=#0969da ctermfg=26 cterm=NONE
hi NeotestMarked guifg=#0969da ctermfg=26 cterm=NONE
hi NeotestWinSelect guifg=#0969da ctermfg=26 cterm=NONE
hi NeotestAdapterName guifg=#8250df ctermfg=98 cterm=NONE gui=bold
hi CocDisabled guifg=#6e7681 ctermfg=243 cterm=NONE
hi CocFadeOut guifg=#9ea7b1 ctermfg=248 cterm=NONE
...
hi CocMarkdownCode guifg=#2c9ab7 ctermfg=31 cterm=NONE
hi CocNotificationProgress guifg=#0969da ctermfg=26 cterm=NONE
...
hi CocHoverRange guibg=#e5e5e5 ctermbg=254 cterm=NONE
hi def link CocLinkedEditing CocCursorRange
hi CocCursorRange guibg=#e5e5e5 ctermbg=254 cterm=NONE
hi CocSelectedText guifg=#d64545 ctermfg=167 cterm=NONE
...
hi TbBufOffClose guifg=#5c6166 guibg=#e0e0e0 ctermfg=241 ctermbg=254 cterm=NONE
hi TbBufOnClose guifg=#d64545 guibg=#f5f5f5 ctermfg=167 ctermbg=255 cterm=NONE
hi TbBufOffModified guifg=#d64545 guibg=#e0e0e0 ctermfg=167 ctermbg=254 cterm=NONE
hi TbBufOnModified guifg=#238636 guibg=#f5f5f5 ctermfg=29 ctermbg=255 cterm=NONE
hi TbBufOff guifg=#5c6166 guibg=#e0e0e0 ctermfg=241 ctermbg=254 cterm=NONE
hi TbBufOn guifg=#1b1f23 guibg=#f5f5f5 ctermfg=234 ctermbg=255 cterm=NONE
hi TbFill guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi Tabline guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi SnacksZenIcon guifg=#0969da ctermfg=26 cterm=NONE
hi SnacksPickerPathHidden guifg=#9ea7b1 ctermfg=248 cterm=NONE
hi SnacksPickerPathIgnored guifg=#9ea7b1 ctermfg=248 cterm=NONE
hi SnacksPickerRow guifg=#6e7681 ctermfg=243 cterm=NONE
...
hi NeogitChangeNewFile guifg=#238636 ctermfg=29 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#bb8009 ctermfg=136 cterm=NONE gui=italic,bold
hi NeogitBranch guifg=#0969da ctermfg=26 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#d9822b guibg=#ececec ctermfg=172 ctermbg=255 cterm=NONE gui=bold
hi NeogitDiffHeader guifg=#0969da guibg=#ececec ctermfg=26 ctermbg=255 cterm=NONE gui=bold
