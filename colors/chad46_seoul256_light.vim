...
hi CocErrorHighlight guifg=#AF5F5F ctermfg=131 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#AF8760 ctermfg=137 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#5F87AE ctermfg=67 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#5F8787 ctermfg=66 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#b8b8b8 ctermbg=250 cterm=NONE
hi CocSelectedText guibg=#c0c0c0 guifg=#4e4e4e ctermfg=239 ctermbg=250 cterm=NONE
hi CocCodeLens guifg=#989898 ctermfg=246 cterm=NONE
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocUnused guifg=#a8a8a8 ctermfg=248 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocListMode guifg=#5F87AE ctermfg=67 cterm=NONE
hi CocListSearch guifg=#AF8760 guibg=#c8c8c8 ctermfg=137 ctermbg=251 cterm=NONE
...
hi CocNormalFloat guibg=#d7d7d7 ctermbg=188 cterm=NONE
hi CocTitle guifg=#4e4e4e ctermfg=239 cterm=NONE
