...
hi NeotestPassed guifg=#5F885F ctermfg=65 cterm=NONE
hi NeotestRunning guifg=#AF8760 ctermfg=137 cterm=NONE
hi NeotestFailed guifg=#AF5F5F ctermfg=131 cterm=NONE
hi NeotestSkipped guifg=#5F87AE ctermfg=67 cterm=NONE
hi NeotestTest guifg=#a8a8a8 ctermfg=248 cterm=NONE
hi NeotestNamespace guifg=#93B2B2 ctermfg=109 cterm=NONE
hi NeotestFocused guifg=#AF8760 ctermfg=137 cterm=NONE
hi NeotestFile guifg=#008787 ctermfg=30 cterm=NONE
hi NeotestDir guifg=#5F87AE ctermfg=67 cterm=NONE
hi NeotestBorder guifg=#5F87AE ctermfg=67 cterm=NONE
hi NeotestIndent guifg=#a0a0a0 ctermfg=247 cterm=NONE
hi NeotestExpandMarker guifg=#a0a0a0 ctermfg=247 cterm=NONE
hi NeotestAdapterName guifg=#875F87 ctermfg=96 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#5F87AE ctermfg=67 cterm=NONE
hi NeotestMarked guifg=#5F87AE ctermfg=67 cterm=NONE
hi NeotestTarget guifg=#5F87AE ctermfg=67 cterm=NONE
...
hi CocSelectedText guifg=#AF5F5F ctermfg=131 cterm=NONE
...
hi CocFloating guifg=#4E4E4E guibg=#d7d7d7 ctermfg=239 ctermbg=188 cterm=NONE
hi CocMenuSel guibg=#67A9AA guifg=#e0e0e0 ctermfg=254 ctermbg=73 cterm=NONE
...
hi CocSelectedLine guibg=#d0d0d0 ctermbg=252 cterm=NONE
...
hi CocDiagnosticsFile guifg=#989898 ctermfg=246 cterm=NONE
...
hi CocServicesPrefix guifg=#875F87 ctermfg=96 cterm=NONE
hi CocServicesName guifg=#5F87AE ctermfg=67 cterm=NONE
hi CocServicesStat guifg=#5F885F ctermfg=65 cterm=NONE
hi CocServicesLanguages guifg=#989898 ctermfg=246 cterm=NONE
hi CocSourcesPrefix guifg=#875F87 ctermfg=96 cterm=NONE
hi CocSourcesName guifg=#5F87AE ctermfg=67 cterm=NONE
hi CocSourcesPriority guifg=#678e8e ctermfg=66 cterm=NONE
hi CocSourcesFileTypes guifg=#989898 ctermfg=246 cterm=NONE
hi CocSourcesType guifg=#5F885F ctermfg=65 cterm=NONE
hi CocListsDesc guifg=#989898 ctermfg=246 cterm=NONE
hi CocExtensionsActivated guifg=#5F885F ctermfg=65 cterm=NONE
hi CocExtensionsLoaded guifg=#4e4e4e ctermfg=239 cterm=NONE
hi CocExtensionsDisabled guifg=#a8a8a8 ctermfg=248 cterm=NONE
hi CocExtensionsName guifg=#5F885F ctermfg=65 cterm=NONE
hi CocExtensionsLocal guifg=#5F87AE ctermfg=67 cterm=NONE
hi CocExtensionsRoot guifg=#989898 ctermfg=246 cterm=NONE
hi CocOutlineName guifg=#4e4e4e ctermfg=239 cterm=NONE
hi CocOutlineIndentLine guifg=#989898 ctermfg=246 cterm=NONE
hi CocOutlineKind guifg=#875F87 ctermfg=96 cterm=NONE
hi CocOutlineLine guifg=#989898 ctermfg=246 cterm=NONE
hi CocNotificationTime guifg=#989898 ctermfg=246 cterm=NONE
hi CocCommandsTitle guifg=#989898 ctermfg=246 cterm=NONE
...
hi CocLoaderHeader guibg=#5F87AE guifg=#e0e0e0 ctermfg=254 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderHeaderSec guibg=#5F8787 guifg=#e0e0e0 ctermfg=254 ctermbg=66 cterm=NONE gui=bold
hi CocLoaderTabActive guibg=#5F8787 guifg=#e0e0e0 ctermfg=254 ctermbg=66 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#b0b0b0 guifg=#e0e0e0 ctermfg=254 ctermbg=145 cterm=NONE
...
hi CocErrorLine guibg=#d8cccc ctermbg=252 cterm=NONE
hi CocWarningLine guibg=#d8d2cc ctermbg=252 cterm=NONE
hi CocInfoLine guibg=#ccd2d8 ctermbg=252 cterm=NONE
hi CocHintLine guibg=#ccd2d2 ctermbg=252 cterm=NONE
hi CocErrorFloat guifg=#AF5F5F guibg=#d7d7d7 ctermfg=131 ctermbg=188 cterm=NONE
hi CocWarningFloat guifg=#AF8760 guibg=#d7d7d7 ctermfg=137 ctermbg=188 cterm=NONE
hi CocInfoFloat guifg=#5F87AE guibg=#d7d7d7 ctermfg=67 ctermbg=188 cterm=NONE
hi CocHintFloat guifg=#5F8787 guibg=#d7d7d7 ctermfg=66 ctermbg=188 cterm=NONE
hi CocInlayHint guifg=#989898 guibg=#d0d0d0 ctermfg=246 ctermbg=252 cterm=NONE
...
hi DevIconJson guifg=#D8865F ctermfg=173 cterm=NONE
...
hi CocLoaderHighlight guifg=#5F87AE ctermfg=67 cterm=NONE
...
hi NeogitChangeAdded guibg=#416a41 guifg=#5F885F ctermfg=65 ctermbg=239 cterm=NONE gui=bold,italic
...
hi TbThemeToggleBtn guibg=#b8b8b8 guifg=#4e4e4e ctermfg=239 ctermbg=250 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#AF5F5F guifg=#e0e0e0 ctermfg=254 ctermbg=131 cterm=NONE gui=bold
...
hi Tabline guibg=#d0d0d0 ctermbg=252 cterm=NONE
hi TbFill guibg=#d0d0d0 ctermbg=252 cterm=NONE
hi TbBufOn guifg=#4e4e4e guibg=#e0e0e0 ctermfg=239 ctermbg=254 cterm=NONE
hi TbBufOff guifg=#989898 guibg=#d0d0d0 ctermfg=246 ctermbg=252 cterm=NONE
hi TbBufOnModified guifg=#5F885F guibg=#e0e0e0 ctermfg=65 ctermbg=254 cterm=NONE
hi TbBufOffModified guifg=#AF5F5F guibg=#d0d0d0 ctermfg=131 ctermbg=252 cterm=NONE
hi TbBufOnClose guifg=#AF5F5F guibg=#e0e0e0 ctermfg=131 ctermbg=254 cterm=NONE
hi TbBufOffClose guifg=#989898 guibg=#d0d0d0 ctermfg=246 ctermbg=252 cterm=NONE
hi TbTabNewBtn guifg=#4e4e4e guibg=#c0c0c0 ctermfg=239 ctermbg=250 cterm=NONE
hi TbTabOn guifg=#AF5F5F guibg=#e0e0e0 ctermfg=131 ctermbg=254 cterm=NONE
hi TbTabOff guifg=#4e4e4e guibg=#d0d0d0 ctermfg=239 ctermbg=252 cterm=NONE
hi TbTabCloseBtn guifg=#e0e0e0 guibg=#7395b8 ctermfg=254 ctermbg=67 cterm=NONE
hi TBTabTitle guifg=#e0e0e0 guibg=#5F87AE ctermfg=254 ctermbg=67 cterm=NONE
...
hi SnacksPickerPathIgnored guifg=#b0b0b0 ctermfg=145 cterm=NONE
hi SnacksPickerPathHidden guifg=#b0b0b0 ctermfg=145 cterm=NONE
...
hi CocLoaderWarning guifg=#AF8760 ctermfg=137 cterm=NONE
hi CocLoaderBackdrop guibg=#e0e0e0 ctermbg=254 cterm=NONE
hi CocLoaderHighlightBlock guibg=#5F87AE guifg=#e0e0e0 ctermfg=254 ctermbg=67 cterm=NONE
hi CocLoaderMutedBlock guibg=#b0b0b0 guifg=#e0e0e0 ctermfg=254 ctermbg=145 cterm=NONE
...
hi FoldColumn guifg=#D8865F guibg=NONE ctermfg=173 cterm=NONE
...
hi CocHintHighlight guifg=#5F8787 guisp=#5F8787 ctermfg=66 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#5F87AE guisp=#5F87AE ctermfg=67 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#AF8760 guisp=#AF8760 ctermfg=137 cterm=NONE gui=undercurl
hi CocErrorHighlight guifg=#AF5F5F guisp=#AF5F5F ctermfg=131 cterm=NONE gui=undercurl
...
hi SnacksPickerDir guifg=#989898 ctermfg=246 cterm=NONE
hi SnacksPickerDelim guifg=#a8a8a8 ctermfg=248 cterm=NONE
hi SnacksPickerRow guifg=#a8a8a8 ctermfg=248 cterm=NONE
hi IlluminatedWordWrite cterm=NONE gui=underline
hi IlluminatedWordRead cterm=NONE gui=underline
hi CocLoaderMuted guifg=#989898 ctermfg=246 cterm=NONE
