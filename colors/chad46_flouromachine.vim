...
hi CocLoaderHeader guifg=#262335 guibg=#61E2FF ctermfg=235 ctermbg=81 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#262335 guibg=#61E2FF ctermfg=235 ctermbg=81 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#262335 guibg=#61E2FF ctermfg=235 ctermbg=81 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#4a476b guifg=#262335 ctermfg=235 ctermbg=240 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocLoaderMuted guifg=#605c88 ctermfg=60 cterm=NONE
...
hi CocLoaderBackdrop guibg=#262335 ctermbg=235 cterm=NONE
hi CocLoaderHighlightBlock guibg=#61E2FF guifg=#262335 ctermfg=235 ctermbg=81 cterm=NONE
hi CocLoaderMutedBlock guibg=#4a476b guifg=#262335 ctermfg=235 ctermbg=240 cterm=NONE
...
hi NeogitChangeAdded guifg=#72F1B8 guibg=#54d39a ctermfg=85 ctermbg=78 cterm=NONE gui=italic,bold
...
hi GitSignsCurrentLineBlame guifg=#545076 ctermfg=60 cterm=NONE
...
hi DevIconJson guifg=#FFCC00 ctermfg=220 cterm=NONE
...
hi SnacksPickerDir guifg=#605c88 ctermfg=60 cterm=NONE
hi SnacksPickerDelim guifg=#545076 ctermfg=60 cterm=NONE
hi SnacksPickerRow guifg=#545076 ctermfg=60 cterm=NONE
hi SnacksPickerPathIgnored guifg=#4a476b ctermfg=240 cterm=NONE
hi SnacksPickerPathHidden guifg=#4a476b ctermfg=240 cterm=NONE
...
hi Tabline guibg=#2c293e ctermbg=236 cterm=NONE
hi TbFill guibg=#2c293e ctermbg=236 cterm=NONE
hi TbBufOn guifg=#ffffff guibg=#262335 ctermfg=231 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#605c88 guibg=#2c293e ctermfg=60 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#72F1B8 guibg=#262335 ctermfg=85 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#FE4450 guibg=#2c293e ctermfg=203 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#FE4450 guibg=#262335 ctermfg=203 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#605c88 guibg=#2c293e ctermfg=60 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#ffffff guibg=#383550 ctermfg=231 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#FE4450 guibg=#262335 ctermfg=203 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#ffffff guibg=#2c293e ctermfg=231 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#262335 guibg=#61E2FF ctermfg=235 ctermbg=81 cterm=NONE
hi TBTabTitle guifg=#262335 guibg=#61E2FF ctermfg=235 ctermbg=81 cterm=NONE
hi TbThemeToggleBtn guifg=#ffffff guibg=#3e3b59 ctermfg=231 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#262335 guibg=#FE4450 ctermfg=235 ctermbg=203 cterm=NONE gui=bold
...
hi FoldColumn guifg=#40dbfc guibg=NONE ctermfg=81 cterm=NONE
...
hi CocHintLine guibg=#2e3f53 ctermbg=238 cterm=NONE
hi CocInfoLine guibg=#2e3f53 ctermbg=238 cterm=NONE
hi CocWarningLine guibg=#463c2d ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#462739 ctermbg=237 cterm=NONE
hi CocHintSign guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocErrorFloat guifg=#FE4450 guibg=#1f1c2b ctermfg=203 ctermbg=235 cterm=NONE
...
hi CocInfoHighlight guifg=#61E2FF guisp=#61E2FF ctermfg=81 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#61E2FF guisp=#61E2FF ctermfg=81 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#545076 ctermfg=60 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#61E2FF guibg=#1f1c2b ctermfg=81 ctermbg=235 cterm=NONE
hi CocInfoFloat guifg=#61E2FF guibg=#1f1c2b ctermfg=81 ctermbg=235 cterm=NONE
hi CocWarningFloat guifg=#FFCC00 guibg=#1f1c2b ctermfg=220 ctermbg=235 cterm=NONE
hi CocUnusedHighlight guifg=#545076 ctermfg=60 cterm=NONE
hi CmpBorder guifg=#545076 ctermfg=60 cterm=NONE
hi CocErrorHighlight guifg=#FE4450 guisp=#FE4450 ctermfg=203 cterm=NONE gui=undercurl
...
hi CocInlayHint guifg=#605c88 guibg=#2c293e ctermfg=60 ctermbg=236 cterm=NONE
...
hi NeotestFile guifg=#61E2FF ctermfg=81 cterm=NONE
hi NeotestFocused guifg=#FFCC00 ctermfg=220 cterm=NONE
hi NeotestNamespace guifg=#72F1B8 ctermfg=85 cterm=NONE
hi NeotestTest guifg=#545076 ctermfg=60 cterm=NONE
...
hi CocDiagnosticsFile guifg=#605c88 ctermfg=60 cterm=NONE
...
hi CocServicesPrefix guifg=#AF6DF9 ctermfg=135 cterm=NONE
hi CocServicesName guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocServicesStat guifg=#72F1B8 ctermfg=85 cterm=NONE
hi CocServicesLanguages guifg=#605c88 ctermfg=60 cterm=NONE
hi CocSourcesPrefix guifg=#AF6DF9 ctermfg=135 cterm=NONE
hi CocSourcesName guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocSourcesPriority guifg=#72F1B8 ctermfg=85 cterm=NONE
hi CocSourcesFileTypes guifg=#605c88 ctermfg=60 cterm=NONE
hi CocSourcesType guifg=#72F1B8 ctermfg=85 cterm=NONE
hi CocListsDesc guifg=#605c88 ctermfg=60 cterm=NONE
hi CocExtensionsActivated guifg=#72F1B8 ctermfg=85 cterm=NONE
hi CocExtensionsLoaded guifg=#ffffff ctermfg=231 cterm=NONE
hi CocExtensionsDisabled guifg=#545076 ctermfg=60 cterm=NONE
hi CocExtensionsName guifg=#72F1B8 ctermfg=85 cterm=NONE
hi CocExtensionsLocal guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocExtensionsRoot guifg=#605c88 ctermfg=60 cterm=NONE
hi CocOutlineName guifg=#ffffff ctermfg=231 cterm=NONE
hi CocOutlineIndentLine guifg=#605c88 ctermfg=60 cterm=NONE
hi CocOutlineKind guifg=#AF6DF9 ctermfg=135 cterm=NONE
hi CocOutlineLine guifg=#605c88 ctermfg=60 cterm=NONE
hi CocNotificationTime guifg=#605c88 ctermfg=60 cterm=NONE
hi CocCommandsTitle guifg=#605c88 ctermfg=60 cterm=NONE
...
hi NeotestAdapterName guifg=#AF6DF9 ctermfg=135 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#61E2FF ctermfg=81 cterm=NONE
...
hi NeotestPassed guifg=#72F1B8 ctermfg=85 cterm=NONE
hi NeotestRunning guifg=#FFCC00 ctermfg=220 cterm=NONE
hi NeotestFailed guifg=#FE4450 ctermfg=203 cterm=NONE
hi NeotestSkipped guifg=#61E2FF ctermfg=81 cterm=NONE
...
hi NeotestMarked guifg=#61E2FF ctermfg=81 cterm=NONE
hi NeotestTarget guifg=#61E2FF ctermfg=81 cterm=NONE
...
hi NeotestExpandMarker guifg=#5a567f ctermfg=60 cterm=NONE
hi NeotestIndent guifg=#5a567f ctermfg=60 cterm=NONE
hi NeotestBorder guifg=#61E2FF ctermfg=81 cterm=NONE
hi NeotestDir guifg=#61E2FF ctermfg=81 cterm=NONE
...
hi CocSelectedText guifg=#FE4450 ctermfg=203 cterm=NONE
...
hi CocFloating guifg=#61E2FF guibg=#1f1c2b ctermfg=81 ctermbg=235 cterm=NONE
hi CocMenuSel guibg=#72F1B8 guifg=#262335 ctermfg=235 ctermbg=85 cterm=NONE
hi def link CocListSearch CocSearch
hi CocListMode guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocSelectedLine guibg=#2c293e ctermbg=236 cterm=NONE
