...
hi CocListSearch guifg=#FFCC00 guibg=#322f47 ctermfg=220 ctermbg=237 cterm=NONE
hi CocListMode guifg=#61E2FF ctermfg=81 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocUnused guifg=#545076 ctermfg=60 cterm=NONE
hi CocCursorRange guibg=#2c293e ctermbg=236 cterm=NONE
...
hi CocErrorHighlight guifg=#FE4450 ctermfg=203 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#FFCC00 ctermfg=220 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#61E2FF ctermfg=81 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#61E2FF ctermfg=81 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#3e3b59 ctermbg=238 cterm=NONE
hi CocSelectedText guibg=#383550 guifg=#ffffff ctermfg=231 ctermbg=237 cterm=NONE
...
hi CocNormalFloat guibg=#1f1c2b ctermbg=235 cterm=NONE
