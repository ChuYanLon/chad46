...
hi NeogitBranchHead guifg=#67b0e8 ctermfg=74 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#67b0e8 ctermfg=74 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#8ccf7e guibg=#6eb160 ctermfg=114 ctermbg=71 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#e57474 ctermfg=174 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#c47fd5 ctermfg=176 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#fcb163 ctermfg=215 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#6cbfbf ctermfg=73 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#e5c76b ctermfg=185 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#8ccf7e ctermfg=114 cterm=NONE gui=italic,bold
...
hi Type guisp=NONE guifg=#e5c76b ctermfg=185 cterm=NONE
...
hi Identifier guisp=NONE guifg=#e57474 ctermfg=174 cterm=NONE
hi Float guifg=#fcb163 ctermfg=215 cterm=NONE
hi Delimiter guifg=#ef7d7d ctermfg=210 cterm=NONE
hi Define guisp=NONE guifg=#c47fd5 ctermfg=176 cterm=NONE
...
hi CocHintHighlight guisp=#9bdead guifg=#9bdead ctermfg=115 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#67b0e8 guifg=#67b0e8 ctermfg=74 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#e5c76b guifg=#e5c76b ctermfg=185 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#e57474 guifg=#e57474 ctermfg=174 cterm=NONE gui=undercurl
...
hi LazyH2 guifg=#e57474 ctermfg=174 cterm=NONE gui=underline,bold
...
hi Operator guisp=NONE guifg=#dadada ctermfg=253 cterm=NONE
