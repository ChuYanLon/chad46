...
hi NeogitChangeModified guifg=#51afef ctermfg=75 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#98be65 guibg=#7aa047 ctermfg=107 ctermbg=107 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#ff6b5a ctermfg=203 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#dc8ef3 ctermfg=177 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#ea9558 ctermfg=173 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#46D9FF ctermfg=81 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#ECBE7B ctermfg=216 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#98be65 ctermfg=107 cterm=NONE gui=italic,bold
...
hi SnacksPickerMatch guifg=#51afef guibg=#32363e ctermfg=75 ctermbg=237 cterm=NONE
hi SnacksPickerFooter guifg=#53575f ctermfg=240 cterm=NONE
hi SnacksPickerListTitle guibg=#ff6b5a guifg=#53575f ctermfg=240 ctermbg=203 cterm=NONE
hi SnacksPickerPreviewTitle guibg=#51afef guifg=#53575f ctermfg=240 ctermbg=75 cterm=NONE
hi SnacksPickerTitle guibg=#98be65 guifg=#53575f ctermfg=240 ctermbg=107 cterm=NONE
