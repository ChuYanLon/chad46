...
hi BlinkCmpMenuSelection guifg=#06101E guibg=#35b5ff ctermfg=233 ctermbg=75 cterm=NONE gui=bold
hi CmpSel guifg=#06101E guibg=#35b5ff ctermfg=233 ctermbg=75 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#06101E guibg=#35b5ff ctermfg=233 ctermbg=75 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#06101E guibg=#66def9 ctermfg=233 ctermbg=81 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#06101E guibg=#66def9 ctermfg=233 ctermbg=81 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#123466 guifg=#06101E ctermfg=233 ctermbg=23 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#35b5ff ctermfg=75 cterm=NONE
hi CocLoaderMuted guifg=#184686 ctermfg=24 cterm=NONE
...
hi CocLoaderWarning guifg=#fd5e3a ctermfg=203 cterm=NONE
hi CocLoaderBackdrop guibg=#06101E ctermbg=233 cterm=NONE
hi CocLoaderHighlightBlock guibg=#35b5ff guifg=#06101E ctermfg=233 ctermbg=75 cterm=NONE
hi CocLoaderMutedBlock guibg=#123466 guifg=#06101E ctermfg=233 ctermbg=23 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#0a1c36 guibg=#123466 ctermfg=234 ctermbg=23 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#66def9 guibg=#06101E ctermfg=81 ctermbg=233 cterm=NONE gui=underline
hi MiniTablineVisible guifg=#66def9 guibg=#06101E ctermfg=81 ctermbg=233 cterm=NONE
hi NeogitHunkHeader guifg=#06101E guibg=#123466 ctermfg=233 ctermbg=23 cterm=NONE gui=bold
hi MiniTablineModifiedCurrent guifg=#01eca7 guibg=#06101E ctermfg=49 ctermbg=233 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#35b5ff guibg=#0e284e ctermfg=75 ctermbg=17 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#01eca7 guibg=#00ce89 ctermfg=49 ctermbg=42 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#66def9 guibg=#0a1c36 ctermfg=81 ctermbg=234 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#164080 ctermfg=24 cterm=NONE
...
hi TodoBgFix guifg=#0a1c36 guibg=#fc9487 ctermfg=234 ctermbg=210 cterm=NONE gui=bold
hi TodoBgHack guifg=#0a1c36 guibg=#fd5e3a ctermfg=234 ctermbg=203 cterm=NONE gui=bold
hi TodoBgNote guifg=#0a1c36 guibg=#66def9 ctermfg=234 ctermbg=81 cterm=NONE gui=bold
hi TodoBgPerf guifg=#0a1c36 guibg=#ec30ac ctermfg=234 ctermbg=205 cterm=NONE gui=bold
hi TodoBgTest guifg=#0a1c36 guibg=#ec30ac ctermfg=234 ctermbg=205 cterm=NONE gui=bold
hi TodoBgTodo guifg=#0a1c36 guibg=#fd5e3a ctermfg=234 ctermbg=203 cterm=NONE gui=bold
...
hi FoldColumn guifg=#008DA3 guibg=NONE ctermfg=31 cterm=NONE
...
hi CocSelectedLine guibg=#0a1c36 ctermbg=234 cterm=NONE
...
hi SnacksPickerDir guifg=#184686 ctermfg=24 cterm=NONE
hi SnacksPickerDelim guifg=#164080 ctermfg=24 cterm=NONE
hi SnacksPickerRow guifg=#164080 ctermfg=24 cterm=NONE
hi SnacksPickerPathIgnored guifg=#123466 ctermfg=23 cterm=NONE
hi SnacksPickerPathHidden guifg=#123466 ctermfg=23 cterm=NONE
...
hi Tabline guibg=#0a1c36 ctermbg=234 cterm=NONE
hi TbFill guibg=#0a1c36 ctermbg=234 cterm=NONE
hi TbBufOn guifg=#66def9 guibg=#06101E ctermfg=81 ctermbg=233 cterm=NONE
hi TbBufOff guifg=#184686 guibg=#0a1c36 ctermfg=24 ctermbg=234 cterm=NONE
hi TbBufOnModified guifg=#01eca7 guibg=#06101E ctermfg=49 ctermbg=233 cterm=NONE
hi TbBufOffModified guifg=#fc9487 guibg=#0a1c36 ctermfg=210 ctermbg=234 cterm=NONE
hi TbBufOnClose guifg=#fc9487 guibg=#06101E ctermfg=210 ctermbg=233 cterm=NONE
hi TbBufOffClose guifg=#184686 guibg=#0a1c36 ctermfg=24 ctermbg=234 cterm=NONE
hi TbTabNewBtn guifg=#66def9 guibg=#0e284e ctermfg=81 ctermbg=17 cterm=NONE
hi TbTabOn guifg=#fc9487 guibg=#06101E ctermfg=210 ctermbg=233 cterm=NONE
hi TbTabOff guifg=#66def9 guibg=#0a1c36 ctermfg=81 ctermbg=234 cterm=NONE
hi TbTabCloseBtn guifg=#06101E guibg=#22536f ctermfg=233 ctermbg=23 cterm=NONE
hi TBTabTitle guifg=#06101E guibg=#35b5ff ctermfg=233 ctermbg=75 cterm=NONE
hi TbThemeToggleBtn guifg=#66def9 guibg=#102e5a ctermfg=81 ctermbg=17 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#06101E guibg=#fc9487 ctermfg=233 ctermbg=210 cterm=NONE gui=bold
...
hi CocHintLine guibg=#142e3e ctermbg=235 cterm=NONE
hi CocInfoLine guibg=#0d283f ctermbg=235 cterm=NONE
hi CocWarningLine guibg=#2b1b22 ctermbg=235 cterm=NONE
hi CocErrorLine guibg=#2a232d ctermbg=235 cterm=NONE
hi CocHintSign guifg=#66def9 ctermfg=81 cterm=NONE
hi CocErrorFloat guifg=#fc9487 guibg=#071426 ctermfg=210 ctermbg=233 cterm=NONE
...
hi CocInfoHighlight guifg=#35b5ff guisp=#35b5ff ctermfg=75 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#66def9 guisp=#66def9 ctermfg=81 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#164080 ctermfg=24 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#66def9 guibg=#071426 ctermfg=81 ctermbg=233 cterm=NONE
hi CocInfoFloat guifg=#35b5ff guibg=#071426 ctermfg=75 ctermbg=233 cterm=NONE
hi CocWarningFloat guifg=#fd5e3a guibg=#071426 ctermfg=203 ctermbg=233 cterm=NONE
hi CocUnusedHighlight guifg=#164080 ctermfg=24 cterm=NONE
hi CmpBorder guifg=#164080 ctermfg=24 cterm=NONE
hi CocErrorHighlight guifg=#fc9487 guisp=#fc9487 ctermfg=210 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#fd5e3a guisp=#fd5e3a ctermfg=203 cterm=NONE gui=undercurl
...
hi CocDiagnosticsFile guifg=#184686 ctermfg=24 cterm=NONE
...
hi CocServicesPrefix guifg=#ec30ac ctermfg=205 cterm=NONE
hi CocServicesName guifg=#35b5ff ctermfg=75 cterm=NONE
hi CocServicesStat guifg=#01eca7 ctermfg=49 cterm=NONE
hi CocServicesLanguages guifg=#184686 ctermfg=24 cterm=NONE
hi CocSourcesPrefix guifg=#ec30ac ctermfg=205 cterm=NONE
hi CocSourcesName guifg=#35b5ff ctermfg=75 cterm=NONE
hi CocSourcesPriority guifg=#fd5e3a ctermfg=203 cterm=NONE
hi CocSourcesFileTypes guifg=#184686 ctermfg=24 cterm=NONE
hi CocSourcesType guifg=#01eca7 ctermfg=49 cterm=NONE
hi CocListsDesc guifg=#184686 ctermfg=24 cterm=NONE
hi CocExtensionsActivated guifg=#01eca7 ctermfg=49 cterm=NONE
hi CocExtensionsLoaded guifg=#66def9 ctermfg=81 cterm=NONE
hi CocExtensionsDisabled guifg=#164080 ctermfg=24 cterm=NONE
hi CocExtensionsName guifg=#01eca7 ctermfg=49 cterm=NONE
hi CocExtensionsLocal guifg=#35b5ff ctermfg=75 cterm=NONE
hi CocExtensionsRoot guifg=#184686 ctermfg=24 cterm=NONE
hi CocOutlineName guifg=#66def9 ctermfg=81 cterm=NONE
hi CocOutlineIndentLine guifg=#184686 ctermfg=24 cterm=NONE
hi CocOutlineKind guifg=#ec30ac ctermfg=205 cterm=NONE
hi CocOutlineLine guifg=#184686 ctermfg=24 cterm=NONE
hi CocNotificationTime guifg=#184686 ctermfg=24 cterm=NONE
hi CocCommandsTitle guifg=#184686 ctermfg=24 cterm=NONE
...
hi NeotestFile guifg=#66def9 ctermfg=81 cterm=NONE
...
hi DevIconJson guifg=#fa7a61 ctermfg=209 cterm=NONE
...
hi NeotestPassed guifg=#01eca7 ctermfg=49 cterm=NONE
hi NeotestRunning guifg=#fd5e3a ctermfg=203 cterm=NONE
hi NeotestFailed guifg=#fc9487 ctermfg=210 cterm=NONE
hi NeotestSkipped guifg=#35b5ff ctermfg=75 cterm=NONE
hi NeotestTest guifg=#164080 ctermfg=24 cterm=NONE
hi NeotestNamespace guifg=#5f6e29 ctermfg=58 cterm=NONE
hi NeotestFocused guifg=#fd5e3a ctermfg=203 cterm=NONE
hi NvimTreeFolderName guifg=#35b5ff ctermfg=75 cterm=NONE
hi NeotestDir guifg=#35b5ff ctermfg=75 cterm=NONE
hi NeotestBorder guifg=#35b5ff ctermfg=75 cterm=NONE
hi NeotestIndent guifg=#184686 ctermfg=24 cterm=NONE
hi NeotestExpandMarker guifg=#184686 ctermfg=24 cterm=NONE
hi NeotestAdapterName guifg=#ec30ac ctermfg=205 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#35b5ff ctermfg=75 cterm=NONE
hi NeotestMarked guifg=#35b5ff ctermfg=75 cterm=NONE
hi NeotestTarget guifg=#35b5ff ctermfg=75 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#fd5e3a guibg=#0e284e ctermfg=203 ctermbg=17 cterm=NONE gui=bold
...
hi NeogitHunkHeaderCursor guifg=#06101E guibg=#722529 ctermfg=233 ctermbg=52 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#06101E guibg=#722529 ctermfg=233 ctermbg=52 cterm=NONE gui=bold
hi MiniTablineHidden guifg=#184686 guibg=#0a1c36 ctermfg=24 ctermbg=234 cterm=NONE
hi NeogitHunkMergeHeaderCursor guifg=#06101E guibg=#66def9 ctermfg=233 ctermbg=81 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#06101E guibg=#66def9 ctermfg=233 ctermbg=81 cterm=NONE gui=bold
hi CocInlayHint guifg=#184686 guibg=#0a1c36 ctermfg=24 ctermbg=234 cterm=NONE
...
hi CocSelectedText guifg=#fc9487 ctermfg=210 cterm=NONE
...
hi CocFloating guifg=#e8e5b5 guibg=#071426 ctermfg=187 ctermbg=233 cterm=NONE
