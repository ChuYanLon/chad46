...
hi TbCloseAllBufsBtn guibg=#db627e guifg=#0e0e0e ctermfg=233 ctermbg=168 cterm=NONE gui=bold
hi TbThemeToggleBtn guibg=#292929 guifg=#FFFFFF ctermfg=231 ctermbg=235 cterm=NONE gui=bold
