...
hi TbThemeToggleBtn guibg=#33363a guifg=#d4d4d5 ctermfg=188 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#f87070 guifg=#101317 ctermfg=233 ctermbg=203 cterm=NONE gui=bold
