...
hi BlinkCmpMenuSelection guifg=#292A37 guibg=#6be6e6 ctermfg=236 ctermbg=80 cterm=NONE gui=bold
hi CmpSel guifg=#292A37 guibg=#6be6e6 ctermfg=236 ctermbg=80 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#292A37 guibg=#78a9ff ctermfg=236 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#292A37 guibg=#09deda ctermfg=236 ctermbg=44 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#292A37 guibg=#09deda ctermfg=236 ctermbg=44 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#50526b guifg=#292A37 ctermfg=236 ctermbg=240 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#78a9ff guifg=#292A37 ctermfg=236 ctermbg=111 cterm=NONE
hi CocLoaderMutedBlock guibg=#50526b guifg=#292A37 ctermfg=236 ctermbg=240 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#2e2f3e guibg=#50526b ctermfg=236 ctermbg=240 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#d9e0ee guibg=#292A37 ctermfg=254 ctermbg=236 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#3FDAA4 guibg=#292A37 ctermfg=79 ctermbg=236 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#78a9ff guibg=#3c3e51 ctermfg=111 ctermbg=238 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#3FDAA4 guibg=#21bc86 ctermfg=79 ctermbg=36 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#ec6a88 ctermfg=204 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#be95ff ctermfg=141 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#efb993 ctermfg=216 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#6be6e6 ctermfg=80 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#e1c697 ctermfg=186 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#3FDAA4 ctermfg=79 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#6be6e6 guibg=#2e2f3e ctermfg=80 ctermbg=236 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#555772 ctermfg=59 cterm=NONE
...
hi DevIconJson guifg=#E8D4B0 ctermfg=187 cterm=NONE
...
hi Tabline guibg=#2e2f3e ctermbg=236 cterm=NONE
hi TbFill guibg=#2e2f3e ctermbg=236 cterm=NONE
hi TbBufOn guifg=#d9e0ee guibg=#292A37 ctermfg=254 ctermbg=236 cterm=NONE
hi TbBufOff guifg=#67698a guibg=#2e2f3e ctermfg=60 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#3FDAA4 guibg=#292A37 ctermfg=79 ctermbg=236 cterm=NONE
hi TbBufOffModified guifg=#ec6a88 guibg=#2e2f3e ctermfg=204 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#ec6a88 guibg=#292A37 ctermfg=204 ctermbg=236 cterm=NONE
hi TbBufOffClose guifg=#67698a guibg=#2e2f3e ctermfg=60 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#d9e0ee guibg=#3c3e51 ctermfg=254 ctermbg=238 cterm=NONE
hi TbTabOn guifg=#ec6a88 guibg=#292A37 ctermfg=204 ctermbg=236 cterm=NONE
hi TbTabOff guifg=#d9e0ee guibg=#2e2f3e ctermfg=254 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#292A37 guibg=#78a9ff ctermfg=236 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#292A37 guibg=#78a9ff ctermfg=236 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#d9e0ee guibg=#45475d ctermfg=254 ctermbg=239 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#292A37 guibg=#ec6a88 ctermfg=236 ctermbg=204 cterm=NONE gui=bold
...
hi FoldColumn guifg=#8b8da9 guibg=NONE ctermfg=103 cterm=NONE
...
hi CocHintLine guibg=#24454f ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#343d55 ctermbg=238 cterm=NONE
hi CocWarningLine guibg=#444145 ctermbg=238 cterm=NONE
hi CocErrorLine guibg=#463343 ctermbg=237 cterm=NONE
hi CocHintSign guifg=#09deda ctermfg=44 cterm=NONE
hi CocErrorFloat guifg=#ec6a88 guibg=#272734 ctermfg=204 ctermbg=236 cterm=NONE
...
hi CocHintHighlight guifg=#09deda guisp=#09deda ctermfg=44 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#555772 ctermfg=59 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#09deda guibg=#272734 ctermfg=44 ctermbg=236 cterm=NONE
hi CocInfoFloat guifg=#78a9ff guibg=#272734 ctermfg=111 ctermbg=236 cterm=NONE
hi CocWarningFloat guifg=#e1c697 guibg=#272734 ctermfg=186 ctermbg=236 cterm=NONE
hi CocUnusedHighlight guifg=#555772 ctermfg=59 cterm=NONE
hi CmpBorder guifg=#555772 ctermfg=59 cterm=NONE
hi CocErrorHighlight guifg=#ec6a88 guisp=#ec6a88 ctermfg=204 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#e1c697 guisp=#e1c697 ctermfg=186 cterm=NONE gui=undercurl
...
hi CocInlayHint guifg=#67698a guibg=#2e2f3e ctermfg=60 ctermbg=236 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#292A37 guibg=#6be6e6 ctermfg=236 ctermbg=80 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#292A37 guibg=#6be6e6 ctermfg=236 ctermbg=80 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#292A37 guibg=#936FDC ctermfg=236 ctermbg=98 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#292A37 guibg=#936FDC ctermfg=236 ctermbg=98 cterm=NONE gui=bold
...
hi NeotestFile guifg=#6be6e6 ctermfg=80 cterm=NONE
hi NeotestFocused guifg=#e1c697 ctermfg=186 cterm=NONE
hi NeotestNamespace guifg=#08bdba ctermfg=37 cterm=NONE
hi NeotestTest guifg=#555772 ctermfg=59 cterm=NONE
...
hi NeogitHunkHeader guifg=#292A37 guibg=#50526b ctermfg=236 ctermbg=240 cterm=NONE gui=bold
...
hi CocDiagnosticsFile guifg=#67698a ctermfg=60 cterm=NONE
...
hi CocServicesStat guifg=#3FDAA4 ctermfg=79 cterm=NONE
hi CocServicesLanguages guifg=#67698a ctermfg=60 cterm=NONE
hi CocSourcesPrefix guifg=#be95ff ctermfg=141 cterm=NONE
hi CocSourcesName guifg=#78a9ff ctermfg=111 cterm=NONE
hi CocSourcesPriority guifg=#efb993 ctermfg=216 cterm=NONE
hi CocSourcesFileTypes guifg=#67698a ctermfg=60 cterm=NONE
hi CocSourcesType guifg=#3FDAA4 ctermfg=79 cterm=NONE
hi CocListsDesc guifg=#67698a ctermfg=60 cterm=NONE
hi CocExtensionsActivated guifg=#3FDAA4 ctermfg=79 cterm=NONE
hi CocExtensionsLoaded guifg=#d9e0ee ctermfg=254 cterm=NONE
hi CocExtensionsDisabled guifg=#555772 ctermfg=59 cterm=NONE
hi CocExtensionsName guifg=#3FDAA4 ctermfg=79 cterm=NONE
hi CocExtensionsLocal guifg=#78a9ff ctermfg=111 cterm=NONE
hi CocExtensionsRoot guifg=#67698a ctermfg=60 cterm=NONE
hi CocOutlineName guifg=#d9e0ee ctermfg=254 cterm=NONE
hi CocOutlineIndentLine guifg=#67698a ctermfg=60 cterm=NONE
hi CocOutlineKind guifg=#be95ff ctermfg=141 cterm=NONE
hi CocOutlineLine guifg=#67698a ctermfg=60 cterm=NONE
hi CocNotificationTime guifg=#67698a ctermfg=60 cterm=NONE
hi CocCommandsTitle guifg=#67698a ctermfg=60 cterm=NONE
...
hi NeotestAdapterName guifg=#be95ff ctermfg=141 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#78a9ff ctermfg=111 cterm=NONE
...
hi NeotestPassed guifg=#3FDAA4 ctermfg=79 cterm=NONE
hi NeotestRunning guifg=#e1c697 ctermfg=186 cterm=NONE
hi NeotestFailed guifg=#ec6a88 ctermfg=204 cterm=NONE
hi NeotestSkipped guifg=#78a9ff ctermfg=111 cterm=NONE
...
hi TodoBgTodo guifg=#2e2f3e guibg=#e1c697 ctermfg=236 ctermbg=186 cterm=NONE gui=bold
hi NeotestMarked guifg=#78a9ff ctermfg=111 cterm=NONE
hi NeotestTarget guifg=#78a9ff ctermfg=111 cterm=NONE
...
hi TodoBgFix guifg=#2e2f3e guibg=#ec6a88 ctermfg=236 ctermbg=204 cterm=NONE gui=bold
hi TodoBgHack guifg=#2e2f3e guibg=#efb993 ctermfg=236 ctermbg=216 cterm=NONE gui=bold
hi TodoBgNote guifg=#2e2f3e guibg=#d9e0ee ctermfg=236 ctermbg=254 cterm=NONE gui=bold
hi TodoBgPerf guifg=#2e2f3e guibg=#be95ff ctermfg=236 ctermbg=141 cterm=NONE gui=bold
hi TodoBgTest guifg=#2e2f3e guibg=#be95ff ctermfg=236 ctermbg=141 cterm=NONE gui=bold
...
hi NeotestExpandMarker guifg=#606281 ctermfg=60 cterm=NONE
hi NeotestIndent guifg=#606281 ctermfg=60 cterm=NONE
hi NeotestBorder guifg=#78a9ff ctermfg=111 cterm=NONE
hi NeotestDir guifg=#78a9ff ctermfg=111 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#efb993 guibg=#3c3e51 ctermfg=216 ctermbg=238 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#ec6a88 ctermfg=204 cterm=NONE
...
hi CocFloating guifg=#c0cbe3 guibg=#272734 ctermfg=152 ctermbg=236 cterm=NONE
...
hi CocSelectedLine guibg=#2e2f3e ctermbg=236 cterm=NONE
