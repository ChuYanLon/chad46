...
hi BlinkCmpMenuSelection guifg=#191724 guibg=#c4a7e7 ctermfg=234 ctermbg=182 cterm=NONE gui=bold
hi CmpSel guifg=#191724 guibg=#c4a7e7 ctermfg=234 ctermbg=182 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#191724 guibg=#8bbec7 ctermfg=234 ctermbg=110 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#191724 guibg=#6aadc8 ctermfg=234 ctermbg=74 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#191724 guibg=#6aadc8 ctermfg=234 ctermbg=74 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#3f3d4a guifg=#191724 ctermfg=234 ctermbg=238 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#8bbec7 ctermfg=110 cterm=NONE
hi CocLoaderMuted guifg=#5d5b68 ctermfg=59 cterm=NONE
...
hi CocLoaderWarning guifg=#f6c177 ctermfg=216 cterm=NONE
hi CocLoaderBackdrop guibg=#191724 ctermbg=234 cterm=NONE
hi CocLoaderHighlightBlock guibg=#8bbec7 guifg=#191724 ctermfg=234 ctermbg=110 cterm=NONE
hi CocLoaderMutedBlock guibg=#3f3d4a guifg=#191724 ctermfg=234 ctermbg=238 cterm=NONE
...
hi MiniTablineCurrent guifg=#e0def4 guibg=#191724 ctermfg=189 ctermbg=234 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#ABE9B3 guibg=#191724 ctermfg=151 ctermbg=234 cterm=NONE gui=underline
...
hi TodoBgFix guifg=#1f1d2a guibg=#eb6f92 ctermfg=235 ctermbg=168 cterm=NONE gui=bold
hi TodoBgHack guifg=#1f1d2a guibg=#f6c177 ctermfg=235 ctermbg=216 cterm=NONE gui=bold
hi TodoBgNote guifg=#1f1d2a guibg=#e0def4 ctermfg=235 ctermbg=189 cterm=NONE gui=bold
hi TodoBgPerf guifg=#1f1d2a guibg=#c4a7e7 ctermfg=235 ctermbg=182 cterm=NONE gui=bold
hi TodoBgTest guifg=#1f1d2a guibg=#c4a7e7 ctermfg=235 ctermbg=182 cterm=NONE gui=bold
hi TodoBgTodo guifg=#1f1d2a guibg=#f6c177 ctermfg=235 ctermbg=216 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#8bbec7 guibg=#2d2b38 ctermfg=110 ctermbg=236 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#ABE9B3 guibg=#8dcb95 ctermfg=151 ctermbg=114 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#a3d6df guibg=#1f1d2a ctermfg=152 ctermbg=235 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#474552 ctermfg=239 cterm=NONE
...
hi CocErrorHighlight guifg=#eb6f92 guisp=#eb6f92 ctermfg=168 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#f6c177 guisp=#f6c177 ctermfg=216 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#8bbec7 guisp=#8bbec7 ctermfg=110 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#6aadc8 guisp=#6aadc8 ctermfg=74 cterm=NONE gui=undercurl
...
hi CocErrorLine guibg=#382434 ctermbg=236 cterm=NONE
hi CocWarningLine guibg=#3a3030 ctermbg=236 cterm=NONE
hi CocInfoLine guibg=#2a303c ctermbg=236 cterm=NONE
hi CocHintLine guibg=#252d3c ctermbg=236 cterm=NONE
hi CocErrorFloat guifg=#eb6f92 guibg=#13111e ctermfg=168 ctermbg=233 cterm=NONE
hi CocWarningFloat guifg=#f6c177 guibg=#13111e ctermfg=216 ctermbg=233 cterm=NONE
hi CocInfoFloat guifg=#8bbec7 guibg=#13111e ctermfg=110 ctermbg=233 cterm=NONE
hi CocHintFloat guifg=#6aadc8 guibg=#13111e ctermfg=74 ctermbg=233 cterm=NONE
...
hi CocSelectedLine guibg=#1f1d2a ctermbg=235 cterm=NONE
...
hi DevIconJson guifg=#fec97f ctermfg=222 cterm=NONE
...
hi SnacksPickerDir guifg=#5d5b68 ctermfg=59 cterm=NONE
hi SnacksPickerDelim guifg=#474552 ctermfg=239 cterm=NONE
hi SnacksPickerRow guifg=#474552 ctermfg=239 cterm=NONE
hi SnacksPickerPathIgnored guifg=#3f3d4a ctermfg=238 cterm=NONE
hi SnacksPickerPathHidden guifg=#3f3d4a ctermfg=238 cterm=NONE
...
hi Tabline guibg=#1f1d2a ctermbg=235 cterm=NONE
hi TbFill guibg=#1f1d2a ctermbg=235 cterm=NONE
hi TbBufOn guifg=#e0def4 guibg=#191724 ctermfg=189 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#5d5b68 guibg=#1f1d2a ctermfg=59 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#ABE9B3 guibg=#191724 ctermfg=151 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#eb6f92 guibg=#1f1d2a ctermfg=168 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#eb6f92 guibg=#191724 ctermfg=168 ctermbg=234 cterm=NONE
hi TbBufOffClose guifg=#5d5b68 guibg=#1f1d2a ctermfg=59 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#e0def4 guibg=#2d2b38 ctermfg=189 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#eb6f92 guibg=#191724 ctermfg=168 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#e0def4 guibg=#1f1d2a ctermfg=189 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#191724 guibg=#86b9c2 ctermfg=234 ctermbg=109 cterm=NONE
hi TBTabTitle guifg=#191724 guibg=#8bbec7 ctermfg=234 ctermbg=110 cterm=NONE
hi TbThemeToggleBtn guifg=#e0def4 guibg=#353340 ctermfg=189 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#191724 guibg=#eb6f92 ctermfg=234 ctermbg=168 cterm=NONE gui=bold
...
hi FoldColumn guifg=#524f67 guibg=NONE ctermfg=240 cterm=NONE
...
hi CocDiagnosticsFile guifg=#5d5b68 ctermfg=59 cterm=NONE
...
hi CocServicesPrefix guifg=#c4a7e7 ctermfg=182 cterm=NONE
hi CocServicesName guifg=#8bbec7 ctermfg=110 cterm=NONE
hi CocServicesStat guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi CocServicesLanguages guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocSourcesPrefix guifg=#c4a7e7 ctermfg=182 cterm=NONE
hi CocSourcesName guifg=#8bbec7 ctermfg=110 cterm=NONE
hi CocSourcesPriority guifg=#f6c177 ctermfg=216 cterm=NONE
hi CocSourcesFileTypes guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocSourcesType guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi CocListsDesc guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocExtensionsActivated guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi CocExtensionsLoaded guifg=#e0def4 ctermfg=189 cterm=NONE
hi CocExtensionsDisabled guifg=#474552 ctermfg=239 cterm=NONE
hi CocExtensionsName guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi CocExtensionsLocal guifg=#8bbec7 ctermfg=110 cterm=NONE
hi CocExtensionsRoot guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocOutlineName guifg=#e0def4 ctermfg=189 cterm=NONE
hi CocOutlineIndentLine guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocOutlineKind guifg=#c4a7e7 ctermfg=182 cterm=NONE
hi CocOutlineLine guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocNotificationTime guifg=#5d5b68 ctermfg=59 cterm=NONE
hi CocCommandsTitle guifg=#5d5b68 ctermfg=59 cterm=NONE
...
hi NeotestTest guifg=#474552 ctermfg=239 cterm=NONE
hi NeotestNamespace guifg=#b5f3bd ctermfg=157 cterm=NONE
hi NeotestFocused guifg=#f6c177 ctermfg=216 cterm=NONE
hi NeotestFile guifg=#a3d6df ctermfg=152 cterm=NONE
hi NeotestDir guifg=#8bbec7 ctermfg=110 cterm=NONE
hi NeotestBorder guifg=#8bbec7 ctermfg=110 cterm=NONE
hi NeotestIndent guifg=#514f5c ctermfg=240 cterm=NONE
hi NeotestExpandMarker guifg=#514f5c ctermfg=240 cterm=NONE
...
hi NeotestSkipped guifg=#8bbec7 ctermfg=110 cterm=NONE
hi NeotestFailed guifg=#eb6f92 ctermfg=168 cterm=NONE
hi GitConflictDiffText guibg=#2e3639 ctermbg=236 cterm=NONE
hi NeotestRunning guifg=#f6c177 ctermfg=216 cterm=NONE
hi NeotestPassed guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi NeotestTarget guifg=#8bbec7 ctermfg=110 cterm=NONE
hi NeotestMarked guifg=#8bbec7 ctermfg=110 cterm=NONE
hi NeotestWinSelect guifg=#8bbec7 ctermfg=110 cterm=NONE
hi NeotestAdapterName guifg=#c4a7e7 ctermfg=182 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#f6c177 guibg=#2d2b38 ctermfg=216 ctermbg=236 cterm=NONE gui=bold
...
hi NeogitHunkHeaderCursor guifg=#191724 guibg=#bb9ede ctermfg=234 ctermbg=146 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#191724 guibg=#bb9ede ctermfg=234 ctermbg=146 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#191724 guibg=#3f3d4a ctermfg=234 ctermbg=238 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#191724 guibg=#a3d6df ctermfg=234 ctermbg=152 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#191724 guibg=#a3d6df ctermfg=234 ctermbg=152 cterm=NONE gui=bold
hi NeogitHunkMergeHeader guifg=#1f1d2a guibg=#3f3d4a ctermfg=235 ctermbg=238 cterm=NONE gui=bold
...
hi CocInlayHint guifg=#5d5b68 guibg=#1f1d2a ctermfg=59 ctermbg=235 cterm=NONE
hi def link CocInlayHintParameter CocInlayHint
hi def link CocInlayHintType CocInlayHint
hi CocHighlightText guibg=#353340 ctermbg=237 cterm=NONE
hi def link CocHighlightRead CocHighlightText
hi def link CocHighlightWrite CocHighlightText
hi CocSelectedText guifg=#eb6f92 ctermfg=168 cterm=NONE
...
hi CocFloating guifg=#e0def4 guibg=#13111e ctermfg=189 ctermbg=233 cterm=NONE
