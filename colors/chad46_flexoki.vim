...
hi BlinkCmpMenuSelection guifg=#100F0F guibg=#3AA99F ctermfg=233 ctermbg=73 cterm=NONE gui=bold
hi CmpSel guifg=#100F0F guibg=#3AA99F ctermfg=233 ctermbg=73 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#100F0F guibg=#4385BE ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#100F0F guibg=#519ABA ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#100F0F guibg=#519ABA ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#393636 guifg=#100F0F ctermfg=233 ctermbg=237 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#4385BE guifg=#100F0F ctermfg=233 ctermbg=67 cterm=NONE
hi CocLoaderMutedBlock guibg=#393636 guifg=#100F0F ctermfg=233 ctermbg=237 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#1c1b1b guibg=#393636 ctermfg=234 ctermbg=237 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#CECDC3 guibg=#100F0F ctermfg=251 ctermbg=233 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#879A39 guibg=#100F0F ctermfg=101 ctermbg=233 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#4385BE guibg=#353232 ctermfg=67 ctermbg=236 cterm=NONE gui=bold
...
hi NeogitFloatHeaderHighlight guifg=#3AA99F guibg=#1c1b1b ctermfg=73 ctermbg=234 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#555050 ctermfg=239 cterm=NONE
...
hi DevIconJson guifg=#eabb2b ctermfg=178 cterm=NONE
...
hi Tabline guibg=#1c1b1b ctermbg=234 cterm=NONE
hi TbFill guibg=#1c1b1b ctermbg=234 cterm=NONE
hi TbBufOn guifg=#CECDC3 guibg=#100F0F ctermfg=251 ctermbg=233 cterm=NONE
hi TbBufOff guifg=#6a6363 guibg=#1c1b1b ctermfg=241 ctermbg=234 cterm=NONE
hi TbBufOnModified guifg=#879A39 guibg=#100F0F ctermfg=101 ctermbg=233 cterm=NONE
hi TbBufOffModified guifg=#D14D41 guibg=#1c1b1b ctermfg=167 ctermbg=234 cterm=NONE
hi TbBufOnClose guifg=#D14D41 guibg=#100F0F ctermfg=167 ctermbg=233 cterm=NONE
hi TbBufOffClose guifg=#6a6363 guibg=#1c1b1b ctermfg=241 ctermbg=234 cterm=NONE
hi TbTabNewBtn guifg=#CECDC3 guibg=#353232 ctermfg=251 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#D14D41 guibg=#100F0F ctermfg=167 ctermbg=233 cterm=NONE
hi TbTabOff guifg=#CECDC3 guibg=#1c1b1b ctermfg=251 ctermbg=234 cterm=NONE
hi TbTabCloseBtn guifg=#100F0F guibg=#4385BE ctermfg=233 ctermbg=67 cterm=NONE
hi TBTabTitle guifg=#100F0F guibg=#4385BE ctermfg=233 ctermbg=67 cterm=NONE
hi TbThemeToggleBtn guifg=#CECDC3 guibg=#373434 ctermfg=251 ctermbg=236 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#100F0F guibg=#D14D41 ctermfg=233 ctermbg=167 cterm=NONE gui=bold
...
hi FoldColumn guifg=#519ABA guibg=NONE ctermfg=67 cterm=NONE
...
hi CocHintLine guibg=#192328 ctermbg=235 cterm=NONE
hi CocInfoLine guibg=#172029 ctermbg=234 cterm=NONE
hi CocWarningLine guibg=#2c250f ctermbg=234 cterm=NONE
hi CocErrorLine guibg=#2c1816 ctermbg=234 cterm=NONE
hi CocHintSign guifg=#519ABA ctermfg=67 cterm=NONE
hi CocErrorFloat guifg=#D14D41 guibg=#171616 ctermfg=167 ctermbg=233 cterm=NONE
...
hi CocHintFloat guifg=#519ABA guibg=#171616 ctermfg=67 ctermbg=233 cterm=NONE
hi CocInfoFloat guifg=#4385BE guibg=#171616 ctermfg=67 ctermbg=233 cterm=NONE
hi CocWarningFloat guifg=#D0A215 guibg=#171616 ctermfg=178 ctermbg=233 cterm=NONE
...
hi CocInlayHint guifg=#6a6363 guibg=#1c1b1b ctermfg=241 ctermbg=234 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#100F0F guibg=#3AA99F ctermfg=233 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#100F0F guibg=#3AA99F ctermfg=233 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#100F0F guibg=#7f70c2 ctermfg=233 ctermbg=97 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#100F0F guibg=#7f70c2 ctermfg=233 ctermbg=97 cterm=NONE gui=bold
...
hi NeotestNamespace guifg=#7e9f0e ctermfg=106 cterm=NONE
hi NeotestTest guifg=#555050 ctermfg=239 cterm=NONE
...
hi NeogitHunkHeader guifg=#100F0F guibg=#393636 ctermfg=233 ctermbg=237 cterm=NONE gui=bold
...
hi CocDiagnosticsFile guifg=#6a6363 ctermfg=241 cterm=NONE
...
hi CocServicesLanguages guifg=#6a6363 ctermfg=241 cterm=NONE
...
hi CocSourcesFileTypes guifg=#6a6363 ctermfg=241 cterm=NONE
hi CocSourcesType guifg=#879A39 ctermfg=101 cterm=NONE
hi CocListsDesc guifg=#6a6363 ctermfg=241 cterm=NONE
hi CocExtensionsActivated guifg=#879A39 ctermfg=101 cterm=NONE
hi CocExtensionsLoaded guifg=#CECDC3 ctermfg=251 cterm=NONE
hi CocExtensionsDisabled guifg=#555050 ctermfg=239 cterm=NONE
hi CocExtensionsName guifg=#879A39 ctermfg=101 cterm=NONE
hi CocExtensionsLocal guifg=#4385BE ctermfg=67 cterm=NONE
hi CocExtensionsRoot guifg=#6a6363 ctermfg=241 cterm=NONE
hi CocOutlineName guifg=#CECDC3 ctermfg=251 cterm=NONE
hi CocOutlineIndentLine guifg=#6a6363 ctermfg=241 cterm=NONE
hi CocOutlineKind guifg=#8B7EC8 ctermfg=104 cterm=NONE
hi CocOutlineLine guifg=#6a6363 ctermfg=241 cterm=NONE
hi CocNotificationTime guifg=#6a6363 ctermfg=241 cterm=NONE
hi CocCommandsTitle guifg=#6a6363 ctermfg=241 cterm=NONE
...
hi TodoBgTodo guifg=#1c1b1b guibg=#D0A215 ctermfg=234 ctermbg=178 cterm=NONE gui=bold
...
hi TodoBgFix guifg=#1c1b1b guibg=#D14D41 ctermfg=234 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#1c1b1b guibg=#DA702C ctermfg=234 ctermbg=166 cterm=NONE gui=bold
hi TodoBgNote guifg=#1c1b1b guibg=#CECDC3 ctermfg=234 ctermbg=251 cterm=NONE gui=bold
hi TodoBgPerf guifg=#1c1b1b guibg=#8B7EC8 ctermfg=234 ctermbg=104 cterm=NONE gui=bold
hi TodoBgTest guifg=#1c1b1b guibg=#8B7EC8 ctermfg=234 ctermbg=104 cterm=NONE gui=bold
...
hi NeotestExpandMarker guifg=#5f5959 ctermfg=240 cterm=NONE
hi NeotestIndent guifg=#5f5959 ctermfg=240 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#DA702C guibg=#353232 ctermfg=166 ctermbg=236 cterm=NONE gui=bold
...
hi CocFloating guifg=#CECDC3 guibg=#171616 ctermfg=251 ctermbg=233 cterm=NONE
...
hi CocSelectedLine guibg=#1c1b1b ctermbg=234 cterm=NONE
