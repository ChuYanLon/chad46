...
hi BlinkCmpMenuSelection guifg=#0B0E14 guibg=#ff9445 ctermfg=233 ctermbg=209 cterm=NONE gui=bold
hi CmpSel guifg=#0B0E14 guibg=#ff9445 ctermfg=233 ctermbg=209 cterm=NONE gui=bold
...
hi CocCursorRange guibg=#14171d ctermbg=234 cterm=NONE
hi CocErrorHighlight guifg=#F07178 ctermfg=204 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#E7C547 ctermfg=185 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#36A3D9 ctermfg=74 cterm=NONE gui=undercurl
...
hi CocSelectedText guibg=#24272d guifg=#ced4df ctermfg=188 ctermbg=235 cterm=NONE
hi CocCodeLens guifg=#54575d ctermfg=240 cterm=NONE
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocUnused guifg=#3d4046 ctermfg=238 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocListMode guifg=#36A3D9 ctermfg=74 cterm=NONE
hi CocListSearch guifg=#E7C547 guibg=#1c1f25 ctermfg=185 ctermbg=234 cterm=NONE
...
hi CocNormalFloat guibg=#05080e ctermbg=232 cterm=NONE
...
hi TodoBgFix guifg=#14171d guibg=#F07178 ctermfg=234 ctermbg=204 cterm=NONE gui=bold
hi TodoBgHack guifg=#14171d guibg=#ffa455 ctermfg=234 ctermbg=215 cterm=NONE gui=bold
hi TodoBgNote guifg=#14171d guibg=#ced4df ctermfg=234 ctermbg=188 cterm=NONE gui=bold
hi TodoBgPerf guifg=#14171d guibg=#c79bf4 ctermfg=234 ctermbg=177 cterm=NONE gui=bold
hi TodoBgTest guifg=#14171d guibg=#c79bf4 ctermfg=234 ctermbg=177 cterm=NONE gui=bold
hi TodoBgTodo guifg=#14171d guibg=#E7C547 ctermfg=234 ctermbg=185 cterm=NONE gui=bold
...
hi NeogitChangeUnmerged guifg=#E7C547 ctermfg=185 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#95E6CB guibg=#14171d ctermfg=116 ctermbg=234 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#ced4df guibg=#0B0E14 ctermfg=188 ctermbg=233 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#AAD84C guibg=#0B0E14 ctermfg=149 ctermbg=233 cterm=NONE gui=underline
...
hi SnacksPickerIcon guifg=#36A3D9 ctermfg=74 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#14171d guibg=#33363c ctermfg=234 ctermbg=237 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#0B0E14 guibg=#95E6CB ctermfg=233 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#0B0E14 guibg=#95E6CB ctermfg=233 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#0B0E14 guibg=#33363c ctermfg=233 ctermbg=237 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#0B0E14 guibg=#A37ACC ctermfg=233 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#0B0E14 guibg=#A37ACC ctermfg=233 ctermbg=140 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#36A3D9 guibg=#24272d ctermfg=74 ctermbg=235 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#ffa455 guibg=#24272d ctermfg=215 ctermbg=235 cterm=NONE gui=bold
hi NeogitBranch guifg=#36A3D9 ctermfg=74 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#36A3D9 ctermfg=74 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#36A3D9 ctermfg=74 cterm=NONE gui=italic,bold
...
hi NeogitChangeRenamed guifg=#c79bf4 ctermfg=177 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#ffa455 ctermfg=215 cterm=NONE gui=italic,bold
