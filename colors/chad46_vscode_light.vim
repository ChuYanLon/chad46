...
hi NeotestPassed guifg=#008000 ctermfg=28 cterm=NONE
hi NeotestRunning guifg=#795E26 ctermfg=94 cterm=NONE
hi NeotestFailed guifg=#FF0000 ctermfg=196 cterm=NONE
hi NeotestSkipped guifg=#007ACC ctermfg=32 cterm=NONE
hi NeotestTest guifg=#c7c7c7 ctermfg=251 cterm=NONE
hi NeotestNamespace guifg=#098658 ctermfg=29 cterm=NONE
hi NeotestFocused guifg=#795E26 ctermfg=94 cterm=NONE
hi NeotestFile guifg=#0064C1 ctermfg=25 cterm=NONE
hi NeotestDir guifg=#007ACC ctermfg=32 cterm=NONE
hi NeotestBorder guifg=#007ACC ctermfg=32 cterm=NONE
hi NeotestIndent guifg=#bfbfbf ctermfg=250 cterm=NONE
hi NeotestExpandMarker guifg=#bfbfbf ctermfg=250 cterm=NONE
hi NeotestAdapterName guifg=#000080 ctermfg=18 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#007ACC ctermfg=32 cterm=NONE
hi NeotestMarked guifg=#007ACC ctermfg=32 cterm=NONE
hi NeotestTarget guifg=#007ACC ctermfg=32 cterm=NONE
...
hi TbBufOn guifg=#343434 guibg=#FFFFFF ctermfg=236 ctermbg=231 cterm=NONE
hi TbBufOff guifg=#afafaf guibg=#efefef ctermfg=145 ctermbg=255 cterm=NONE
hi TbBufOnModified guifg=#008000 guibg=#FFFFFF ctermfg=28 ctermbg=231 cterm=NONE
hi TbBufOffModified guifg=#FF0000 guibg=#efefef ctermfg=196 ctermbg=255 cterm=NONE
hi TbBufOnClose guifg=#FF0000 guibg=#FFFFFF ctermfg=196 ctermbg=231 cterm=NONE
hi TbBufOffClose guifg=#afafaf guibg=#efefef ctermfg=145 ctermbg=255 cterm=NONE
hi TbTabNewBtn guifg=#343434 guibg=#dfdfdf ctermfg=236 ctermbg=253 cterm=NONE
hi TbTabOn guifg=#FF0000 guibg=#FFFFFF ctermfg=196 ctermbg=231 cterm=NONE
hi TbTabOff guifg=#343434 guibg=#efefef ctermfg=236 ctermbg=255 cterm=NONE
hi TbTabCloseBtn guifg=#FFFFFF guibg=#007ACC ctermfg=231 ctermbg=32 cterm=NONE
...
hi CocErrorLine guibg=#ffd8d8 ctermbg=224 cterm=NONE
hi CocWarningLine guibg=#eae6de ctermbg=254 cterm=NONE
hi CocInfoLine guibg=#d8ebf7 ctermbg=189 cterm=NONE
...
hi CocFloating guifg=#343434 guibg=#efefef ctermfg=236 ctermbg=255 cterm=NONE
...
hi CocDiagnosticsFile guifg=#afafaf ctermfg=145 cterm=NONE
...
hi CocServicesPrefix guifg=#000080 ctermfg=18 cterm=NONE
hi CocServicesName guifg=#007ACC ctermfg=32 cterm=NONE
hi CocServicesStat guifg=#008000 ctermfg=28 cterm=NONE
hi CocServicesLanguages guifg=#afafaf ctermfg=145 cterm=NONE
hi CocSourcesPrefix guifg=#000080 ctermfg=18 cterm=NONE
hi CocSourcesName guifg=#007ACC ctermfg=32 cterm=NONE
hi CocSourcesPriority guifg=#0451A5 ctermfg=25 cterm=NONE
hi CocSourcesFileTypes guifg=#afafaf ctermfg=145 cterm=NONE
hi CocSourcesType guifg=#008000 ctermfg=28 cterm=NONE
hi TBTabTitle guifg=#FFFFFF guibg=#007ACC ctermfg=231 ctermbg=32 cterm=NONE
hi TbThemeToggleBtn guifg=#343434 guibg=#d7d7d7 ctermfg=236 ctermbg=188 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#FFFFFF guibg=#FF0000 ctermfg=231 ctermbg=196 cterm=NONE gui=bold
hi CocExtensionsDisabled guifg=#c7c7c7 ctermfg=251 cterm=NONE
hi CocExtensionsName guifg=#008000 ctermfg=28 cterm=NONE
hi CocExtensionsLocal guifg=#007ACC ctermfg=32 cterm=NONE
hi CocExtensionsRoot guifg=#afafaf ctermfg=145 cterm=NONE
hi CocOutlineName guifg=#343434 ctermfg=236 cterm=NONE
hi CocOutlineIndentLine guifg=#afafaf ctermfg=145 cterm=NONE
hi CocOutlineKind guifg=#000080 ctermfg=18 cterm=NONE
hi CocOutlineLine guifg=#afafaf ctermfg=145 cterm=NONE
hi CocNotificationTime guifg=#afafaf ctermfg=145 cterm=NONE
hi CocCommandsTitle guifg=#afafaf ctermfg=145 cterm=NONE
...
hi CocHintLine guibg=#dcece6 ctermbg=254 cterm=NONE
...
hi CocListsDesc guifg=#afafaf ctermfg=145 cterm=NONE
hi CocExtensionsActivated guifg=#008000 ctermfg=28 cterm=NONE
hi CocExtensionsLoaded guifg=#343434 ctermfg=236 cterm=NONE
...
hi CocSelectedText guifg=#FF0000 ctermfg=196 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#c7c7c7 ctermfg=251 cterm=NONE
...
hi FoldColumn guifg=#6F6F6F guibg=NONE ctermfg=242 cterm=NONE
hi Exception guifg=#007ACC ctermfg=32 cterm=NONE
hi Error guifg=#ffffff guibg=#007ACC ctermfg=231 ctermbg=32 cterm=NONE
hi CocLoaderHeader guifg=#FFFFFF guibg=#007ACC ctermfg=231 ctermbg=32 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#FFFFFF guibg=#16825D ctermfg=231 ctermbg=29 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#FFFFFF guibg=#16825D ctermfg=231 ctermbg=29 cterm=NONE gui=bold
