...
hi BlinkCmpMenuSelection guifg=#fff9e8 guibg=#5f9b93 ctermfg=230 ctermbg=66 cterm=NONE gui=bold
hi CmpSel guifg=#fff9e8 guibg=#5f9b93 ctermfg=230 ctermbg=66 cterm=NONE gui=bold
...
hi CocSemTypeMethod guifg=#87a060 ctermfg=107 cterm=NONE
hi CocSemTypeMacro guifg=#8da101 ctermfg=106 cterm=NONE
hi CocSemTypeKeyword guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSemTypeModifier guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSemTypeComment guifg=#857F6E ctermfg=101 cterm=NONE
hi CocSemTypeString guifg=#d59600 ctermfg=172 cterm=NONE
hi CocSemTypeNumber guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSemTypeBoolean guifg=#89bfdc ctermfg=110 cterm=NONE
hi CocSemTypeRegexp guifg=#d59600 ctermfg=172 cterm=NONE
hi CocSemTypeOperator guifg=#495157 ctermfg=239 cterm=NONE
hi CocSemTypeDecorator guifg=#89bfdc ctermfg=110 cterm=NONE
hi CocSemModDeprecated guifg=#A39D8C ctermfg=247 cterm=NONE gui=strikethrough
hi CocSnippetVisual guibg=#C2BCAB ctermbg=250 cterm=NONE
...
hi CocLoaderHeader guifg=#fff9e8 guibg=#3a94c5 ctermfg=230 ctermbg=68 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#fff9e8 guibg=#69a59d ctermfg=230 ctermbg=73 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#fff9e8 guibg=#69a59d ctermfg=230 ctermbg=73 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#B3AD9C guifg=#fff9e8 ctermfg=230 ctermbg=248 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocLoaderMuted guifg=#857F6E ctermfg=101 cterm=NONE
...
hi CocLoaderWarning guifg=#dfa000 ctermfg=178 cterm=NONE
hi CocLoaderBackdrop guibg=#fff9e8 ctermbg=230 cterm=NONE
hi CocLoaderHighlightBlock guibg=#3a94c5 guifg=#fff9e8 ctermfg=230 ctermbg=68 cterm=NONE
hi CocLoaderMutedBlock guibg=#B3AD9C guifg=#fff9e8 ctermfg=230 ctermbg=248 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#F0EAD9 guibg=#B3AD9C ctermfg=254 ctermbg=248 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#272f35 guibg=#fff9e8 ctermfg=236 ctermbg=230 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#5da111 guibg=#fff9e8 ctermfg=70 ctermbg=230 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#3a94c5 guibg=#D1CBBA ctermfg=68 ctermbg=251 cterm=NONE gui=bold
hi WarningMsg guifg=#5f9b93 ctermfg=66 cterm=NONE
hi NeogitBranch guifg=#3a94c5 ctermfg=68 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#3a94c5 ctermfg=68 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#3a94c5 ctermfg=68 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#5da111 guibg=#3f8300 ctermfg=70 ctermbg=64 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#c85552 ctermfg=167 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#b67996 ctermfg=138 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#F7954F ctermfg=209 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#89bfdc ctermfg=110 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#dfa000 ctermfg=178 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#5da111 ctermfg=70 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#89bfdc guibg=#F0EAD9 ctermfg=110 ctermbg=254 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#A39D8C ctermfg=247 cterm=NONE
...
hi CocErrorVirtualText guifg=#c85552 ctermfg=167 cterm=NONE
hi CocWarningVirtualText guifg=#dfa000 ctermfg=178 cterm=NONE
hi CocInfoVirtualText guifg=#3a94c5 ctermfg=68 cterm=NONE
...
hi LazyH2 guifg=#c85552 ctermfg=167 cterm=NONE gui=underline,bold
...
hi CocFloatThumb guibg=#B3AD9C ctermbg=248 cterm=NONE
hi CocFloatSbar guibg=#E0DAC9 ctermbg=188 cterm=NONE
hi CocFloatBorder guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocFloatActive guibg=#E0DAC9 ctermbg=188 cterm=NONE
hi CocFloatDividingLine guifg=#e8e2d1 ctermfg=253 cterm=NONE
hi CocPumSearch guifg=#F7954F ctermfg=209 cterm=NONE
hi CocPumDetail guifg=#857F6E ctermfg=101 cterm=NONE
hi def link CocPumMenu CocFloating
hi CocPumShortcut guifg=#A39D8C ctermfg=247 cterm=NONE
hi CocPumDeprecated guifg=#A39D8C ctermfg=247 cterm=NONE gui=strikethrough
hi CocPumVirtualText guifg=#A39D8C ctermfg=247 cterm=NONE
hi CocVirtualText guifg=#A39D8C ctermfg=247 cterm=NONE
hi def link CocInputBoxVirtualText CocVirtualText
hi CocInlineVirtualText guifg=#A39D8C ctermfg=247 cterm=NONE
hi CocInlineAnnotation guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSearch guifg=#F7954F ctermfg=209 cterm=NONE
hi CocLink guifg=#3a94c5 ctermfg=68 cterm=NONE gui=underline
...
hi CocListFgBlue guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocListFgMagenta guifg=#b67996 ctermfg=138 cterm=NONE
hi CocListFgCyan guifg=#89bfdc ctermfg=110 cterm=NONE
hi CocListFgWhite guifg=#272f35 ctermfg=236 cterm=NONE
hi CocListFgGrey guifg=#A39D8C ctermfg=247 cterm=NONE
hi CocListBgBlack guibg=#F0EAD9 ctermbg=254 cterm=NONE
hi CocListBgRed guibg=#c85552 ctermbg=167 cterm=NONE
hi CocListBgGreen guibg=#5da111 ctermbg=70 cterm=NONE
hi CocListBgYellow guibg=#dfa000 ctermbg=178 cterm=NONE
...
hi SnacksPickerDir guifg=#857F6E ctermfg=101 cterm=NONE
hi SnacksPickerDelim guifg=#A39D8C ctermfg=247 cterm=NONE
hi SnacksPickerRow guifg=#A39D8C ctermfg=247 cterm=NONE
hi SnacksPickerPathIgnored guifg=#B3AD9C ctermfg=248 cterm=NONE
hi SnacksPickerPathHidden guifg=#B3AD9C ctermfg=248 cterm=NONE
...
hi Tabline guibg=#F0EAD9 ctermbg=254 cterm=NONE
hi TbFill guibg=#F0EAD9 ctermbg=254 cterm=NONE
hi TbBufOn guifg=#272f35 guibg=#fff9e8 ctermfg=236 ctermbg=230 cterm=NONE
hi TbBufOff guifg=#857F6E guibg=#F0EAD9 ctermfg=101 ctermbg=254 cterm=NONE
hi TbBufOnModified guifg=#5da111 guibg=#fff9e8 ctermfg=70 ctermbg=230 cterm=NONE
hi TbBufOffModified guifg=#c85552 guibg=#F0EAD9 ctermfg=167 ctermbg=254 cterm=NONE
hi TbBufOnClose guifg=#c85552 guibg=#fff9e8 ctermfg=167 ctermbg=230 cterm=NONE
hi TbBufOffClose guifg=#857F6E guibg=#F0EAD9 ctermfg=101 ctermbg=254 cterm=NONE
hi TbTabNewBtn guifg=#272f35 guibg=#D1CBBA ctermfg=236 ctermbg=251 cterm=NONE
hi TbTabOn guifg=#c85552 guibg=#fff9e8 ctermfg=167 ctermbg=230 cterm=NONE
hi TbTabOff guifg=#272f35 guibg=#F0EAD9 ctermfg=236 ctermbg=254 cterm=NONE
hi TbTabCloseBtn guifg=#fff9e8 guibg=#656c5f ctermfg=230 ctermbg=241 cterm=NONE
hi TBTabTitle guifg=#fff9e8 guibg=#3a94c5 ctermfg=230 ctermbg=68 cterm=NONE
hi TbThemeToggleBtn guifg=#272f35 guibg=#C2BCAB ctermfg=236 ctermbg=250 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#fff9e8 guibg=#c85552 ctermfg=230 ctermbg=167 cterm=NONE gui=bold
hi TelescopePromptPrefix guibg=#F0EAD9 guifg=#c85552 ctermfg=167 ctermbg=254 cterm=NONE
...
hi FoldColumn guifg=#c85552 guibg=NONE ctermfg=167 cterm=NONE
...
hi CocHintLine guibg=#e8ecdc ctermbg=254 cterm=NONE
hi CocInfoLine guibg=#e1e9e2 ctermbg=254 cterm=NONE
hi CocWarningLine guibg=#faebc5 ctermbg=224 cterm=NONE
hi CocErrorLine guibg=#f6e0d1 ctermbg=224 cterm=NONE
hi CocHintSign guifg=#69a59d ctermfg=73 cterm=NONE
hi CocErrorFloat guifg=#c85552 guibg=#f5efde ctermfg=167 ctermbg=255 cterm=NONE
...
hi CocInfoHighlight guifg=#3a94c5 guisp=#3a94c5 ctermfg=68 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#69a59d guisp=#69a59d ctermfg=73 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#A39D8C ctermfg=247 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#69a59d guibg=#f5efde ctermfg=73 ctermbg=255 cterm=NONE
hi CocInfoFloat guifg=#3a94c5 guibg=#f5efde ctermfg=68 ctermbg=255 cterm=NONE
hi CocWarningFloat guifg=#dfa000 guibg=#f5efde ctermfg=178 ctermbg=255 cterm=NONE
hi CocUnusedHighlight guifg=#A39D8C ctermfg=247 cterm=NONE
hi CmpBorder guifg=#A39D8C ctermfg=247 cterm=NONE
hi CocErrorHighlight guifg=#c85552 guisp=#c85552 ctermfg=167 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#dfa000 guisp=#dfa000 ctermfg=178 cterm=NONE gui=undercurl
...
hi CocHoverRange guibg=#C2BCAB ctermbg=250 cterm=NONE
hi def link CocLinkedEditing CocCursorRange
hi CocCursorRange guibg=#C2BCAB ctermbg=250 cterm=NONE
...
hi CocInlayHint guifg=#857F6E guibg=#F0EAD9 ctermfg=101 ctermbg=254 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#fff9e8 guibg=#89bfdc ctermfg=230 ctermbg=110 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#fff9e8 guibg=#89bfdc ctermfg=230 ctermbg=110 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#fff9e8 guibg=#966986 ctermfg=230 ctermbg=96 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#fff9e8 guibg=#966986 ctermfg=230 ctermbg=96 cterm=NONE gui=bold
...
hi NeotestFile guifg=#89bfdc ctermfg=110 cterm=NONE
hi NeotestFocused guifg=#dfa000 ctermfg=178 cterm=NONE
hi NeotestNamespace guifg=#87a060 ctermfg=107 cterm=NONE
hi NeotestTest guifg=#A39D8C ctermfg=247 cterm=NONE
hi SnacksNotifierTitleWarn guifg=#dfa000 ctermfg=178 cterm=NONE
hi CocFadeOut guifg=#B3AD9C ctermfg=248 cterm=NONE
...
hi CocSemTypeEnum guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSemTypeInterface guifg=#5da111 ctermfg=70 cterm=NONE
hi CocSemTypeStruct guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSemTypeTypeParameter guifg=#5f9b93 ctermfg=66 cterm=NONE
hi CocSemTypeParameter guifg=#5f9b93 ctermfg=66 cterm=NONE
hi CocSemTypeVariable guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSemTypeProperty guifg=#5f9b93 ctermfg=66 cterm=NONE
hi CocSemTypeEnumMember guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSemTypeEvent guifg=#dfa000 ctermfg=178 cterm=NONE
hi CocSemTypeFunction guifg=#87a060 ctermfg=107 cterm=NONE
...
hi NeogitHunkHeader guifg=#fff9e8 guibg=#B3AD9C ctermfg=230 ctermbg=248 cterm=NONE gui=bold
...
hi CocListBgBlue guibg=#3a94c5 ctermbg=68 cterm=NONE
hi CocListBgMagenta guibg=#b67996 ctermbg=138 cterm=NONE
hi CocListBgCyan guibg=#89bfdc ctermbg=110 cterm=NONE
hi CocListBgWhite guibg=#272f35 ctermbg=236 cterm=NONE
hi CocListBgGrey guibg=#B3AD9C ctermbg=248 cterm=NONE
hi CocDiagnosticsFile guifg=#857F6E ctermfg=101 cterm=NONE
...
hi CocServicesPrefix guifg=#b67996 ctermfg=138 cterm=NONE
hi CocServicesName guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocServicesStat guifg=#5da111 ctermfg=70 cterm=NONE
hi CocServicesLanguages guifg=#857F6E ctermfg=101 cterm=NONE
hi CocSourcesPrefix guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSourcesName guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSourcesPriority guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSourcesFileTypes guifg=#857F6E ctermfg=101 cterm=NONE
hi CocSourcesType guifg=#5da111 ctermfg=70 cterm=NONE
hi CocListsDesc guifg=#857F6E ctermfg=101 cterm=NONE
hi CocExtensionsActivated guifg=#5da111 ctermfg=70 cterm=NONE
hi CocExtensionsLoaded guifg=#272f35 ctermfg=236 cterm=NONE
hi CocExtensionsDisabled guifg=#A39D8C ctermfg=247 cterm=NONE
hi CocExtensionsName guifg=#5da111 ctermfg=70 cterm=NONE
hi CocExtensionsLocal guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocExtensionsRoot guifg=#857F6E ctermfg=101 cterm=NONE
hi CocOutlineName guifg=#272f35 ctermfg=236 cterm=NONE
hi CocOutlineIndentLine guifg=#857F6E ctermfg=101 cterm=NONE
hi CocOutlineKind guifg=#b67996 ctermfg=138 cterm=NONE
hi CocOutlineLine guifg=#857F6E ctermfg=101 cterm=NONE
hi CocNotificationTime guifg=#857F6E ctermfg=101 cterm=NONE
hi CocCommandsTitle guifg=#857F6E ctermfg=101 cterm=NONE
hi def link CocPopupTerminal CocFloating
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocStrikeThrough cterm=NONE gui=strikethrough
hi CocUnderline guisp=#A39D8C cterm=NONE gui=underline
hi CocDisabled guifg=#A39D8C ctermfg=247 cterm=NONE
...
hi CocNotificationButton guifg=#3a94c5 ctermfg=68 cterm=NONE gui=underline
hi CocNotificationKey guifg=#857F6E ctermfg=101 cterm=NONE
hi def link CocNotificationError CocErrorFloat
hi def link CocNotificationWarning CocWarningFloat
hi def link CocNotificationInfo CocInfoFloat
hi CocTreeTitle guifg=#272f35 ctermfg=236 cterm=NONE gui=bold
hi CocTreeDescription guifg=#857F6E ctermfg=101 cterm=NONE
hi CocTreeOpenClose cterm=NONE gui=bold
hi CocTreeSelected guibg=#F0EAD9 ctermbg=254 cterm=NONE
hi CocSymbolDefault guifg=#857F6E ctermfg=101 cterm=NONE
hi CocSymbolKeyword guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSymbolNamespace guifg=#87a060 ctermfg=107 cterm=NONE
hi CocSymbolClass guifg=#69a59d ctermfg=73 cterm=NONE
hi CocSymbolMethod guifg=#87a060 ctermfg=107 cterm=NONE
hi CocSymbolProperty guifg=#5f9b93 ctermfg=66 cterm=NONE
hi def link CocSymbolText CocSymbolDefault
hi def link CocSymbolUnit CocSymbolDefault
hi def link CocSymbolValue CocSymbolDefault
hi CocSymbolSnippet guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSymbolColor guifg=#272f35 ctermfg=236 cterm=NONE
hi CocSymbolReference guifg=#495157 ctermfg=239 cterm=NONE
hi CocSymbolFolder guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSymbolFile guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSymbolModule guifg=#8da101 ctermfg=106 cterm=NONE
hi CocSymbolPackage guifg=#8da101 ctermfg=106 cterm=NONE
hi CocSymbolField guifg=#5f9b93 ctermfg=66 cterm=NONE
hi CocSymbolConstructor guifg=#69a59d ctermfg=73 cterm=NONE
hi CocSymbolEnum guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSymbolInterface guifg=#5da111 ctermfg=70 cterm=NONE
hi CocSymbolFunction guifg=#87a060 ctermfg=107 cterm=NONE
hi CocSymbolVariable guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSymbolConstant guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSymbolString guifg=#d59600 ctermfg=172 cterm=NONE
hi CocSymbolNumber guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSymbolBoolean guifg=#89bfdc ctermfg=110 cterm=NONE
hi def link CocSymbolArray CocSymbolDefault
hi def link CocSymbolObject CocSymbolDefault
hi CocSymbolKey guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSymbolNull guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocSymbolEnumMember guifg=#b67996 ctermfg=138 cterm=NONE
hi CocSymbolStruct guifg=#c85552 ctermfg=167 cterm=NONE
hi CocSymbolEvent guifg=#dfa000 ctermfg=178 cterm=NONE
hi CocSymbolOperator guifg=#495157 ctermfg=239 cterm=NONE
hi CocSymbolTypeParameter guifg=#5f9b93 ctermfg=66 cterm=NONE
hi CocSemTypeNamespace guifg=#87a060 ctermfg=107 cterm=NONE
hi CocSemTypeType guifg=#8da101 ctermfg=106 cterm=NONE
hi CocMarkdownCode guifg=#69a59d ctermfg=73 cterm=NONE
hi CocNotificationProgress guifg=#3a94c5 ctermfg=68 cterm=NONE
hi NeotestAdapterName guifg=#b67996 ctermfg=138 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#3a94c5 ctermfg=68 cterm=NONE
...
hi NeotestPassed guifg=#5da111 ctermfg=70 cterm=NONE
hi NeotestRunning guifg=#dfa000 ctermfg=178 cterm=NONE
hi NeotestFailed guifg=#c85552 ctermfg=167 cterm=NONE
hi NeotestSkipped guifg=#3a94c5 ctermfg=68 cterm=NONE
...
hi TodoBgTodo guifg=#F0EAD9 guibg=#dfa000 ctermfg=254 ctermbg=178 cterm=NONE gui=bold
hi NeotestMarked guifg=#3a94c5 ctermfg=68 cterm=NONE
hi NeotestTarget guifg=#3a94c5 ctermfg=68 cterm=NONE
...
hi TodoBgFix guifg=#F0EAD9 guibg=#c85552 ctermfg=254 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#F0EAD9 guibg=#F7954F ctermfg=254 ctermbg=209 cterm=NONE gui=bold
hi TodoBgNote guifg=#F0EAD9 guibg=#272f35 ctermfg=254 ctermbg=236 cterm=NONE gui=bold
hi TodoBgPerf guifg=#F0EAD9 guibg=#b67996 ctermfg=254 ctermbg=138 cterm=NONE gui=bold
hi TodoBgTest guifg=#F0EAD9 guibg=#b67996 ctermfg=254 ctermbg=138 cterm=NONE gui=bold
...
hi NeotestExpandMarker guifg=#948E7D ctermfg=245 cterm=NONE
hi NeotestIndent guifg=#948E7D ctermfg=245 cterm=NONE
hi NeotestBorder guifg=#3a94c5 ctermfg=68 cterm=NONE
hi NeotestDir guifg=#3a94c5 ctermfg=68 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#F7954F guibg=#D1CBBA ctermfg=209 ctermbg=251 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#c85552 ctermfg=167 cterm=NONE
...
hi CocFloating guifg=#495157 guibg=#f5efde ctermfg=239 ctermbg=255 cterm=NONE
...
hi CocSelectedLine guibg=#F0EAD9 ctermbg=254 cterm=NONE
hi CocListPath guifg=#857F6E ctermfg=101 cterm=NONE
hi CocListLine guibg=#F0EAD9 ctermbg=254 cterm=NONE
hi CocListFgBlack guifg=#F0EAD9 ctermfg=254 cterm=NONE
hi CocListFgRed guifg=#c85552 ctermfg=167 cterm=NONE
hi CocListFgGreen guifg=#5da111 ctermfg=70 cterm=NONE
hi CocListFgYellow guifg=#dfa000 ctermfg=178 cterm=NONE
...
hi CocInfoSign guifg=#3a94c5 ctermfg=68 cterm=NONE
hi CocWarningSign guifg=#dfa000 ctermfg=178 cterm=NONE
hi CocErrorSign guifg=#c85552 ctermfg=167 cterm=NONE
...
hi DiffAdd guifg=#5da111 guibg=#eef0d2 ctermfg=70 ctermbg=230 cterm=NONE
