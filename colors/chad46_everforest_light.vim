...
hi NvimDapViewTabSelected guibg=#fff9e8 guifg=#272f35 ctermfg=236 ctermbg=230 cterm=NONE
hi NvimDapViewTab guibg=#F0EAD9 guifg=#857F6E ctermfg=101 ctermbg=254 cterm=NONE
...
hi FlashCurrent guibg=#5da111 guifg=#fff9e8 ctermfg=230 ctermbg=70 cterm=NONE
hi FlashMatch guibg=#3a94c5 guifg=#fff9e8 ctermfg=230 ctermbg=68 cterm=NONE
...
hi LspInlayHint guifg=#857F6E guibg=#f3eddc ctermfg=101 ctermbg=255 cterm=NONE
...
hi MasonHeader guifg=#fff9e8 guibg=#c85552 ctermfg=230 ctermbg=167 cterm=NONE
