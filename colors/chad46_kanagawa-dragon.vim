...
hi Operator guisp=NONE guifg=#adada4 ctermfg=248 cterm=NONE
...
hi Type guisp=NONE guifg=#8ea4a2 ctermfg=247 cterm=NONE
...
hi CocHintHighlight guisp=#949fb5 guifg=#949fb5 ctermfg=109 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#8ba4b0 guifg=#8ba4b0 ctermfg=109 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#c4b28a guifg=#c4b28a ctermfg=180 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#c4746e guifg=#c4746e ctermfg=173 cterm=NONE gui=undercurl
...
hi NeogitChangeAdded guifg=#8a9a7b guibg=#6c7c5d ctermfg=245 ctermbg=65 cterm=NONE gui=bold,italic
...
hi Define guisp=NONE guifg=#a292a3 ctermfg=247 cterm=NONE
hi Delimiter guifg=#9e9b93 ctermfg=247 cterm=NONE
hi Float guifg=#b6927b ctermfg=138 cterm=NONE
hi Identifier guisp=NONE guifg=#c4b28a ctermfg=180 cterm=NONE
