...
hi BlinkCmpMenuSelection guifg=#171B20 guibg=#7ddac5 ctermfg=234 ctermbg=116 cterm=NONE gui=bold
hi CmpSel guifg=#171B20 guibg=#7ddac5 ctermfg=234 ctermbg=116 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#494d52 ctermfg=239 cterm=NONE
...
hi MiniTablineModifiedCurrent guifg=#78DBA9 guibg=#171B20 ctermfg=115 ctermbg=234 cterm=NONE gui=underline
...
hi CocLoaderHeader guifg=#171B20 guibg=#86aaec ctermfg=234 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#171B20 guibg=#7ddac5 ctermfg=234 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#171B20 guibg=#7ddac5 ctermfg=234 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#41454a guifg=#171B20 ctermfg=234 ctermbg=238 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#86aaec guifg=#171B20 ctermfg=234 ctermbg=111 cterm=NONE
hi CocLoaderMutedBlock guibg=#41454a guifg=#171B20 ctermfg=234 ctermbg=238 cterm=NONE
...
hi NeogitBranchHead guifg=#86aaec ctermfg=111 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#86aaec ctermfg=111 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#78DBA9 guibg=#5abd8b ctermfg=115 ctermbg=72 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#e26c7c ctermfg=168 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#c68aee ctermfg=177 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#e9a180 ctermfg=180 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#98d3ee ctermfg=117 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#ecd3a0 ctermfg=223 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#78DBA9 ctermfg=115 cterm=NONE gui=italic,bold
...
hi NeotestPassed guifg=#78DBA9 ctermfg=115 cterm=NONE
hi NeotestRunning guifg=#ecd3a0 ctermfg=223 cterm=NONE
hi NeotestFailed guifg=#e26c7c ctermfg=168 cterm=NONE
hi NeotestSkipped guifg=#86aaec ctermfg=111 cterm=NONE
hi NeotestTest guifg=#494d52 ctermfg=239 cterm=NONE
hi NeotestNamespace guifg=#87eab8 ctermfg=115 cterm=NONE
hi NeotestFocused guifg=#ecd3a0 ctermfg=223 cterm=NONE
hi NeotestFile guifg=#98d3ee ctermfg=117 cterm=NONE
hi NeotestDir guifg=#86aaec ctermfg=111 cterm=NONE
hi NeotestBorder guifg=#86aaec ctermfg=111 cterm=NONE
hi NeotestIndent guifg=#505459 ctermfg=240 cterm=NONE
hi NeotestExpandMarker guifg=#505459 ctermfg=240 cterm=NONE
hi NeotestAdapterName guifg=#c68aee ctermfg=177 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#86aaec ctermfg=111 cterm=NONE
hi NeotestMarked guifg=#86aaec ctermfg=111 cterm=NONE
hi NeotestTarget guifg=#86aaec ctermfg=111 cterm=NONE
...
hi FoldColumn guifg=#9cd1ff guibg=NONE ctermfg=153 cterm=NONE
...
hi LazyH2 guifg=#e26c7c ctermfg=168 cterm=NONE gui=underline,bold
...
hi CocSelectedLine guibg=#1e2227 ctermbg=235 cterm=NONE
...
hi CocWarningLine guibg=#363633 ctermbg=236 cterm=NONE
hi DapUIStoppedThread guifg=#98d3ee ctermfg=117 cterm=NONE
hi MiniTablineCurrent guifg=#dee1e6 guibg=#171B20 ctermfg=254 ctermbg=234 cterm=NONE gui=underline
...
hi CocSelectedText guifg=#e26c7c ctermfg=168 cterm=NONE
...
hi CocDiagnosticsFile guifg=#5a5e63 ctermfg=59 cterm=NONE
...
hi CocServicesName guifg=#86aaec ctermfg=111 cterm=NONE
hi CocServicesStat guifg=#78DBA9 ctermfg=115 cterm=NONE
hi CocServicesLanguages guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocSourcesPrefix guifg=#c68aee ctermfg=177 cterm=NONE
hi CocSourcesName guifg=#86aaec ctermfg=111 cterm=NONE
hi CocSourcesPriority guifg=#e9a180 ctermfg=180 cterm=NONE
hi CocSourcesFileTypes guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocSourcesType guifg=#78DBA9 ctermfg=115 cterm=NONE
hi CocListsDesc guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocExtensionsActivated guifg=#78DBA9 ctermfg=115 cterm=NONE
hi CocExtensionsLoaded guifg=#dee1e6 ctermfg=254 cterm=NONE
hi CocExtensionsDisabled guifg=#494d52 ctermfg=239 cterm=NONE
hi CocExtensionsName guifg=#78DBA9 ctermfg=115 cterm=NONE
hi CocExtensionsLocal guifg=#86aaec ctermfg=111 cterm=NONE
hi CocExtensionsRoot guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocOutlineName guifg=#dee1e6 ctermfg=254 cterm=NONE
hi CocOutlineIndentLine guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocOutlineKind guifg=#c68aee ctermfg=177 cterm=NONE
hi CocOutlineLine guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocNotificationTime guifg=#5a5e63 ctermfg=59 cterm=NONE
hi CocCommandsTitle guifg=#5a5e63 ctermfg=59 cterm=NONE
...
hi DevIconJson guifg=#f1d8a5 ctermfg=223 cterm=NONE
...
hi CocErrorLine guibg=#35272d ctermbg=236 cterm=NONE
...
hi CocWarningFloat guifg=#ecd3a0 guibg=#111519 ctermfg=223 ctermbg=233 cterm=NONE
hi GitSignsDelete guifg=#e26c7c ctermfg=168 cterm=NONE
hi LeapMatch guifg=#ecd3a0 ctermfg=223 cterm=NONE gui=bold
hi CocInfoFloat guifg=#86aaec guibg=#111519 ctermfg=111 ctermbg=233 cterm=NONE
hi CocHintFloat guifg=#7ddac5 guibg=#111519 ctermfg=116 ctermbg=233 cterm=NONE
...
hi SnacksPickerDir guifg=#5a5e63 ctermfg=59 cterm=NONE
hi SnacksPickerDelim guifg=#494d52 ctermfg=239 cterm=NONE
hi SnacksPickerRow guifg=#494d52 ctermfg=239 cterm=NONE
hi SnacksPickerPathIgnored guifg=#41454a ctermfg=238 cterm=NONE
hi SnacksPickerPathHidden guifg=#41454a ctermfg=238 cterm=NONE
...
hi Tabline guibg=#1e2227 ctermbg=235 cterm=NONE
hi TbFill guibg=#1e2227 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#dee1e6 guibg=#171B20 ctermfg=254 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#5a5e63 guibg=#1e2227 ctermfg=59 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#78DBA9 guibg=#171B20 ctermfg=115 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#e26c7c guibg=#1e2227 ctermfg=168 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#e26c7c guibg=#171B20 ctermfg=168 ctermbg=234 cterm=NONE
hi TbBufOffClose guifg=#5a5e63 guibg=#1e2227 ctermfg=59 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#dee1e6 guibg=#2f3338 ctermfg=254 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#e26c7c guibg=#171B20 ctermfg=168 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#dee1e6 guibg=#1e2227 ctermfg=254 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#171B20 guibg=#96b5ee ctermfg=234 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#171B20 guibg=#86aaec ctermfg=234 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#dee1e6 guibg=#373b40 ctermfg=254 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#171B20 guibg=#e26c7c ctermfg=234 ctermbg=168 cterm=NONE gui=bold
hi CocFloating guifg=#b6beca guibg=#111519 ctermfg=250 ctermbg=233 cterm=NONE
hi CocInfoLine guibg=#27303e ctermbg=236 cterm=NONE
hi CocHintLine guibg=#263738 ctermbg=236 cterm=NONE
hi CocErrorFloat guifg=#e26c7c guibg=#111519 ctermfg=168 ctermbg=233 cterm=NONE
...
hi CocInlayHint guifg=#5a5e63 guibg=#1e2227 ctermfg=59 ctermbg=235 cterm=NONE
hi def link CocInlayHintParameter CocInlayHint
hi def link CocInlayHintType CocInlayHint
hi CocHighlightText guibg=#373b40 ctermbg=237 cterm=NONE
hi def link CocHighlightRead CocHighlightText
hi TelescopePromptPrefix guibg=#1e2227 guifg=#e26c7c ctermfg=168 ctermbg=235 cterm=NONE
