...
hi NeogitChangeAdded guifg=#78DBA9 guibg=#5abd8b ctermfg=115 ctermbg=72 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#f1cf8a ctermfg=222 cterm=NONE
...
hi Identifier guisp=NONE guifg=#70A5EB ctermfg=74 cterm=NONE
hi Float guifg=#e9a180 ctermfg=180 cterm=NONE
hi Delimiter guifg=#9cd1ff ctermfg=153 cterm=NONE
hi Define guisp=NONE guifg=#c68aee ctermfg=177 cterm=NONE
...
hi CocHintHighlight guisp=#7ddac5 guifg=#7ddac5 ctermfg=116 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#86aaec guifg=#86aaec ctermfg=111 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#ecd3a0 guifg=#ecd3a0 ctermfg=223 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#e26c7c guifg=#e26c7c ctermfg=168 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#b6beca ctermfg=250 cterm=NONE
