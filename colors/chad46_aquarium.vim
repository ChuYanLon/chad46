...
hi NeogitBranchHead guifg=#CDDBF9 ctermfg=189 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#CDDBF9 ctermfg=189 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#b1dba4 guibg=#93bd86 ctermfg=151 ctermbg=108 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#ebb9b9 ctermfg=181 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#f6bbe7 ctermfg=218 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#E8CCA7 ctermfg=187 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#b8dceb ctermfg=152 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#E6DFB8 ctermfg=187 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#b1dba4 ctermfg=151 cterm=NONE gui=italic,bold
...
hi Type guisp=NONE guifg=#e6dfb8 ctermfg=187 cterm=NONE
...
hi Identifier guisp=NONE guifg=#ebb9b9 ctermfg=181 cterm=NONE
hi Float guifg=#e8cca7 ctermfg=187 cterm=NONE
hi Delimiter guifg=#eAc1c1 ctermfg=181 cterm=NONE
hi Define guisp=NONE guifg=#f6bbe7 ctermfg=218 cterm=NONE
...
hi CocHintHighlight guisp=#AEDCB7 guifg=#AEDCB7 ctermfg=151 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#CDDBF9 guifg=#CDDBF9 ctermfg=189 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#E6DFB8 guifg=#E6DFB8 ctermfg=187 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#ebb9b9 guifg=#ebb9b9 ctermfg=181 cterm=NONE gui=undercurl
...
hi LazyH2 guifg=#ebb9b9 ctermfg=181 cterm=NONE gui=underline,bold
...
hi Operator guisp=NONE guifg=#bac0cb ctermfg=251 cterm=NONE
