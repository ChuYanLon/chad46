...
hi TbThemeToggleBtn guibg=#044A67 guifg=#9eabac ctermfg=248 ctermbg=23 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#db302d guifg=#011219 ctermfg=233 ctermbg=166 cterm=NONE gui=bold
