...
hi NeogitChangeAdded guifg=#849900 guibg=#667b00 ctermfg=100 ctermbg=64 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#b28500 ctermfg=136 cterm=NONE
...
hi Identifier guisp=NONE guifg=#268bd2 ctermfg=32 cterm=NONE
hi Float guifg=#519ABA ctermfg=67 cterm=NONE
hi Delimiter guifg=#c94c16 ctermfg=166 cterm=NONE
hi Define guisp=NONE guifg=#849900 ctermfg=100 cterm=NONE
...
hi CocInfoHighlight guisp=#268bd3 guifg=#268bd3 ctermfg=32 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#b28500 guifg=#b28500 ctermfg=136 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#db302d guifg=#db302d ctermfg=166 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#9eabac ctermfg=248 cterm=NONE
