...
hi BlinkCmpMenuSelection guifg=#011219 guibg=#29a298 ctermfg=233 ctermbg=36 cterm=NONE gui=bold
hi CmpSel guifg=#011219 guibg=#29a298 ctermfg=233 ctermbg=36 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#9eabac guibg=#011219 ctermfg=248 ctermbg=233 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#849900 guibg=#011219 ctermfg=100 ctermbg=233 cterm=NONE gui=underline
...
hi NeotestPassed guifg=#849900 ctermfg=100 cterm=NONE
hi NeotestRunning guifg=#b28500 ctermfg=136 cterm=NONE
hi NeotestFailed guifg=#db302d ctermfg=166 cterm=NONE
hi NeotestSkipped guifg=#268bd3 ctermfg=32 cterm=NONE
hi NeotestTest guifg=#47585E ctermfg=240 cterm=NONE
hi NeotestNamespace guifg=#bad600 ctermfg=148 cterm=NONE
hi NeotestFocused guifg=#b28500 ctermfg=136 cterm=NONE
hi NeotestFile guifg=#2aa198 ctermfg=36 cterm=NONE
hi NeotestDir guifg=#268bd3 ctermfg=32 cterm=NONE
hi NeotestBorder guifg=#268bd3 ctermfg=32 cterm=NONE
hi NeotestIndent guifg=#4F6369 ctermfg=59 cterm=NONE
hi NeotestExpandMarker guifg=#4F6369 ctermfg=59 cterm=NONE
...
hi CocLoaderHeader guifg=#011219 guibg=#268bd3 ctermfg=233 ctermbg=32 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#011219 guibg=#519ABA ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#011219 guibg=#519ABA ctermfg=233 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#405055 guifg=#011219 ctermfg=233 ctermbg=239 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#268bd3 guifg=#011219 ctermfg=233 ctermbg=32 cterm=NONE
hi CocLoaderMutedBlock guibg=#405055 guifg=#011219 ctermfg=233 ctermbg=239 cterm=NONE
hi NeogitBranchHead guifg=#268bd3 ctermfg=32 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#268bd3 ctermfg=32 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#849900 guibg=#667b00 ctermfg=100 ctermbg=64 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#db302d ctermfg=166 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#29a298 ctermfg=36 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#C84C16 ctermfg=166 cterm=NONE gui=italic,bold
...
hi SnacksPickerDir guifg=#586E75 ctermfg=242 cterm=NONE
hi SnacksPickerDelim guifg=#47585E ctermfg=240 cterm=NONE
...
hi TbTabNewBtn guifg=#9eabac guibg=#03394F ctermfg=248 ctermbg=23 cterm=NONE
hi TbTabOn guifg=#db302d guibg=#011219 ctermfg=166 ctermbg=233 cterm=NONE
hi TbTabOff guifg=#9eabac guibg=#02202D ctermfg=248 ctermbg=234 cterm=NONE
hi TbTabCloseBtn guifg=#011219 guibg=#1a6397 ctermfg=233 ctermbg=24 cterm=NONE
hi TBTabTitle guifg=#011219 guibg=#268bd3 ctermfg=233 ctermbg=32 cterm=NONE
hi TbThemeToggleBtn guifg=#9eabac guibg=#044A67 ctermfg=248 ctermbg=23 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#011219 guibg=#db302d ctermfg=233 ctermbg=166 cterm=NONE gui=bold
...
hi FoldColumn guifg=#c94c16 guibg=NONE ctermfg=166 cterm=NONE
hi Folded guifg=#586E75 guibg=#02202D ctermfg=242 ctermbg=234 cterm=NONE
hi IncSearch guifg=#c94c16 guibg=NONE ctermfg=166 cterm=NONE
...
hi LazyH2 guifg=#db302d ctermfg=166 cterm=NONE gui=underline,bold
...
hi CocSelectedLine guibg=#02202D ctermbg=234 cterm=NONE
...
hi TelescopePromptPrefix guibg=#02202D guifg=#db302d ctermfg=166 ctermbg=234 cterm=NONE
...
hi DevIconJson guifg=#e6ac00 ctermfg=178 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#47585E ctermfg=240 cterm=NONE
...
hi CocDiagnosticsFile guifg=#586E75 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#29a298 ctermfg=36 cterm=NONE
hi CocServicesName guifg=#268bd3 ctermfg=32 cterm=NONE
hi CocServicesStat guifg=#849900 ctermfg=100 cterm=NONE
hi CocServicesLanguages guifg=#586E75 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#29a298 ctermfg=36 cterm=NONE
hi CocSourcesName guifg=#268bd3 ctermfg=32 cterm=NONE
hi CocSourcesPriority guifg=#519ABA ctermfg=67 cterm=NONE
hi CocSourcesFileTypes guifg=#586E75 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#849900 ctermfg=100 cterm=NONE
hi CocListsDesc guifg=#586E75 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#849900 ctermfg=100 cterm=NONE
hi CocExtensionsLoaded guifg=#9eabac ctermfg=248 cterm=NONE
hi CocExtensionsDisabled guifg=#47585E ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#849900 ctermfg=100 cterm=NONE
hi CocExtensionsLocal guifg=#268bd3 ctermfg=32 cterm=NONE
hi CocExtensionsRoot guifg=#586E75 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#9eabac ctermfg=248 cterm=NONE
hi CocOutlineIndentLine guifg=#586E75 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#29a298 ctermfg=36 cterm=NONE
hi CocOutlineLine guifg=#586E75 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#586E75 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#586E75 ctermfg=242 cterm=NONE
...
hi CocFloating guifg=#9eabac guibg=#011923 ctermfg=248 ctermbg=233 cterm=NONE
...
hi CocInlayHint guifg=#586E75 guibg=#02202D ctermfg=242 ctermbg=234 cterm=NONE
hi DiagnosticError guifg=#db302d ctermfg=166 cterm=NONE
hi CocHintFloat guifg=#519ABA guibg=#011923 ctermfg=67 ctermbg=233 cterm=NONE
hi CocInfoFloat guifg=#268bd3 guibg=#011923 ctermfg=32 ctermbg=233 cterm=NONE
hi CocWarningFloat guifg=#b28500 guibg=#011923 ctermfg=136 ctermbg=233 cterm=NONE
hi CocErrorFloat guifg=#db302d guibg=#011923 ctermfg=166 ctermbg=233 cterm=NONE
hi CocHintLine guibg=#0d2631 ctermbg=235 cterm=NONE
hi CocInfoLine guibg=#062434 ctermbg=234 cterm=NONE
hi CocWarningLine guibg=#1b2315 ctermbg=234 cterm=NONE
hi CocErrorLine guibg=#21161c ctermbg=234 cterm=NONE
...
hi NeotestTarget guifg=#268bd3 ctermfg=32 cterm=NONE
hi NeotestMarked guifg=#268bd3 ctermfg=32 cterm=NONE
hi NeotestWinSelect guifg=#268bd3 ctermfg=32 cterm=NONE
hi NeotestAdapterName guifg=#29a298 ctermfg=36 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#db302d ctermfg=166 cterm=NONE
...
hi TbBufOffClose guifg=#586E75 guibg=#02202D ctermfg=242 ctermbg=234 cterm=NONE
hi TbBufOnClose guifg=#db302d guibg=#011219 ctermfg=166 ctermbg=233 cterm=NONE
hi TbBufOffModified guifg=#db302d guibg=#02202D ctermfg=166 ctermbg=234 cterm=NONE
hi TbBufOnModified guifg=#849900 guibg=#011219 ctermfg=100 ctermbg=233 cterm=NONE
hi TbBufOff guifg=#586E75 guibg=#02202D ctermfg=242 ctermbg=234 cterm=NONE
hi TbBufOn guifg=#9eabac guibg=#011219 ctermfg=248 ctermbg=233 cterm=NONE
hi TbFill guibg=#02202D ctermbg=234 cterm=NONE
hi Tabline guibg=#02202D ctermbg=234 cterm=NONE
hi SnacksZenIcon guifg=#268bd3 ctermfg=32 cterm=NONE
hi SnacksPickerPathHidden guifg=#405055 ctermfg=239 cterm=NONE
hi SnacksPickerPathIgnored guifg=#405055 ctermfg=239 cterm=NONE
hi SnacksPickerRow guifg=#47585E ctermfg=240 cterm=NONE
...
hi NeogitChangeNewFile guifg=#849900 ctermfg=100 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#b28500 ctermfg=136 cterm=NONE gui=italic,bold
