...
hi NeogitChangeModified guifg=#409cff ctermfg=75 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#92D923 guibg=#74bb05 ctermfg=112 ctermbg=106 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#ee7762 ctermfg=209 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#9380ff ctermfg=105 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#f59762 ctermfg=209 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#7fdbca ctermfg=116 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#ffb900 ctermfg=214 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#92D923 ctermfg=112 cterm=NONE gui=italic,bold
...
hi SnacksPickerMatch guifg=#409cff guibg=#2a2625 ctermfg=75 ctermbg=235 cterm=NONE
hi SnacksPickerFooter guifg=#4a4241 ctermfg=238 cterm=NONE
hi SnacksPickerListTitle guibg=#ee7762 guifg=#4a4241 ctermfg=238 ctermbg=209 cterm=NONE
hi SnacksPickerPreviewTitle guibg=#409cff guifg=#4a4241 ctermfg=238 ctermbg=75 cterm=NONE
hi SnacksPickerTitle guibg=#92D923 guifg=#4a4241 ctermfg=238 ctermbg=112 cterm=NONE
