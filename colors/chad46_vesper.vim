...
hi BlinkCmpMenuSelection guifg=#101010 guibg=#FFC799 ctermfg=233 ctermbg=222 cterm=NONE gui=bold
hi CmpSel guifg=#101010 guibg=#FFC799 ctermfg=233 ctermbg=222 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#FFFFFF guibg=#101010 ctermfg=231 ctermbg=233 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#99FFE4 guibg=#101010 ctermfg=122 ctermbg=233 cterm=NONE gui=underline
...
hi NeotestPassed guifg=#99FFE4 ctermfg=122 cterm=NONE
hi NeotestRunning guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestFailed guifg=#FF8080 ctermfg=210 cterm=NONE
hi NeotestSkipped guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestTest guifg=#595959 ctermfg=240 cterm=NONE
hi NeotestNamespace guifg=#99FFE4 ctermfg=122 cterm=NONE
hi NeotestFocused guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestFile guifg=#99FFE4 ctermfg=122 cterm=NONE
hi NeotestDir guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestBorder guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestIndent guifg=#6e6e6e ctermfg=242 cterm=NONE
hi NeotestExpandMarker guifg=#6e6e6e ctermfg=242 cterm=NONE
...
hi TodoBgFix guifg=#1C1C1C guibg=#FF8080 ctermfg=234 ctermbg=210 cterm=NONE gui=bold
hi TodoBgHack guifg=#1C1C1C guibg=#FFC799 ctermfg=234 ctermbg=222 cterm=NONE gui=bold
hi TodoBgNote guifg=#1C1C1C guibg=#FFFFFF ctermfg=234 ctermbg=231 cterm=NONE gui=bold
hi TodoBgPerf guifg=#1C1C1C guibg=#FBADFF ctermfg=234 ctermbg=219 cterm=NONE gui=bold
hi TodoBgTest guifg=#1C1C1C guibg=#FBADFF ctermfg=234 ctermbg=219 cterm=NONE gui=bold
hi TodoBgTodo guifg=#1C1C1C guibg=#FFC799 ctermfg=234 ctermbg=222 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guifg=#1C1C1C guibg=#505050 ctermfg=234 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#101010 guibg=#99FFE4 ctermfg=233 ctermbg=122 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#101010 guibg=#99FFE4 ctermfg=233 ctermbg=122 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#101010 guibg=#505050 ctermfg=233 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#101010 guibg=#FBADFF ctermfg=233 ctermbg=219 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#101010 guibg=#FBADFF ctermfg=233 ctermbg=219 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#101010 guibg=#FFC799 ctermfg=233 ctermbg=222 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#101010 guibg=#99FFE4 ctermfg=233 ctermbg=122 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#101010 guibg=#99FFE4 ctermfg=233 ctermbg=122 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#FFC799 ctermfg=222 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#99FFE4 guibg=#7be1c6 ctermfg=122 ctermbg=116 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#FF8080 ctermfg=210 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#FBADFF ctermfg=219 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#FFC799 ctermfg=222 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#99FFE4 ctermfg=122 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#99FFE4 guibg=#1C1C1C ctermfg=122 ctermbg=234 cterm=NONE gui=bold
...
hi TbTabNewBtn guifg=#FFFFFF guibg=#282828 ctermfg=231 ctermbg=235 cterm=NONE
hi TbTabOn guifg=#FF8080 guibg=#101010 ctermfg=210 ctermbg=233 cterm=NONE
hi TbTabOff guifg=#FFFFFF guibg=#1C1C1C ctermfg=231 ctermbg=234 cterm=NONE
hi TbTabCloseBtn guifg=#101010 guibg=#FFC799 ctermfg=233 ctermbg=222 cterm=NONE
hi TBTabTitle guifg=#101010 guibg=#FFC799 ctermfg=233 ctermbg=222 cterm=NONE
hi TbThemeToggleBtn guifg=#FFFFFF guibg=#343434 ctermfg=231 ctermbg=236 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#101010 guibg=#FF8080 ctermfg=233 ctermbg=210 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#595959 ctermfg=240 cterm=NONE
...
hi NeotestTarget guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestMarked guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestWinSelect guifg=#FFC799 ctermfg=222 cterm=NONE
hi NeotestAdapterName guifg=#FBADFF ctermfg=219 cterm=NONE gui=bold
...
hi TbBufOffClose guifg=#7E7E7E guibg=#1C1C1C ctermfg=244 ctermbg=234 cterm=NONE
hi TbBufOnClose guifg=#FF8080 guibg=#101010 ctermfg=210 ctermbg=233 cterm=NONE
hi TbBufOffModified guifg=#FF8080 guibg=#1C1C1C ctermfg=210 ctermbg=234 cterm=NONE
hi TbBufOnModified guifg=#99FFE4 guibg=#101010 ctermfg=122 ctermbg=233 cterm=NONE
hi TbBufOff guifg=#7E7E7E guibg=#1C1C1C ctermfg=244 ctermbg=234 cterm=NONE
hi TbBufOn guifg=#FFFFFF guibg=#101010 ctermfg=231 ctermbg=233 cterm=NONE
...
hi NeogitChangeNewFile guifg=#99FFE4 ctermfg=122 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#FFC799 ctermfg=222 cterm=NONE gui=italic,bold
hi NeogitBranch guifg=#FFC799 ctermfg=222 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#FFC799 guibg=#282828 ctermfg=222 ctermbg=235 cterm=NONE gui=bold
hi NeogitDiffHeader guifg=#FFC799 guibg=#282828 ctermfg=222 ctermbg=235 cterm=NONE gui=bold
