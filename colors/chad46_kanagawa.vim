...
hi TbThemeToggleBtn guibg=#363646 guifg=#DCD7BA ctermfg=187 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#d8616b guifg=#1F1F28 ctermfg=235 ctermbg=167 cterm=NONE gui=bold
