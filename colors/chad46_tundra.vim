...
hi MiniTablineCurrent guifg=#FFFFFF guibg=#111827 ctermfg=231 ctermbg=234 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#B5E8B0 guibg=#111827 ctermfg=151 ctermbg=234 cterm=NONE gui=underline
...
hi NeotestPassed guifg=#B5E8B0 ctermfg=151 cterm=NONE
hi NeotestRunning guifg=#E8D4B0 ctermfg=187 cterm=NONE
hi NeotestFailed guifg=#FCA5A5 ctermfg=217 cterm=NONE
hi NeotestSkipped guifg=#A5B4FC ctermfg=147 cterm=NONE
hi NeotestTest guifg=#4a5160 ctermfg=240 cterm=NONE
hi NeotestNamespace guifg=#B5E8B0 ctermfg=151 cterm=NONE
hi NeotestFocused guifg=#E8D4B0 ctermfg=187 cterm=NONE
hi NeotestFile guifg=#BAE6FD ctermfg=153 cterm=NONE
hi NeotestDir guifg=#A5B4FC ctermfg=147 cterm=NONE
hi NeotestBorder guifg=#A5B4FC ctermfg=147 cterm=NONE
hi NeotestIndent guifg=#545b6a ctermfg=59 cterm=NONE
hi NeotestExpandMarker guifg=#545b6a ctermfg=59 cterm=NONE
...
hi CocLoaderHeader guifg=#111827 guibg=#A5B4FC ctermfg=234 ctermbg=147 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#111827 guibg=#719bd3 ctermfg=234 ctermbg=68 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#111827 guibg=#719bd3 ctermfg=234 ctermbg=68 cterm=NONE gui=bold
...
hi NeogitBranchHead guifg=#A5B4FC ctermfg=147 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#A5B4FC ctermfg=147 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#B5E8B0 guibg=#97ca92 ctermfg=151 ctermbg=114 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#FCA5A5 ctermfg=217 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#BDB0E4 ctermfg=146 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#FBC19D ctermfg=217 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#BAE6FD ctermfg=153 cterm=NONE gui=italic,bold
...
hi TbTabNewBtn guifg=#FFFFFF guibg=#282f3e ctermfg=231 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#FCA5A5 guibg=#111827 ctermfg=217 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#FFFFFF guibg=#1a2130 ctermfg=231 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#111827 guibg=#9baaf2 ctermfg=234 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#111827 guibg=#A5B4FC ctermfg=234 ctermbg=147 cterm=NONE
hi TbThemeToggleBtn guifg=#FFFFFF guibg=#323948 ctermfg=231 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#111827 guibg=#FCA5A5 ctermfg=234 ctermbg=217 cterm=NONE gui=bold
...
hi FoldColumn guifg=#9CA3AF guibg=NONE ctermfg=248 cterm=NONE
...
hi CocSelectedLine guibg=#1a2130 ctermbg=235 cterm=NONE
...
hi TelescopePromptPrefix guibg=#1a2130 guifg=#FCA5A5 ctermfg=217 ctermbg=235 cterm=NONE
...
hi Operator guisp=NONE guifg=#FECDD3 ctermfg=224 cterm=NONE
hi Structure guifg=#FCA5A5 ctermfg=217 cterm=NONE
hi Tag guifg=#FBC19D ctermfg=217 cterm=NONE
hi Type guisp=NONE guifg=#FECDD3 ctermfg=224 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#4a5160 ctermfg=240 cterm=NONE
...
hi CocDiagnosticsFile guifg=#5f6675 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#BDB0E4 ctermfg=146 cterm=NONE
hi CocServicesName guifg=#A5B4FC ctermfg=147 cterm=NONE
hi CocServicesStat guifg=#B5E8B0 ctermfg=151 cterm=NONE
hi CocServicesLanguages guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#BDB0E4 ctermfg=146 cterm=NONE
hi CocSourcesName guifg=#A5B4FC ctermfg=147 cterm=NONE
hi CocSourcesPriority guifg=#E8D4B0 ctermfg=187 cterm=NONE
hi CocSourcesFileTypes guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#B5E8B0 ctermfg=151 cterm=NONE
hi CocListsDesc guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#B5E8B0 ctermfg=151 cterm=NONE
hi CocExtensionsLoaded guifg=#FFFFFF ctermfg=231 cterm=NONE
hi CocExtensionsDisabled guifg=#4a5160 ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#B5E8B0 ctermfg=151 cterm=NONE
hi CocExtensionsLocal guifg=#A5B4FC ctermfg=147 cterm=NONE
hi CocExtensionsRoot guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#FFFFFF ctermfg=231 cterm=NONE
hi CocOutlineIndentLine guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#BDB0E4 ctermfg=146 cterm=NONE
hi CocOutlineLine guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#5f6675 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#5f6675 ctermfg=242 cterm=NONE
...
hi CocFloating guifg=#F3F4F6 guibg=#0b1221 ctermfg=255 ctermbg=233 cterm=NONE
...
hi CocHintLine guibg=#1f2b40 ctermbg=236 cterm=NONE
hi CocInfoLine guibg=#272f46 ctermbg=236 cterm=NONE
hi CocWarningLine guibg=#31343b ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#342d39 ctermbg=236 cterm=NONE
...
hi NeotestTarget guifg=#A5B4FC ctermfg=147 cterm=NONE
hi NeotestMarked guifg=#A5B4FC ctermfg=147 cterm=NONE
hi NeotestWinSelect guifg=#A5B4FC ctermfg=147 cterm=NONE
hi NeotestAdapterName guifg=#BDB0E4 ctermfg=146 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#FCA5A5 ctermfg=217 cterm=NONE
...
hi TbBufOffClose guifg=#5f6675 guibg=#1a2130 ctermfg=242 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#FCA5A5 guibg=#111827 ctermfg=217 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#FCA5A5 guibg=#1a2130 ctermfg=217 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#B5E8B0 guibg=#111827 ctermfg=151 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#5f6675 guibg=#1a2130 ctermfg=242 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#FFFFFF guibg=#111827 ctermfg=231 ctermbg=234 cterm=NONE
hi TbFill guibg=#1a2130 ctermbg=235 cterm=NONE
hi Tabline guibg=#1a2130 ctermbg=235 cterm=NONE
...
hi NeogitChangeNewFile guifg=#B5E8B0 ctermfg=151 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#E8D4B0 ctermfg=187 cterm=NONE gui=italic,bold
