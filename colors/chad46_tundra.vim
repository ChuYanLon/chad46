...
hi NeogitChangeAdded guifg=#B5E8B0 guibg=#97ca92 ctermfg=151 ctermbg=114 cterm=NONE gui=bold,italic
...
hi Identifier guisp=NONE guifg=#DDD6FE ctermfg=189 cterm=NONE
hi Float guifg=#E8D4B0 ctermfg=187 cterm=NONE
hi Delimiter guifg=#9CA3AF ctermfg=248 cterm=NONE
hi Define guisp=NONE guifg=#FCA5A5 ctermfg=217 cterm=NONE
...
hi CocHintHighlight guisp=#719bd3 guifg=#719bd3 ctermfg=68 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#A5B4FC guifg=#A5B4FC ctermfg=147 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#E8D4B0 guifg=#E8D4B0 ctermfg=187 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#FCA5A5 guifg=#FCA5A5 ctermfg=217 cterm=NONE gui=undercurl
