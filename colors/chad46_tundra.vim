...
hi TbThemeToggleBtn guibg=#323948 guifg=#FFFFFF ctermfg=231 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#FCA5A5 guifg=#111827 ctermfg=234 ctermbg=217 cterm=NONE gui=bold
