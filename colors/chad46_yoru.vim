...
hi TbThemeToggleBtn guibg=#27292a guifg=#edeff0 ctermfg=255 ctermbg=235 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#DF5B61 guifg=#0c0e0f ctermfg=233 ctermbg=167 cterm=NONE gui=bold
