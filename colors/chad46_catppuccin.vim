...
hi BlinkCmpMenuSelection guifg=#1E1D2D guibg=#ABE9B3 ctermfg=235 ctermbg=151 cterm=NONE gui=bold
hi CmpSel guifg=#1E1D2D guibg=#ABE9B3 ctermfg=235 ctermbg=151 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#4e4d5d ctermfg=239 cterm=NONE
...
hi CocLoaderHeader guifg=#1E1D2D guibg=#89B4FA ctermfg=235 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1E1D2D guibg=#B5E8E0 ctermfg=235 ctermbg=152 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1E1D2D guibg=#B5E8E0 ctermfg=235 ctermbg=152 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#474656 guifg=#1E1D2D ctermfg=235 ctermbg=239 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#89B4FA guifg=#1E1D2D ctermfg=235 ctermbg=111 cterm=NONE
hi CocLoaderMutedBlock guibg=#474656 guifg=#1E1D2D ctermfg=235 ctermbg=239 cterm=NONE
...
hi NeotestFailed guifg=#F38BA8 ctermfg=211 cterm=NONE
hi NeotestSkipped guifg=#89B4FA ctermfg=111 cterm=NONE
hi NeotestTest guifg=#4e4d5d ctermfg=239 cterm=NONE
hi NeotestNamespace guifg=#b6f4be ctermfg=157 cterm=NONE
hi NeotestFocused guifg=#FAE3B0 ctermfg=223 cterm=NONE
hi NeotestFile guifg=#89DCEB ctermfg=116 cterm=NONE
hi NeotestDir guifg=#89B4FA ctermfg=111 cterm=NONE
hi NeotestBorder guifg=#89B4FA ctermfg=111 cterm=NONE
hi NeotestIndent guifg=#555464 ctermfg=240 cterm=NONE
hi NeotestExpandMarker guifg=#555464 ctermfg=240 cterm=NONE
hi NeotestAdapterName guifg=#d0a9e5 ctermfg=182 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#89B4FA ctermfg=111 cterm=NONE
hi NeotestMarked guifg=#89B4FA ctermfg=111 cterm=NONE
hi NeotestTarget guifg=#89B4FA ctermfg=111 cterm=NONE
...
hi Tabline guibg=#252434 ctermbg=235 cterm=NONE
hi TbFill guibg=#252434 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#D9E0EE guibg=#1E1D2D ctermfg=254 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#605f6f guibg=#252434 ctermfg=241 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#ABE9B3 guibg=#1E1D2D ctermfg=151 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#F38BA8 guibg=#252434 ctermfg=211 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#F38BA8 guibg=#1E1D2D ctermfg=211 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#605f6f guibg=#252434 ctermfg=241 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#D9E0EE guibg=#363545 ctermfg=254 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#F38BA8 guibg=#1E1D2D ctermfg=211 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#D9E0EE guibg=#252434 ctermfg=254 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#1E1D2D guibg=#8bc2f0 ctermfg=235 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#1E1D2D guibg=#89B4FA ctermfg=235 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#D9E0EE guibg=#3e3d4d ctermfg=254 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1E1D2D guibg=#F38BA8 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
...
hi TodoBgFix guifg=#252434 guibg=#F38BA8 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
hi TodoBgHack guifg=#252434 guibg=#F8BD96 ctermfg=235 ctermbg=216 cterm=NONE gui=bold
hi TodoBgNote guifg=#252434 guibg=#D9E0EE ctermfg=235 ctermbg=254 cterm=NONE gui=bold
hi TodoBgPerf guifg=#252434 guibg=#d0a9e5 ctermfg=235 ctermbg=182 cterm=NONE gui=bold
hi TodoBgTest guifg=#252434 guibg=#d0a9e5 ctermfg=235 ctermbg=182 cterm=NONE gui=bold
hi TodoBgTodo guifg=#252434 guibg=#FAE3B0 ctermfg=235 ctermbg=223 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#D9E0EE guibg=#1E1D2D ctermfg=254 ctermbg=235 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#ABE9B3 guibg=#1E1D2D ctermfg=151 ctermbg=235 cterm=NONE gui=underline
...
hi FoldColumn guifg=#F38BA8 guibg=NONE ctermfg=211 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#252434 guibg=#474656 ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#1E1D2D guibg=#89DCEB ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#1E1D2D guibg=#89DCEB ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi LazyReasonFt guifg=#d0a9e5 ctermfg=182 cterm=NONE
hi NeogitHunkHeaderHighlight guifg=#1E1D2D guibg=#c7a0dc ctermfg=235 ctermbg=182 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#1E1D2D guibg=#c7a0dc ctermfg=235 ctermbg=182 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#89B4FA guibg=#363545 ctermfg=111 ctermbg=237 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#F8BD96 guibg=#363545 ctermfg=216 ctermbg=237 cterm=NONE gui=bold
...
hi CocFloating guifg=#bfc6d4 guibg=#191828 ctermfg=251 ctermbg=234 cterm=NONE
...
hi CocSelectedText guifg=#F38BA8 ctermfg=211 cterm=NONE
...
hi CocSelectedLine guibg=#252434 ctermbg=235 cterm=NONE
...
hi NeogitChangeUpdated guifg=#F8BD96 ctermfg=216 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#89DCEB guibg=#252434 ctermfg=116 ctermbg=235 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#89B4FA ctermfg=111 cterm=NONE gui=italic,bold
...
hi NeogitChangeDeleted guifg=#F38BA8 ctermfg=211 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#d0a9e5 ctermfg=182 cterm=NONE gui=italic,bold
hi DevIconC guifg=#89B4FA ctermfg=111 cterm=NONE
hi NeogitChangeCopied guifg=#89DCEB ctermfg=116 cterm=NONE gui=italic,bold
...
hi CocDiagnosticsFile guifg=#605f6f ctermfg=241 cterm=NONE
...
hi CocServicesName guifg=#89B4FA ctermfg=111 cterm=NONE
hi CocServicesStat guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi CocServicesLanguages guifg=#605f6f ctermfg=241 cterm=NONE
hi CocSourcesPrefix guifg=#d0a9e5 ctermfg=182 cterm=NONE
hi CocSourcesName guifg=#89B4FA ctermfg=111 cterm=NONE
hi CocSourcesPriority guifg=#F8BD96 ctermfg=216 cterm=NONE
hi CocSourcesFileTypes guifg=#605f6f ctermfg=241 cterm=NONE
...
hi CocExtensionsLocal guifg=#89B4FA ctermfg=111 cterm=NONE
hi CocExtensionsRoot guifg=#605f6f ctermfg=241 cterm=NONE
hi CocOutlineName guifg=#D9E0EE ctermfg=254 cterm=NONE
hi CocOutlineIndentLine guifg=#605f6f ctermfg=241 cterm=NONE
hi CocOutlineKind guifg=#d0a9e5 ctermfg=182 cterm=NONE
hi CocOutlineLine guifg=#605f6f ctermfg=241 cterm=NONE
hi CocNotificationTime guifg=#605f6f ctermfg=241 cterm=NONE
hi CocCommandsTitle guifg=#605f6f ctermfg=241 cterm=NONE
...
hi NeogitChangeUnmerged guifg=#FAE3B0 ctermfg=223 cterm=NONE gui=italic,bold
...
hi CocInlayHint guifg=#605f6f guibg=#252434 ctermfg=241 ctermbg=235 cterm=NONE
...
hi CocHintLine guibg=#343b47 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#2e334b ctermbg=237 cterm=NONE
...
hi CocListsDesc guifg=#605f6f ctermfg=241 cterm=NONE
hi CocExtensionsActivated guifg=#ABE9B3 ctermfg=151 cterm=NONE
hi CocExtensionsLoaded guifg=#D9E0EE ctermfg=254 cterm=NONE
hi CocExtensionsDisabled guifg=#4e4d5d ctermfg=239 cterm=NONE
...
hi CocWarningLine guibg=#3f3a40 ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#3d2d3f ctermbg=237 cterm=NONE
...
hi CocInfoHighlight guifg=#89B4FA guisp=#89B4FA ctermfg=111 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#FAE3B0 guisp=#FAE3B0 ctermfg=223 cterm=NONE gui=undercurl
hi CocErrorHighlight guifg=#F38BA8 guisp=#F38BA8 ctermfg=211 cterm=NONE gui=undercurl
hi NeogitHunkHeader guifg=#1E1D2D guibg=#474656 ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi CmpItemKindSuperMaven guifg=#FAE3B0 ctermfg=223 cterm=NONE
hi CmpItemKindTabNine guifg=#ffa5c3 ctermfg=217 cterm=NONE
hi CocHintFloat guifg=#B5E8E0 guibg=#191828 ctermfg=152 ctermbg=234 cterm=NONE
hi DapUIFloatBorder guifg=#89DCEB ctermfg=116 cterm=NONE
hi CocInfoFloat guifg=#89B4FA guibg=#191828 ctermfg=111 ctermbg=234 cterm=NONE
...
hi CocWarningFloat guifg=#FAE3B0 guibg=#191828 ctermfg=223 ctermbg=234 cterm=NONE
...
hi CocErrorFloat guifg=#F38BA8 guibg=#191828 ctermfg=211 ctermbg=234 cterm=NONE
