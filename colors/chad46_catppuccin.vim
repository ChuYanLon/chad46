...
hi SnacksPickerMatch guifg=#89B4FA guibg=#2d2c3c ctermfg=111 ctermbg=236 cterm=NONE
hi Variable guifg=#bfc6d4 ctermfg=251 cterm=NONE
hi SnacksPickerListTitle guibg=#F38BA8 guifg=#4e4d5d ctermfg=239 ctermbg=211 cterm=NONE
hi SnacksPickerPreviewTitle guibg=#89B4FA guifg=#4e4d5d ctermfg=239 ctermbg=111 cterm=NONE
hi SnacksPickerTitle guibg=#ABE9B3 guifg=#4e4d5d ctermfg=239 ctermbg=151 cterm=NONE
