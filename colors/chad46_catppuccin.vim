...
hi TbThemeToggleBtn guibg=#3e3d4d guifg=#D9E0EE ctermfg=254 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#F38BA8 guifg=#1E1D2D ctermfg=235 ctermbg=211 cterm=NONE gui=bold
