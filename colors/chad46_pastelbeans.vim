...
hi TbThemeToggleBtn guibg=#3a3a3a guifg=#e8e8d3 ctermfg=254 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#ff9da4 guifg=#151515 ctermfg=233 ctermbg=217 cterm=NONE gui=bold
