...
hi BlinkCmpMenuSelection guifg=#2B2B2B guibg=#98be65 ctermfg=235 ctermbg=107 cterm=NONE gui=bold
hi CmpSel guifg=#2B2B2B guibg=#98be65 ctermfg=235 ctermbg=107 cterm=NONE gui=bold
...
hi CocSemTypeClass guifg=#6897BB ctermfg=67 cterm=NONE
hi CocSemTypeEnum guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSemTypeInterface guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocSemTypeStruct guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSemTypeTypeParameter guifg=#C9D0D3 ctermfg=252 cterm=NONE
hi CocSemTypeParameter guifg=#C9D0D3 ctermfg=252 cterm=NONE
hi CocSemTypeVariable guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSemTypeProperty guifg=#C9D0D3 ctermfg=252 cterm=NONE
hi CocSemTypeEnumMember guifg=#9876AA ctermfg=103 cterm=NONE
hi CocSemTypeEvent guifg=#ffc24b ctermfg=215 cterm=NONE
hi CocSemTypeFunction guifg=#AD9E7D ctermfg=144 cterm=NONE
hi CocSemTypeMethod guifg=#AD9E7D ctermfg=144 cterm=NONE
hi CocSemTypeMacro guifg=#dc9656 ctermfg=173 cterm=NONE
hi CocSemTypeKeyword guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSemTypeModifier guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSemTypeComment guifg=#727272 ctermfg=243 cterm=NONE
hi CocSemTypeString guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocSemTypeNumber guifg=#9876AA ctermfg=103 cterm=NONE
hi CocSemTypeBoolean guifg=#00f1f5 ctermfg=51 cterm=NONE
hi CocSemTypeRegexp guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocSemTypeOperator guifg=#abb2bf ctermfg=249 cterm=NONE
hi CocSemTypeDecorator guifg=#00f1f5 ctermfg=51 cterm=NONE
hi CocSemModDeprecated guifg=#646464 ctermfg=241 cterm=NONE gui=strikethrough
hi CocSnippetVisual guibg=#474747 ctermbg=238 cterm=NONE
hi CocCursorTransparent cterm=NONE
hi CocLoaderHeader guifg=#2B2B2B guibg=#6FAFBD ctermfg=235 ctermbg=73 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#2B2B2B guibg=#6897BB ctermfg=235 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#2B2B2B guibg=#6897BB ctermfg=235 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#555555 guifg=#2B2B2B ctermfg=235 ctermbg=240 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocLoaderMuted guifg=#727272 ctermfg=243 cterm=NONE
...
hi CocLoaderWarning guifg=#ffc24b ctermfg=215 cterm=NONE
hi CocLoaderBackdrop guibg=#2B2B2B ctermbg=235 cterm=NONE
hi CocLoaderHighlightBlock guibg=#6FAFBD guifg=#2B2B2B ctermfg=235 ctermbg=73 cterm=NONE
hi CocLoaderMutedBlock guibg=#555555 guifg=#2B2B2B ctermfg=235 ctermbg=240 cterm=NONE
...
hi NeotestPassed guifg=#6A8759 ctermfg=65 cterm=NONE
hi NeotestRunning guifg=#ffc24b ctermfg=215 cterm=NONE
hi NeotestFailed guifg=#f43753 ctermfg=203 cterm=NONE
hi NeotestSkipped guifg=#6FAFBD ctermfg=73 cterm=NONE
hi NeotestTest guifg=#646464 ctermfg=241 cterm=NONE
hi NeotestNamespace guifg=#98be65 ctermfg=107 cterm=NONE
hi NeotestFocused guifg=#ffc24b ctermfg=215 cterm=NONE
hi NeotestFile guifg=#00f1f5 ctermfg=51 cterm=NONE
hi NeotestDir guifg=#6FAFBD ctermfg=73 cterm=NONE
hi NeotestBorder guifg=#6FAFBD ctermfg=73 cterm=NONE
hi NeotestIndent guifg=#6b6b6b ctermfg=242 cterm=NONE
hi NeotestExpandMarker guifg=#6b6b6b ctermfg=242 cterm=NONE
hi NeotestAdapterName guifg=#9876AA ctermfg=103 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#6FAFBD ctermfg=73 cterm=NONE
hi NeotestMarked guifg=#6FAFBD ctermfg=73 cterm=NONE
hi NeotestTarget guifg=#6FAFBD ctermfg=73 cterm=NONE
...
hi SnacksPickerDir guifg=#727272 ctermfg=243 cterm=NONE
hi SnacksPickerDelim guifg=#646464 ctermfg=241 cterm=NONE
hi SnacksPickerRow guifg=#646464 ctermfg=241 cterm=NONE
hi SnacksPickerPathIgnored guifg=#555555 ctermfg=240 cterm=NONE
hi SnacksPickerPathHidden guifg=#555555 ctermfg=240 cterm=NONE
...
hi Tabline guibg=#323232 ctermbg=236 cterm=NONE
hi TbFill guibg=#323232 ctermbg=236 cterm=NONE
hi TbBufOn guifg=#eeeeee guibg=#2B2B2B ctermfg=255 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#727272 guibg=#323232 ctermfg=243 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#6A8759 guibg=#2B2B2B ctermfg=65 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#f43753 guibg=#323232 ctermfg=203 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#f43753 guibg=#2B2B2B ctermfg=203 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#727272 guibg=#323232 ctermfg=243 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#eeeeee guibg=#404040 ctermfg=255 ctermbg=238 cterm=NONE
hi TbTabOn guifg=#f43753 guibg=#2B2B2B ctermfg=203 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#eeeeee guibg=#323232 ctermfg=255 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#2B2B2B guibg=#6897BB ctermfg=235 ctermbg=67 cterm=NONE
hi TBTabTitle guifg=#2B2B2B guibg=#6FAFBD ctermfg=235 ctermbg=73 cterm=NONE
hi TbThemeToggleBtn guifg=#eeeeee guibg=#474747 ctermfg=255 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#2B2B2B guibg=#f43753 ctermfg=235 ctermbg=203 cterm=NONE gui=bold
hi TelescopePromptPrefix guibg=#323232 guifg=#f43753 ctermfg=203 ctermbg=236 cterm=NONE
...
hi TodoBgFix guifg=#323232 guibg=#f43753 ctermfg=236 ctermbg=203 cterm=NONE gui=bold
hi TodoBgHack guifg=#323232 guibg=#dc9656 ctermfg=236 ctermbg=173 cterm=NONE gui=bold
hi TodoBgNote guifg=#323232 guibg=#eeeeee ctermfg=236 ctermbg=255 cterm=NONE gui=bold
hi TodoBgPerf guifg=#323232 guibg=#9876AA ctermfg=236 ctermbg=103 cterm=NONE gui=bold
hi TodoBgTest guifg=#323232 guibg=#9876AA ctermfg=236 ctermbg=103 cterm=NONE gui=bold
hi TodoBgTodo guifg=#323232 guibg=#ffc24b ctermfg=236 ctermbg=215 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#eeeeee guibg=#2B2B2B ctermfg=255 ctermbg=235 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#6A8759 guibg=#2B2B2B ctermfg=65 ctermbg=235 cterm=NONE gui=underline
...
hi FoldColumn guifg=#CC7832 guibg=NONE ctermfg=173 cterm=NONE
...
hi LazyH2 guifg=#f43753 ctermfg=203 cterm=NONE gui=underline,bold
...
hi NeogitHunkMergeHeader guifg=#323232 guibg=#555555 ctermfg=236 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#2B2B2B guibg=#00f1f5 ctermfg=235 ctermbg=51 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#2B2B2B guibg=#00f1f5 ctermfg=235 ctermbg=51 cterm=NONE gui=bold
hi LazyReasonFt guifg=#9876AA ctermfg=103 cterm=NONE
hi NeogitHunkHeaderHighlight guifg=#2B2B2B guibg=#b33076 ctermfg=235 ctermbg=132 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#2B2B2B guibg=#b33076 ctermfg=235 ctermbg=132 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#6FAFBD guibg=#404040 ctermfg=73 ctermbg=238 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#dc9656 guibg=#404040 ctermfg=173 ctermbg=238 cterm=NONE gui=bold
hi NeogitBranch guifg=#6FAFBD ctermfg=73 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#6FAFBD ctermfg=73 cterm=NONE gui=underline,bold
hi NeogitRemote guifg=#6A8759 ctermfg=65 cterm=NONE gui=bold
hi CocPumVirtualText guifg=#646464 ctermfg=241 cterm=NONE
hi CocVirtualText guifg=#646464 ctermfg=241 cterm=NONE
hi def link CocInputBoxVirtualText CocVirtualText
hi CocInlineVirtualText guifg=#646464 ctermfg=241 cterm=NONE
hi CocInlineAnnotation guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSearch guifg=#dc9656 ctermfg=173 cterm=NONE
hi CocLink guifg=#6FAFBD ctermfg=73 cterm=NONE gui=underline
...
hi DevIconJson guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocListFgBlue guifg=#6FAFBD ctermfg=73 cterm=NONE
...
hi CocListFgGrey guifg=#646464 ctermfg=241 cterm=NONE
hi CocListBgBlack guibg=#323232 ctermbg=236 cterm=NONE
hi CocListBgRed guibg=#f43753 ctermbg=203 cterm=NONE
hi CocListBgGreen guibg=#6A8759 ctermbg=65 cterm=NONE
hi CocListBgYellow guibg=#ffc24b ctermbg=215 cterm=NONE
...
hi CocFloating guifg=#abb2bf guibg=#252525 ctermfg=249 ctermbg=235 cterm=NONE
hi NvDashFooter guifg=#f43753 ctermfg=203 cterm=NONE
hi CocFloatThumb guibg=#555555 ctermbg=240 cterm=NONE
...
hi CocFloatSbar guibg=#393939 ctermbg=237 cterm=NONE
hi Operator guifg=#abb2bf guisp=NONE ctermfg=249 cterm=NONE
hi CocFloatBorder guifg=#6FAFBD ctermfg=73 cterm=NONE
...
hi Type guisp=NONE guifg=#6897BB ctermfg=67 cterm=NONE
...
hi CocSelectedText guifg=#f43753 ctermfg=203 cterm=NONE
hi CocCursorRange guibg=#474747 ctermbg=238 cterm=NONE
...
hi CocSelectedLine guibg=#323232 ctermbg=236 cterm=NONE
hi CocListPath guifg=#727272 ctermfg=243 cterm=NONE
hi CocListLine guibg=#323232 ctermbg=236 cterm=NONE
hi CocListFgBlack guifg=#323232 ctermfg=236 cterm=NONE
hi CocListFgRed guifg=#f43753 ctermfg=203 cterm=NONE
hi CocListFgGreen guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocListFgYellow guifg=#ffc24b ctermfg=215 cterm=NONE
...
hi NeogitChangeUpdated guifg=#dc9656 ctermfg=173 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#00f1f5 guibg=#323232 ctermfg=51 ctermbg=236 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#6FAFBD ctermfg=73 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#6A8759 guibg=#4c693b ctermfg=65 ctermbg=239 cterm=NONE gui=italic,bold
hi CocDisabled guifg=#646464 ctermfg=241 cterm=NONE
hi CocFadeOut guifg=#555555 ctermfg=240 cterm=NONE
...
hi CocMarkdownCode guifg=#6897BB ctermfg=67 cterm=NONE
hi CocNotificationProgress guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSymbolSnippet guifg=#f43753 ctermfg=203 cterm=NONE
hi CocSymbolColor guifg=#eeeeee ctermfg=255 cterm=NONE
hi CocSymbolReference guifg=#abb2bf ctermfg=249 cterm=NONE
hi CocSymbolFolder guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSymbolFile guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSymbolModule guifg=#dc9656 ctermfg=173 cterm=NONE
hi CocSymbolPackage guifg=#dc9656 ctermfg=173 cterm=NONE
hi CocSymbolField guifg=#C9D0D3 ctermfg=252 cterm=NONE
hi CocFloatDividingLine guifg=#4c4c4c ctermfg=239 cterm=NONE
hi CocPumSearch guifg=#dc9656 ctermfg=173 cterm=NONE
hi CocPumDetail guifg=#727272 ctermfg=243 cterm=NONE
hi def link CocPumMenu CocFloating
hi CocPumShortcut guifg=#646464 ctermfg=241 cterm=NONE
hi CocPumDeprecated guifg=#646464 ctermfg=241 cterm=NONE gui=strikethrough
hi NeogitChangeDeleted guifg=#f43753 ctermfg=203 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#9876AA ctermfg=103 cterm=NONE gui=italic,bold
hi DevIconC guifg=#6FAFBD ctermfg=73 cterm=NONE
hi NeogitChangeCopied guifg=#00f1f5 ctermfg=51 cterm=NONE gui=italic,bold
hi CocListBgBlue guibg=#6FAFBD ctermbg=73 cterm=NONE
hi CocListBgMagenta guibg=#9876AA ctermbg=103 cterm=NONE
hi CocListBgCyan guibg=#00f1f5 ctermbg=51 cterm=NONE
hi CocListBgWhite guibg=#eeeeee ctermbg=255 cterm=NONE
hi CocListBgGrey guibg=#555555 ctermbg=240 cterm=NONE
hi CocDiagnosticsFile guifg=#727272 ctermfg=243 cterm=NONE
...
hi CocServicesPrefix guifg=#9876AA ctermfg=103 cterm=NONE
hi CocServicesName guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocServicesStat guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocServicesLanguages guifg=#727272 ctermfg=243 cterm=NONE
hi CocSourcesPrefix guifg=#9876AA ctermfg=103 cterm=NONE
hi CocSourcesName guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSourcesPriority guifg=#9876AA ctermfg=103 cterm=NONE
hi CocSourcesFileTypes guifg=#727272 ctermfg=243 cterm=NONE
hi CocSourcesType guifg=#6A8759 ctermfg=65 cterm=NONE
...
hi CocExtensionsLocal guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocExtensionsRoot guifg=#727272 ctermfg=243 cterm=NONE
hi CocOutlineName guifg=#eeeeee ctermfg=255 cterm=NONE
hi CocOutlineIndentLine guifg=#727272 ctermfg=243 cterm=NONE
hi CocOutlineKind guifg=#9876AA ctermfg=103 cterm=NONE
hi CocOutlineLine guifg=#727272 ctermfg=243 cterm=NONE
hi CocNotificationTime guifg=#727272 ctermfg=243 cterm=NONE
hi CocCommandsTitle guifg=#727272 ctermfg=243 cterm=NONE
hi def link CocPopupTerminal CocFloating
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocStrikeThrough cterm=NONE gui=strikethrough
hi CocUnderline guisp=#646464 cterm=NONE gui=underline
...
hi CocNotificationButton guifg=#6FAFBD ctermfg=73 cterm=NONE gui=underline
hi CocNotificationKey guifg=#727272 ctermfg=243 cterm=NONE
hi def link CocNotificationError CocErrorFloat
hi def link CocNotificationWarning CocWarningFloat
hi def link CocNotificationInfo CocInfoFloat
hi CocTreeTitle guifg=#eeeeee ctermfg=255 cterm=NONE gui=bold
hi CocTreeDescription guifg=#727272 ctermfg=243 cterm=NONE
hi IlluminatedWordRead cterm=NONE gui=underline
hi IlluminatedWordWrite cterm=NONE gui=underline
hi CocSymbolDefault guifg=#727272 ctermfg=243 cterm=NONE
hi CocSymbolKeyword guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSymbolNamespace guifg=#AD9E7D ctermfg=144 cterm=NONE
hi CocSymbolClass guifg=#6897BB ctermfg=67 cterm=NONE
hi CocSymbolMethod guifg=#AD9E7D ctermfg=144 cterm=NONE
hi CocSymbolProperty guifg=#C9D0D3 ctermfg=252 cterm=NONE
...
hi CocSymbolConstructor guifg=#6897BB ctermfg=67 cterm=NONE
hi CocSymbolEnum guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSymbolInterface guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocSymbolFunction guifg=#AD9E7D ctermfg=144 cterm=NONE
hi CocSymbolVariable guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSymbolConstant guifg=#9876AA ctermfg=103 cterm=NONE
hi CocSymbolString guifg=#6A8759 ctermfg=65 cterm=NONE
...
hi CocSymbolKey guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSymbolNull guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocSymbolEnumMember guifg=#9876AA ctermfg=103 cterm=NONE
hi CocSymbolStruct guifg=#d3b987 ctermfg=180 cterm=NONE
hi CocSymbolEvent guifg=#ffc24b ctermfg=215 cterm=NONE
hi CocSymbolOperator guifg=#abb2bf ctermfg=249 cterm=NONE
hi CocSymbolTypeParameter guifg=#C9D0D3 ctermfg=252 cterm=NONE
hi CocSemTypeNamespace guifg=#AD9E7D ctermfg=144 cterm=NONE
hi CocSemTypeType guifg=#dc9656 ctermfg=173 cterm=NONE
hi NeogitChangeUnmerged guifg=#ffc24b ctermfg=215 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#6A8759 ctermfg=65 cterm=NONE gui=italic,bold
...
hi CocListFgMagenta guifg=#9876AA ctermfg=103 cterm=NONE
hi CocListFgCyan guifg=#00f1f5 ctermfg=51 cterm=NONE
hi CocListFgWhite guifg=#eeeeee ctermfg=255 cterm=NONE
...
hi CocInlayHint guifg=#727272 guibg=#323232 ctermfg=243 ctermbg=236 cterm=NONE
...
hi CocHintLine guibg=#343b40 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#353e40 ctermbg=237 cterm=NONE
...
hi CocListsDesc guifg=#727272 ctermfg=243 cterm=NONE
hi CocExtensionsActivated guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocExtensionsLoaded guifg=#eeeeee ctermfg=255 cterm=NONE
hi CocExtensionsDisabled guifg=#646464 ctermfg=241 cterm=NONE
hi CocExtensionsName guifg=#6A8759 ctermfg=65 cterm=NONE
hi CocTreeOpenClose cterm=NONE gui=bold
hi CocTreeSelected guibg=#323232 ctermbg=236 cterm=NONE
hi NoiceScrollbarThumb guibg=#555555 ctermbg=240 cterm=NONE
hi NoiceVirtualText guifg=#727272 ctermfg=243 cterm=NONE
hi CocSymbolBoolean guifg=#00f1f5 ctermfg=51 cterm=NONE
hi CocSymbolNumber guifg=#9876AA ctermfg=103 cterm=NONE
...
hi CocHoverRange guibg=#474747 ctermbg=238 cterm=NONE
...
hi CocWarningLine guibg=#4a412f ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#492c31 ctermbg=237 cterm=NONE
hi CocHintSign guifg=#6897BB ctermfg=67 cterm=NONE
hi CocInfoSign guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocWarningSign guifg=#ffc24b ctermfg=215 cterm=NONE
hi CocErrorSign guifg=#f43753 ctermfg=203 cterm=NONE
hi CocHintVirtualText guifg=#6897BB ctermfg=67 cterm=NONE
hi CocInfoVirtualText guifg=#6FAFBD ctermfg=73 cterm=NONE
hi CocWarningVirtualText guifg=#ffc24b ctermfg=215 cterm=NONE
hi CocErrorVirtualText guifg=#f43753 ctermfg=203 cterm=NONE
hi CocUnusedHighlight guifg=#646464 ctermfg=241 cterm=NONE
hi CocDeprecatedHighlight guifg=#646464 ctermfg=241 cterm=NONE gui=strikethrough
hi CocHintHighlight guifg=#6897BB guisp=#6897BB ctermfg=67 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#6FAFBD guisp=#6FAFBD ctermfg=73 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#ffc24b guisp=#ffc24b ctermfg=215 cterm=NONE gui=undercurl
hi CocErrorHighlight guifg=#f43753 guisp=#f43753 ctermfg=203 cterm=NONE gui=undercurl
hi NeogitHunkHeader guifg=#2B2B2B guibg=#555555 ctermfg=235 ctermbg=240 cterm=NONE gui=bold
hi CmpItemKindSuperMaven guifg=#ffc24b ctermfg=215 cterm=NONE
hi CmpItemKindTabNine guifg=#f70067 ctermfg=197 cterm=NONE
hi CocHintFloat guifg=#6897BB guibg=#252525 ctermfg=67 ctermbg=235 cterm=NONE
hi DapUIFloatBorder guifg=#00f1f5 ctermfg=51 cterm=NONE
hi CocInfoFloat guifg=#6FAFBD guibg=#252525 ctermfg=73 ctermbg=235 cterm=NONE
...
hi CocWarningFloat guifg=#ffc24b guibg=#252525 ctermfg=215 ctermbg=235 cterm=NONE
...
hi CocErrorFloat guifg=#f43753 guibg=#252525 ctermfg=203 ctermbg=235 cterm=NONE
