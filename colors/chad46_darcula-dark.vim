...
hi NvimDapViewTabSelected guibg=#2B2B2B guifg=#eeeeee ctermfg=255 ctermbg=235 cterm=NONE
hi NvimDapViewTab guibg=#323232 guifg=#727272 ctermfg=243 ctermbg=236 cterm=NONE
...
hi FlashCurrent guibg=#6A8759 guifg=#2B2B2B ctermfg=235 ctermbg=65 cterm=NONE
hi FlashMatch guibg=#6FAFBD guifg=#2B2B2B ctermfg=235 ctermbg=73 cterm=NONE
...
hi LspInlayHint guifg=#727272 guibg=#323232 ctermfg=243 ctermbg=236 cterm=NONE
...
hi MasonHeader guifg=#2B2B2B guibg=#f43753 ctermfg=235 ctermbg=203 cterm=NONE
