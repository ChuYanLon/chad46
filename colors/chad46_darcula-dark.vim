...
hi Identifier guisp=NONE guifg=#C9D0D3 ctermfg=252 cterm=NONE
hi Float guifg=#9876AA ctermfg=103 cterm=NONE
hi Delimiter guifg=#CC7832 ctermfg=173 cterm=NONE
hi Define guisp=NONE guifg=#d3b987 ctermfg=180 cterm=NONE
...
hi CocHintHighlight guisp=#6897BB guifg=#6897BB ctermfg=67 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#6FAFBD guifg=#6FAFBD ctermfg=73 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#ffc24b guifg=#ffc24b ctermfg=215 cterm=NONE gui=undercurl
...
hi NeogitChangeAdded guifg=#6A8759 guibg=#4c693b ctermfg=65 ctermbg=239 cterm=NONE gui=bold,italic
...
hi CocErrorHighlight guisp=#f43753 guifg=#f43753 ctermfg=203 cterm=NONE gui=undercurl
