...
hi TbCloseAllBufsBtn guibg=#f43753 guifg=#2B2B2B ctermfg=235 ctermbg=203 cterm=NONE gui=bold
hi TbThemeToggleBtn guibg=#474747 guifg=#eeeeee ctermfg=255 ctermbg=238 cterm=NONE gui=bold
