...
hi BlinkCmpMenuSelection guifg=#fafafa guibg=#00BCD4 ctermfg=231 ctermbg=38 cterm=NONE gui=bold
hi CmpSel guifg=#fafafa guibg=#00BCD4 ctermfg=231 ctermbg=38 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#fafafa guibg=#6182b8 ctermfg=231 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#fafafa guibg=#39ADB5 ctermfg=231 ctermbg=73 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#fafafa guibg=#39ADB5 ctermfg=231 ctermbg=73 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#C4C4C4 guifg=#fafafa ctermfg=231 ctermbg=251 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#6182b8 ctermfg=67 cterm=NONE
hi CocLoaderMuted guifg=#B3B3B3 ctermfg=249 cterm=NONE
...
hi CocLoaderWarning guifg=#F59717 ctermfg=208 cterm=NONE
hi CocLoaderBackdrop guibg=#fafafa ctermbg=231 cterm=NONE
hi CocLoaderHighlightBlock guibg=#6182b8 guifg=#fafafa ctermfg=231 ctermbg=67 cterm=NONE
hi CocLoaderMutedBlock guibg=#C4C4C4 guifg=#fafafa ctermfg=231 ctermbg=251 cterm=NONE
...
hi Define guisp=NONE guifg=#6182b8 ctermfg=67 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#EBEBEB guibg=#C4C4C4 ctermfg=255 ctermbg=251 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#435862 guibg=#fafafa ctermfg=240 ctermbg=231 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#91b859 guibg=#fafafa ctermfg=107 ctermbg=231 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#6182b8 guibg=#E1E1E1 ctermfg=67 ctermbg=254 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#91b859 guibg=#739a3b ctermfg=107 ctermbg=65 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#39adb5 guibg=#EBEBEB ctermfg=73 ctermbg=255 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#C4C4C4 ctermfg=251 cterm=NONE
...
hi DevIconJson guifg=#f6a434 ctermfg=215 cterm=NONE
...
hi SnacksPickerDir guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi SnacksPickerDelim guifg=#C4C4C4 ctermfg=251 cterm=NONE
hi SnacksPickerRow guifg=#C4C4C4 ctermfg=251 cterm=NONE
...
hi Tabline guibg=#EBEBEB ctermbg=255 cterm=NONE
hi TbFill guibg=#EBEBEB ctermbg=255 cterm=NONE
hi TbBufOn guifg=#435862 guibg=#fafafa ctermfg=240 ctermbg=231 cterm=NONE
hi TbBufOff guifg=#B3B3B3 guibg=#EBEBEB ctermfg=249 ctermbg=255 cterm=NONE
hi TbBufOnModified guifg=#91b859 guibg=#fafafa ctermfg=107 ctermbg=231 cterm=NONE
hi TbBufOffModified guifg=#e53935 guibg=#EBEBEB ctermfg=167 ctermbg=255 cterm=NONE
hi TbBufOnClose guifg=#e53935 guibg=#fafafa ctermfg=167 ctermbg=231 cterm=NONE
hi TbBufOffClose guifg=#B3B3B3 guibg=#EBEBEB ctermfg=249 ctermbg=255 cterm=NONE
hi TbTabNewBtn guifg=#435862 guibg=#E1E1E1 ctermfg=240 ctermbg=254 cterm=NONE
hi TbTabOn guifg=#e53935 guibg=#fafafa ctermfg=167 ctermbg=231 cterm=NONE
hi TbTabOff guifg=#435862 guibg=#EBEBEB ctermfg=240 ctermbg=255 cterm=NONE
hi TbTabCloseBtn guifg=#fafafa guibg=#4e73ae ctermfg=231 ctermbg=61 cterm=NONE
hi TBTabTitle guifg=#fafafa guibg=#6182b8 ctermfg=231 ctermbg=67 cterm=NONE
hi TbThemeToggleBtn guifg=#435862 guibg=#D9D9D9 ctermfg=240 ctermbg=253 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#fafafa guibg=#e53935 ctermfg=231 ctermbg=167 cterm=NONE gui=bold
...
hi FoldColumn guifg=#E53935 guibg=NONE ctermfg=167 cterm=NONE
...
hi CocHintLine guibg=#ddeeef ctermbg=254 cterm=NONE
hi CocInfoLine guibg=#e3e8f0 ctermbg=254 cterm=NONE
hi CocWarningLine guibg=#f9ebd7 ctermbg=224 cterm=NONE
hi CocErrorLine guibg=#f6dddc ctermbg=224 cterm=NONE
hi CocHintSign guifg=#39ADB5 ctermfg=73 cterm=NONE
hi CocErrorFloat guifg=#e53935 guibg=#F2F2F2 ctermfg=167 ctermbg=255 cterm=NONE
...
hi CocInfoHighlight guifg=#6182b8 guisp=#6182b8 ctermfg=67 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#39ADB5 guisp=#39ADB5 ctermfg=73 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#C4C4C4 ctermfg=251 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#39ADB5 guibg=#F2F2F2 ctermfg=73 ctermbg=255 cterm=NONE
hi CocInfoFloat guifg=#6182b8 guibg=#F2F2F2 ctermfg=67 ctermbg=255 cterm=NONE
hi CocWarningFloat guifg=#F59717 guibg=#F2F2F2 ctermfg=208 ctermbg=255 cterm=NONE
hi CocUnusedHighlight guifg=#C4C4C4 ctermfg=251 cterm=NONE
hi CmpBorder guifg=#C4C4C4 ctermfg=251 cterm=NONE
hi CocErrorHighlight guifg=#e53935 guisp=#e53935 ctermfg=167 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#F59717 guisp=#F59717 ctermfg=208 cterm=NONE gui=undercurl
...
hi CocInlayHint guifg=#B3B3B3 guibg=#EBEBEB ctermfg=249 ctermbg=255 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#fafafa guibg=#39adb5 ctermfg=231 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#fafafa guibg=#39adb5 ctermfg=231 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#fafafa guibg=#9671ff ctermfg=231 ctermbg=99 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#fafafa guibg=#9671ff ctermfg=231 ctermbg=99 cterm=NONE gui=bold
...
hi NeotestFile guifg=#39adb5 ctermfg=73 cterm=NONE
hi NeotestFocused guifg=#F59717 ctermfg=208 cterm=NONE
hi NeotestNamespace guifg=#a7c67a ctermfg=150 cterm=NONE
hi NeotestTest guifg=#C4C4C4 ctermfg=251 cterm=NONE
...
hi NeogitHunkHeader guifg=#fafafa guibg=#C4C4C4 ctermfg=231 ctermbg=251 cterm=NONE gui=bold
...
hi CocDiagnosticsFile guifg=#B3B3B3 ctermfg=249 cterm=NONE
...
hi CocServicesPrefix guifg=#7c4dff ctermfg=99 cterm=NONE
hi CocServicesName guifg=#6182b8 ctermfg=67 cterm=NONE
hi CocServicesStat guifg=#91b859 ctermfg=107 cterm=NONE
hi CocServicesLanguages guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocSourcesPrefix guifg=#7c4dff ctermfg=99 cterm=NONE
hi CocSourcesName guifg=#6182b8 ctermfg=67 cterm=NONE
hi CocSourcesPriority guifg=#F76D47 ctermfg=203 cterm=NONE
hi CocSourcesFileTypes guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocSourcesType guifg=#91b859 ctermfg=107 cterm=NONE
hi CocListsDesc guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocExtensionsActivated guifg=#91b859 ctermfg=107 cterm=NONE
hi CocExtensionsLoaded guifg=#435862 ctermfg=240 cterm=NONE
hi CocExtensionsDisabled guifg=#C4C4C4 ctermfg=251 cterm=NONE
hi CocExtensionsName guifg=#91b859 ctermfg=107 cterm=NONE
hi CocExtensionsLocal guifg=#6182b8 ctermfg=67 cterm=NONE
hi CocExtensionsRoot guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocOutlineName guifg=#435862 ctermfg=240 cterm=NONE
hi CocOutlineIndentLine guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocOutlineKind guifg=#7c4dff ctermfg=99 cterm=NONE
hi CocOutlineLine guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocNotificationTime guifg=#B3B3B3 ctermfg=249 cterm=NONE
hi CocCommandsTitle guifg=#B3B3B3 ctermfg=249 cterm=NONE
...
hi NeotestAdapterName guifg=#7c4dff ctermfg=99 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#6182b8 ctermfg=67 cterm=NONE
...
hi NeotestPassed guifg=#91b859 ctermfg=107 cterm=NONE
hi NeotestRunning guifg=#F59717 ctermfg=208 cterm=NONE
hi NeotestFailed guifg=#e53935 ctermfg=167 cterm=NONE
hi NeotestSkipped guifg=#6182b8 ctermfg=67 cterm=NONE
...
hi TodoBgTodo guifg=#EBEBEB guibg=#F59717 ctermfg=255 ctermbg=208 cterm=NONE gui=bold
hi NeotestMarked guifg=#6182b8 ctermfg=67 cterm=NONE
hi NeotestTarget guifg=#6182b8 ctermfg=67 cterm=NONE
...
hi TodoBgFix guifg=#EBEBEB guibg=#e53935 ctermfg=255 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#EBEBEB guibg=#f76d47 ctermfg=255 ctermbg=203 cterm=NONE gui=bold
hi TodoBgNote guifg=#EBEBEB guibg=#435862 ctermfg=255 ctermbg=240 cterm=NONE gui=bold
hi TodoBgPerf guifg=#EBEBEB guibg=#7c4dff ctermfg=255 ctermbg=99 cterm=NONE gui=bold
hi TodoBgTest guifg=#EBEBEB guibg=#7c4dff ctermfg=255 ctermbg=99 cterm=NONE gui=bold
...
hi NeotestExpandMarker guifg=#BDBDBD ctermfg=250 cterm=NONE
hi NeotestIndent guifg=#BDBDBD ctermfg=250 cterm=NONE
hi NeotestBorder guifg=#6182b8 ctermfg=67 cterm=NONE
hi NeotestDir guifg=#6182b8 ctermfg=67 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#f76d47 guibg=#E1E1E1 ctermfg=203 ctermbg=254 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#e53935 ctermfg=167 cterm=NONE
...
hi CocFloating guifg=#435862 guibg=#F2F2F2 ctermfg=240 ctermbg=255 cterm=NONE
...
hi CocSelectedLine guibg=#EBEBEB ctermbg=255 cterm=NONE
