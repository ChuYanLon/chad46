...
hi BlinkCmpMenuSelection guifg=#D8DEE9 guibg=#7191b1 ctermfg=254 ctermbg=67 cterm=NONE gui=bold
hi CmpSel guifg=#D8DEE9 guibg=#7191b1 ctermfg=254 ctermbg=67 cterm=NONE gui=bold
hi NeotestFocused guifg=#c18401 ctermfg=136 cterm=NONE
hi NeotestFile guifg=#6181a1 ctermfg=67 cterm=NONE
hi NeotestDir guifg=#3f5f7f ctermfg=60 cterm=NONE
hi NeotestBorder guifg=#3f5f7f ctermfg=60 cterm=NONE
hi NeotestIndent guifg=#959ba6 ctermfg=247 cterm=NONE
hi NeotestExpandMarker guifg=#959ba6 ctermfg=247 cterm=NONE
hi NeotestAdapterName guifg=#9c87c7 ctermfg=140 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#3f5f7f ctermfg=60 cterm=NONE
hi NeotestMarked guifg=#3f5f7f ctermfg=60 cterm=NONE
hi NeotestTarget guifg=#3f5f7f ctermfg=60 cterm=NONE
...
hi CocSemTypeClass guifg=#395979 ctermfg=60 cterm=NONE
hi CocSemTypeEnum guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSemTypeInterface guifg=#75905e ctermfg=101 cterm=NONE
hi CocSemTypeStruct guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSemTypeTypeParameter guifg=#a3454e ctermfg=131 cterm=NONE
hi CocSemTypeParameter guifg=#a3454e ctermfg=131 cterm=NONE
hi CocSemTypeVariable guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSemTypeProperty guifg=#a3454e ctermfg=131 cterm=NONE
hi CocSemTypeEnumMember guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocSemTypeEvent guifg=#c18401 ctermfg=136 cterm=NONE
hi CocSemTypeFunction guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSemTypeMethod guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSemTypeMacro guifg=#b88339 ctermfg=137 cterm=NONE
hi CocSemTypeKeyword guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSemTypeModifier guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSemTypeComment guifg=#8b919c ctermfg=246 cterm=NONE
hi CocSemTypeString guifg=#75905e ctermfg=101 cterm=NONE
hi CocSemTypeNumber guifg=#b46b54 ctermfg=131 cterm=NONE
hi CocSemTypeBoolean guifg=#6181a1 ctermfg=67 cterm=NONE
hi CocSemTypeRegexp guifg=#75905e ctermfg=101 cterm=NONE
hi CocSemTypeOperator guifg=#3e4450 ctermfg=238 cterm=NONE
hi CocSemTypeDecorator guifg=#6181a1 ctermfg=67 cterm=NONE
hi CocSemModDeprecated guifg=#9fa5b0 ctermfg=248 cterm=NONE gui=strikethrough
hi CocSnippetVisual guibg=#b3b9c4 ctermbg=250 cterm=NONE
hi CocCursorTransparent cterm=NONE
hi SagaBorder guibg=#ced4df ctermbg=188 cterm=NONE
hi SagaNormal guibg=#ced4df ctermbg=188 cterm=NONE
hi CocLoaderHeader guifg=#D8DEE9 guibg=#3f5f7f ctermfg=254 ctermbg=60 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#D8DEE9 guibg=#395979 ctermfg=254 ctermbg=60 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#D8DEE9 guibg=#395979 ctermfg=254 ctermbg=60 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#a9afba guifg=#D8DEE9 ctermfg=254 ctermbg=249 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocLoaderMuted guifg=#8b919c ctermfg=246 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#3f5f7f guifg=#D8DEE9 ctermfg=254 ctermbg=60 cterm=NONE
hi CocLoaderMutedBlock guibg=#a9afba guifg=#D8DEE9 ctermfg=254 ctermbg=249 cterm=NONE
...
hi MiniTablineModifiedCurrent guifg=#75905e guibg=#D8DEE9 ctermfg=101 ctermbg=254 cterm=NONE gui=underline
...
hi NeogitHunkMergeHeader guifg=#c9cfda guibg=#a9afba ctermfg=252 ctermbg=249 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#D8DEE9 guibg=#6181a1 ctermfg=254 ctermbg=67 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#D8DEE9 guibg=#6181a1 ctermfg=254 ctermbg=67 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#D8DEE9 guibg=#a9afba ctermfg=254 ctermbg=249 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#D8DEE9 guibg=#927dbd ctermfg=254 ctermbg=103 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#D8DEE9 guibg=#927dbd ctermfg=254 ctermbg=103 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#3f5f7f guibg=#bdc3ce ctermfg=60 ctermbg=251 cterm=NONE gui=bold
hi WarningMsg guifg=#a3454e ctermfg=131 cterm=NONE
hi NeogitBranch guifg=#3f5f7f ctermfg=60 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#3f5f7f ctermfg=60 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#3f5f7f ctermfg=60 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#75905e guibg=#577240 ctermfg=101 ctermbg=240 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#a3454e ctermfg=131 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#9c87c7 ctermfg=140 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#b46b54 ctermfg=131 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#6181a1 ctermfg=67 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#c18401 ctermfg=136 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#75905e ctermfg=101 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#6181a1 guibg=#c9cfda ctermfg=67 ctermbg=252 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#9fa5b0 ctermfg=248 cterm=NONE
...
hi SnacksPickerDir guifg=#8b919c ctermfg=246 cterm=NONE
hi SnacksPickerDelim guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi SnacksPickerRow guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi SnacksPickerPathIgnored guifg=#a9afba ctermfg=249 cterm=NONE
hi SnacksPickerPathHidden guifg=#a9afba ctermfg=249 cterm=NONE
...
hi Tabline guibg=#c9cfda ctermbg=252 cterm=NONE
hi TbFill guibg=#c9cfda ctermbg=252 cterm=NONE
hi TbBufOn guifg=#2a303c guibg=#D8DEE9 ctermfg=236 ctermbg=254 cterm=NONE
hi TbBufOff guifg=#8b919c guibg=#c9cfda ctermfg=246 ctermbg=252 cterm=NONE
hi TbBufOnModified guifg=#75905e guibg=#D8DEE9 ctermfg=101 ctermbg=254 cterm=NONE
hi TbBufOffModified guifg=#a3454e guibg=#c9cfda ctermfg=131 ctermbg=252 cterm=NONE
hi TbBufOnClose guifg=#a3454e guibg=#D8DEE9 ctermfg=131 ctermbg=254 cterm=NONE
hi TbBufOffClose guifg=#8b919c guibg=#c9cfda ctermfg=246 ctermbg=252 cterm=NONE
hi TbTabNewBtn guifg=#2a303c guibg=#bdc3ce ctermfg=236 ctermbg=251 cterm=NONE
...
hi TBTabTitle guifg=#D8DEE9 guibg=#3f5f7f ctermfg=254 ctermbg=60 cterm=NONE
hi TbThemeToggleBtn guifg=#2a303c guibg=#b3b9c4 ctermfg=236 ctermbg=250 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#D8DEE9 guibg=#a3454e ctermfg=254 ctermbg=131 cterm=NONE gui=bold
...
hi TodoBgFix guifg=#c9cfda guibg=#a3454e ctermfg=252 ctermbg=131 cterm=NONE gui=bold
...
hi FoldColumn guifg=#a3454e guibg=NONE ctermfg=131 cterm=NONE
...
hi LazyH2 guifg=#a3454e ctermfg=131 cterm=NONE gui=underline,bold
...
hi CocCursorRange guibg=#b3b9c4 ctermbg=250 cterm=NONE
...
hi CocFloatBorder guifg=#3f5f7f ctermfg=60 cterm=NONE
...
hi CocInlineVirtualText guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocInlineAnnotation guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSearch guifg=#b46b54 ctermfg=131 cterm=NONE
hi CocLink guifg=#3f5f7f ctermfg=60 cterm=NONE gui=underline
...
hi CocListPath guifg=#8b919c ctermfg=246 cterm=NONE
hi CocListLine guibg=#c9cfda ctermbg=252 cterm=NONE
...
hi CocListFgBlue guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocListFgMagenta guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocListFgCyan guifg=#6181a1 ctermfg=67 cterm=NONE
hi CocListFgWhite guifg=#2a303c ctermfg=236 cterm=NONE
hi CocListFgGrey guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocListBgBlack guibg=#c9cfda ctermbg=252 cterm=NONE
hi CocListBgRed guibg=#a3454e ctermbg=131 cterm=NONE
hi CocListBgGreen guibg=#75905e ctermbg=101 cterm=NONE
...
hi TelescopeSelection guifg=#2a303c guibg=#c7cdd8 ctermfg=236 ctermbg=252 cterm=NONE
...
hi CocListFgGreen guifg=#75905e ctermfg=101 cterm=NONE
hi CocListFgRed guifg=#a3454e ctermfg=131 cterm=NONE
hi CocListFgBlack guifg=#c9cfda ctermfg=252 cterm=NONE
hi CocSelectedText guifg=#a3454e ctermfg=131 cterm=NONE
hi def link CocHighlightWrite CocHighlightText
hi def link CocHighlightRead CocHighlightText
hi CocHighlightText guibg=#b3b9c4 ctermbg=250 cterm=NONE
hi def link CocInlayHintType CocInlayHint
hi def link CocInlayHintParameter CocInlayHint
hi CocInlayHint guifg=#8b919c guibg=#c9cfda ctermfg=246 ctermbg=252 cterm=NONE
hi CmpItemKindModule guifg=#b88339 ctermfg=137 cterm=NONE
hi CocWarningSign guifg=#c18401 ctermfg=136 cterm=NONE
hi CocInfoSign guifg=#3f5f7f ctermfg=60 cterm=NONE
...
hi CocErrorSign guifg=#a3454e ctermfg=131 cterm=NONE
hi CocHintVirtualText guifg=#395979 ctermfg=60 cterm=NONE
hi CocInfoVirtualText guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocWarningVirtualText guifg=#c18401 ctermfg=136 cterm=NONE
hi CocErrorVirtualText guifg=#a3454e ctermfg=131 cterm=NONE
hi CocUnusedHighlight guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocDeprecatedHighlight guifg=#9fa5b0 ctermfg=248 cterm=NONE gui=strikethrough
hi CocHintHighlight guifg=#395979 guisp=#395979 ctermfg=60 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#3f5f7f guisp=#3f5f7f ctermfg=60 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#c18401 guisp=#c18401 ctermfg=136 cterm=NONE gui=undercurl
hi CocErrorHighlight guifg=#a3454e guisp=#a3454e ctermfg=131 cterm=NONE gui=undercurl
...
hi CocHintFloat guifg=#395979 guibg=#ced4df ctermfg=60 ctermbg=188 cterm=NONE
hi CocInfoFloat guifg=#3f5f7f guibg=#ced4df ctermfg=60 ctermbg=188 cterm=NONE
hi CocWarningFloat guifg=#c18401 guibg=#ced4df ctermfg=136 ctermbg=188 cterm=NONE
...
hi MiniTablineCurrent guifg=#2a303c guibg=#D8DEE9 ctermfg=236 ctermbg=254 cterm=NONE gui=underline
...
hi CocListBgBlue guibg=#3f5f7f ctermbg=60 cterm=NONE
hi CocListBgMagenta guibg=#9c87c7 ctermbg=140 cterm=NONE
hi CocListBgCyan guibg=#6181a1 ctermbg=67 cterm=NONE
hi CocListBgWhite guibg=#2a303c ctermbg=236 cterm=NONE
hi CocListBgGrey guibg=#a9afba ctermbg=249 cterm=NONE
hi CocDiagnosticsFile guifg=#8b919c ctermfg=246 cterm=NONE
...
hi CocServicesPrefix guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocServicesName guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocServicesStat guifg=#75905e ctermfg=101 cterm=NONE
hi CocServicesLanguages guifg=#8b919c ctermfg=246 cterm=NONE
hi CocSourcesPrefix guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocSourcesName guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSourcesPriority guifg=#b46b54 ctermfg=131 cterm=NONE
hi CocSourcesFileTypes guifg=#8b919c ctermfg=246 cterm=NONE
hi CocSourcesType guifg=#75905e ctermfg=101 cterm=NONE
hi CocListsDesc guifg=#8b919c ctermfg=246 cterm=NONE
hi CocExtensionsActivated guifg=#75905e ctermfg=101 cterm=NONE
hi CocExtensionsLoaded guifg=#2a303c ctermfg=236 cterm=NONE
hi CocExtensionsDisabled guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocExtensionsName guifg=#75905e ctermfg=101 cterm=NONE
hi CocExtensionsLocal guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocExtensionsRoot guifg=#8b919c ctermfg=246 cterm=NONE
hi CocOutlineName guifg=#2a303c ctermfg=236 cterm=NONE
hi CocOutlineIndentLine guifg=#8b919c ctermfg=246 cterm=NONE
hi CocOutlineKind guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocOutlineLine guifg=#8b919c ctermfg=246 cterm=NONE
hi CocNotificationTime guifg=#8b919c ctermfg=246 cterm=NONE
hi CocCommandsTitle guifg=#8b919c ctermfg=246 cterm=NONE
hi def link CocPopupTerminal CocFloating
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocStrikeThrough cterm=NONE gui=strikethrough
hi CocUnderline guisp=#9fa5b0 cterm=NONE gui=underline
...
hi CocNotificationButton guifg=#3f5f7f ctermfg=60 cterm=NONE gui=underline
hi CocNotificationKey guifg=#8b919c ctermfg=246 cterm=NONE
hi def link CocNotificationError CocErrorFloat
hi def link CocNotificationWarning CocWarningFloat
hi def link CocNotificationInfo CocInfoFloat
hi CocTreeTitle guifg=#2a303c ctermfg=236 cterm=NONE gui=bold
hi CocTreeDescription guifg=#8b919c ctermfg=246 cterm=NONE
hi CocTreeOpenClose cterm=NONE gui=bold
hi CocTreeSelected guibg=#c9cfda ctermbg=252 cterm=NONE
hi CocSymbolDefault guifg=#8b919c ctermfg=246 cterm=NONE
hi CocSymbolKeyword guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSymbolNamespace guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolClass guifg=#395979 ctermfg=60 cterm=NONE
hi CocSymbolMethod guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolProperty guifg=#a3454e ctermfg=131 cterm=NONE
hi def link CocSymbolText CocSymbolDefault
hi def link CocSymbolUnit CocSymbolDefault
hi def link CocSymbolValue CocSymbolDefault
hi CocSymbolSnippet guifg=#a3454e ctermfg=131 cterm=NONE
hi CocSymbolColor guifg=#2a303c ctermfg=236 cterm=NONE
hi CocSymbolReference guifg=#3e4450 ctermfg=238 cterm=NONE
hi CocSymbolFolder guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolFile guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolModule guifg=#b88339 ctermfg=137 cterm=NONE
hi CocSymbolPackage guifg=#b88339 ctermfg=137 cterm=NONE
hi CocSymbolField guifg=#a3454e ctermfg=131 cterm=NONE
hi CocSymbolConstructor guifg=#395979 ctermfg=60 cterm=NONE
hi CocSymbolEnum guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolInterface guifg=#75905e ctermfg=101 cterm=NONE
hi CocSymbolFunction guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolVariable guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSymbolConstant guifg=#b46b54 ctermfg=131 cterm=NONE
hi CocSymbolString guifg=#75905e ctermfg=101 cterm=NONE
hi CocSymbolNumber guifg=#b46b54 ctermfg=131 cterm=NONE
hi CocSymbolBoolean guifg=#6181a1 ctermfg=67 cterm=NONE
hi def link CocSymbolArray CocSymbolDefault
hi def link CocSymbolObject CocSymbolDefault
hi CocSymbolKey guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSymbolNull guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSymbolEnumMember guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocSymbolStruct guifg=#8d6786 ctermfg=96 cterm=NONE
hi CocSymbolEvent guifg=#c18401 ctermfg=136 cterm=NONE
hi CocSymbolOperator guifg=#3e4450 ctermfg=238 cterm=NONE
hi CocSymbolTypeParameter guifg=#a3454e ctermfg=131 cterm=NONE
hi CocSemTypeNamespace guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSemTypeType guifg=#b88339 ctermfg=137 cterm=NONE
...
hi CocHintLine guibg=#c0cad8 ctermbg=252 cterm=NONE
hi CocInfoLine guibg=#c1cad9 ctermbg=252 cterm=NONE
hi CocWarningLine guibg=#d4d0c6 ctermbg=252 cterm=NONE
hi CocErrorLine guibg=#d0c7d1 ctermbg=252 cterm=NONE
hi CocHintSign guifg=#395979 ctermfg=60 cterm=NONE
hi CocErrorFloat guifg=#a3454e guibg=#ced4df ctermfg=131 ctermbg=188 cterm=NONE
hi CmpItemKindEnumMember guifg=#9c87c7 ctermfg=140 cterm=NONE
hi CocDisabled guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocFadeOut guifg=#a9afba ctermfg=249 cterm=NONE
...
hi CocMarkdownCode guifg=#395979 ctermfg=60 cterm=NONE
hi CocNotificationProgress guifg=#3f5f7f ctermfg=60 cterm=NONE
...
hi CocHoverRange guibg=#b3b9c4 ctermbg=250 cterm=NONE
hi def link CocSelectedRange CocHighlightText
hi CocCodeLens guifg=#8b919c ctermfg=246 cterm=NONE
hi CocFloating guifg=#3e4450 guibg=#ced4df ctermfg=238 ctermbg=188 cterm=NONE
hi TbTabCloseBtn guifg=#D8DEE9 guibg=#5b7b9b ctermfg=254 ctermbg=66 cterm=NONE
hi TbTabOff guifg=#2a303c guibg=#c9cfda ctermfg=236 ctermbg=252 cterm=NONE
hi TbTabOn guifg=#a3454e guibg=#D8DEE9 ctermfg=131 ctermbg=254 cterm=NONE
hi CocMenuSel guibg=#7191b1 guifg=#D8DEE9 ctermfg=254 ctermbg=67 cterm=NONE
hi CocFloatThumb guibg=#a9afba ctermbg=249 cterm=NONE
hi CocFloatSbar guibg=#c7cdd8 ctermbg=252 cterm=NONE
hi CocFloatDividingLine guifg=#acb2bd ctermfg=249 cterm=NONE
hi CocPumSearch guifg=#b46b54 ctermfg=131 cterm=NONE
hi CocPumDetail guifg=#8b919c ctermfg=246 cterm=NONE
hi DiagnosticError guifg=#a3454e ctermfg=131 cterm=NONE
hi def link CocPumMenu CocFloating
hi CocPumShortcut guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocPumDeprecated guifg=#9fa5b0 ctermfg=248 cterm=NONE gui=strikethrough
hi CocPumVirtualText guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi CocVirtualText guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi def link CocInputBoxVirtualText CocVirtualText
hi def link CocListSearch CocSearch
hi CocListMode guifg=#3f5f7f ctermfg=60 cterm=NONE
hi CocSelectedLine guibg=#c9cfda ctermbg=252 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#b46b54 guibg=#bdc3ce ctermfg=131 ctermbg=251 cterm=NONE gui=bold
...
hi TodoBgTodo guifg=#c9cfda guibg=#c18401 ctermfg=252 ctermbg=136 cterm=NONE gui=bold
hi TodoBgTest guifg=#c9cfda guibg=#9c87c7 ctermfg=252 ctermbg=140 cterm=NONE gui=bold
hi TodoBgPerf guifg=#c9cfda guibg=#9c87c7 ctermfg=252 ctermbg=140 cterm=NONE gui=bold
hi TodoBgNote guifg=#c9cfda guibg=#2a303c ctermfg=252 ctermbg=236 cterm=NONE gui=bold
hi TodoBgHack guifg=#c9cfda guibg=#b46b54 ctermfg=252 ctermbg=131 cterm=NONE gui=bold
...
hi DiffAdd guifg=#3e4450 guibg=#ced6db ctermfg=238 ctermbg=188 cterm=NONE
...
hi NeotestPassed guifg=#75905e ctermfg=101 cterm=NONE
hi NeotestRunning guifg=#c18401 ctermfg=136 cterm=NONE
hi NeotestFailed guifg=#a3454e ctermfg=131 cterm=NONE
hi NeotestSkipped guifg=#3f5f7f ctermfg=60 cterm=NONE
hi NeotestTest guifg=#9fa5b0 ctermfg=248 cterm=NONE
hi NeotestNamespace guifg=#809b69 ctermfg=101 cterm=NONE
