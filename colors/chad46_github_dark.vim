...
hi CocLoaderHeader guifg=#24292E guibg=#79c0ff ctermfg=235 ctermbg=111 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#24292E guibg=#39c5cf ctermfg=235 ctermbg=80 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#24292E guibg=#39c5cf ctermfg=235 ctermbg=80 cterm=NONE gui=bold
...
hi ErrorMsg guifg=#B392E9 guibg=#24292E ctermfg=140 ctermbg=235 cterm=NONE
hi def link CocLoaderNormal NormalFloat
hi NormalFloat guibg=#1F2428 ctermbg=235 cterm=NONE
hi def link CocLoaderSearchMatch Search
hi Search guifg=#33383d guibg=#ffdf5d ctermfg=237 ctermbg=221 cterm=NONE
...
hi PmenuSel guibg=#58a6ff guifg=#24292E ctermfg=235 ctermbg=75 cterm=NONE
...
hi Todo guifg=#ffdf5d guibg=#33383d ctermfg=221 ctermbg=237 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#2e3338 guibg=#4c5156 ctermfg=236 ctermbg=239 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#d3dbe3 guibg=#24292E ctermfg=253 ctermbg=235 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#56d364 guibg=#24292E ctermfg=77 ctermbg=235 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#79c0ff guibg=#383d42 ctermfg=111 ctermbg=237 cterm=NONE gui=bold
hi WarningMsg guifg=#B392E9 ctermfg=140 cterm=NONE
hi NeogitBranch guifg=#79c0ff ctermfg=111 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#79c0ff ctermfg=111 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#79c0ff ctermfg=111 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#56d364 guibg=#38b546 ctermfg=77 ctermbg=71 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#ff7f8d ctermfg=210 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#d2a8ff ctermfg=183 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#ffab70 ctermfg=215 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#56d4dd ctermfg=80 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#56d4dd guibg=#2e3338 ctermfg=80 ctermbg=236 cterm=NONE gui=bold
hi FlashMatch guifg=#24292E guibg=#79c0ff ctermfg=235 ctermbg=111 cterm=NONE
hi FlashCurrent guifg=#24292E guibg=#56d364 ctermfg=235 ctermbg=77 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#565b60 ctermfg=240 cterm=NONE
...
hi LspSignatureActiveParameter guifg=#24292E guibg=#56d364 ctermfg=235 ctermbg=77 cterm=NONE
hi LspInlayHint guibg=#2e3338 guifg=#6a6f74 ctermfg=242 ctermbg=236 cterm=NONE
hi SagaBorder guibg=#1F2428 ctermbg=235 cterm=NONE
hi SagaNormal guibg=#1F2428 ctermbg=235 cterm=NONE
hi MasonHeader guibg=#ff7f8d guifg=#24292E ctermfg=235 ctermbg=210 cterm=NONE
hi MasonHighlight guifg=#79c0ff ctermfg=111 cterm=NONE
hi MasonHighlightBlock guifg=#24292E guibg=#56d364 ctermfg=235 ctermbg=77 cterm=NONE
hi def link MasonHighlightBlockBold MasonHighlightBlock
hi def link MasonHeaderSecondary MasonHighlightBlock
hi MasonMuted guifg=#6a6f74 ctermfg=242 cterm=NONE
hi MasonMutedBlock guifg=#6a6f74 guibg=#33383d ctermfg=242 ctermbg=237 cterm=NONE
...
hi BufferLineBackground guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi BufferlineIndicatorVisible guifg=#2e3338 guibg=#2e3338 ctermfg=236 ctermbg=236 cterm=NONE
hi BufferLineBufferSelected guifg=#d3dbe3 guibg=#24292E ctermfg=253 ctermbg=235 cterm=NONE
hi BufferLineBufferVisible guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi BufferLineError guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi BufferLineErrorDiagnostic guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi DapUIRestartNC guifg=#56d364 ctermfg=77 cterm=NONE
hi BufferLineCloseButtonVisible guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi BufferLineCloseButtonSelected guifg=#ff7f8d guibg=#24292E ctermfg=210 ctermbg=235 cterm=NONE
hi BufferLineFill guifg=#565b60 guibg=#2e3338 ctermfg=240 ctermbg=236 cterm=NONE
hi BufferlineIndicatorSelected guifg=#24292E guibg=#24292E ctermfg=235 ctermbg=235 cterm=NONE
hi BufferLineModified guifg=#ff7f8d guibg=#2e3338 ctermfg=210 ctermbg=236 cterm=NONE
hi BufferLineModifiedVisible guifg=#ff7f8d guibg=#2e3338 ctermfg=210 ctermbg=236 cterm=NONE
hi BufferLineModifiedSelected guifg=#56d364 guibg=#24292E ctermfg=77 ctermbg=235 cterm=NONE
hi BufferLineSeparator guifg=#2e3338 guibg=#2e3338 ctermfg=236 ctermbg=236 cterm=NONE
...
hi NvimDapViewTab guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi NvimDapViewTabSelected guifg=#d3dbe3 guibg=#24292E ctermfg=253 ctermbg=235 cterm=NONE
...
hi FloatTitle guifg=#d3dbe3 guibg=#4c5156 ctermfg=253 ctermbg=239 cterm=NONE
hi NvimInternalError guifg=#ff7f8d ctermfg=210 cterm=NONE
hi WinSeparator guifg=#33383d ctermfg=237 cterm=NONE
hi Normal guifg=#c9d1d9 guibg=#24292E ctermfg=252 ctermbg=235 cterm=NONE
...
hi Error guifg=#24292E guibg=#B392E9 ctermfg=235 ctermbg=140 cterm=NONE
hi CmpItemKindTabNine guifg=#ffa198 ctermfg=216 cterm=NONE
hi CmpItemKindSuperMaven guifg=#ffdf5d ctermfg=221 cterm=NONE
hi Folded guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi IncSearch guifg=#33383d guibg=#ffab70 ctermfg=237 ctermbg=215 cterm=NONE
...
hi Substitute guifg=#33383d guibg=#ffdf5d ctermfg=237 ctermbg=221 cterm=NONE
...
hi WildMenu guifg=#B392E9 guibg=#ffdf5d ctermfg=140 ctermbg=221 cterm=NONE
hi Title guifg=#6AB1F0 ctermfg=75 cterm=NONE
hi Conceal guibg=NONE cterm=NONE
hi Cursor guifg=#24292E guibg=#c9d1d9 ctermfg=235 ctermbg=252 cterm=NONE
...
hi LazyH1 guibg=#56d364 guifg=#24292E ctermfg=235 ctermbg=77 cterm=NONE
hi LazyButton guibg=#33383d guifg=#74797e ctermfg=243 ctermbg=237 cterm=NONE
...
hi Tabline guibg=#2e3338 ctermbg=236 cterm=NONE
hi TbFill guibg=#2e3338 ctermbg=236 cterm=NONE
hi TbBufOn guifg=#d3dbe3 guibg=#24292E ctermfg=253 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#56d364 guibg=#24292E ctermfg=77 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#ff7f8d guibg=#2e3338 ctermfg=210 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#ff7f8d guibg=#24292E ctermfg=210 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#d3dbe3 guibg=#383d42 ctermfg=253 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#ff7f8d guibg=#24292E ctermfg=210 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#d3dbe3 guibg=#2e3338 ctermfg=253 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#24292E guibg=#58a6ff ctermfg=235 ctermbg=75 cterm=NONE
hi TBTabTitle guifg=#24292E guibg=#79c0ff ctermfg=235 ctermbg=111 cterm=NONE
hi TbThemeToggleBtn guifg=#d3dbe3 guibg=#42474c ctermfg=253 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#24292E guibg=#ff7f8d ctermfg=235 ctermbg=210 cterm=NONE gui=bold
hi TelescopePromptPrefix guibg=#2e3338 guifg=#ff7f8d ctermfg=210 ctermbg=236 cterm=NONE
...
hi healthSuccess guibg=#56d364 guifg=#24292E ctermfg=235 ctermbg=77 cterm=NONE
...
hi BufferLineDuplicateVisible guifg=#79c0ff guibg=#2e3338 ctermfg=111 ctermbg=236 cterm=NONE
hi BufferLineDuplicateSelected guifg=#ff7f8d guibg=#24292E ctermfg=210 ctermbg=235 cterm=NONE
hi BufferLineDuplicate guifg=NONE guibg=#2e3338 ctermbg=236 cterm=NONE
...
hi CocHintLine guibg=#274046 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#303f4d ctermbg=237 cterm=NONE
hi CocWarningLine guibg=#444435 ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#44353c ctermbg=237 cterm=NONE
...
hi BufferLineTabSelected guifg=#2e3338 guibg=#58a6ff ctermfg=236 ctermbg=75 cterm=NONE
hi BufferLineTabClose guifg=#ff7f8d guibg=#24292E ctermfg=210 ctermbg=235 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#24292E guibg=#56d4dd ctermfg=235 ctermbg=80 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#24292E guibg=#56d4dd ctermfg=235 ctermbg=80 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#24292E guibg=#bc8cff ctermfg=235 ctermbg=141 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#24292E guibg=#bc8cff ctermfg=235 ctermbg=141 cterm=NONE gui=bold
...
hi NeotestFile guifg=#56d4dd ctermfg=80 cterm=NONE
hi NeotestFocused guifg=#ffdf5d ctermfg=221 cterm=NONE
hi NeotestNamespace guifg=#85e89d ctermfg=115 cterm=NONE
hi NeotestTest guifg=#565b60 ctermfg=240 cterm=NONE
...
hi NeogitHunkHeader guifg=#24292E guibg=#4c5156 ctermfg=235 ctermbg=239 cterm=NONE gui=bold
...
hi CocDiagnosticsFile guifg=#6a6f74 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#d2a8ff ctermfg=183 cterm=NONE
hi CocServicesName guifg=#79c0ff ctermfg=111 cterm=NONE
hi CocServicesStat guifg=#56d364 ctermfg=77 cterm=NONE
hi CocServicesLanguages guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#d2a8ff ctermfg=183 cterm=NONE
hi CocSourcesName guifg=#79c0ff ctermfg=111 cterm=NONE
hi CocSourcesPriority guifg=#ffab70 ctermfg=215 cterm=NONE
hi CocSourcesFileTypes guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#56d364 ctermfg=77 cterm=NONE
hi CocListsDesc guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#56d364 ctermfg=77 cterm=NONE
hi CocExtensionsLoaded guifg=#d3dbe3 ctermfg=253 cterm=NONE
hi CocExtensionsDisabled guifg=#565b60 ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#56d364 ctermfg=77 cterm=NONE
hi CocExtensionsLocal guifg=#79c0ff ctermfg=111 cterm=NONE
hi CocExtensionsRoot guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#d3dbe3 ctermfg=253 cterm=NONE
hi CocOutlineIndentLine guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#d2a8ff ctermfg=183 cterm=NONE
hi CocOutlineLine guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#6a6f74 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#6a6f74 ctermfg=242 cterm=NONE
...
hi NeotestAdapterName guifg=#d2a8ff ctermfg=183 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#79c0ff ctermfg=111 cterm=NONE
...
hi NeotestFailed guifg=#ff7f8d ctermfg=210 cterm=NONE
hi NeotestSkipped guifg=#79c0ff ctermfg=111 cterm=NONE
...
hi TodoBgTodo guifg=#2e3338 guibg=#ffdf5d ctermfg=236 ctermbg=221 cterm=NONE gui=bold
hi NeotestMarked guifg=#79c0ff ctermfg=111 cterm=NONE
hi NeotestTarget guifg=#79c0ff ctermfg=111 cterm=NONE
...
hi NoiceFormatProgressDone guibg=#56d364 guifg=#24292E ctermfg=235 ctermbg=77 cterm=NONE
...
hi TodoBgFix guifg=#2e3338 guibg=#ff7f8d ctermfg=236 ctermbg=210 cterm=NONE gui=bold
hi TodoBgHack guifg=#2e3338 guibg=#ffab70 ctermfg=236 ctermbg=215 cterm=NONE gui=bold
hi TodoBgNote guifg=#2e3338 guibg=#d3dbe3 ctermfg=236 ctermbg=253 cterm=NONE gui=bold
hi TodoBgPerf guifg=#2e3338 guibg=#d2a8ff ctermfg=236 ctermbg=183 cterm=NONE gui=bold
hi TodoBgTest guifg=#2e3338 guibg=#d2a8ff ctermfg=236 ctermbg=183 cterm=NONE gui=bold
...
hi NeotestExpandMarker guifg=#60656a ctermfg=241 cterm=NONE
hi NeotestIndent guifg=#60656a ctermfg=241 cterm=NONE
hi NeotestBorder guifg=#79c0ff ctermfg=111 cterm=NONE
hi NeotestDir guifg=#79c0ff ctermfg=111 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#ffab70 guibg=#383d42 ctermfg=215 ctermbg=237 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#ff7f8d ctermfg=210 cterm=NONE
...
hi CocFloating guifg=#c9d1d9 guibg=#1F2428 ctermfg=252 ctermbg=235 cterm=NONE
hi CocMenuSel guibg=#58a6ff guifg=#24292E ctermfg=235 ctermbg=75 cterm=NONE
hi def link CocListSearch CocSearch
hi CocListMode guifg=#79c0ff ctermfg=111 cterm=NONE
hi CocSelectedLine guibg=#2e3338 ctermbg=236 cterm=NONE
...
hi BufferLineCloseButton guifg=#6a6f74 guibg=#2e3338 ctermfg=242 ctermbg=236 cterm=NONE
...
hi BufferLineSeparatorVisible guifg=#2e3338 guibg=#2e3338 ctermfg=236 ctermbg=236 cterm=NONE
hi BufferLineSeparatorSelected guifg=#2e3338 guibg=#2e3338 ctermfg=236 ctermbg=236 cterm=NONE
hi BufferLineTab guifg=#6a6f74 guibg=#42474c ctermfg=242 ctermbg=238 cterm=NONE
...
hi MatchWord guibg=#4c5156 guifg=#d3dbe3 ctermfg=253 ctermbg=239 cterm=NONE
