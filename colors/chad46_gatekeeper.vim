...
hi NeogitBranchHead guifg=#29adff ctermfg=39 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#29adff ctermfg=39 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#00e756 guibg=#00c938 ctermfg=41 ctermbg=41 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#ff1a67 ctermfg=197 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#a79ac0 ctermfg=139 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#ffa300 ctermfg=214 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#29adff ctermfg=39 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#fff024 ctermfg=226 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#00e756 ctermfg=41 cterm=NONE gui=italic,bold
...
hi Type guisp=NONE guifg=#be620a ctermfg=130 cterm=NONE
...
hi Identifier guisp=NONE guifg=#ffb20f ctermfg=214 cterm=NONE
hi Float guifg=#ff004d ctermfg=197 cterm=NONE
hi Delimiter guifg=#ffccaa ctermfg=223 cterm=NONE
hi Define guisp=NONE guifg=#ff4394 ctermfg=204 cterm=NONE
...
hi CocHintHighlight guisp=#0b925c guifg=#0b925c ctermfg=29 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#29adff guifg=#29adff ctermfg=39 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#fff024 guifg=#fff024 ctermfg=226 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#ff1a67 guifg=#ff1a67 ctermfg=197 cterm=NONE gui=undercurl
...
hi LazyH2 guifg=#ff1a67 ctermfg=197 cterm=NONE gui=underline,bold
...
hi Operator guisp=NONE guifg=#d8d9dd ctermfg=253 cterm=NONE
...
hi TelescopePromptPrefix guibg=#181818 guifg=#ff1a67 ctermfg=197 ctermbg=234 cterm=NONE
