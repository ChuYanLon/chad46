...
hi CocLoaderHeader guifg=#1E1C31 guibg=#91ddff ctermfg=235 ctermbg=117 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1E1C31 guibg=#aaffe4 ctermfg=235 ctermbg=158 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1E1C31 guibg=#aaffe4 ctermfg=235 ctermbg=158 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guifg=#23213a guibg=#413f70 ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#1E1C31 guibg=#aaffe4 ctermfg=235 ctermbg=158 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#1E1C31 guibg=#aaffe4 ctermfg=235 ctermbg=158 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#1E1C31 guibg=#413f70 ctermfg=235 ctermbg=239 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#1E1C31 guibg=#a87ffc ctermfg=235 ctermbg=141 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#1E1C31 guibg=#a87ffc ctermfg=235 ctermbg=141 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#91ddff guibg=#2d2b4c ctermfg=117 ctermbg=237 cterm=NONE gui=bold
hi WarningMsg guifg=#a1efd3 ctermfg=158 cterm=NONE
hi NeogitBranch guifg=#91ddff ctermfg=117 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#91ddff ctermfg=117 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#91ddff ctermfg=117 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#a1efd3 guibg=#83d1b5 ctermfg=158 ctermbg=115 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#f48fb1 ctermfg=211 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#d4bfff ctermfg=183 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#ffb378 ctermfg=216 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#aaffe4 ctermfg=158 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#ffb378 ctermfg=216 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#a1efd3 ctermfg=158 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#aaffe4 guibg=#23213a ctermfg=158 ctermbg=235 cterm=NONE gui=bold
hi FlashMatch guifg=#1E1C31 guibg=#91ddff ctermfg=235 ctermbg=117 cterm=NONE
hi NeotestRunning guifg=#ffb378 ctermfg=216 cterm=NONE
hi NeotestFailed guifg=#f48fb1 ctermfg=211 cterm=NONE
hi NeotestSkipped guifg=#91ddff ctermfg=117 cterm=NONE
hi NeotestTest guifg=#4b4982 ctermfg=60 cterm=NONE
hi NeotestNamespace guifg=#62d196 ctermfg=78 cterm=NONE
hi NeotestFocused guifg=#ffb378 ctermfg=216 cterm=NONE
hi NeotestFile guifg=#aaffe4 ctermfg=158 cterm=NONE
hi NeotestDir guifg=#91ddff ctermfg=117 cterm=NONE
hi NeotestBorder guifg=#91ddff ctermfg=117 cterm=NONE
hi NeotestIndent guifg=#504e8b ctermfg=60 cterm=NONE
hi NeotestExpandMarker guifg=#504e8b ctermfg=60 cterm=NONE
hi NeotestAdapterName guifg=#d4bfff ctermfg=183 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#91ddff ctermfg=117 cterm=NONE
hi NeotestMarked guifg=#91ddff ctermfg=117 cterm=NONE
hi NeotestTarget guifg=#91ddff ctermfg=117 cterm=NONE
...
hi FoldColumn guifg=#ffb378 guibg=NONE ctermfg=216 cterm=NONE
...
hi CocSelectedText guifg=#f48fb1 ctermfg=211 cterm=NONE
...
hi CocFloating guifg=#cbe3e7 guibg=#181627 ctermfg=253 ctermbg=234 cterm=NONE
...
hi CocSelectedLine guibg=#23213a ctermbg=235 cterm=NONE
...
hi TbTabNewBtn guifg=#cbe3e7 guibg=#2d2b4c ctermfg=253 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#f48fb1 guibg=#1E1C31 ctermfg=211 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#cbe3e7 guibg=#23213a ctermfg=253 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#1E1C31 guibg=#78A8ff ctermfg=235 ctermbg=111 cterm=NONE
hi TBTabTitle guifg=#1E1C31 guibg=#91ddff ctermfg=235 ctermbg=117 cterm=NONE
hi TbThemeToggleBtn guifg=#cbe3e7 guibg=#37355e ctermfg=253 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1E1C31 guibg=#f48fb1 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
...
hi TodoBgFix guifg=#23213a guibg=#f48fb1 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
hi TodoBgHack guifg=#23213a guibg=#ffb378 ctermfg=235 ctermbg=216 cterm=NONE gui=bold
hi TodoBgNote guifg=#23213a guibg=#cbe3e7 ctermfg=235 ctermbg=253 cterm=NONE gui=bold
hi TodoBgPerf guifg=#23213a guibg=#d4bfff ctermfg=235 ctermbg=183 cterm=NONE gui=bold
hi TodoBgTest guifg=#23213a guibg=#d4bfff ctermfg=235 ctermbg=183 cterm=NONE gui=bold
hi TodoBgTodo guifg=#23213a guibg=#ffb378 ctermfg=235 ctermbg=216 cterm=NONE gui=bold
...
hi CocHintLine guibg=#333e4b ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#2f384f ctermbg=237 cterm=NONE
...
hi CocDiagnosticsFile guifg=#555394 ctermfg=60 cterm=NONE
...
hi CocServicesPrefix guifg=#d4bfff ctermfg=183 cterm=NONE
hi CocServicesName guifg=#91ddff ctermfg=117 cterm=NONE
hi CocServicesStat guifg=#a1efd3 ctermfg=158 cterm=NONE
hi CocServicesLanguages guifg=#555394 ctermfg=60 cterm=NONE
hi CocSourcesPrefix guifg=#d4bfff ctermfg=183 cterm=NONE
hi CocSourcesName guifg=#91ddff ctermfg=117 cterm=NONE
hi CocSourcesPriority guifg=#d4bfff ctermfg=183 cterm=NONE
hi CocSourcesFileTypes guifg=#555394 ctermfg=60 cterm=NONE
hi CocSourcesType guifg=#a1efd3 ctermfg=158 cterm=NONE
hi CocListsDesc guifg=#555394 ctermfg=60 cterm=NONE
hi CocExtensionsActivated guifg=#a1efd3 ctermfg=158 cterm=NONE
hi CocExtensionsLoaded guifg=#cbe3e7 ctermfg=253 cterm=NONE
hi CocExtensionsDisabled guifg=#4b4982 ctermfg=60 cterm=NONE
hi CocExtensionsName guifg=#a1efd3 ctermfg=158 cterm=NONE
hi CocExtensionsLocal guifg=#91ddff ctermfg=117 cterm=NONE
hi CocExtensionsRoot guifg=#555394 ctermfg=60 cterm=NONE
hi CocOutlineName guifg=#cbe3e7 ctermfg=253 cterm=NONE
hi CocOutlineIndentLine guifg=#555394 ctermfg=60 cterm=NONE
hi CocOutlineKind guifg=#d4bfff ctermfg=183 cterm=NONE
hi CocOutlineLine guifg=#555394 ctermfg=60 cterm=NONE
hi CocNotificationTime guifg=#555394 ctermfg=60 cterm=NONE
hi CocCommandsTitle guifg=#555394 ctermfg=60 cterm=NONE
...
hi CocWarningLine guibg=#3f323b ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#3e2d44 ctermbg=237 cterm=NONE
...
hi NeotestPassed guifg=#a1efd3 ctermfg=158 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#4b4982 ctermfg=60 cterm=NONE
...
hi MiniTablineCurrent guifg=#cbe3e7 guibg=#1E1C31 ctermfg=253 ctermbg=235 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#a1efd3 guibg=#1E1C31 ctermfg=158 ctermbg=235 cterm=NONE gui=underline
...
hi Tabline guibg=#23213a ctermbg=235 cterm=NONE
hi TbFill guibg=#23213a ctermbg=235 cterm=NONE
hi TbBufOn guifg=#cbe3e7 guibg=#1E1C31 ctermfg=253 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#555394 guibg=#23213a ctermfg=60 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#a1efd3 guibg=#1E1C31 ctermfg=158 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#f48fb1 guibg=#23213a ctermfg=211 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#f48fb1 guibg=#1E1C31 ctermfg=211 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#555394 guibg=#23213a ctermfg=60 ctermbg=235 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#ffb378 guibg=#2d2b4c ctermfg=216 ctermbg=237 cterm=NONE gui=bold
