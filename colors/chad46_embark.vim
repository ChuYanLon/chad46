...
hi TbThemeToggleBtn guibg=#37355e guifg=#cbe3e7 ctermfg=253 ctermbg=238 cterm=NONE gui=bold
...
hi TbCloseAllBufsBtn guibg=#f48fb1 guifg=#1E1C31 ctermfg=235 ctermbg=211 cterm=NONE gui=bold
