...
hi MatchParen guibg=#545c6b guifg=#5eead4 ctermfg=80 ctermbg=59 cterm=NONE gui=underline,bold
...
hi NeogitChangeAdded guibg=#40ccb6 guifg=#5eead4 ctermfg=80 ctermbg=79 cterm=NONE gui=italic,bold
...
hi Search guifg=#0f172a guibg=#38bdf8 ctermfg=234 ctermbg=75 cterm=NONE
...
hi Type guifg=#99f6e4 guisp=NONE ctermfg=122 cterm=NONE
...
hi Identifier guifg=#e2e8f0 guisp=NONE ctermfg=254 cterm=NONE
...
hi TelescopePromptPrefix guifg=#ef5350 guibg=#2d323c ctermfg=203 ctermbg=236 cterm=NONE
...
hi Define guifg=#B388FF guisp=NONE ctermfg=141 cterm=NONE
hi Variable guifg=#e2e8f0 ctermfg=254 cterm=NONE
hi Operator guifg=#94a3b8 guisp=NONE ctermfg=109 cterm=NONE
...
hi IncSearch guifg=#0f172a guibg=#fbbf24 ctermfg=234 ctermbg=214 cterm=NONE
