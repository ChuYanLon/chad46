...
hi Identifier guisp=NONE guifg=#b8aad9 ctermfg=146 cterm=NONE
hi Float guifg=#cd9672 ctermfg=173 cterm=NONE
hi Delimiter guifg=#90a0a0 ctermfg=247 cterm=NONE
hi Define guisp=NONE guifg=#8e9cb4 ctermfg=109 cterm=NONE
...
hi CocHintHighlight guisp=#7aacaa guifg=#7aacaa ctermfg=109 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#5a6986 guifg=#5a6986 ctermfg=60 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#ccb89c guifg=#ccb89c ctermfg=181 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#a67476 guifg=#a67476 ctermfg=138 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#b8af9e ctermfg=145 cterm=NONE
...
hi NeogitChangeAdded guifg=#8aa387 guibg=#6c8569 ctermfg=108 ctermbg=65 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#ccb89c ctermfg=181 cterm=NONE
