...
hi TbThemeToggleBtn guibg=#33343a guifg=#e0d6bd ctermfg=187 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#a67476 guifg=#18191f ctermfg=234 ctermbg=138 cterm=NONE gui=bold
