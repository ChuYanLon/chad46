...
hi NeogitChangeModified guifg=#a1b1e3 ctermfg=146 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#50fa7b guibg=#32dc5d ctermfg=84 ctermbg=77 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#ff7070 ctermfg=203 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#BD93F9 ctermfg=141 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#FFB86C ctermfg=215 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#8BE9FD ctermfg=117 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#F1FA8C ctermfg=228 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#50fa7b ctermfg=84 cterm=NONE gui=italic,bold
...
hi SnacksPickerMatch guifg=#a1b1e3 guibg=#373844 ctermfg=146 ctermbg=237 cterm=NONE
hi SnacksPickerFooter guifg=#666771 ctermfg=242 cterm=NONE
hi SnacksPickerListTitle guibg=#ff7070 guifg=#666771 ctermfg=242 ctermbg=203 cterm=NONE
hi SnacksPickerPreviewTitle guibg=#a1b1e3 guifg=#666771 ctermfg=242 ctermbg=146 cterm=NONE
hi SnacksPickerTitle guibg=#50fa7b guifg=#666771 ctermfg=242 ctermbg=84 cterm=NONE
