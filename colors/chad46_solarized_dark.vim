...
hi NeotestFailed guifg=#dc322f ctermfg=166 cterm=NONE
hi NeotestSkipped guifg=#268bd2 ctermfg=32 cterm=NONE
hi NeotestTest guifg=#325d68 ctermfg=239 cterm=NONE
...
hi NeotestIndent guifg=#3c6772 ctermfg=59 cterm=NONE
hi NeotestExpandMarker guifg=#3c6772 ctermfg=59 cterm=NONE
...
hi CocLoaderHeader guifg=#002b36 guibg=#268bd2 ctermfg=234 ctermbg=32 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#002b36 guibg=#519ABA ctermfg=234 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#002b36 guibg=#519ABA ctermfg=234 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#28535e guifg=#002b36 ctermfg=234 ctermbg=238 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#268bd2 guifg=#002b36 ctermfg=234 ctermbg=32 cterm=NONE
hi CocLoaderMutedBlock guibg=#28535e guifg=#002b36 ctermfg=234 ctermbg=238 cterm=NONE
...
hi TbTabNewBtn guifg=#abb2bf guibg=#133e49 ctermfg=249 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#dc322f guibg=#002b36 ctermfg=166 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#abb2bf guibg=#06313c ctermfg=249 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#002b36 guibg=#197ec5 ctermfg=234 ctermbg=32 cterm=NONE
hi TBTabTitle guifg=#002b36 guibg=#268bd2 ctermfg=234 ctermbg=32 cterm=NONE
hi TbThemeToggleBtn guifg=#abb2bf guibg=#1b4651 ctermfg=249 ctermbg=23 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#002b36 guibg=#dc322f ctermfg=234 ctermbg=166 cterm=NONE gui=bold
...
hi CocSelectedLine guibg=#06313c ctermbg=235 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#325d68 ctermfg=239 cterm=NONE
...
hi CocDiagnosticsFile guifg=#446f7a ctermfg=60 cterm=NONE
...
hi CocServicesLanguages guifg=#446f7a ctermfg=60 cterm=NONE
...
hi CocSourcesFileTypes guifg=#446f7a ctermfg=60 cterm=NONE
hi CocSourcesType guifg=#859900 ctermfg=100 cterm=NONE
hi CocListsDesc guifg=#446f7a ctermfg=60 cterm=NONE
hi CocExtensionsActivated guifg=#859900 ctermfg=100 cterm=NONE
hi CocExtensionsLoaded guifg=#abb2bf ctermfg=249 cterm=NONE
hi CocExtensionsDisabled guifg=#325d68 ctermfg=239 cterm=NONE
hi CocExtensionsName guifg=#859900 ctermfg=100 cterm=NONE
hi CocExtensionsLocal guifg=#268bd2 ctermfg=32 cterm=NONE
hi CocExtensionsRoot guifg=#446f7a ctermfg=60 cterm=NONE
hi CocOutlineName guifg=#abb2bf ctermfg=249 cterm=NONE
hi CocOutlineIndentLine guifg=#446f7a ctermfg=60 cterm=NONE
hi CocOutlineKind guifg=#6c71c4 ctermfg=62 cterm=NONE
hi CocOutlineLine guifg=#446f7a ctermfg=60 cterm=NONE
hi CocNotificationTime guifg=#446f7a ctermfg=60 cterm=NONE
hi CocCommandsTitle guifg=#446f7a ctermfg=60 cterm=NONE
...
hi CocMenuSel guibg=#268bd2 guifg=#002b36 ctermfg=234 ctermbg=32 cterm=NONE
hi CocFloating guifg=#93a1a1 guibg=#002530 ctermfg=247 ctermbg=234 cterm=NONE
...
hi CocInlayHint guifg=#446f7a guibg=#06313c ctermfg=60 ctermbg=235 cterm=NONE
hi DiagnosticError guifg=#dc322f ctermfg=166 cterm=NONE
hi CocHintFloat guifg=#519ABA guibg=#002530 ctermfg=67 ctermbg=234 cterm=NONE
hi CocInfoFloat guifg=#268bd2 guibg=#002530 ctermfg=32 ctermbg=234 cterm=NONE
hi CocWarningFloat guifg=#b58900 guibg=#002530 ctermfg=136 ctermbg=234 cterm=NONE
hi CocErrorFloat guifg=#dc322f guibg=#002530 ctermfg=166 ctermbg=234 cterm=NONE
hi CocHintLine guibg=#0c3b49 ctermbg=23 cterm=NONE
hi CocInfoLine guibg=#05394d ctermbg=23 cterm=NONE
hi CocWarningLine guibg=#1b392d ctermbg=235 cterm=NONE
hi CocErrorLine guibg=#212c34 ctermbg=235 cterm=NONE
...
hi NeotestAdapterName guifg=#6c71c4 ctermfg=62 cterm=NONE gui=bold
...
hi TbBufOffClose guifg=#446f7a guibg=#06313c ctermfg=60 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#dc322f guibg=#002b36 ctermfg=166 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#dc322f guibg=#06313c ctermfg=166 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#859900 guibg=#002b36 ctermfg=100 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#446f7a guibg=#06313c ctermfg=60 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#abb2bf guibg=#002b36 ctermfg=249 ctermbg=234 cterm=NONE
hi TbFill guibg=#06313c ctermbg=235 cterm=NONE
hi Tabline guibg=#06313c ctermbg=235 cterm=NONE
