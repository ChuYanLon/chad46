...
hi TbThemeToggleBtn guibg=#DEC7B3 guifg=#575279 ctermfg=60 ctermbg=187 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#b4637a guifg=#faf4ed ctermfg=255 ctermbg=132 cterm=NONE gui=bold
