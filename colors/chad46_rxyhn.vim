...
hi BlinkCmpMenuSelection guifg=#061115 guibg=#78B892 ctermfg=233 ctermbg=108 cterm=NONE gui=bold
hi CmpSel guifg=#061115 guibg=#78B892 ctermfg=233 ctermbg=108 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#061115 guibg=#6791C9 ctermfg=233 ctermbg=68 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#061115 guibg=#7ACFE4 ctermfg=233 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#061115 guibg=#7ACFE4 ctermfg=233 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#313c40 guifg=#061115 ctermfg=233 ctermbg=237 cterm=NONE
...
hi CocLoaderHighlightBlock guibg=#6791C9 guifg=#061115 ctermfg=233 ctermbg=68 cterm=NONE
hi CocLoaderMutedBlock guibg=#313c40 guifg=#061115 ctermfg=233 ctermbg=237 cterm=NONE
...
hi MiniTablineCurrent guifg=#D9D7D6 guibg=#061115 ctermfg=188 ctermbg=233 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#78B892 guibg=#061115 ctermfg=108 ctermbg=233 cterm=NONE gui=underline
...
hi NeogitHunkMergeHeader guifg=#0d181c guibg=#313c40 ctermfg=233 ctermbg=237 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#061115 guibg=#67AFC1 ctermfg=233 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#061115 guibg=#67AFC1 ctermfg=233 ctermbg=73 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#061115 guibg=#313c40 ctermfg=233 ctermbg=237 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#061115 guibg=#BC83E3 ctermfg=233 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#061115 guibg=#BC83E3 ctermfg=233 ctermbg=140 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#6791C9 guibg=#1c272b ctermfg=68 ctermbg=235 cterm=NONE gui=bold
...
hi NeogitChangeRenamed guifg=#C488EC ctermfg=177 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#67AFC1 guibg=#0d181c ctermfg=73 ctermbg=233 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#3b464a ctermfg=238 cterm=NONE
...
hi CocHintHighlight guifg=#7ACFE4 guisp=#7ACFE4 ctermfg=116 cterm=NONE gui=undercurl
...
hi CocErrorLine guibg=#261c20 ctermbg=234 cterm=NONE
hi CocWarningLine guibg=#282d26 ctermbg=235 cterm=NONE
hi LazyDir guifg=#D9D7D6 ctermfg=188 cterm=NONE
hi LazyUrl guifg=#D9D7D6 ctermfg=188 cterm=NONE
hi CocErrorFloat guifg=#DF5B61 guibg=#000a0e ctermfg=167 ctermbg=232 cterm=NONE
hi CocWarningFloat guifg=#ecd28b guibg=#000a0e ctermfg=222 ctermbg=232 cterm=NONE
hi CocInfoFloat guifg=#6791C9 guibg=#000a0e ctermfg=68 ctermbg=232 cterm=NONE
hi CocHintFloat guifg=#7ACFE4 guibg=#000a0e ctermfg=116 ctermbg=232 cterm=NONE
hi CocInlayHint guifg=#4f5a5e guibg=#0d181c ctermfg=240 ctermbg=233 cterm=NONE
...
hi CocFloating guifg=#D9D7D6 guibg=#000a0e ctermfg=188 ctermbg=232 cterm=NONE
...
hi CocSelectedLine guibg=#0d181c ctermbg=233 cterm=NONE
...
hi FoldColumn guifg=#F16269 guibg=NONE ctermfg=203 cterm=NONE
...
hi CocDiagnosticsFile guifg=#4f5a5e ctermfg=240 cterm=NONE
...
hi CocServicesPrefix guifg=#C488EC ctermfg=177 cterm=NONE
hi CocServicesName guifg=#6791C9 ctermfg=68 cterm=NONE
hi CocServicesStat guifg=#78B892 ctermfg=108 cterm=NONE
hi CocServicesLanguages guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocSourcesPrefix guifg=#C488EC ctermfg=177 cterm=NONE
hi CocSourcesName guifg=#6791C9 ctermfg=68 cterm=NONE
hi CocSourcesPriority guifg=#ecd28b ctermfg=222 cterm=NONE
hi CocSourcesFileTypes guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocSourcesType guifg=#78B892 ctermfg=108 cterm=NONE
hi CocListsDesc guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocExtensionsActivated guifg=#78B892 ctermfg=108 cterm=NONE
hi CocExtensionsLoaded guifg=#D9D7D6 ctermfg=188 cterm=NONE
hi CocExtensionsDisabled guifg=#3b464a ctermfg=238 cterm=NONE
hi CocExtensionsName guifg=#78B892 ctermfg=108 cterm=NONE
hi CocExtensionsLocal guifg=#6791C9 ctermfg=68 cterm=NONE
hi CocExtensionsRoot guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocOutlineName guifg=#D9D7D6 ctermfg=188 cterm=NONE
hi CocOutlineIndentLine guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocOutlineKind guifg=#C488EC ctermfg=177 cterm=NONE
hi CocOutlineLine guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocNotificationTime guifg=#4f5a5e ctermfg=240 cterm=NONE
hi CocCommandsTitle guifg=#4f5a5e ctermfg=240 cterm=NONE
...
hi NeotestTest guifg=#3b464a ctermfg=238 cterm=NONE
hi NeotestNamespace guifg=#8CD7AA ctermfg=115 cterm=NONE
...
hi NeotestIndent guifg=#455054 ctermfg=239 cterm=NONE
hi NeotestExpandMarker guifg=#455054 ctermfg=239 cterm=NONE
...
hi NeotestAdapterName guifg=#C488EC ctermfg=177 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#E89982 guibg=#1c272b ctermfg=174 ctermbg=235 cterm=NONE gui=bold
...
hi CocInfoLine guibg=#142430 ctermbg=235 cterm=NONE
hi Tabline guibg=#0d181c ctermbg=233 cterm=NONE
hi TbFill guibg=#0d181c ctermbg=233 cterm=NONE
hi TbBufOn guifg=#D9D7D6 guibg=#061115 ctermfg=188 ctermbg=233 cterm=NONE
hi TbBufOff guifg=#4f5a5e guibg=#0d181c ctermfg=240 ctermbg=233 cterm=NONE
hi TbBufOnModified guifg=#78B892 guibg=#061115 ctermfg=108 ctermbg=233 cterm=NONE
hi TbBufOffModified guifg=#DF5B61 guibg=#0d181c ctermfg=167 ctermbg=233 cterm=NONE
hi TbBufOnClose guifg=#DF5B61 guibg=#061115 ctermfg=167 ctermbg=233 cterm=NONE
hi TbBufOffClose guifg=#4f5a5e guibg=#0d181c ctermfg=240 ctermbg=233 cterm=NONE
hi TbTabNewBtn guifg=#D9D7D6 guibg=#1c272b ctermfg=188 ctermbg=235 cterm=NONE
hi TbTabOn guifg=#DF5B61 guibg=#061115 ctermfg=167 ctermbg=233 cterm=NONE
hi TbTabOff guifg=#D9D7D6 guibg=#0d181c ctermfg=188 ctermbg=233 cterm=NONE
hi TbTabCloseBtn guifg=#061115 guibg=#5A84BC ctermfg=233 ctermbg=67 cterm=NONE
hi TBTabTitle guifg=#061115 guibg=#6791C9 ctermfg=233 ctermbg=68 cterm=NONE
hi TbThemeToggleBtn guifg=#D9D7D6 guibg=#242f33 ctermfg=188 ctermbg=236 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#061115 guibg=#DF5B61 ctermfg=233 ctermbg=167 cterm=NONE gui=bold
...
hi CocHintLine guibg=#172d34 ctermbg=235 cterm=NONE
...
hi TodoBgFix guifg=#0d181c guibg=#DF5B61 ctermfg=233 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#0d181c guibg=#E89982 ctermfg=233 ctermbg=174 cterm=NONE gui=bold
hi TodoBgNote guifg=#0d181c guibg=#D9D7D6 ctermfg=233 ctermbg=188 cterm=NONE gui=bold
hi TodoBgPerf guifg=#0d181c guibg=#C488EC ctermfg=233 ctermbg=177 cterm=NONE gui=bold
hi TodoBgTest guifg=#0d181c guibg=#C488EC ctermfg=233 ctermbg=177 cterm=NONE gui=bold
hi TodoBgTodo guifg=#0d181c guibg=#ecd28b ctermfg=233 ctermbg=222 cterm=NONE gui=bold
