...
hi BlinkCmpMenuSelection guifg=#FFFfff guibg=#673AB7 ctermfg=231 ctermbg=61 cterm=NONE gui=bold
hi CmpSel guifg=#FFFfff guibg=#673AB7 ctermfg=231 ctermbg=61 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#FFFfff guibg=#42A5F5 ctermfg=231 ctermbg=75 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#FFFfff guibg=#008080 ctermfg=231 ctermbg=30 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#FFFfff guibg=#008080 ctermfg=231 ctermbg=30 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#c4c4c4 guifg=#FFFfff ctermfg=231 ctermbg=251 cterm=NONE
...
hi ErrorMsg guifg=#673AB7 guibg=#FFFfff ctermfg=61 ctermbg=231 cterm=NONE
hi def link CocLoaderNormal NormalFloat
hi NormalFloat guibg=#f7f7f7 ctermbg=231 cterm=NONE
hi def link CocLoaderSearchMatch Search
hi Search guifg=#ECEFF1 guibg=#673AB7 ctermfg=255 ctermbg=61 cterm=NONE
hi CocLoaderWarning guifg=#d0b22b ctermfg=178 cterm=NONE
hi CocLoaderBackdrop guibg=#FFFfff ctermbg=231 cterm=NONE
hi CocLoaderHighlightBlock guibg=#42A5F5 guifg=#FFFfff ctermfg=231 ctermbg=75 cterm=NONE
hi CocLoaderMutedBlock guibg=#c4c4c4 guifg=#FFFfff ctermfg=231 ctermbg=251 cterm=NONE
...
hi PmenuSel guibg=#673AB7 guifg=#FFFfff ctermfg=231 ctermbg=61 cterm=NONE
...
hi Define guifg=#37474F guisp=NONE ctermfg=238 cterm=NONE
...
hi Todo guifg=#673AB7 guibg=#ECEFF1 ctermfg=61 ctermbg=255 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#ECEFF1 guibg=#c4c4c4 ctermfg=255 ctermbg=251 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#37474F guibg=#FFFfff ctermfg=238 ctermbg=231 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#66BB6A guibg=#FFFfff ctermfg=71 ctermbg=231 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#42A5F5 guibg=#e0e0e0 ctermfg=75 ctermbg=254 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#42A5F5 ctermfg=75 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#66BB6A guibg=#489d4c ctermfg=71 ctermbg=71 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#EF5350 ctermfg=203 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#673AB7 ctermfg=61 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#FF6F00 ctermfg=202 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#26C6DA ctermfg=44 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#d0b22b ctermfg=178 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#66BB6A ctermfg=71 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#26C6DA guibg=#ECEFF1 ctermfg=44 ctermbg=255 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#b5b5b5 ctermfg=249 cterm=NONE
...
hi LspSignatureActiveParameter guifg=#FFFfff guibg=#66BB6A ctermfg=231 ctermbg=71 cterm=NONE
...
hi MasonHighlightBlock guifg=#FFFfff guibg=#66BB6A ctermfg=231 ctermbg=71 cterm=NONE
hi def link MasonHighlightBlockBold MasonHighlightBlock
hi def link MasonHeaderSecondary MasonHighlightBlock
hi MasonMuted guifg=#848484 ctermfg=102 cterm=NONE
hi MasonMutedBlock guifg=#848484 guibg=#ebebeb ctermfg=102 ctermbg=255 cterm=NONE
...
hi BufferLineBackground guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi BufferlineIndicatorVisible guifg=#ECEFF1 guibg=#ECEFF1 ctermfg=255 ctermbg=255 cterm=NONE
hi BufferLineBufferSelected guifg=#37474F guibg=#FFFfff ctermfg=238 ctermbg=231 cterm=NONE
hi BufferLineBufferVisible guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi BufferLineError guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi BufferLineErrorDiagnostic guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi DapUIRestartNC guifg=#66BB6A ctermfg=71 cterm=NONE
hi BufferLineCloseButtonVisible guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi BufferLineCloseButtonSelected guifg=#EF5350 guibg=#FFFfff ctermfg=203 ctermbg=231 cterm=NONE
hi BufferLineFill guifg=#b5b5b5 guibg=#ECEFF1 ctermfg=249 ctermbg=255 cterm=NONE
hi BufferlineIndicatorSelected guifg=#FFFfff guibg=#FFFfff ctermfg=231 ctermbg=231 cterm=NONE
hi BufferLineModified guifg=#EF5350 guibg=#ECEFF1 ctermfg=203 ctermbg=255 cterm=NONE
hi BufferLineModifiedVisible guifg=#EF5350 guibg=#ECEFF1 ctermfg=203 ctermbg=255 cterm=NONE
hi BufferLineModifiedSelected guifg=#66BB6A guibg=#FFFfff ctermfg=71 ctermbg=231 cterm=NONE
hi BufferLineSeparator guifg=#ECEFF1 guibg=#ECEFF1 ctermfg=255 ctermbg=255 cterm=NONE
...
hi FloatTitle guifg=#37474F guibg=#c4c4c4 ctermfg=238 ctermbg=251 cterm=NONE
hi NvimInternalError guifg=#EF5350 ctermfg=203 cterm=NONE
hi WinSeparator guifg=#e0e0e0 ctermfg=254 cterm=NONE
hi Normal guifg=#37474F guibg=#FFFfff ctermfg=238 ctermbg=231 cterm=NONE
...
hi Error guifg=#FFFfff guibg=#673AB7 ctermfg=231 ctermbg=61 cterm=NONE
hi CmpItemKindTabNine guifg=#b55dc4 ctermfg=134 cterm=NONE
hi CmpItemKindSuperMaven guifg=#d0b22b ctermfg=178 cterm=NONE
hi Folded guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi IncSearch guifg=#ECEFF1 guibg=#8497a0 ctermfg=255 ctermbg=246 cterm=NONE
...
hi Substitute guifg=#ECEFF1 guibg=#673AB7 ctermfg=255 ctermbg=61 cterm=NONE
...
hi WildMenu guifg=#673AB7 guibg=#673AB7 ctermfg=61 ctermbg=61 cterm=NONE
hi Title guifg=#263238 ctermfg=236 cterm=NONE
hi Conceal guibg=NONE cterm=NONE
hi Cursor guifg=#FFFfff guibg=#37474F ctermfg=231 ctermbg=238 cterm=NONE
...
hi LazyH1 guibg=#66BB6A guifg=#FFFfff ctermfg=231 ctermbg=71 cterm=NONE
hi LazyButton guibg=#ebebeb guifg=#707070 ctermfg=242 ctermbg=255 cterm=NONE
...
hi DevIconJson guifg=#E2C12F ctermfg=178 cterm=NONE
...
hi SnacksPickerFile guifg=#37474F ctermfg=238 cterm=NONE
...
hi Tabline guibg=#ECEFF1 ctermbg=255 cterm=NONE
hi TbFill guibg=#ECEFF1 ctermbg=255 cterm=NONE
hi TbBufOn guifg=#37474F guibg=#FFFfff ctermfg=238 ctermbg=231 cterm=NONE
hi TbBufOff guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi TbBufOnModified guifg=#66BB6A guibg=#FFFfff ctermfg=71 ctermbg=231 cterm=NONE
hi TbBufOffModified guifg=#EF5350 guibg=#ECEFF1 ctermfg=203 ctermbg=255 cterm=NONE
hi TbBufOnClose guifg=#EF5350 guibg=#FFFfff ctermfg=203 ctermbg=231 cterm=NONE
hi TbBufOffClose guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
hi TbTabNewBtn guifg=#37474F guibg=#e0e0e0 ctermfg=238 ctermbg=254 cterm=NONE
hi TbTabOn guifg=#EF5350 guibg=#FFFfff ctermfg=203 ctermbg=231 cterm=NONE
hi TbTabOff guifg=#37474F guibg=#ECEFF1 ctermfg=238 ctermbg=255 cterm=NONE
hi TbTabCloseBtn guifg=#FFFfff guibg=#42A5F5 ctermfg=231 ctermbg=75 cterm=NONE
hi TBTabTitle guifg=#FFFfff guibg=#42A5F5 ctermfg=231 ctermbg=75 cterm=NONE
hi TbThemeToggleBtn guifg=#37474F guibg=#d4d4d4 ctermfg=238 ctermbg=188 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#FFFfff guibg=#EF5350 ctermfg=231 ctermbg=203 cterm=NONE gui=bold
...
hi FoldColumn guifg=#8497a0 guibg=NONE ctermfg=246 cterm=NONE
hi CursorLine guibg=#ECEFF1 ctermbg=255 cterm=NONE
hi QuickFixLine guibg=#ECEFF1 ctermbg=255 cterm=NONE
hi healthSuccess guibg=#66BB6A guifg=#FFFfff ctermfg=231 ctermbg=71 cterm=NONE
...
hi Identifier guifg=#673AB7 guisp=NONE ctermfg=61 cterm=NONE
...
hi Operator guifg=#37474F guisp=NONE ctermfg=238 cterm=NONE
...
hi BufferLineDuplicateVisible guifg=#42A5F5 guibg=#ECEFF1 ctermfg=75 ctermbg=255 cterm=NONE
hi BufferLineDuplicateSelected guifg=#EF5350 guibg=#FFFfff ctermfg=203 ctermbg=231 cterm=NONE
hi BufferLineDuplicate guifg=NONE guibg=#ECEFF1 ctermbg=255 cterm=NONE
...
hi Type guifg=#673AB7 guisp=NONE ctermfg=61 cterm=NONE
...
hi CocHintLine guibg=#d8ebeb ctermbg=254 cterm=NONE
hi CocInfoLine guibg=#e2f1fd ctermbg=195 cterm=NONE
hi CocWarningLine guibg=#f7f3df ctermbg=230 cterm=NONE
hi CocErrorLine guibg=#fce5e4 ctermbg=224 cterm=NONE
hi CocHintSign guifg=#008080 ctermfg=30 cterm=NONE
hi CocErrorFloat guifg=#EF5350 guibg=#f7f7f7 ctermfg=203 ctermbg=231 cterm=NONE
...
hi BufferLineTabSelected guifg=#ECEFF1 guibg=#42A5F5 ctermfg=255 ctermbg=75 cterm=NONE
hi BufferLineTabClose guifg=#EF5350 guibg=#FFFfff ctermfg=203 ctermbg=231 cterm=NONE
hi BufferLineDevIconDefaultSelected guibg=NONE cterm=NONE
hi BufferLineDevIconDefaultInactive guibg=NONE cterm=NONE
hi CmpItemKindEnum guifg=#42A5F5 ctermfg=75 cterm=NONE
hi CocInfoHighlight guifg=#42A5F5 guisp=#42A5F5 ctermfg=75 cterm=NONE gui=undercurl
...
hi CocHintFloat guifg=#008080 guibg=#f7f7f7 ctermfg=30 ctermbg=231 cterm=NONE
hi CocInfoFloat guifg=#42A5F5 guibg=#f7f7f7 ctermfg=75 ctermbg=231 cterm=NONE
hi CocWarningFloat guifg=#d0b22b guibg=#f7f7f7 ctermfg=178 ctermbg=231 cterm=NONE
...
hi CocWarningHighlight guifg=#d0b22b guisp=#d0b22b ctermfg=178 cterm=NONE gui=undercurl
...
hi CocInlayHint guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#FFFfff guibg=#26C6DA ctermfg=231 ctermbg=44 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#FFFfff guibg=#26C6DA ctermfg=231 ctermbg=44 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#FFFfff guibg=#673AB7 ctermfg=231 ctermbg=61 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#FFFfff guibg=#673AB7 ctermfg=231 ctermbg=61 cterm=NONE gui=bold
...
hi NeotestFile guifg=#26C6DA ctermfg=44 cterm=NONE
hi NeotestFocused guifg=#d0b22b ctermfg=178 cterm=NONE
hi NeotestNamespace guifg=#75c279 ctermfg=108 cterm=NONE
hi NeotestTest guifg=#b5b5b5 ctermfg=249 cterm=NONE
...
hi NeogitHunkHeader guifg=#FFFfff guibg=#c4c4c4 ctermfg=231 ctermbg=251 cterm=NONE gui=bold
...
hi CocDiagnosticsFile guifg=#848484 ctermfg=102 cterm=NONE
...
hi CocServicesPrefix guifg=#673AB7 ctermfg=61 cterm=NONE
hi CocServicesName guifg=#42A5F5 ctermfg=75 cterm=NONE
hi CocServicesStat guifg=#66BB6A ctermfg=71 cterm=NONE
hi CocServicesLanguages guifg=#848484 ctermfg=102 cterm=NONE
hi CocSourcesPrefix guifg=#673AB7 ctermfg=61 cterm=NONE
hi CocSourcesName guifg=#42A5F5 ctermfg=75 cterm=NONE
hi CocSourcesPriority guifg=#8497a0 ctermfg=246 cterm=NONE
hi CocSourcesFileTypes guifg=#848484 ctermfg=102 cterm=NONE
hi CocSourcesType guifg=#66BB6A ctermfg=71 cterm=NONE
hi CocListsDesc guifg=#848484 ctermfg=102 cterm=NONE
hi CocExtensionsActivated guifg=#66BB6A ctermfg=71 cterm=NONE
hi CocExtensionsLoaded guifg=#37474F ctermfg=238 cterm=NONE
hi CocExtensionsDisabled guifg=#b5b5b5 ctermfg=249 cterm=NONE
hi CocExtensionsName guifg=#66BB6A ctermfg=71 cterm=NONE
hi CocExtensionsLocal guifg=#42A5F5 ctermfg=75 cterm=NONE
hi CocExtensionsRoot guifg=#848484 ctermfg=102 cterm=NONE
hi CocOutlineName guifg=#37474F ctermfg=238 cterm=NONE
hi CocOutlineIndentLine guifg=#848484 ctermfg=102 cterm=NONE
hi CocOutlineKind guifg=#673AB7 ctermfg=61 cterm=NONE
hi CocOutlineLine guifg=#848484 ctermfg=102 cterm=NONE
hi CocNotificationTime guifg=#848484 ctermfg=102 cterm=NONE
hi CocCommandsTitle guifg=#848484 ctermfg=102 cterm=NONE
...
hi NeotestAdapterName guifg=#673AB7 ctermfg=61 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#42A5F5 ctermfg=75 cterm=NONE
...
hi NeotestPassed guifg=#66BB6A ctermfg=71 cterm=NONE
hi NeotestRunning guifg=#d0b22b ctermfg=178 cterm=NONE
hi NeotestFailed guifg=#EF5350 ctermfg=203 cterm=NONE
hi NeotestSkipped guifg=#42A5F5 ctermfg=75 cterm=NONE
...
hi TodoBgTodo guifg=#ECEFF1 guibg=#d0b22b ctermfg=255 ctermbg=178 cterm=NONE gui=bold
hi NeotestMarked guifg=#42A5F5 ctermfg=75 cterm=NONE
hi NeotestTarget guifg=#42A5F5 ctermfg=75 cterm=NONE
...
hi NoiceFormatProgressDone guibg=#66BB6A guifg=#FFFfff ctermfg=231 ctermbg=71 cterm=NONE
...
hi TodoBgFix guifg=#ECEFF1 guibg=#EF5350 ctermfg=255 ctermbg=203 cterm=NONE gui=bold
hi TodoBgHack guifg=#ECEFF1 guibg=#FF6F00 ctermfg=255 ctermbg=202 cterm=NONE gui=bold
hi TodoBgNote guifg=#ECEFF1 guibg=#37474F ctermfg=255 ctermbg=238 cterm=NONE gui=bold
hi TodoBgPerf guifg=#ECEFF1 guibg=#673AB7 ctermfg=255 ctermbg=61 cterm=NONE gui=bold
hi TodoBgTest guifg=#ECEFF1 guibg=#673AB7 ctermfg=255 ctermbg=61 cterm=NONE gui=bold
...
hi NeotestExpandMarker guifg=#a3a3a3 ctermfg=247 cterm=NONE
hi NeotestIndent guifg=#a3a3a3 ctermfg=247 cterm=NONE
hi NeotestBorder guifg=#42A5F5 ctermfg=75 cterm=NONE
hi NeotestDir guifg=#42A5F5 ctermfg=75 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#FF6F00 guibg=#e0e0e0 ctermfg=202 ctermbg=254 cterm=NONE gui=bold
...
hi CocFloating guifg=#37474F guibg=#f7f7f7 ctermfg=238 ctermbg=231 cterm=NONE
hi CocMenuSel guibg=#673AB7 guifg=#FFFfff ctermfg=231 ctermbg=61 cterm=NONE
hi def link CocListSearch CocSearch
hi CocListMode guifg=#42A5F5 ctermfg=75 cterm=NONE
hi CocSelectedLine guibg=#ECEFF1 ctermbg=255 cterm=NONE
...
hi BufferLineCloseButton guifg=#848484 guibg=#ECEFF1 ctermfg=102 ctermbg=255 cterm=NONE
...
hi BufferLineSeparatorVisible guifg=#ECEFF1 guibg=#ECEFF1 ctermfg=255 ctermbg=255 cterm=NONE
hi BufferLineSeparatorSelected guifg=#ECEFF1 guibg=#ECEFF1 ctermfg=255 ctermbg=255 cterm=NONE
hi BufferLineTab guifg=#848484 guibg=#d4d4d4 ctermfg=102 ctermbg=188 cterm=NONE
...
hi MatchWord guibg=#c4c4c4 guifg=#37474F ctermfg=238 ctermbg=251 cterm=NONE
