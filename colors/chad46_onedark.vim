...
hi NeogitBranchHead guifg=#61afef ctermfg=75 cterm=NONE gui=bold,underline
...
hi NeogitChangeModified guifg=#61afef ctermfg=75 cterm=NONE gui=bold,italic
hi NeogitChangeAdded guibg=#7aa55b guifg=#98c379 ctermfg=108 ctermbg=107 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#e06c75 ctermfg=168 cterm=NONE gui=bold,italic
hi NeogitChangeRenamed guifg=#de98fd ctermfg=177 cterm=NONE gui=bold,italic
hi NeogitChangeUpdated guifg=#fca2aa ctermfg=217 cterm=NONE gui=bold,italic
hi NeogitChangeCopied guifg=#a3b8ef ctermfg=147 cterm=NONE gui=bold,italic
hi NeogitChangeUnmerged guifg=#e7c787 ctermfg=186 cterm=NONE gui=bold,italic
...
hi CocLoaderHeader guibg=#61afef guifg=#1e222a ctermfg=235 ctermbg=75 cterm=NONE gui=bold
hi CocLoaderHeaderSec guibg=#519ABA guifg=#1e222a ctermfg=235 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderTabActive guibg=#519ABA guifg=#1e222a ctermfg=235 ctermbg=67 cterm=NONE gui=bold
...
hi TbThemeToggleBtn guibg=#373b43 guifg=#abb2bf ctermfg=249 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#e06c75 guifg=#1e222a ctermfg=235 ctermbg=168 cterm=NONE gui=bold
...
hi LazyH2 guifg=#e06c75 ctermfg=168 cterm=NONE gui=bold,underline
