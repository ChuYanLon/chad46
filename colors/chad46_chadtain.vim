...
hi NeogitBranchHead guifg=#6b8bab ctermfg=67 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#6b8bab ctermfg=67 cterm=NONE gui=italic,bold
...
hi NeogitChangeRenamed guifg=#a39ec4 ctermfg=146 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#C9938A ctermfg=174 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#9aafe6 ctermfg=110 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#c4c19e ctermfg=249 cterm=NONE gui=italic,bold
...
hi Type guisp=NONE guifg=#aca98a ctermfg=144 cterm=NONE
...
hi Identifier guisp=NONE guifg=#ac8a8c ctermfg=138 cterm=NONE
hi Float guifg=#C9938A ctermfg=174 cterm=NONE
hi Delimiter guifg=#ac8a8c ctermfg=138 cterm=NONE
hi Define guisp=NONE guifg=#948fb1 ctermfg=103 cterm=NONE
...
hi CocHintHighlight guisp=#7c9cbc guifg=#7c9cbc ctermfg=109 cterm=NONE gui=undercurl
hi IlluminatedWordWrite cterm=NONE gui=reverse,bold
hi CocInfoHighlight guisp=#6b8bab guifg=#6b8bab ctermfg=67 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#c4c19e guifg=#c4c19e ctermfg=249 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#bebebe ctermfg=250 cterm=NONE
