...
hi LspInlayHint guifg=#828282 guibg=#515151 ctermfg=244 ctermbg=239 cterm=NONE
...
hi MasonHeader guifg=#4A4A4A guibg=#DF9A98 ctermfg=239 ctermbg=174 cterm=NONE
...
hi CocLoaderTabActive guibg=#7FB7BD guifg=#4A4A4A ctermfg=239 ctermbg=109 cterm=NONE gui=bold
hi CocLoaderHeaderSec guibg=#7FB7BD guifg=#4A4A4A ctermfg=239 ctermbg=109 cterm=NONE gui=bold
hi CocLoaderHeader guibg=#96BBDC guifg=#4A4A4A ctermfg=239 ctermbg=110 cterm=NONE gui=bold
...
hi NvimDapViewTabSelected guibg=#4A4A4A guifg=#DFE0E0 ctermfg=254 ctermbg=239 cterm=NONE
hi NvimDapViewTab guibg=#515151 guifg=#828282 ctermfg=244 ctermbg=239 cterm=NONE
...
hi TelescopePromptPrefix guifg=#DF9A98 guibg=#515151 ctermfg=174 ctermbg=239 cterm=NONE
hi FlashMatch guibg=#96BBDC guifg=#4A4A4A ctermfg=239 ctermbg=110 cterm=NONE
hi FlashCurrent guibg=#719672 guifg=#4A4A4A ctermfg=239 ctermbg=244 cterm=NONE
