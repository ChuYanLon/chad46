...
hi CocLoaderHighlightBlock guifg=#4A4A4A guibg=#96BBDC ctermfg=239 ctermbg=110 cterm=NONE
...
hi CocLoaderTabInactive guifg=#4A4A4A guibg=#6d6d6d ctermfg=239 ctermbg=242 cterm=NONE
...
hi CocLoaderMutedBlock guifg=#4A4A4A guibg=#6d6d6d ctermfg=239 ctermbg=242 cterm=NONE
