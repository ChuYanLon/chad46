...
hi TbThemeToggleBtn guibg=#666666 guifg=#DFE0E0 ctermfg=254 ctermbg=241 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#DF9A98 guifg=#4A4A4A ctermfg=239 ctermbg=174 cterm=NONE gui=bold
