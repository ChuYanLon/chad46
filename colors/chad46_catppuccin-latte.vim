...
hi BlinkCmpMenuSelection guifg=#EFF1F5 guibg=#6c6e83 ctermfg=255 ctermbg=243 cterm=NONE gui=bold
hi CmpSel guifg=#EFF1F5 guibg=#6c6e83 ctermfg=255 ctermbg=243 cterm=NONE gui=bold
...
hi MiniTablineModifiedCurrent guifg=#40A02B guibg=#EFF1F5 ctermfg=70 ctermbg=255 cterm=NONE gui=underline
...
hi CocCursorRange guibg=#dbdfe9 ctermbg=254 cterm=NONE
hi CocErrorHighlight guifg=#E64553 ctermfg=167 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#DF8E1D ctermfg=172 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#04A5E5 ctermfg=38 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#179299 ctermfg=30 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#bdc4d7 ctermbg=251 cterm=NONE
hi CocSelectedText guibg=#c7cddd guifg=#7287FD ctermfg=69 ctermbg=252 cterm=NONE
hi CocCodeLens guifg=#8b97b9 ctermfg=103 cterm=NONE
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocUnused guifg=#a9b2cb ctermfg=146 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocListMode guifg=#04A5E5 ctermfg=38 cterm=NONE
hi CocListSearch guifg=#DF8E1D guibg=#d1d6e3 ctermfg=172 ctermbg=253 cterm=NONE
...
hi CocNormalFloat guibg=#E6E9EF ctermbg=255 cterm=NONE
hi CocTitle guifg=#7287FD ctermfg=69 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#EFF1F5 guibg=#209FB5 ctermfg=255 ctermbg=37 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#EFF1F5 guibg=#209FB5 ctermfg=255 ctermbg=37 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#EFF1F5 guibg=#b3bbd1 ctermfg=255 ctermbg=146 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#EFF1F5 guibg=#DD7878 ctermfg=255 ctermbg=174 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guifg=#EFF1F5 guibg=#DD7878 ctermfg=255 ctermbg=174 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#04A5E5 guibg=#c7cddd ctermfg=38 ctermbg=252 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#FE640B guibg=#c7cddd ctermfg=202 ctermbg=252 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#04A5E5 ctermfg=38 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#40A02B guibg=#22820d ctermfg=70 ctermbg=28 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#E64553 ctermfg=167 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#8839EF ctermfg=99 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#FE640B ctermfg=202 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#209FB5 ctermfg=37 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#DF8E1D ctermfg=172 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#40A02B ctermfg=70 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#209FB5 guibg=#dbdfe9 ctermfg=37 ctermbg=254 cterm=NONE gui=bold
hi TodoBgFix guifg=#dbdfe9 guibg=#E64553 ctermfg=254 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#dbdfe9 guibg=#FE640B ctermfg=254 ctermbg=202 cterm=NONE gui=bold
hi TodoBgNote guifg=#dbdfe9 guibg=#7287FD ctermfg=254 ctermbg=69 cterm=NONE gui=bold
hi TodoBgPerf guifg=#dbdfe9 guibg=#8839EF ctermfg=254 ctermbg=99 cterm=NONE gui=bold
hi TodoBgTest guifg=#dbdfe9 guibg=#8839EF ctermfg=254 ctermbg=99 cterm=NONE gui=bold
hi TodoBgTodo guifg=#dbdfe9 guibg=#DF8E1D ctermfg=254 ctermbg=172 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#7287FD guibg=#EFF1F5 ctermfg=69 ctermbg=255 cterm=NONE gui=underline
...
hi NeogitHunkMergeHeader guifg=#dbdfe9 guibg=#b3bbd1 ctermfg=254 ctermbg=146 cterm=NONE gui=bold
...
hi SnacksPickerIcon guifg=#04A5E5 ctermfg=38 cterm=NONE
