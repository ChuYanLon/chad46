...
hi BlinkCmpMenuSelection guifg=#192330 guibg=#719cd6 ctermfg=235 ctermbg=74 cterm=NONE gui=bold
hi CmpSel guifg=#192330 guibg=#719cd6 ctermfg=235 ctermbg=74 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#192330 guibg=#719cd6 ctermfg=235 ctermbg=74 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#192330 guibg=#5cc6c8 ctermfg=235 ctermbg=80 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#192330 guibg=#5cc6c8 ctermfg=235 ctermbg=80 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#495360 guifg=#192330 ctermfg=235 ctermbg=240 cterm=NONE
hi CocLoaderHeading cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#719cd6 ctermfg=74 cterm=NONE
hi CocLoaderMuted guifg=#646e7b ctermfg=242 cterm=NONE
...
hi CocLoaderWarning guifg=#dbc074 ctermfg=180 cterm=NONE
hi CocLoaderBackdrop guibg=#192330 ctermbg=235 cterm=NONE
hi CocLoaderHighlightBlock guibg=#719cd6 guifg=#192330 ctermfg=235 ctermbg=74 cterm=NONE
hi CocLoaderMutedBlock guibg=#495360 guifg=#192330 ctermfg=235 ctermbg=240 cterm=NONE
...
hi NeogitHunkMergeHeader guifg=#202a37 guibg=#495360 ctermfg=235 ctermbg=240 cterm=NONE gui=bold
hi MiniTablineCurrent guifg=#cdcecf guibg=#192330 ctermfg=252 ctermbg=235 cterm=NONE gui=underline
hi MiniTablineVisible guifg=#cdcecf guibg=#192330 ctermfg=252 ctermbg=235 cterm=NONE
hi NeogitHunkHeader guifg=#192330 guibg=#495360 ctermfg=235 ctermbg=240 cterm=NONE gui=bold
hi MiniTablineModifiedCurrent guifg=#8ebaa4 guibg=#192330 ctermfg=109 ctermbg=235 cterm=NONE gui=underline
...
hi NeogitDiffHeader guifg=#719cd6 guibg=#313b48 ctermfg=74 ctermbg=237 cterm=NONE gui=bold
...
hi NeogitChangeAdded guifg=#8ebaa4 guibg=#709c86 ctermfg=109 ctermbg=72 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#8be5e7 guibg=#202a37 ctermfg=116 ctermbg=235 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#535d6a ctermfg=59 cterm=NONE
...
hi TodoBgFix guifg=#202a37 guibg=#c94f6d ctermfg=235 ctermbg=167 cterm=NONE gui=bold
hi TodoBgHack guifg=#202a37 guibg=#fe9373 ctermfg=235 ctermbg=209 cterm=NONE gui=bold
hi TodoBgNote guifg=#202a37 guibg=#cdcecf ctermfg=235 ctermbg=252 cterm=NONE gui=bold
hi TodoBgPerf guifg=#202a37 guibg=#baa1e2 ctermfg=235 ctermbg=146 cterm=NONE gui=bold
hi TodoBgTest guifg=#202a37 guibg=#baa1e2 ctermfg=235 ctermbg=146 cterm=NONE gui=bold
hi TodoBgTodo guifg=#202a37 guibg=#dbc074 ctermfg=235 ctermbg=180 cterm=NONE gui=bold
...
hi FoldColumn guifg=#c0c8d5 guibg=NONE ctermfg=251 cterm=NONE
...
hi CocSelectedLine guibg=#202a37 ctermbg=235 cterm=NONE
...
hi SnacksPickerDir guifg=#646e7b ctermfg=242 cterm=NONE
hi SnacksPickerDelim guifg=#535d6a ctermfg=59 cterm=NONE
hi SnacksPickerRow guifg=#535d6a ctermfg=59 cterm=NONE
hi SnacksPickerPathIgnored guifg=#495360 ctermfg=240 cterm=NONE
hi SnacksPickerPathHidden guifg=#495360 ctermfg=240 cterm=NONE
...
hi Tabline guibg=#202a37 ctermbg=235 cterm=NONE
hi TbFill guibg=#202a37 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#cdcecf guibg=#192330 ctermfg=252 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#646e7b guibg=#202a37 ctermfg=242 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#8ebaa4 guibg=#192330 ctermfg=109 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#c94f6d guibg=#202a37 ctermfg=167 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#c94f6d guibg=#192330 ctermfg=167 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#646e7b guibg=#202a37 ctermfg=242 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#cdcecf guibg=#313b48 ctermfg=252 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#c94f6d guibg=#192330 ctermfg=167 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#cdcecf guibg=#202a37 ctermfg=252 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#192330 guibg=#86abdc ctermfg=235 ctermbg=110 cterm=NONE
hi TBTabTitle guifg=#192330 guibg=#719cd6 ctermfg=235 ctermbg=74 cterm=NONE
hi TbThemeToggleBtn guifg=#cdcecf guibg=#3d4754 ctermfg=252 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#192330 guibg=#c94f6d ctermfg=235 ctermbg=167 cterm=NONE gui=bold
...
hi CocHintLine guibg=#233b46 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#263548 ctermbg=237 cterm=NONE
hi CocWarningLine guibg=#363a3a ctermbg=237 cterm=NONE
hi CocErrorLine guibg=#332939 ctermbg=236 cterm=NONE
hi CocHintSign guifg=#5cc6c8 ctermfg=80 cterm=NONE
hi CocErrorFloat guifg=#c94f6d guibg=#121c29 ctermfg=167 ctermbg=234 cterm=NONE
...
hi CocInfoHighlight guifg=#719cd6 guisp=#719cd6 ctermfg=74 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#5cc6c8 guisp=#5cc6c8 ctermfg=80 cterm=NONE gui=undercurl
hi CocDeprecatedHighlight guifg=#535d6a ctermfg=59 cterm=NONE gui=strikethrough
hi CocHintFloat guifg=#5cc6c8 guibg=#121c29 ctermfg=80 ctermbg=234 cterm=NONE
hi CocInfoFloat guifg=#719cd6 guibg=#121c29 ctermfg=74 ctermbg=234 cterm=NONE
hi CocWarningFloat guifg=#dbc074 guibg=#121c29 ctermfg=180 ctermbg=234 cterm=NONE
hi CocUnusedHighlight guifg=#535d6a ctermfg=59 cterm=NONE
hi CmpBorder guifg=#535d6a ctermfg=59 cterm=NONE
hi CocErrorHighlight guifg=#c94f6d guisp=#c94f6d ctermfg=167 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#dbc074 guisp=#dbc074 ctermfg=180 cterm=NONE gui=undercurl
...
hi CocDiagnosticsFile guifg=#646e7b ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#baa1e2 ctermfg=146 cterm=NONE
hi CocServicesName guifg=#719cd6 ctermfg=74 cterm=NONE
hi CocServicesStat guifg=#8ebaa4 ctermfg=109 cterm=NONE
hi CocServicesLanguages guifg=#646e7b ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#baa1e2 ctermfg=146 cterm=NONE
hi CocSourcesName guifg=#719cd6 ctermfg=74 cterm=NONE
hi CocSourcesPriority guifg=#fe9373 ctermfg=209 cterm=NONE
hi CocSourcesFileTypes guifg=#646e7b ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#8ebaa4 ctermfg=109 cterm=NONE
hi CocListsDesc guifg=#646e7b ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#8ebaa4 ctermfg=109 cterm=NONE
hi CocExtensionsLoaded guifg=#cdcecf ctermfg=252 cterm=NONE
hi CocExtensionsDisabled guifg=#535d6a ctermfg=59 cterm=NONE
hi CocExtensionsName guifg=#8ebaa4 ctermfg=109 cterm=NONE
hi CocExtensionsLocal guifg=#719cd6 ctermfg=74 cterm=NONE
hi CocExtensionsRoot guifg=#646e7b ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#cdcecf ctermfg=252 cterm=NONE
hi CocOutlineIndentLine guifg=#646e7b ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#baa1e2 ctermfg=146 cterm=NONE
hi CocOutlineLine guifg=#646e7b ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#646e7b ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#646e7b ctermfg=242 cterm=NONE
...
hi NeotestFile guifg=#8be5e7 ctermfg=116 cterm=NONE
...
hi DevIconJson guifg=#e0c989 ctermfg=186 cterm=NONE
...
hi NeotestPassed guifg=#8ebaa4 ctermfg=109 cterm=NONE
hi NeotestRunning guifg=#dbc074 ctermfg=180 cterm=NONE
hi NeotestFailed guifg=#c94f6d ctermfg=167 cterm=NONE
hi NeotestSkipped guifg=#719cd6 ctermfg=74 cterm=NONE
hi NeotestTest guifg=#535d6a ctermfg=59 cterm=NONE
hi NeotestNamespace guifg=#6ad4d6 ctermfg=80 cterm=NONE
hi NeotestFocused guifg=#dbc074 ctermfg=180 cterm=NONE
hi NvimTreeFolderName guifg=#719cd6 ctermfg=74 cterm=NONE
hi NeotestDir guifg=#719cd6 ctermfg=74 cterm=NONE
hi NeotestBorder guifg=#719cd6 ctermfg=74 cterm=NONE
hi NeotestIndent guifg=#5c6673 ctermfg=241 cterm=NONE
hi NeotestExpandMarker guifg=#5c6673 ctermfg=241 cterm=NONE
hi NeotestAdapterName guifg=#baa1e2 ctermfg=146 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#719cd6 ctermfg=74 cterm=NONE
hi NeotestMarked guifg=#719cd6 ctermfg=74 cterm=NONE
hi NeotestTarget guifg=#719cd6 ctermfg=74 cterm=NONE
...
hi NeogitDiffHeaderHighlight guifg=#fe9373 guibg=#313b48 ctermfg=209 ctermbg=237 cterm=NONE gui=bold
...
hi NeogitHunkHeaderCursor guifg=#192330 guibg=#9d79d6 ctermfg=235 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#192330 guibg=#9d79d6 ctermfg=235 ctermbg=140 cterm=NONE gui=bold
hi MiniTablineHidden guifg=#646e7b guibg=#202a37 ctermfg=242 ctermbg=235 cterm=NONE
hi NeogitHunkMergeHeaderCursor guifg=#192330 guibg=#8be5e7 ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#192330 guibg=#8be5e7 ctermfg=235 ctermbg=116 cterm=NONE gui=bold
hi CocInlayHint guifg=#646e7b guibg=#202a37 ctermfg=242 ctermbg=235 cterm=NONE
...
hi CocSelectedText guifg=#c94f6d ctermfg=167 cterm=NONE
...
hi CocFloating guifg=#c0c8d5 guibg=#121c29 ctermfg=251 ctermbg=234 cterm=NONE
