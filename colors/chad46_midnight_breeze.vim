...
hi TelescopePromptPrefix guifg=#fb6f6f guibg=#121619 ctermfg=203 ctermbg=233 cterm=NONE
...
hi LazyH2 guifg=#fb6f6f ctermfg=203 cterm=NONE gui=bold,underline
...
hi CocListSearch guifg=#ffdf5d guibg=#161b22 ctermfg=221 ctermbg=234 cterm=NONE
hi CocListMode guifg=#58a6ff ctermfg=75 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocUnused guifg=#434b59 ctermfg=239 cterm=NONE
hi CocCursorRange guibg=#121619 ctermbg=233 cterm=NONE
...
hi NeogitBranchHead guifg=#58a6ff ctermfg=75 cterm=NONE gui=bold,underline
...
hi CocErrorHighlight guifg=#fb6f6f ctermfg=203 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#ffdf5d ctermfg=221 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#58a6ff ctermfg=75 cterm=NONE gui=undercurl
...
hi CocSelectedText guibg=#1b2128 guifg=#c9d1d9 ctermfg=252 ctermbg=235 cterm=NONE
...
hi CocNormalFloat guibg=#070a0d ctermbg=232 cterm=NONE
hi CocTitle guifg=#c9d1d9 ctermfg=252 cterm=NONE
...
hi SnacksPickerIcon guifg=#58a6ff ctermfg=75 cterm=NONE
