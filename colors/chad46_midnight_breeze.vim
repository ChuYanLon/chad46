...
hi TbThemeToggleBtn guibg=#21262d guifg=#c9d1d9 ctermfg=252 ctermbg=235 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#fb6f6f guifg=#0d1117 ctermfg=233 ctermbg=203 cterm=NONE gui=bold
