...
hi Operator guisp=NONE guifg=#dcdccc ctermfg=188 cterm=NONE
...
hi CocHintHighlight guisp=#93e0e3 guifg=#93e0e3 ctermfg=116 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#7cb8bb guifg=#7cb8bb ctermfg=109 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#e0cf9f guifg=#e0cf9f ctermfg=187 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#dca3a3 guifg=#dca3a3 ctermfg=181 cterm=NONE gui=undercurl
...
hi NeogitChangeAdded guifg=#5f7f5f guibg=#416141 ctermfg=65 ctermbg=239 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#e0cf9f ctermfg=187 cterm=NONE
...
hi Define guisp=NONE guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi Delimiter guifg=#dca3a3 ctermfg=181 cterm=NONE
hi Float guifg=#dfaf8f ctermfg=180 cterm=NONE
hi Identifier guisp=NONE guifg=#BC98EC ctermfg=141 cterm=NONE
