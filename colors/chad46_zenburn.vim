...
hi BlinkCmpMenuSelection guifg=#383838 guibg=#5f7f5f ctermfg=237 ctermbg=65 cterm=NONE gui=bold
hi CmpSel guifg=#383838 guibg=#5f7f5f ctermfg=237 ctermbg=65 cterm=NONE gui=bold
hi CocLoaderHighlight guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocLoaderMuted guifg=#707070 ctermfg=242 cterm=NONE
hi def link CocLoaderError ErrorMsg
hi def link CocLoaderNormal NormalFloat
hi def link CocLoaderSearchMatch Search
hi CocLoaderWarning guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocLoaderBackdrop guibg=#383838 ctermbg=237 cterm=NONE
hi CocLoaderHighlightBlock guibg=#7cb8bb guifg=#383838 ctermfg=237 ctermbg=109 cterm=NONE
hi CocLoaderMutedBlock guibg=#5b5b5b guifg=#383838 ctermfg=237 ctermbg=240 cterm=NONE
...
hi MiniTablineCurrent guifg=#ffffff guibg=#383838 ctermfg=231 ctermbg=237 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#5f7f5f guibg=#383838 ctermfg=65 ctermbg=237 cterm=NONE gui=underline
...
hi NeotestPassed guifg=#5f7f5f ctermfg=65 cterm=NONE
hi NeotestRunning guifg=#e0cf9f ctermfg=187 cterm=NONE
hi NeotestFailed guifg=#dca3a3 ctermfg=181 cterm=NONE
hi NeotestSkipped guifg=#7cb8bb ctermfg=109 cterm=NONE
hi NeotestTest guifg=#626262 ctermfg=241 cterm=NONE
hi NeotestNamespace guifg=#5f7f5f ctermfg=65 cterm=NONE
hi NeotestFocused guifg=#e0cf9f ctermfg=187 cterm=NONE
hi NeotestFile guifg=#93e0e3 ctermfg=116 cterm=NONE
hi NeotestDir guifg=#7cb8bb ctermfg=109 cterm=NONE
hi NeotestBorder guifg=#7cb8bb ctermfg=109 cterm=NONE
hi NeotestIndent guifg=#696969 ctermfg=242 cterm=NONE
hi NeotestExpandMarker guifg=#696969 ctermfg=242 cterm=NONE
hi NeotestAdapterName guifg=#BC98EC ctermfg=141 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#7cb8bb ctermfg=109 cterm=NONE
hi NeotestMarked guifg=#7cb8bb ctermfg=109 cterm=NONE
hi NeotestTarget guifg=#7cb8bb ctermfg=109 cterm=NONE
...
hi CocSemTypeClass guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocSemTypeEnum guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSemTypeInterface guifg=#5f7f5f ctermfg=65 cterm=NONE
hi CocSemTypeStruct guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSemTypeTypeParameter guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSemTypeParameter guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSemTypeVariable guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSemTypeProperty guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSemTypeEnumMember guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSemTypeEvent guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocSemTypeFunction guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSemTypeMethod guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSemTypeMacro guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocSemTypeKeyword guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSemTypeModifier guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSemTypeComment guifg=#707070 ctermfg=242 cterm=NONE
hi CocSemTypeString guifg=#ca7b7b ctermfg=174 cterm=NONE
hi CocSemTypeNumber guifg=#dfaf8f ctermfg=180 cterm=NONE
hi CocSemTypeBoolean guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocSemTypeRegexp guifg=#ca7b7b ctermfg=174 cterm=NONE
hi CocSemTypeOperator guifg=#dcdccc ctermfg=188 cterm=NONE
hi CocSemTypeDecorator guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocSemModDeprecated guifg=#626262 ctermfg=241 cterm=NONE gui=strikethrough
hi CocSnippetVisual guibg=#545454 ctermbg=240 cterm=NONE
...
hi SnacksPickerDir guifg=#707070 ctermfg=242 cterm=NONE
hi SnacksPickerDelim guifg=#626262 ctermfg=241 cterm=NONE
hi SnacksPickerRow guifg=#626262 ctermfg=241 cterm=NONE
hi SnacksPickerPathIgnored guifg=#5b5b5b ctermfg=240 cterm=NONE
hi SnacksPickerPathHidden guifg=#5b5b5b ctermfg=240 cterm=NONE
...
hi Tabline guibg=#3f3f3f ctermbg=237 cterm=NONE
hi TbFill guibg=#3f3f3f ctermbg=237 cterm=NONE
hi TbBufOn guifg=#ffffff guibg=#383838 ctermfg=231 ctermbg=237 cterm=NONE
hi TbBufOff guifg=#707070 guibg=#3f3f3f ctermfg=242 ctermbg=237 cterm=NONE
hi TbBufOnModified guifg=#5f7f5f guibg=#383838 ctermfg=65 ctermbg=237 cterm=NONE
hi TbBufOffModified guifg=#dca3a3 guibg=#3f3f3f ctermfg=181 ctermbg=237 cterm=NONE
hi TbBufOnClose guifg=#dca3a3 guibg=#383838 ctermfg=181 ctermbg=237 cterm=NONE
hi TbBufOffClose guifg=#707070 guibg=#3f3f3f ctermfg=242 ctermbg=237 cterm=NONE
hi TbTabNewBtn guifg=#ffffff guibg=#4d4d4d ctermfg=231 ctermbg=239 cterm=NONE
hi TbTabOn guifg=#dca3a3 guibg=#383838 ctermfg=181 ctermbg=237 cterm=NONE
hi TbTabOff guifg=#ffffff guibg=#3f3f3f ctermfg=231 ctermbg=237 cterm=NONE
hi TbTabCloseBtn guifg=#383838 guibg=#93e0e3 ctermfg=237 ctermbg=116 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guifg=#383838 guibg=#93e0e3 ctermfg=237 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#383838 guibg=#93e0e3 ctermfg=237 ctermbg=116 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#383838 guibg=#5b5b5b ctermfg=237 ctermbg=240 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#383838 guibg=#7A89B4 ctermfg=237 ctermbg=103 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#7cb8bb guibg=#4d4d4d ctermfg=109 ctermbg=239 cterm=NONE gui=bold
hi WarningMsg guifg=#BC98EC ctermfg=141 cterm=NONE
hi NeogitBranch guifg=#7cb8bb ctermfg=109 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#7cb8bb ctermfg=109 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#7cb8bb ctermfg=109 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#5f7f5f guibg=#416141 ctermfg=65 ctermbg=239 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#dca3a3 ctermfg=181 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#BC98EC ctermfg=141 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#dfaf8f ctermfg=180 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#93e0e3 ctermfg=116 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#e0cf9f ctermfg=187 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#5f7f5f ctermfg=65 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#93e0e3 guibg=#3f3f3f ctermfg=116 ctermbg=237 cterm=NONE gui=bold
...
hi DevIconJson guifg=#dfaf8f ctermfg=180 cterm=NONE
...
hi CocErrorHighlight guifg=#dca3a3 guisp=#dca3a3 ctermfg=181 cterm=NONE gui=undercurl
...
hi CocErrorVirtualText guifg=#dca3a3 ctermfg=181 cterm=NONE
hi CocWarningVirtualText guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocInfoVirtualText guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocHintVirtualText guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocErrorSign guifg=#dca3a3 ctermfg=181 cterm=NONE
hi CocWarningSign guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocInfoSign guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocHintSign guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocErrorLine guibg=#504848 ctermbg=239 cterm=NONE
hi CocWarningLine guibg=#514e47 ctermbg=239 cterm=NONE
hi CocInfoLine guibg=#424b4b ctermbg=238 cterm=NONE
...
hi CocFloating guifg=#dcdccc guibg=#303030 ctermfg=188 ctermbg=236 cterm=NONE
hi CocMenuSel guibg=#5f7f5f guifg=#383838 ctermfg=237 ctermbg=65 cterm=NONE
hi CocFloatThumb guibg=#5b5b5b ctermbg=240 cterm=NONE
hi CocFloatSbar guibg=#464646 ctermbg=238 cterm=NONE
hi CocFloatBorder guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocFloatActive guibg=#464646 ctermbg=238 cterm=NONE
hi CocFloatDividingLine guifg=#464646 ctermfg=238 cterm=NONE
hi CocPumSearch guifg=#dfaf8f ctermfg=180 cterm=NONE
hi CocPumDetail guifg=#707070 ctermfg=242 cterm=NONE
hi def link CocPumMenu CocFloating
hi CocPumShortcut guifg=#626262 ctermfg=241 cterm=NONE
hi CocPumDeprecated guifg=#626262 ctermfg=241 cterm=NONE gui=strikethrough
hi CocPumVirtualText guifg=#626262 ctermfg=241 cterm=NONE
hi CocVirtualText guifg=#626262 ctermfg=241 cterm=NONE
hi def link CocInputBoxVirtualText CocVirtualText
hi CocInlineVirtualText guifg=#626262 ctermfg=241 cterm=NONE
hi CocInlineAnnotation guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSearch guifg=#dfaf8f ctermfg=180 cterm=NONE
hi CocLink guifg=#7cb8bb ctermfg=109 cterm=NONE gui=underline
hi def link CocListSearch CocSearch
hi CocListMode guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSelectedLine guibg=#3f3f3f ctermbg=237 cterm=NONE
hi CocListPath guifg=#707070 ctermfg=242 cterm=NONE
hi CocListLine guibg=#3f3f3f ctermbg=237 cterm=NONE
hi CocListFgBlack guifg=#3f3f3f ctermfg=237 cterm=NONE
hi CocListFgRed guifg=#dca3a3 ctermfg=181 cterm=NONE
hi CocListFgGreen guifg=#5f7f5f ctermfg=65 cterm=NONE
hi CocListFgYellow guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocListFgBlue guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocListFgMagenta guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocListFgCyan guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocListFgWhite guifg=#ffffff ctermfg=231 cterm=NONE
hi CocListFgGrey guifg=#626262 ctermfg=241 cterm=NONE
hi CocListBgBlack guibg=#3f3f3f ctermbg=237 cterm=NONE
hi CocListBgRed guibg=#dca3a3 ctermbg=181 cterm=NONE
hi CocListBgGreen guibg=#5f7f5f ctermbg=65 cterm=NONE
hi CocListBgYellow guibg=#e0cf9f ctermbg=187 cterm=NONE
...
hi TelescopePromptPrefix guibg=#3f3f3f guifg=#dca3a3 ctermfg=181 ctermbg=237 cterm=NONE
...
hi LazyH2 guifg=#dca3a3 ctermfg=181 cterm=NONE gui=underline,bold
...
hi CocCursorRange guibg=#545454 ctermbg=240 cterm=NONE
...
hi CocListBgBlue guibg=#7cb8bb ctermbg=109 cterm=NONE
hi CocListBgMagenta guibg=#BC98EC ctermbg=141 cterm=NONE
hi CocListBgCyan guibg=#93e0e3 ctermbg=116 cterm=NONE
hi CocListBgWhite guibg=#ffffff ctermbg=231 cterm=NONE
hi CocListBgGrey guibg=#5b5b5b ctermbg=240 cterm=NONE
hi CocDiagnosticsFile guifg=#707070 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocServicesName guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocServicesStat guifg=#5f7f5f ctermfg=65 cterm=NONE
hi CocServicesLanguages guifg=#707070 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSourcesName guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSourcesPriority guifg=#dfaf8f ctermfg=180 cterm=NONE
hi CocSourcesFileTypes guifg=#707070 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#5f7f5f ctermfg=65 cterm=NONE
hi TBTabTitle guifg=#383838 guibg=#7cb8bb ctermfg=237 ctermbg=109 cterm=NONE
hi TbThemeToggleBtn guifg=#ffffff guibg=#545454 ctermfg=231 ctermbg=240 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#383838 guibg=#dca3a3 ctermfg=237 ctermbg=181 cterm=NONE gui=bold
hi CocExtensionsDisabled guifg=#626262 ctermfg=241 cterm=NONE
hi CocExtensionsName guifg=#5f7f5f ctermfg=65 cterm=NONE
hi CocExtensionsLocal guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocExtensionsRoot guifg=#707070 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#ffffff ctermfg=231 cterm=NONE
hi CocOutlineIndentLine guifg=#707070 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocOutlineLine guifg=#707070 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#707070 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#707070 ctermfg=242 cterm=NONE
...
hi CocNotificationButton guifg=#7cb8bb ctermfg=109 cterm=NONE gui=underline
hi CocNotificationKey guifg=#707070 ctermfg=242 cterm=NONE
hi def link CocNotificationError CocErrorFloat
hi def link CocNotificationWarning CocWarningFloat
hi def link CocNotificationInfo CocInfoFloat
hi CocTreeTitle guifg=#ffffff ctermfg=231 cterm=NONE gui=bold
hi CocTreeDescription guifg=#707070 ctermfg=242 cterm=NONE
hi CocTreeOpenClose cterm=NONE gui=bold
hi CocTreeSelected guibg=#3f3f3f ctermbg=237 cterm=NONE
hi CocSymbolDefault guifg=#707070 ctermfg=242 cterm=NONE
hi CocSymbolKeyword guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSymbolNamespace guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolClass guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocSymbolMethod guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolProperty guifg=#BC98EC ctermfg=141 cterm=NONE
hi def link CocSymbolText CocSymbolDefault
hi def link CocSymbolUnit CocSymbolDefault
hi def link CocSymbolValue CocSymbolDefault
hi CocSymbolSnippet guifg=#dca3a3 ctermfg=181 cterm=NONE
hi CocSymbolColor guifg=#ffffff ctermfg=231 cterm=NONE
hi CocSymbolReference guifg=#dcdccc ctermfg=188 cterm=NONE
hi CocSymbolFolder guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolFile guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolModule guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocSymbolPackage guifg=#e0cf9f ctermfg=187 cterm=NONE
hi TodoBgFix guifg=#3f3f3f guibg=#dca3a3 ctermfg=237 ctermbg=181 cterm=NONE gui=bold
hi TodoBgHack guifg=#3f3f3f guibg=#dfaf8f ctermfg=237 ctermbg=180 cterm=NONE gui=bold
hi TodoBgNote guifg=#3f3f3f guibg=#ffffff ctermfg=237 ctermbg=231 cterm=NONE gui=bold
hi TodoBgPerf guifg=#3f3f3f guibg=#BC98EC ctermfg=237 ctermbg=141 cterm=NONE gui=bold
hi TodoBgTest guifg=#3f3f3f guibg=#BC98EC ctermfg=237 ctermbg=141 cterm=NONE gui=bold
hi TodoBgTodo guifg=#3f3f3f guibg=#e0cf9f ctermfg=237 ctermbg=187 cterm=NONE gui=bold
...
hi CocSymbolOperator guifg=#dcdccc ctermfg=188 cterm=NONE
hi CocSymbolTypeParameter guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSemTypeNamespace guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSemTypeType guifg=#e0cf9f ctermfg=187 cterm=NONE
...
hi CocUnusedHighlight guifg=#626262 ctermfg=241 cterm=NONE
hi CocDeprecatedHighlight guifg=#626262 ctermfg=241 cterm=NONE gui=strikethrough
hi CocHintHighlight guifg=#93e0e3 guisp=#93e0e3 ctermfg=116 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#7cb8bb guisp=#7cb8bb ctermfg=109 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#e0cf9f guisp=#e0cf9f ctermfg=187 cterm=NONE gui=undercurl
hi CocInlayHint guifg=#707070 guibg=#3f3f3f ctermfg=242 ctermbg=237 cterm=NONE
hi CocHintLine guibg=#455151 ctermbg=239 cterm=NONE
hi CocErrorFloat guifg=#dca3a3 guibg=#303030 ctermfg=181 ctermbg=236 cterm=NONE
hi CocWarningFloat guifg=#e0cf9f guibg=#303030 ctermfg=187 ctermbg=236 cterm=NONE
hi CocHintFloat guifg=#93e0e3 guibg=#303030 ctermfg=116 ctermbg=236 cterm=NONE
...
hi CocInfoFloat guifg=#7cb8bb guibg=#303030 ctermfg=109 ctermbg=236 cterm=NONE
...
hi NeogitHunkHeaderCursor guifg=#383838 guibg=#7A89B4 ctermfg=237 ctermbg=103 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guifg=#3f3f3f guibg=#5b5b5b ctermfg=237 ctermbg=240 cterm=NONE gui=bold
...
hi CocListsDesc guifg=#707070 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#5f7f5f ctermfg=65 cterm=NONE
hi CocExtensionsLoaded guifg=#ffffff ctermfg=231 cterm=NONE
hi CocItalic cterm=NONE gui=italic
hi CocStrikeThrough cterm=NONE gui=strikethrough
hi CocUnderline guisp=#626262 cterm=NONE gui=underline
hi CocDisabled guifg=#626262 ctermfg=241 cterm=NONE
hi CocFadeOut guifg=#5b5b5b ctermfg=240 cterm=NONE
...
hi CocMarkdownCode guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocNotificationProgress guifg=#7cb8bb ctermfg=109 cterm=NONE
...
hi CocSelectedText guifg=#dca3a3 ctermfg=181 cterm=NONE
...
hi CocHoverRange guibg=#545454 ctermbg=240 cterm=NONE
...
hi CocSymbolEvent guifg=#e0cf9f ctermfg=187 cterm=NONE
hi CocSymbolStruct guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi NeogitDiffHeaderHighlight guifg=#dfaf8f guibg=#4d4d4d ctermfg=180 ctermbg=239 cterm=NONE gui=bold
hi NeogitDiffAddHighlight guifg=#5f7f5f guibg=#305030 ctermfg=65 ctermbg=237 cterm=NONE
hi CocSymbolField guifg=#BC98EC ctermfg=141 cterm=NONE
hi CocSymbolConstructor guifg=#93e0e3 ctermfg=116 cterm=NONE
hi CocSymbolEnum guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolInterface guifg=#5f7f5f ctermfg=65 cterm=NONE
hi CocSymbolFunction guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolVariable guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSymbolConstant guifg=#dfaf8f ctermfg=180 cterm=NONE
hi CocSymbolString guifg=#ca7b7b ctermfg=174 cterm=NONE
hi CocSymbolNumber guifg=#dfaf8f ctermfg=180 cterm=NONE
hi CocSymbolBoolean guifg=#93e0e3 ctermfg=116 cterm=NONE
hi def link CocSymbolArray CocSymbolDefault
hi def link CocSymbolObject CocSymbolDefault
hi CocSymbolKey guifg=#dc8cc3 ctermfg=175 cterm=NONE
hi CocSymbolNull guifg=#7cb8bb ctermfg=109 cterm=NONE
hi CocSymbolEnumMember guifg=#BC98EC ctermfg=141 cterm=NONE
...
hi FoldColumn guifg=#dca3a3 guibg=NONE ctermfg=181 cterm=NONE
hi Exception guifg=#BC98EC ctermfg=141 cterm=NONE
hi Error guifg=#383838 guibg=#BC98EC ctermfg=237 ctermbg=141 cterm=NONE
hi CocLoaderHeader guifg=#383838 guibg=#7cb8bb ctermfg=237 ctermbg=109 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#383838 guibg=#93e0e3 ctermfg=237 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#383838 guibg=#93e0e3 ctermfg=237 ctermbg=116 cterm=NONE gui=bold
hi CocLoaderTabInactive guibg=#5b5b5b guifg=#383838 ctermfg=237 ctermbg=240 cterm=NONE
