...
hi BlinkCmpMenuSelection guibg=#5e5f65 guifg=#fafafa ctermfg=231 ctermbg=241 cterm=NONE gui=bold
hi CmpSel guibg=#5e5f65 guifg=#fafafa ctermfg=231 ctermbg=241 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#a2a2a3 ctermfg=247 cterm=NONE
hi GitSignsDeletePreview guibg=#d84a3d ctermbg=167 cterm=NONE
hi GitSignsChangePreview guibg=#4078f2 ctermbg=69 cterm=NONE
hi GitSignsAddPreview guibg=#50a14f ctermbg=71 cterm=NONE
...
hi GitSignsChangeLn guifg=#4078f2 ctermfg=69 cterm=NONE
...
hi LazyButton guifg=#8e8e8f guibg=#dadadb ctermfg=245 ctermbg=253 cterm=NONE
hi LazyH1 guifg=#fafafa guibg=#50a14f ctermfg=231 ctermbg=71 cterm=NONE
hi healthSuccess guifg=#fafafa guibg=#50a14f ctermfg=231 ctermbg=71 cterm=NONE
...
hi Cursor guibg=#383a42 guifg=#fafafa ctermfg=231 ctermbg=237 cterm=NONE
hi Conceal guibg=NONE cterm=NONE
hi WildMenu guibg=#c18401 guifg=#d84a3d ctermfg=167 ctermbg=136 cterm=NONE
...
hi Substitute guibg=#c18401 guifg=#f4f4f4 ctermfg=255 ctermbg=136 cterm=NONE
hi Search guibg=#c18401 guifg=#f4f4f4 ctermfg=255 ctermbg=136 cterm=NONE
...
hi IncSearch guibg=#d75f00 guifg=#f4f4f4 ctermfg=255 ctermbg=166 cterm=NONE
hi Folded guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
hi FoldColumn guibg=NONE cterm=NONE
hi Operator guisp=NONE guifg=#383a42 ctermfg=237 cterm=NONE
hi ErrorMsg guibg=#fafafa guifg=#d84a3d ctermfg=167 ctermbg=231 cterm=NONE
hi Debug guifg=#d84a3d ctermfg=167 cterm=NONE
hi CocLoaderMutedBlock guifg=#fafafa guibg=#b7b7b8 ctermfg=231 ctermbg=250 cterm=NONE
hi CocLoaderHighlightBlock guifg=#fafafa guibg=#4078f2 ctermfg=231 ctermbg=69 cterm=NONE
...
hi CocLoaderTabInactive guifg=#fafafa guibg=#b7b7b8 ctermfg=231 ctermbg=250 cterm=NONE
hi CocLoaderTabActive guibg=#519ABA guifg=#fafafa ctermfg=231 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderHeaderSec guibg=#519ABA guifg=#fafafa ctermfg=231 ctermbg=67 cterm=NONE gui=bold
hi CocLoaderHeader guibg=#4078f2 guifg=#fafafa ctermfg=231 ctermbg=69 cterm=NONE gui=bold
...
hi LspSignatureActiveParameter guibg=#50a14f guifg=#fafafa ctermfg=231 ctermbg=71 cterm=NONE
...
hi Type guisp=NONE guifg=#c18401 ctermfg=136 cterm=NONE
hi Todo guibg=#f4f4f4 guifg=#c18401 ctermfg=136 ctermbg=255 cterm=NONE
...
hi Identifier guisp=NONE guifg=#d84a3d ctermfg=167 cterm=NONE
hi Float guifg=#d75f00 ctermfg=166 cterm=NONE
hi Delimiter guifg=#986801 ctermfg=94 cterm=NONE
hi Define guisp=NONE guifg=#a626a4 ctermfg=127 cterm=NONE
...
hi BufferLineDuplicateSelected guibg=#fafafa guifg=#d84a3d ctermfg=167 ctermbg=231 cterm=NONE
hi BufferLineDuplicate guibg=#EAEAEB guifg=NONE ctermbg=255 cterm=NONE
hi BufferLineDevIconDefaultInactive guibg=NONE cterm=NONE
hi BufferLineDevIconDefaultSelected guibg=NONE cterm=NONE
hi CmpItemKindSuperMaven guifg=#c18401 ctermfg=136 cterm=NONE
hi BufferLineTabSelected guibg=#428bab guifg=#EAEAEB ctermfg=255 ctermbg=67 cterm=NONE
hi CmpItemKindCodeium guifg=#7eca9c ctermfg=115 cterm=NONE
hi BufferLineSeparatorSelected guibg=#EAEAEB guifg=#EAEAEB ctermfg=255 ctermbg=255 cterm=NONE
hi BufferLineSeparatorVisible guibg=#EAEAEB guifg=#EAEAEB ctermfg=255 ctermbg=255 cterm=NONE
hi BufferLineSeparator guibg=#EAEAEB guifg=#EAEAEB ctermfg=255 ctermbg=255 cterm=NONE
hi CmpItemKindEvent guifg=#c18401 ctermfg=136 cterm=NONE
hi BufferLineModifiedVisible guibg=#EAEAEB guifg=#d84a3d ctermfg=167 ctermbg=255 cterm=NONE
hi CmpItemKindStruct guifg=#a626a4 ctermfg=127 cterm=NONE
hi CmpItemKindEnumMember guifg=#a28dcd ctermfg=140 cterm=NONE
hi BufferLineFill guibg=#EAEAEB guifg=#b0b0b1 ctermfg=145 ctermbg=255 cterm=NONE
hi BufferLineCloseButtonSelected guibg=#fafafa guifg=#d84a3d ctermfg=167 ctermbg=231 cterm=NONE
hi BufferLineCloseButtonVisible guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
...
hi MasonMutedBlock guibg=#dadadb guifg=#a2a2a3 ctermfg=247 ctermbg=253 cterm=NONE
hi MasonMuted guifg=#a2a2a3 ctermfg=247 cterm=NONE
hi def link MasonHeaderSecondary MasonHighlightBlock
hi MasonHighlightBlock guibg=#50a14f guifg=#fafafa ctermfg=231 ctermbg=71 cterm=NONE
...
hi Error guibg=#d84a3d guifg=#fafafa ctermfg=231 ctermbg=167 cterm=NONE
hi MiniTablineCurrent guibg=#fafafa guifg=#54555b ctermfg=240 ctermbg=231 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guibg=#fafafa guifg=#50a14f ctermfg=71 ctermbg=231 cterm=NONE gui=underline
...
hi Normal guibg=#fafafa guifg=#383a42 ctermfg=237 ctermbg=231 cterm=NONE
...
hi CocInfoFloat guibg=#efeff0 guifg=#4078f2 ctermfg=69 ctermbg=255 cterm=NONE
hi def link CocNotificationWarning CocWarningFloat
hi CocWarningFloat guibg=#efeff0 guifg=#c18401 ctermfg=136 ctermbg=255 cterm=NONE
hi def link CocNotificationError CocErrorFloat
hi CocErrorFloat guibg=#efeff0 guifg=#d84a3d ctermfg=167 ctermbg=255 cterm=NONE
...
hi CocFloating guibg=#efeff0 ctermbg=255 cterm=NONE
...
hi CocMenuSel guifg=#fafafa guibg=#5e5f65 ctermfg=231 ctermbg=241 cterm=NONE
...
hi CocSelectedText guifg=#54555b guibg=#d4d4d5 ctermfg=240 ctermbg=188 cterm=NONE
hi def link CocHighlightWrite CocHighlightText
hi def link CocHighlightRead CocHighlightText
hi def link CocInlayHintType CocInlayHint
hi CocInlayHint guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
hi def link CocInlayHintParameter CocInlayHint
hi CocHintFloat guibg=#efeff0 guifg=#519ABA ctermfg=67 ctermbg=255 cterm=NONE
...
hi CocInfoHighlight guisp=#4078f2 guifg=#4078f2 ctermfg=69 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#c18401 guifg=#c18401 ctermfg=136 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#d84a3d guifg=#d84a3d ctermfg=167 cterm=NONE gui=undercurl
...
hi NoiceFormatProgressDone guifg=#fafafa guibg=#50a14f ctermfg=231 ctermbg=71 cterm=NONE
...
hi TodoBgHack guibg=#FF6A00 guifg=#EAEAEB ctermfg=255 ctermbg=202 cterm=NONE gui=bold
hi TodoBgFix guibg=#d84a3d guifg=#EAEAEB ctermfg=255 ctermbg=167 cterm=NONE gui=bold
hi SnacksPickerComment guifg=#a2a2a3 ctermfg=247 cterm=NONE
hi SnacksPickerTree guifg=#b7b7b8 ctermfg=250 cterm=NONE
hi TodoBgPerf guibg=#a28dcd guifg=#EAEAEB ctermfg=255 ctermbg=140 cterm=NONE gui=bold
hi TodoBgTest guibg=#a28dcd guifg=#EAEAEB ctermfg=255 ctermbg=140 cterm=NONE gui=bold
hi TodoBgTodo guibg=#c18401 guifg=#EAEAEB ctermfg=255 ctermbg=136 cterm=NONE gui=bold
...
hi FloatTitle guibg=#b7b7b8 guifg=#54555b ctermfg=240 ctermbg=250 cterm=NONE
...
hi NeogitHunkHeaderHighlight guibg=#8e79b9 guifg=#fafafa ctermfg=231 ctermbg=103 cterm=NONE gui=bold
hi NeogitHunkHeader guibg=#b7b7b8 guifg=#fafafa ctermfg=231 ctermbg=250 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guibg=#0b8ec6 guifg=#fafafa ctermfg=231 ctermbg=32 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guibg=#0b8ec6 guifg=#fafafa ctermfg=231 ctermbg=32 cterm=NONE gui=bold
hi NeogitHunkMergeHeader guibg=#b7b7b8 guifg=#EAEAEB ctermfg=255 ctermbg=250 cterm=NONE gui=bold
...
hi NeogitHunkHeaderCursor guibg=#8e79b9 guifg=#fafafa ctermfg=231 ctermbg=103 cterm=NONE gui=bold
...
hi NeogitDiffHeader guibg=#d4d4d5 guifg=#4078f2 ctermfg=69 ctermbg=188 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guibg=#d4d4d5 guifg=#FF6A00 ctermfg=202 ctermbg=188 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#4078f2 ctermfg=69 cterm=NONE gui=bold,italic
hi NeogitChangeAdded guifg=#50a14f guibg=#328331 ctermfg=71 ctermbg=65 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#d84a3d ctermfg=167 cterm=NONE gui=bold,italic
hi NeogitChangeRenamed guifg=#a28dcd ctermfg=140 cterm=NONE gui=bold,italic
hi NeogitChangeUpdated guifg=#FF6A00 ctermfg=202 cterm=NONE gui=bold,italic
...
hi NeogitChangeNewFile guifg=#50a14f ctermfg=71 cterm=NONE gui=bold,italic
...
hi NeogitFloatHeaderHighlight guibg=#EAEAEB guifg=#0b8ec6 ctermfg=32 ctermbg=255 cterm=NONE gui=bold
...
hi BufferLineCloseButton guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
hi BufferLineErrorDiagnostic guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
hi BufferLineError guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
...
hi PmenuSel guifg=#fafafa guibg=#5e5f65 ctermfg=231 ctermbg=241 cterm=NONE
hi PmenuThumb guibg=#b7b7b8 ctermbg=250 cterm=NONE
hi MatchWord guifg=#54555b guibg=#b7b7b8 ctermfg=240 ctermbg=250 cterm=NONE
...
hi BufferlineIndicatorVisible guibg=#EAEAEB guifg=#EAEAEB ctermfg=255 ctermbg=255 cterm=NONE
hi BufferLineBackground guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
...
hi TodoBgNote guibg=#54555b guifg=#EAEAEB ctermfg=255 ctermbg=240 cterm=NONE gui=bold
...
hi BufferLineBufferSelected guibg=#fafafa guifg=#54555b ctermfg=240 ctermbg=231 cterm=NONE
hi BufferLineBufferVisible guibg=#EAEAEB guifg=#a2a2a3 ctermfg=247 ctermbg=255 cterm=NONE
...
hi BufferLineModified guibg=#EAEAEB guifg=#d84a3d ctermfg=167 ctermbg=255 cterm=NONE
hi BufferLineModifiedSelected guibg=#fafafa guifg=#50a14f ctermfg=71 ctermbg=231 cterm=NONE
...
hi BufferLineTab guibg=#cccccd guifg=#a2a2a3 ctermfg=247 ctermbg=252 cterm=NONE
hi CmpItemKindTabNine guifg=#F07178 ctermfg=204 cterm=NONE
hi BufferLineTabClose guibg=#fafafa guifg=#d84a3d ctermfg=167 ctermbg=231 cterm=NONE
hi CmpPmenu guibg=#fafafa ctermbg=231 cterm=NONE
hi BufferLineDuplicateVisible guibg=#EAEAEB guifg=#4078f2 ctermfg=69 ctermbg=255 cterm=NONE
