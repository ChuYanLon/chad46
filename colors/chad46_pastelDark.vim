...
hi CocLoaderHeader guifg=#131a21 guibg=#99aee5 ctermfg=234 ctermbg=110 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#131a21 guibg=#92dbb6 ctermfg=234 ctermbg=115 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#131a21 guibg=#92dbb6 ctermfg=234 ctermbg=115 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#b5bcc9 guibg=#131a21 ctermfg=250 ctermbg=234 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#9fe8c3 guibg=#131a21 ctermfg=151 ctermbg=234 cterm=NONE gui=underline
...
hi TodoBgFix guifg=#1a2128 guibg=#ef8891 ctermfg=234 ctermbg=210 cterm=NONE gui=bold
hi TodoBgHack guifg=#1a2128 guibg=#EDA685 ctermfg=234 ctermbg=216 cterm=NONE gui=bold
hi TodoBgNote guifg=#1a2128 guibg=#b5bcc9 ctermfg=234 ctermbg=250 cterm=NONE gui=bold
hi TodoBgPerf guifg=#1a2128 guibg=#c2a2e3 ctermfg=234 ctermbg=146 cterm=NONE gui=bold
hi TodoBgTest guifg=#1a2128 guibg=#c2a2e3 ctermfg=234 ctermbg=146 cterm=NONE gui=bold
hi TodoBgTodo guifg=#1a2128 guibg=#fbdf90 ctermfg=234 ctermbg=222 cterm=NONE gui=bold
...
hi NeogitDiffHeader guifg=#99aee5 guibg=#2a3138 ctermfg=110 ctermbg=236 cterm=NONE gui=bold
hi WarningMsg guifg=#ef8891 ctermfg=210 cterm=NONE
hi NeogitBranch guifg=#99aee5 ctermfg=110 cterm=NONE gui=bold
hi NeogitBranchHead guifg=#99aee5 ctermfg=110 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#99aee5 ctermfg=110 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#9fe8c3 guibg=#81caa5 ctermfg=151 ctermbg=115 cterm=NONE gui=italic,bold
hi TroubleCount guifg=#fca2af ctermfg=217 cterm=NONE
hi TroubleCode guifg=#b5bcc9 ctermfg=250 cterm=NONE
hi NeogitChangeUpdated guifg=#EDA685 ctermfg=216 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#b5c3ea ctermfg=146 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#fbdf90 ctermfg=222 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#9fe8c3 ctermfg=151 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guifg=#b5c3ea guibg=#1a2128 ctermfg=146 ctermbg=234 cterm=NONE gui=bold
...
hi GitSignsCurrentLineBlame guifg=#4e555c ctermfg=240 cterm=NONE
...
hi CocErrorLine guibg=#342a31 ctermbg=236 cterm=NONE
hi CocWarningLine guibg=#353731 ctermbg=236 cterm=NONE
hi CocInfoLine guibg=#27303e ctermbg=236 cterm=NONE
hi CocHintLine guibg=#263637 ctermbg=236 cterm=NONE
...
hi CocSelectedLine guibg=#1a2128 ctermbg=234 cterm=NONE
...
hi Tabline guibg=#1a2128 ctermbg=234 cterm=NONE
hi TbFill guibg=#1a2128 ctermbg=234 cterm=NONE
hi TbBufOn guifg=#b5bcc9 guibg=#131a21 ctermfg=250 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#545b62 guibg=#1a2128 ctermfg=240 ctermbg=234 cterm=NONE
hi TbBufOnModified guifg=#9fe8c3 guibg=#131a21 ctermfg=151 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#ef8891 guibg=#1a2128 ctermfg=210 ctermbg=234 cterm=NONE
hi TbBufOnClose guifg=#ef8891 guibg=#131a21 ctermfg=210 ctermbg=234 cterm=NONE
hi TbBufOffClose guifg=#545b62 guibg=#1a2128 ctermfg=240 ctermbg=234 cterm=NONE
hi TbTabNewBtn guifg=#b5bcc9 guibg=#2a3138 ctermfg=250 ctermbg=236 cterm=NONE
hi TbTabOn guifg=#ef8891 guibg=#131a21 ctermfg=210 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#b5bcc9 guibg=#1a2128 ctermfg=250 ctermbg=234 cterm=NONE
hi TbTabCloseBtn guifg=#131a21 guibg=#9aa8cf ctermfg=234 ctermbg=110 cterm=NONE
hi TBTabTitle guifg=#131a21 guibg=#99aee5 ctermfg=234 ctermbg=110 cterm=NONE
hi TbThemeToggleBtn guifg=#b5bcc9 guibg=#363d44 ctermfg=250 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#131a21 guibg=#ef8891 ctermfg=234 ctermbg=210 cterm=NONE gui=bold
...
hi CocFloating guifg=#ced4df guibg=#10171e ctermfg=188 ctermbg=233 cterm=NONE
...
hi CocDiagnosticsFile guifg=#545b62 ctermfg=240 cterm=NONE
...
hi CocServicesPrefix guifg=#c2a2e3 ctermfg=146 cterm=NONE
hi CocServicesName guifg=#99aee5 ctermfg=110 cterm=NONE
hi CocServicesStat guifg=#9fe8c3 ctermfg=151 cterm=NONE
hi CocServicesLanguages guifg=#545b62 ctermfg=240 cterm=NONE
hi CocSourcesPrefix guifg=#c2a2e3 ctermfg=146 cterm=NONE
hi CocSourcesName guifg=#99aee5 ctermfg=110 cterm=NONE
hi CocSourcesPriority guifg=#EDA685 ctermfg=216 cterm=NONE
hi CocSourcesFileTypes guifg=#545b62 ctermfg=240 cterm=NONE
hi CocSourcesType guifg=#9fe8c3 ctermfg=151 cterm=NONE
hi CocListsDesc guifg=#545b62 ctermfg=240 cterm=NONE
hi CocExtensionsActivated guifg=#9fe8c3 ctermfg=151 cterm=NONE
hi CocExtensionsLoaded guifg=#b5bcc9 ctermfg=250 cterm=NONE
hi CocExtensionsDisabled guifg=#4e555c ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#9fe8c3 ctermfg=151 cterm=NONE
hi CocExtensionsLocal guifg=#99aee5 ctermfg=110 cterm=NONE
hi CocExtensionsRoot guifg=#545b62 ctermfg=240 cterm=NONE
hi CocOutlineName guifg=#b5bcc9 ctermfg=250 cterm=NONE
hi CocOutlineIndentLine guifg=#545b62 ctermfg=240 cterm=NONE
hi CocOutlineKind guifg=#c2a2e3 ctermfg=146 cterm=NONE
hi CocOutlineLine guifg=#545b62 ctermfg=240 cterm=NONE
hi CocNotificationTime guifg=#545b62 ctermfg=240 cterm=NONE
hi CocCommandsTitle guifg=#545b62 ctermfg=240 cterm=NONE
...
hi NeotestTest guifg=#4e555c ctermfg=240 cterm=NONE
hi NeotestNamespace guifg=#9ce5c0 ctermfg=151 cterm=NONE
hi NeotestFocused guifg=#fbdf90 ctermfg=222 cterm=NONE
hi NeotestFile guifg=#b5c3ea ctermfg=146 cterm=NONE
hi NeotestDir guifg=#99aee5 ctermfg=110 cterm=NONE
hi NeotestBorder guifg=#99aee5 ctermfg=110 cterm=NONE
hi NeotestIndent guifg=#51585f ctermfg=240 cterm=NONE
hi NeotestExpandMarker guifg=#51585f ctermfg=240 cterm=NONE
...
hi NeotestSkipped guifg=#99aee5 ctermfg=110 cterm=NONE
hi NeotestFailed guifg=#ef8891 ctermfg=210 cterm=NONE
hi NeotestRunning guifg=#fbdf90 ctermfg=222 cterm=NONE
hi NeotestPassed guifg=#9fe8c3 ctermfg=151 cterm=NONE
hi NeotestTarget guifg=#99aee5 ctermfg=110 cterm=NONE
hi NeotestMarked guifg=#99aee5 ctermfg=110 cterm=NONE
hi NeotestWinSelect guifg=#99aee5 ctermfg=110 cterm=NONE
hi NeotestAdapterName guifg=#c2a2e3 ctermfg=146 cterm=NONE gui=bold
hi NeogitDiffHeaderHighlight guifg=#EDA685 guibg=#2a3138 ctermfg=216 ctermbg=236 cterm=NONE gui=bold
...
hi NeogitChangeRenamed guifg=#c2a2e3 ctermfg=146 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#ef8891 ctermfg=210 cterm=NONE gui=italic,bold
...
hi NeogitHunkHeaderCursor guifg=#131a21 guibg=#b696d7 ctermfg=234 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guifg=#131a21 guibg=#b696d7 ctermfg=234 ctermbg=140 cterm=NONE gui=bold
hi NeogitHunkHeader guifg=#131a21 guibg=#363d44 ctermfg=234 ctermbg=237 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guifg=#131a21 guibg=#b5c3ea ctermfg=234 ctermbg=146 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderHighlight guifg=#131a21 guibg=#b5c3ea ctermfg=234 ctermbg=146 cterm=NONE gui=bold
hi NeogitHunkMergeHeader guifg=#1a2128 guibg=#363d44 ctermfg=234 ctermbg=237 cterm=NONE gui=bold
...
hi CocSelectedText guifg=#ef8891 ctermfg=210 cterm=NONE
...
hi FoldColumn guifg=#e88e9b guibg=NONE ctermfg=174 cterm=NONE
