...
hi NeogitChangeAdded guifg=#9fe8c3 guibg=#81caa5 ctermfg=151 ctermbg=115 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#f5d595 ctermfg=222 cterm=NONE
...
hi Identifier guisp=NONE guifg=#ef8891 ctermfg=210 cterm=NONE
hi Float guifg=#EDA685 ctermfg=216 cterm=NONE
hi Delimiter guifg=#e88e9b ctermfg=174 cterm=NONE
hi Define guisp=NONE guifg=#c2a2e3 ctermfg=146 cterm=NONE
...
hi CocHintHighlight guisp=#92dbb6 guifg=#92dbb6 ctermfg=115 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#99aee5 guifg=#99aee5 ctermfg=110 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#fbdf90 guifg=#fbdf90 ctermfg=222 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#ef8891 guifg=#ef8891 ctermfg=210 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#ced4df ctermfg=188 cterm=NONE
