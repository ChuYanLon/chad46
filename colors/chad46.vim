...
hi NeotestPassed guifg=#3CEC85 ctermfg=84 cterm=NONE
hi NeotestRunning guifg=#EACD61 ctermfg=185 cterm=NONE
hi NeotestFailed guifg=#FF738A ctermfg=204 cterm=NONE
hi NeotestSkipped guifg=#69C3FF ctermfg=75 cterm=NONE
hi NeotestTest guifg=#4e5665 ctermfg=240 cterm=NONE
hi NeotestNamespace guifg=#9bdead ctermfg=115 cterm=NONE
hi NeotestFocused guifg=#EACD61 ctermfg=185 cterm=NONE
hi NeotestFile guifg=#22ECDB ctermfg=50 cterm=NONE
hi NeotestDir guifg=#69C3FF ctermfg=75 cterm=NONE
hi NeotestBorder guifg=#69C3FF ctermfg=75 cterm=NONE
hi NeotestIndent guifg=#58606f ctermfg=241 cterm=NONE
hi NeotestExpandMarker guifg=#58606f ctermfg=241 cterm=NONE
hi NeotestAdapterName guifg=#bd93ff ctermfg=141 cterm=NONE gui=bold
hi NeotestWinSelect guifg=#69C3FF ctermfg=75 cterm=NONE
hi NeotestMarked guifg=#69C3FF ctermfg=75 cterm=NONE
hi NeotestTarget guifg=#69C3FF ctermfg=75 cterm=NONE
...
hi Tabline guibg=#232b3a ctermbg=236 cterm=NONE
hi TbFill guibg=#232b3a ctermbg=236 cterm=NONE
hi TbBufOn guifg=#ABB7C1 guibg=#1c2433 ctermfg=249 ctermbg=235 cterm=NONE
hi TbBufOff guifg=#626a79 guibg=#232b3a ctermfg=242 ctermbg=236 cterm=NONE
hi TbBufOnModified guifg=#3CEC85 guibg=#1c2433 ctermfg=84 ctermbg=235 cterm=NONE
hi TbBufOffModified guifg=#FF738A guibg=#232b3a ctermfg=204 ctermbg=236 cterm=NONE
hi TbBufOnClose guifg=#FF738A guibg=#1c2433 ctermfg=204 ctermbg=235 cterm=NONE
hi TbBufOffClose guifg=#626a79 guibg=#232b3a ctermfg=242 ctermbg=236 cterm=NONE
hi TbTabNewBtn guifg=#ABB7C1 guibg=#303847 ctermfg=249 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#FF738A guibg=#1c2433 ctermfg=204 ctermbg=235 cterm=NONE
hi TbTabOff guifg=#ABB7C1 guibg=#232b3a ctermfg=249 ctermbg=236 cterm=NONE
hi TbTabCloseBtn guifg=#1c2433 guibg=#6da4cd ctermfg=235 ctermbg=74 cterm=NONE
...
hi NeogitBranchHead guifg=#69C3FF ctermfg=75 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#69C3FF ctermfg=75 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#3CEC85 guibg=#1ece67 ctermfg=84 ctermbg=41 cterm=NONE gui=italic,bold
hi NeogitChangeDeleted guifg=#FF738A ctermfg=204 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#bd93ff ctermfg=141 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#FF955C ctermfg=209 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#22ECDB ctermfg=50 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#EACD61 ctermfg=185 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#3CEC85 ctermfg=84 cterm=NONE gui=italic,bold
...
hi CocErrorLine guibg=#3e2f40 ctermbg=237 cterm=NONE
hi CocWarningLine guibg=#3a3d39 ctermbg=237 cterm=NONE
hi CocInfoLine guibg=#273b51 ctermbg=237 cterm=NONE
...
hi CocFloating guifg=#c3cfd9 guibg=#19212e ctermfg=252 ctermbg=235 cterm=NONE
hi CocMenuSel guibg=#3CEC85 guifg=#1c2433 ctermfg=235 ctermbg=84 cterm=NONE
...
hi CocSelectedLine guibg=#232b3a ctermbg=236 cterm=NONE
...
hi TelescopePromptPrefix guibg=#232b3a guifg=#FF738A ctermfg=204 ctermbg=236 cterm=NONE
...
hi CocDiagnosticsFile guifg=#626a79 ctermfg=242 cterm=NONE
...
hi CocServicesPrefix guifg=#bd93ff ctermfg=141 cterm=NONE
hi CocServicesName guifg=#69C3FF ctermfg=75 cterm=NONE
hi CocServicesStat guifg=#3CEC85 ctermfg=84 cterm=NONE
hi CocServicesLanguages guifg=#626a79 ctermfg=242 cterm=NONE
hi CocSourcesPrefix guifg=#bd93ff ctermfg=141 cterm=NONE
hi CocSourcesName guifg=#69C3FF ctermfg=75 cterm=NONE
hi CocSourcesPriority guifg=#FF955C ctermfg=209 cterm=NONE
hi CocSourcesFileTypes guifg=#626a79 ctermfg=242 cterm=NONE
hi CocSourcesType guifg=#3CEC85 ctermfg=84 cterm=NONE
hi TBTabTitle guifg=#1c2433 guibg=#69C3FF ctermfg=235 ctermbg=75 cterm=NONE
hi TbThemeToggleBtn guifg=#ABB7C1 guibg=#3a4251 ctermfg=249 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1c2433 guibg=#FF738A ctermfg=235 ctermbg=204 cterm=NONE gui=bold
hi CocExtensionsDisabled guifg=#4e5665 ctermfg=240 cterm=NONE
hi CocExtensionsName guifg=#3CEC85 ctermfg=84 cterm=NONE
hi CocExtensionsLocal guifg=#69C3FF ctermfg=75 cterm=NONE
hi CocExtensionsRoot guifg=#626a79 ctermfg=242 cterm=NONE
hi CocOutlineName guifg=#ABB7C1 ctermfg=249 cterm=NONE
hi CocOutlineIndentLine guifg=#626a79 ctermfg=242 cterm=NONE
hi CocOutlineKind guifg=#bd93ff ctermfg=141 cterm=NONE
hi CocOutlineLine guifg=#626a79 ctermfg=242 cterm=NONE
hi CocNotificationTime guifg=#626a79 ctermfg=242 cterm=NONE
hi CocCommandsTitle guifg=#626a79 ctermfg=242 cterm=NONE
...
hi CocHintLine guibg=#1a3c48 ctermbg=236 cterm=NONE
...
hi CocListsDesc guifg=#626a79 ctermfg=242 cterm=NONE
hi CocExtensionsActivated guifg=#3CEC85 ctermfg=84 cterm=NONE
hi CocExtensionsLoaded guifg=#ABB7C1 ctermfg=249 cterm=NONE
...
hi CocSelectedText guifg=#FF738A ctermfg=204 cterm=NONE
...
hi GitSignsCurrentLineBlame guifg=#4e5665 ctermfg=240 cterm=NONE
...
hi FoldColumn guifg=#B78AFF guibg=NONE ctermfg=141 cterm=NONE
hi Exception guifg=#FF738A ctermfg=204 cterm=NONE
hi Error guifg=#1c2433 guibg=#FF738A ctermfg=235 ctermbg=204 cterm=NONE
hi CocLoaderHeader guifg=#1c2433 guibg=#69C3FF ctermfg=235 ctermbg=75 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1c2433 guibg=#12c7c4 ctermfg=235 ctermbg=44 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1c2433 guibg=#12c7c4 ctermfg=235 ctermbg=44 cterm=NONE gui=bold
