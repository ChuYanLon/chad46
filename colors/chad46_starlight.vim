...
hi NeogitChangeAdded guifg=#47B413 guibg=#299600 ctermfg=70 ctermbg=28 cterm=NONE gui=bold,italic
...
hi Type guisp=NONE guifg=#13C299 ctermfg=36 cterm=NONE
...
hi Identifier guisp=NONE guifg=#E3C401 ctermfg=184 cterm=NONE
hi Float guifg=#24DFC4 ctermfg=44 cterm=NONE
hi Delimiter guifg=#9b9b9b ctermfg=247 cterm=NONE
hi Define guisp=NONE guifg=#F2AFFD ctermfg=219 cterm=NONE
...
hi CocHintHighlight guisp=#21BFC2 guifg=#21BFC2 ctermfg=37 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#24ACD4 guifg=#24ACD4 ctermfg=38 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#E3C401 guifg=#E3C401 ctermfg=184 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#F62B5A guifg=#F62B5A ctermfg=197 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#E6E6E6 ctermfg=254 cterm=NONE
