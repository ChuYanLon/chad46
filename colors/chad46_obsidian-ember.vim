...
hi TbThemeToggleBtn guibg=#3a3a3a guifg=#d3d3d3 ctermfg=252 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#ff6464 guifg=#1e1e1e ctermfg=234 ctermbg=203 cterm=NONE gui=bold
