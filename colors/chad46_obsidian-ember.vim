...
hi CocNormalFloat guibg=#161616 ctermbg=233 cterm=NONE
hi CocTitle guifg=#d3d3d3 ctermfg=252 cterm=NONE
...
hi CocErrorHighlight guifg=#ff6464 ctermfg=203 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#ffcc00 ctermfg=220 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#eeeeee ctermfg=255 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#729cff ctermfg=75 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#3a3a3a ctermbg=237 cterm=NONE
hi CocSelectedText guibg=#333333 guifg=#d3d3d3 ctermfg=252 ctermbg=236 cterm=NONE
...
hi CocUnused guifg=#484848 ctermfg=238 cterm=NONE
...
hi CocListSearch guifg=#ffcc00 guibg=#2c2c2c ctermfg=220 ctermbg=236 cterm=NONE
...
hi SnacksPickerIcon guifg=#eeeeee ctermfg=255 cterm=NONE
