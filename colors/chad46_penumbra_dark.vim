...
hi CocCursorRange guibg=#3a3d42 ctermbg=237 cterm=NONE
hi CocErrorHighlight guifg=#CA7081 ctermfg=168 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#c1ad4b ctermfg=143 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#8C96EC ctermfg=105 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#00a6c8 ctermfg=38 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#515459 ctermbg=240 cterm=NONE
hi CocSelectedText guibg=#484b50 guifg=#FFFDFB ctermfg=231 ctermbg=239 cterm=NONE
hi CocCodeLens guifg=#7d8085 ctermfg=244 cterm=NONE
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocUnused guifg=#676a6f ctermfg=242 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocListMode guifg=#8C96EC ctermfg=105 cterm=NONE
hi CocListSearch guifg=#c1ad4b guibg=#3d4045 ctermfg=143 ctermbg=238 cterm=NONE
...
hi CocNormalFloat guibg=#2b2e33 ctermbg=236 cterm=NONE
hi CocTitle guifg=#FFFDFB ctermfg=231 cterm=NONE
...
hi NeogitHunkMergeHeaderHighlight guibg=#00B3C2 guifg=#303338 ctermfg=236 ctermbg=37 cterm=NONE gui=bold
hi NeogitHunkMergeHeaderCursor guibg=#00B3C2 guifg=#303338 ctermfg=236 ctermbg=37 cterm=NONE gui=bold
hi NeogitHunkHeader guibg=#5c5f64 guifg=#303338 ctermfg=236 ctermbg=59 cterm=NONE gui=bold
hi NeogitHunkHeaderHighlight guibg=#8C96EC guifg=#303338 ctermfg=236 ctermbg=105 cterm=NONE gui=bold
hi NeogitHunkHeaderCursor guibg=#8C96EC guifg=#303338 ctermfg=236 ctermbg=105 cterm=NONE gui=bold
...
hi NeogitDiffHeader guibg=#484b50 guifg=#8C96EC ctermfg=105 ctermbg=239 cterm=NONE gui=bold
...
hi NeogitChangeAdded guibg=#309861 guifg=#4EB67F ctermfg=72 ctermbg=65 cterm=NONE gui=italic,bold
...
hi NeogitFloatHeaderHighlight guibg=#3a3d42 guifg=#00B3C2 ctermfg=37 ctermbg=237 cterm=NONE gui=bold
...
hi NeogitHunkMergeHeader guibg=#5c5f64 guifg=#3a3d42 ctermfg=237 ctermbg=59 cterm=NONE gui=bold
...
hi NeogitDiffHeaderHighlight guibg=#484b50 guifg=#CE9042 ctermfg=173 ctermbg=239 cterm=NONE gui=bold
...
hi TodoBgFix guibg=#CA7081 guifg=#3a3d42 ctermfg=237 ctermbg=168 cterm=NONE gui=bold
hi TodoBgHack guibg=#CE9042 guifg=#3a3d42 ctermfg=237 ctermbg=173 cterm=NONE gui=bold
hi TodoBgNote guibg=#FFFDFB guifg=#3a3d42 ctermfg=237 ctermbg=231 cterm=NONE gui=bold
hi TodoBgPerf guibg=#ac78bd guifg=#3a3d42 ctermfg=237 ctermbg=139 cterm=NONE gui=bold
hi TodoBgTest guibg=#ac78bd guifg=#3a3d42 ctermfg=237 ctermbg=139 cterm=NONE gui=bold
hi TodoBgTodo guibg=#c1ad4b guifg=#3a3d42 ctermfg=237 ctermbg=143 cterm=NONE gui=bold
