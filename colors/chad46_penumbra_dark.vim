...
hi Type guisp=NONE guifg=#CA7081 ctermfg=168 cterm=NONE
...
hi Identifier guisp=NONE guifg=#999999 ctermfg=246 cterm=NONE
hi Float guifg=#BE85D1 ctermfg=140 cterm=NONE
hi Delimiter guifg=#A1A641 ctermfg=143 cterm=NONE
hi Define guisp=NONE guifg=#BE85D1 ctermfg=140 cterm=NONE
...
hi CocHintHighlight guisp=#00a6c8 guifg=#00a6c8 ctermfg=38 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#8C96EC guifg=#8C96EC ctermfg=105 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#c1ad4b guifg=#c1ad4b ctermfg=143 cterm=NONE gui=undercurl
...
hi NeogitChangeAdded guifg=#4EB67F guibg=#309861 ctermfg=72 ctermbg=65 cterm=NONE gui=bold,italic
