...
hi NeogitChangeAdded guibg=#3d7e72 guifg=#5b9c90 ctermfg=72 ctermbg=65 cterm=NONE gui=bold,italic
...
hi SnacksPickerMatch guifg=#526f93 guibg=#cbd1dc ctermfg=60 ctermbg=252 cterm=NONE
hi Variable guifg=#343d46 ctermfg=237 cterm=NONE
hi SnacksPickerListTitle guibg=#b40b11 guifg=#a3a9b4 ctermfg=248 ctermbg=124 cterm=NONE
hi SnacksPickerPreviewTitle guibg=#526f93 guifg=#a3a9b4 ctermfg=248 ctermbg=60 cterm=NONE
hi SnacksPickerTitle guibg=#5b9c90 guifg=#a3a9b4 ctermfg=248 ctermbg=72 cterm=NONE
