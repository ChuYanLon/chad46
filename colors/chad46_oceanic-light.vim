...
hi TbCloseAllBufsBtn guibg=#b40b11 guifg=#d8dee9 ctermfg=254 ctermbg=124 cterm=NONE gui=bold
hi TbThemeToggleBtn guibg=#bac0cb guifg=#26292f ctermfg=235 ctermbg=251 cterm=NONE gui=bold
