...
hi CocCursorRange guibg=#22262a ctermbg=235 cterm=NONE
hi CocErrorHighlight guifg=#e5a3a1 ctermfg=181 cterm=NONE gui=undercurl
hi CocWarningHighlight guifg=#ECE3B1 ctermfg=223 cterm=NONE gui=undercurl
hi CocInfoHighlight guifg=#A3CBE7 ctermfg=152 cterm=NONE gui=undercurl
hi CocHintHighlight guifg=#94D2CF ctermfg=116 cterm=NONE gui=undercurl
hi CocHighlightText guibg=#393d41 ctermbg=237 cterm=NONE
hi CocSelectedText guibg=#2f3337 guifg=#FFDEDE ctermfg=224 ctermbg=236 cterm=NONE
hi CocCodeLens guifg=#5d6165 ctermfg=241 cterm=NONE
hi CocBold cterm=NONE gui=bold
hi CocItalic cterm=NONE gui=italic
hi CocUnused guifg=#4b4f53 ctermfg=239 cterm=NONE
hi CocStrike cterm=NONE gui=strikethrough
hi CocListMode guifg=#A3CBE7 ctermfg=152 cterm=NONE
hi CocListSearch guifg=#ECE3B1 guibg=#25292d ctermfg=223 ctermbg=235 cterm=NONE
...
hi CocNormalFloat guibg=#161a1e ctermbg=234 cterm=NONE
hi CocTitle guifg=#FFDEDE ctermfg=224 cterm=NONE
...
hi NeogitChangeAdded guibg=#96c58f guifg=#B4E3AD ctermfg=151 ctermbg=114 cterm=NONE gui=italic,bold
