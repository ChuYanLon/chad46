...
hi TbThemeToggleBtn guibg=#393d41 guifg=#FFDEDE ctermfg=224 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#e5a3a1 guifg=#1B1F23 ctermfg=234 ctermbg=181 cterm=NONE gui=bold
