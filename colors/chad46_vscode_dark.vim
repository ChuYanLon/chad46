...
hi SnacksPickerMatch guifg=#569CD6 guibg=#282828 ctermfg=74 ctermbg=235 cterm=NONE
hi SnacksPickerFooter guifg=#4e4e4e ctermfg=239 cterm=NONE
hi SnacksPickerListTitle guibg=#D16969 guifg=#4e4e4e ctermfg=239 ctermbg=167 cterm=NONE
hi SnacksPickerPreviewTitle guibg=#569CD6 guifg=#4e4e4e ctermfg=239 ctermbg=74 cterm=NONE
hi SnacksPickerTitle guibg=#B5CEA8 guifg=#4e4e4e ctermfg=239 ctermbg=151 cterm=NONE
