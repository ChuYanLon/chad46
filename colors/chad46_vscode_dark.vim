...
hi TbThemeToggleBtn guibg=#3a3a3a guifg=#dee1e6 ctermfg=254 ctermbg=237 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guibg=#D16969 guifg=#1E1E1E ctermfg=234 ctermbg=167 cterm=NONE gui=bold
