...
hi BlinkCmpMenuSelection guifg=#1b1e28 guibg=#5FB3A1 ctermfg=234 ctermbg=73 cterm=NONE gui=bold
...
hi CocLoaderHeader guifg=#1b1e28 guibg=#89DDFF ctermfg=234 ctermbg=117 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#1b1e28 guibg=#5DE4C7 ctermfg=234 ctermbg=80 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#1b1e28 guibg=#5DE4C7 ctermfg=234 ctermbg=80 cterm=NONE gui=bold
...
hi MiniTablineCurrent guifg=#E4F0FB guibg=#1b1e28 ctermfg=255 ctermbg=234 cterm=NONE gui=underline
...
hi MiniTablineModifiedCurrent guifg=#5FB3A1 guibg=#1b1e28 ctermfg=73 ctermbg=234 cterm=NONE gui=underline
...
hi NeogitChangeAdded guifg=#5FB3A1 guibg=#419583 ctermfg=73 ctermbg=66 cterm=NONE gui=italic,bold
...
hi GitSignsCurrentLineBlame guifg=#515977 ctermfg=60 cterm=NONE
...
hi Tabline guibg=#222633 ctermbg=235 cterm=NONE
hi TbFill guibg=#222633 ctermbg=235 cterm=NONE
hi TbBufOn guifg=#E4F0FB guibg=#1b1e28 ctermfg=255 ctermbg=234 cterm=NONE
hi TbBufOff guifg=#657096 guibg=#222633 ctermfg=60 ctermbg=235 cterm=NONE
hi TbBufOnModified guifg=#5FB3A1 guibg=#1b1e28 ctermfg=73 ctermbg=234 cterm=NONE
hi TbBufOffModified guifg=#D0679D guibg=#222633 ctermfg=169 ctermbg=235 cterm=NONE
hi TbBufOnClose guifg=#D0679D guibg=#1b1e28 ctermfg=169 ctermbg=234 cterm=NONE
hi TbBufOffClose guifg=#657096 guibg=#222633 ctermfg=60 ctermbg=235 cterm=NONE
hi TbTabNewBtn guifg=#E4F0FB guibg=#32384a ctermfg=255 ctermbg=237 cterm=NONE
hi TbTabOn guifg=#D0679D guibg=#1b1e28 ctermfg=169 ctermbg=234 cterm=NONE
hi TbTabOff guifg=#E4F0FB guibg=#222633 ctermfg=255 ctermbg=235 cterm=NONE
hi TbTabCloseBtn guifg=#1b1e28 guibg=#91B4D5 ctermfg=234 ctermbg=110 cterm=NONE
hi TBTabTitle guifg=#1b1e28 guibg=#89DDFF ctermfg=234 ctermbg=117 cterm=NONE
hi TbThemeToggleBtn guifg=#E4F0FB guibg=#3b4258 ctermfg=255 ctermbg=238 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#1b1e28 guibg=#D0679D ctermfg=234 ctermbg=169 cterm=NONE gui=bold
...
hi NeotestTest guifg=#515977 ctermfg=60 cterm=NONE
hi NeotestNamespace guifg=#71bbab ctermfg=73 cterm=NONE
hi NeotestFocused guifg=#FFFAC2 ctermfg=229 cterm=NONE
hi NeotestFile guifg=#92e0ff ctermfg=117 cterm=NONE
hi NeotestDir guifg=#89DDFF ctermfg=117 cterm=NONE
hi NeotestBorder guifg=#89DDFF ctermfg=117 cterm=NONE
hi NeotestIndent guifg=#5d678a ctermfg=60 cterm=NONE
hi NeotestExpandMarker guifg=#5d678a ctermfg=60 cterm=NONE
...
hi NeotestSkipped guifg=#89DDFF ctermfg=117 cterm=NONE
hi NeotestFailed guifg=#D0679D ctermfg=169 cterm=NONE
hi GitConflictDiffText guibg=#25343a ctermbg=236 cterm=NONE
hi NeotestRunning guifg=#FFFAC2 ctermfg=229 cterm=NONE
hi NeotestPassed guifg=#5FB3A1 ctermfg=73 cterm=NONE
hi NeotestTarget guifg=#89DDFF ctermfg=117 cterm=NONE
hi NeotestMarked guifg=#89DDFF ctermfg=117 cterm=NONE
hi NeotestWinSelect guifg=#89DDFF ctermfg=117 cterm=NONE
hi NeotestAdapterName guifg=#A6ACCD ctermfg=146 cterm=NONE gui=bold
