...
hi TelescopeMatching guifg=#5DE4C7 guibg=#2b3040 ctermfg=80 ctermbg=236 cterm=NONE
...
hi NeogitBranchHead guifg=#89DDFF ctermfg=117 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#89DDFF ctermfg=117 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#5FB3A1 guibg=#419583 ctermfg=73 ctermbg=66 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#D0679D ctermfg=169 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#A6ACCD ctermfg=146 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#91B4D5 ctermfg=110 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#92e0ff ctermfg=117 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#FFFAC2 ctermfg=229 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#5FB3A1 ctermfg=73 cterm=NONE gui=italic,bold
...
hi LazyH2 guifg=#D0679D ctermfg=169 cterm=NONE gui=underline,bold
...
hi Identifier guisp=NONE guifg=#A6ACCD ctermfg=146 cterm=NONE
hi Float guifg=#D0679D ctermfg=169 cterm=NONE
hi Delimiter guifg=#ffffff ctermfg=231 cterm=NONE
hi Define guisp=NONE guifg=#91B4D5 ctermfg=110 cterm=NONE
...
hi CocHintHighlight guisp=#5DE4C7 guifg=#5DE4C7 ctermfg=80 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#89DDFF guifg=#89DDFF ctermfg=117 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#FFFAC2 guifg=#FFFAC2 ctermfg=229 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#D0679D guifg=#D0679D ctermfg=169 cterm=NONE gui=undercurl
...
hi TelescopePromptPrefix guibg=#222633 guifg=#D0679D ctermfg=169 ctermbg=235 cterm=NONE
...
hi Operator guisp=NONE guifg=#A6ACCD ctermfg=146 cterm=NONE
