...
hi CocLoaderHeader guifg=#FFF7ED guibg=#6E8DD5 ctermfg=255 ctermbg=68 cterm=NONE gui=bold
hi CocLoaderHeaderSec guifg=#FFF7ED guibg=#22839b ctermfg=255 ctermbg=30 cterm=NONE gui=bold
hi CocLoaderTabActive guifg=#FFF7ED guibg=#22839b ctermfg=255 ctermbg=30 cterm=NONE gui=bold
...
hi NeogitChangeModified guifg=#6E8DD5 ctermfg=68 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#3ea57b guibg=#20875d ctermfg=72 ctermbg=29 cterm=NONE gui=italic,bold
...
hi NeogitChangeUpdated guifg=#BA823A ctermfg=137 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#00A0BA ctermfg=37 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#92963a ctermfg=101 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#3ea57b ctermfg=72 cterm=NONE gui=italic,bold
...
hi GitSignsCurrentLineBlame guifg=#c4bcb2 ctermfg=250 cterm=NONE
...
hi Tabline guibg=#f0e8de ctermbg=254 cterm=NONE
hi TbFill guibg=#f0e8de ctermbg=254 cterm=NONE
hi TbBufOn guifg=#3E4044 guibg=#FFF7ED ctermfg=238 ctermbg=255 cterm=NONE
hi TbBufOff guifg=#b0a89e guibg=#f0e8de ctermfg=248 ctermbg=254 cterm=NONE
hi TbBufOnModified guifg=#3ea57b guibg=#FFF7ED ctermfg=72 ctermbg=255 cterm=NONE
hi TbBufOffModified guifg=#ca7081 guibg=#f0e8de ctermfg=168 ctermbg=254 cterm=NONE
hi TbBufOnClose guifg=#ca7081 guibg=#FFF7ED ctermfg=168 ctermbg=255 cterm=NONE
hi TbBufOffClose guifg=#b0a89e guibg=#f0e8de ctermfg=248 ctermbg=254 cterm=NONE
hi TbTabNewBtn guifg=#3E4044 guibg=#e6ded4 ctermfg=238 ctermbg=253 cterm=NONE
hi TbTabOn guifg=#ca7081 guibg=#FFF7ED ctermfg=168 ctermbg=255 cterm=NONE
hi TbTabOff guifg=#3E4044 guibg=#f0e8de ctermfg=238 ctermbg=254 cterm=NONE
hi TbTabCloseBtn guifg=#FFF7ED guibg=#5794D0 ctermfg=255 ctermbg=68 cterm=NONE
hi TBTabTitle guifg=#FFF7ED guibg=#6E8DD5 ctermfg=255 ctermbg=68 cterm=NONE
hi TbThemeToggleBtn guifg=#3E4044 guibg=#dad2c8 ctermfg=238 ctermbg=252 cterm=NONE gui=bold
hi TbCloseAllBufsBtn guifg=#FFF7ED guibg=#ca7081 ctermfg=255 ctermbg=168 cterm=NONE gui=bold
...
hi NeotestTest guifg=#c4bcb2 ctermfg=250 cterm=NONE
hi NeotestNamespace guifg=#46A473 ctermfg=71 cterm=NONE
hi NeotestFocused guifg=#92963a ctermfg=101 cterm=NONE
hi NeotestFile guifg=#00A0BA ctermfg=37 cterm=NONE
hi NeotestDir guifg=#6E8DD5 ctermfg=68 cterm=NONE
hi NeotestBorder guifg=#6E8DD5 ctermfg=68 cterm=NONE
hi NeotestIndent guifg=#bab2a8 ctermfg=249 cterm=NONE
hi NeotestExpandMarker guifg=#bab2a8 ctermfg=249 cterm=NONE
...
hi NeotestSkipped guifg=#6E8DD5 ctermfg=68 cterm=NONE
hi NeotestFailed guifg=#ca7081 ctermfg=168 cterm=NONE
hi GitConflictDiffText guibg=#e2eadb ctermbg=254 cterm=NONE
hi NeotestRunning guifg=#92963a ctermfg=101 cterm=NONE
hi NeotestPassed guifg=#3ea57b ctermfg=72 cterm=NONE
hi NeotestTarget guifg=#6E8DD5 ctermfg=68 cterm=NONE
hi NeotestMarked guifg=#6E8DD5 ctermfg=68 cterm=NONE
hi NeotestWinSelect guifg=#6E8DD5 ctermfg=68 cterm=NONE
