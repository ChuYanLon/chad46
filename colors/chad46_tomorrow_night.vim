...
hi NeogitBranchHead guifg=#6f8dab ctermfg=67 cterm=NONE gui=underline,bold
...
hi NeogitChangeModified guifg=#6f8dab ctermfg=67 cterm=NONE gui=italic,bold
hi NeogitChangeAdded guifg=#a4b595 guibg=#869777 ctermfg=144 ctermbg=102 cterm=NONE gui=bold,italic
hi NeogitChangeDeleted guifg=#cc6666 ctermfg=167 cterm=NONE gui=italic,bold
hi NeogitChangeRenamed guifg=#b4bbc8 ctermfg=250 cterm=NONE gui=italic,bold
hi NeogitChangeUpdated guifg=#DE935F ctermfg=173 cterm=NONE gui=italic,bold
hi NeogitChangeCopied guifg=#70c0b1 ctermfg=73 cterm=NONE gui=italic,bold
hi NeogitChangeUnmerged guifg=#d7bd8d ctermfg=180 cterm=NONE gui=italic,bold
hi NeogitChangeNewFile guifg=#a4b595 ctermfg=144 cterm=NONE gui=italic,bold
...
hi Type guisp=NONE guifg=#f0c674 ctermfg=222 cterm=NONE
...
hi Identifier guisp=NONE guifg=#cc6666 ctermfg=167 cterm=NONE
hi Float guifg=#de935f ctermfg=173 cterm=NONE
hi Delimiter guifg=#a3685a ctermfg=131 cterm=NONE
hi Define guisp=NONE guifg=#b294bb ctermfg=139 cterm=NONE
...
hi CocHintHighlight guisp=#8abdb6 guifg=#8abdb6 ctermfg=109 cterm=NONE gui=undercurl
hi CocInfoHighlight guisp=#6f8dab guifg=#6f8dab ctermfg=67 cterm=NONE gui=undercurl
hi CocWarningHighlight guisp=#d7bd8d guifg=#d7bd8d ctermfg=180 cterm=NONE gui=undercurl
hi CocErrorHighlight guisp=#cc6666 guifg=#cc6666 ctermfg=167 cterm=NONE gui=undercurl
...
hi Operator guisp=NONE guifg=#c5c8c6 ctermfg=251 cterm=NONE
...
hi LazyH2 guifg=#cc6666 ctermfg=167 cterm=NONE gui=underline,bold
